...
#define GIMP_VALUE_HOLDS_MATRIX2(value)                                        \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_MATRIX2))
...
#define GIMP_IS_PARAM_SPEC_MATRIX2(pspec)                                      \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_MATRIX2))
...
#define GIMP_VALUE_HOLDS_MATRIX3(value)                                        \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_MATRIX3))

GType gimp_matrix3_get_type(void) G_GNUC_CONST;

#define GIMP_TYPE_PARAM_MATRIX3 (gimp_param_matrix3_get_type())
#define GIMP_IS_PARAM_SPEC_MATRIX3(pspec)                                      \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_MATRIX3))
