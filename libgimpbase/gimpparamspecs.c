 ...
 * @static_data:
 */
GimpArray *gimp_array_new(const guint8 *data, gsize length,
                          gboolean static_data) {
  GimpArray *array;

  g_return_val_if_fail(
      (data == NULL && length == 0) || (data != NULL && length > 0), NULL);
...
static gboolean gimp_param_array_validate(GParamSpec *pspec, GValue *value);
static gint gimp_param_array_values_cmp(GParamSpec *pspec, const GValue *value1,
                                        const GValue *value2);
...
GType gimp_param_array_get_type(void) {
  ...
  if (!type) {
    const GTypeInfo info = {sizeof(GParamSpecClass),
                            NULL,
                            NULL,
    ...
    type =
        g_type_register_static(G_TYPE_PARAM_BOXED, "GimpParamArray", &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_array(const gchar *name, const gchar *nick,
                                  const gchar *blurb, GParamFlags flags) {
  GimpParamSpecArray *array_spec;

  array_spec =
      g_param_spec_internal(GIMP_TYPE_PARAM_ARRAY, name, nick, blurb, flags);

  return G_PARAM_SPEC(array_spec);
}

static const guint8 *gimp_value_get_array(const GValue *value) {
  GimpArray *array = value->data[0].v_pointer;
...
static guint8 *gimp_value_dup_array(const GValue *value) {
  GimpArray *array = value->data[0].v_pointer;
...
static void gimp_value_set_array(GValue *value, const guint8 *data,
                                 gsize length) {
...
static void gimp_value_set_static_array(GValue *value, const guint8 *data,
                                        gsize length) {
...
static void gimp_value_take_array(GValue *value, guint8 *data, gsize length) {
  GimpArray *array = gimp_array_new(data, length, TRUE);
...
G_DEFINE_BOXED_TYPE(GimpUint8Array, gimp_uint8_array, gimp_array_copy,
                    gimp_array_free)
...
GType gimp_param_uint8_array_get_type(void) {
  static GType type = 0;
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ARRAY, "GimpParamUInt8Array",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_uint8_array(const gchar *name, const gchar *nick,
                                        const gchar *blurb, GParamFlags flags) {
  GimpParamSpecArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_UINT8_ARRAY, name, nick,
                                     blurb, flags);
 ...
 */
void gimp_value_set_uint8_array(GValue *value, const guint8 *data,
                                gsize length) {
 ...
 */
void gimp_value_set_static_uint8_array(GValue *value, const guint8 *data,
                                       gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_UINT8_ARRAY(value));
 ...
 */
void gimp_value_take_uint8_array(GValue *value, guint8 *data, gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_UINT8_ARRAY(value));
...
G_DEFINE_BOXED_TYPE(GimpInt16Array, gimp_int16_array, gimp_array_copy,
                    gimp_array_free)
...
GType gimp_param_int16_array_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ARRAY, "GimpParamInt16Array",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_int16_array(const gchar *name, const gchar *nick,
                                        const gchar *blurb, GParamFlags flags) {
  GimpParamSpecArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_INT16_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_int16_array(GValue *value, const gint16 *data,
                                gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT16_ARRAY(value));

  gimp_value_set_array(value, (const guint8 *)data, length * sizeof(gint16));
}
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_int16_array(GValue *value, const gint16 *data,
                                       gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT16_ARRAY(value));
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_int16_array(GValue *value, gint16 *data, gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT16_ARRAY(value));

  gimp_value_take_array(value, (guint8 *)data, length * sizeof(gint16));
}
...
G_DEFINE_BOXED_TYPE(GimpInt32Array, gimp_int32_array, gimp_array_copy,
                    gimp_array_free)
...
GType gimp_param_int32_array_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ARRAY, "GimpParamInt32Array",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_int32_array(const gchar *name, const gchar *nick,
                                        const gchar *blurb, GParamFlags flags) {
  GimpParamSpecArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_INT32_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_int32_array(GValue *value, const gint32 *data,
                                gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT32_ARRAY(value));

  gimp_value_set_array(value, (const guint8 *)data, length * sizeof(gint32));
}
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_int32_array(GValue *value, const gint32 *data,
                                       gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT32_ARRAY(value));
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_int32_array(GValue *value, gint32 *data, gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_INT32_ARRAY(value));

  gimp_value_take_array(value, (guint8 *)data, length * sizeof(gint32));
}
...
G_DEFINE_BOXED_TYPE(GimpFloatArray, gimp_float_array, gimp_array_copy,
                    gimp_array_free)
...
GType gimp_param_float_array_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ARRAY, "GimpParamFloatArray",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_float_array(const gchar *name, const gchar *nick,
                                        const gchar *blurb, GParamFlags flags) {
  GimpParamSpecArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_FLOAT_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_float_array(GValue *value, const gdouble *data,
                                gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_FLOAT_ARRAY(value));

  gimp_value_set_array(value, (const guint8 *)data, length * sizeof(gdouble));
}
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_float_array(GValue *value, const gdouble *data,
                                       gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_FLOAT_ARRAY(value));
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_float_array(GValue *value, gdouble *data, gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_FLOAT_ARRAY(value));

  gimp_value_take_array(value, (guint8 *)data, length * sizeof(gdouble));
}
 ...
 */
GimpStringArray *gimp_string_array_new(const gchar **data, gsize length,
                                       gboolean static_data) {
...
GimpStringArray *gimp_string_array_copy(const GimpStringArray *array) {
  if (array)
    return gimp_string_array_new((const gchar **)array->data, array->length,
                                 FALSE);
...
G_DEFINE_BOXED_TYPE(GimpStringArray, gimp_string_array, gimp_string_array_copy,
...
GType gimp_param_string_array_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(G_TYPE_PARAM_BOXED, "GimpParamStringArray",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_string_array(const gchar *name, const gchar *nick,
                                         const gchar *blurb,
                                         GParamFlags flags) {
  GimpParamSpecStringArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_STRING_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_string_array(GValue *value, const gchar **data,
                                 gsize length) {
  GimpStringArray *array;
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_string_array(GValue *value, const gchar **data,
                                        gsize length) {
  GimpStringArray *array;
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_string_array(GValue *value, gchar **data, gsize length) {
  GimpStringArray *array;
...
G_DEFINE_BOXED_TYPE(GimpRGBArray, gimp_rgb_array, gimp_array_copy,
                    gimp_array_free)
...
GType gimp_param_rgb_array_get_type(void) {
  static GType type = 0;
  ...
  if (!type) {
    ...
    type = g_type_register_static(G_TYPE_PARAM_BOXED, "GimpParamRGBArray",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_rgb_array(const gchar *name, const gchar *nick,
                                      const gchar *blurb, GParamFlags flags) {
  GimpParamSpecRGBArray *array_spec;

  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_RGB_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_rgb_array(GValue *value, const GimpRGB *data,
                              gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_RGB_ARRAY(value));

  gimp_value_set_array(value, (const guint8 *)data, length * sizeof(GimpRGB));
}
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_rgb_array(GValue *value, const GimpRGB *data,
                                     gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_RGB_ARRAY(value));
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_rgb_array(GValue *value, GimpRGB *data, gsize length) {
  g_return_if_fail(GIMP_VALUE_HOLDS_RGB_ARRAY(value));

  gimp_value_take_array(value, (guint8 *)data, length * sizeof(GimpRGB));
}
 ...
 */
GimpObjectArray *gimp_object_array_new(GType object_type, GObject **data,
                                       gsize length, gboolean static_data) {
...
GimpObjectArray *gimp_object_array_copy(const GimpObjectArray *array) {
  if (array)
    return gimp_object_array_new(array->object_type, array->data, array->length,
                                 FALSE);
...
G_DEFINE_BOXED_TYPE(GimpObjectArray, gimp_object_array, gimp_object_array_copy,
...
GType gimp_param_object_array_get_type(void) {
  static GType type = 0;
  ...
  if (!type) {
    ...
    type = g_type_register_static(G_TYPE_PARAM_BOXED, "GimpParamObjectArray",
                                  &info, 0);
  }
 ...
 * Since: 3.0
 **/
GParamSpec *gimp_param_spec_object_array(const gchar *name, const gchar *nick,
  ...
  array_spec = g_param_spec_internal(GIMP_TYPE_PARAM_OBJECT_ARRAY, name, nick,
                                     blurb, flags);
 ...
 * Sets the contents of @value to @data.
 */
void gimp_value_set_object_array(GValue *value, GType object_type,
                                 GObject **data, gsize length) {
  GimpObjectArray *array;
 ...
 * Sets the contents of @value to @data, without copying the data.
 */
void gimp_value_set_static_object_array(GValue *value, GType object_type,
                                        GObject **data, gsize length) {
  GimpObjectArray *array;
 ...
 * Sets the contents of @value to @data, and takes ownership of @data.
 */
void gimp_value_take_object_array(GValue *value, GType object_type,
                                  GObject **data, gsize length) {
  GimpObjectArray *array;
