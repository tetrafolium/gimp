 ...
 * Since: 2.4
 **/
#define GIMP_PARAM_READABLE (G_PARAM_READABLE | GIMP_PARAM_STATIC_STRINGS)
 ...
 * Since: 2.4
 **/
#define GIMP_PARAM_WRITABLE (G_PARAM_WRITABLE | GIMP_PARAM_STATIC_STRINGS)
 ...
 * Since: 2.4
 **/
#define GIMP_PARAM_READWRITE (G_PARAM_READWRITE | GIMP_PARAM_STATIC_STRINGS)
...
#define GIMP_VALUE_HOLDS_ARRAY(value)                                          \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_ARRAY))
...
#define GIMP_PARAM_SPEC_ARRAY(pspec)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_ARRAY,                  \
                              GimpParamSpecArray))
#define GIMP_IS_PARAM_SPEC_ARRAY(pspec)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_ARRAY))
...
#define GIMP_VALUE_HOLDS_UINT8_ARRAY(value)                                    \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_UINT8_ARRAY))
...
#define GIMP_PARAM_SPEC_UINT8_ARRAY(pspec)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_UINT8_ARRAY,            \
                              GimpParamSpecUInt8Array))
#define GIMP_IS_PARAM_SPEC_UINT8_ARRAY(pspec)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_UINT8_ARRAY))
...
#define GIMP_VALUE_HOLDS_INT16_ARRAY(value)                                    \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_INT16_ARRAY))
...
#define GIMP_PARAM_SPEC_INT16_ARRAY(pspec)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_INT16_ARRAY,            \
                              GimpParamSpecInt16Array))
#define GIMP_IS_PARAM_SPEC_INT16_ARRAY(pspec)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_INT16_ARRAY))
...
#define GIMP_VALUE_HOLDS_INT32_ARRAY(value)                                    \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_INT32_ARRAY))
...
#define GIMP_PARAM_SPEC_INT32_ARRAY(pspec)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_INT32_ARRAY,            \
                              GimpParamSpecInt32Array))
#define GIMP_IS_PARAM_SPEC_INT32_ARRAY(pspec)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_INT32_ARRAY))
...
#define GIMP_VALUE_HOLDS_FLOAT_ARRAY(value)                                    \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_FLOAT_ARRAY))
...
#define GIMP_PARAM_SPEC_FLOAT_ARRAY(pspec)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_FLOAT_ARRAY,            \
                              GimpParamSpecFloatArray))
#define GIMP_IS_PARAM_SPEC_FLOAT_ARRAY(pspec)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_FLOAT_ARRAY))
...
#define GIMP_VALUE_HOLDS_STRING_ARRAY(value)                                   \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_STRING_ARRAY))
...
#define GIMP_PARAM_SPEC_STRING_ARRAY(pspec)                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_STRING_ARRAY,           \
                              GimpParamSpecStringArray))
#define GIMP_IS_PARAM_SPEC_STRING_ARRAY(pspec)                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_STRING_ARRAY))
...
#define GIMP_VALUE_HOLDS_RGB_ARRAY(value)                                      \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_RGB_ARRAY))
...
#define GIMP_PARAM_SPEC_RGB_ARRAY(pspec)                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_RGB_ARRAY,              \
                              GimpParamSpecRGBArray))
#define GIMP_IS_PARAM_SPEC_RGB_ARRAY(pspec)                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_RGB_ARRAY))
...
void gimp_value_set_rgb_array(GValue *value, const GimpRGB *data, gsize length);
...
#define GIMP_VALUE_HOLDS_OBJECT_ARRAY(value)                                   \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_OBJECT_ARRAY))
...
#define GIMP_PARAM_SPEC_OBJECT_ARRAY(pspec)                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((pspec), GIMP_TYPE_PARAM_OBJECT_ARRAY,           \
                              GimpParamSpecObjectArray))
#define GIMP_IS_PARAM_SPEC_OBJECT_ARRAY(pspec)                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_OBJECT_ARRAY))
