...
static void gimp_config_class_init(GObjectClass *klass, GParamSpec **pspecs);
static void gimp_config_set_property(GObject *object, guint property_id,
                                     const GValue *value, GParamSpec *pspec);
static void gimp_config_get_property(GObject *object, guint property_id,
                                     GValue *value, GParamSpec *pspec);

static GValue *gimp_config_value_get(GObject *object, GParamSpec *pspec);
 ...
 * @pspecs: (array length=n_pspecs): array of #GParamSpec to install as
 *properties on the new type
...
GType gimp_config_type_register(GType parent_type, const gchar *type_name,
...

  {
    ...
    config_type = g_type_register_static(parent_type, type_name, &info, 0);
    ...
    if (!g_type_is_a(parent_type, GIMP_TYPE_CONFIG)) {
      ...
      g_type_add_interface_static(config_type, GIMP_TYPE_CONFIG, &config_info);
    }
  }
