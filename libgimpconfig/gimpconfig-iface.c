...
static gboolean gimp_config_iface_equal(GimpConfig *a, GimpConfig *b);
static void gimp_config_iface_reset(GimpConfig *config);
static gboolean gimp_config_iface_copy(GimpConfig *src, GimpConfig *dest,
                                       GParamFlags flags);
...
GType gimp_config_get_type(void) {
  ...
  if (!config_iface_type) {
    ...
    config_iface_type = g_type_register_static(
        G_TYPE_INTERFACE, "GimpConfigInterface", &config_iface_info, 0);
...
static GimpConfig *gimp_config_iface_duplicate(GimpConfig *config) {
  ...
  dup = g_object_new_with_properties(
      G_TYPE_FROM_INSTANCE(object), n_construct_properties,
      (const gchar **)construct_names, (const GValue *)construct_values);
 ...
 * Since: 2.10
 **/
gboolean gimp_config_serialize_to_file(GimpConfig *config, GFile *file,
                                       const gchar *header, const gchar *footer,
...
gboolean gimp_config_serialize_to_stream(GimpConfig *config,
                                         ...
                                         const gchar *header,
                                         const gchar *footer, gpointer data,
                                         GError **error) {
  GimpConfigWriter *writer;
 ...
 * Since: 2.4
 **/
gboolean gimp_config_serialize_to_fd(GimpConfig *config, gint fd,
                                     gpointer data) {
  GimpConfigWriter *writer;
 ...
 * Since: 3.0
 **/
GimpParasite *gimp_config_serialize_to_parasite(GimpConfig *config,
  ...
  parasite = gimp_parasite_new(parasite_name, parasite_flags, 0, NULL);
 ...
 * Since: 2.10
 **/
gboolean gimp_config_deserialize_file(GimpConfig *config, GFile *file,
                                      gpointer data, GError **error) {
  GScanner *scanner;
  gboolean success;
  ...
  success =
      GIMP_CONFIG_GET_IFACE(config)->deserialize(config, scanner, 0, data);
 ...
 * Since: 2.4
 **/
gboolean gimp_config_deserialize_string(GimpConfig *config, const gchar *text,
                                        gint text_len, gpointer data,
                                        GError **error) {
  GScanner *scanner;
  gboolean success;
...
gboolean gimp_config_deserialize_parasite(GimpConfig *config,
  ...
  return gimp_config_deserialize_string(config, gimp_parasite_data(parasite),
                                        gimp_parasite_data_size(parasite), data,
                                        error);
}
 ...
 * Since: 2.8
 **/
gboolean gimp_config_serialize(GimpConfig *config, GimpConfigWriter *writer,
                               gpointer data) {
  g_return_val_if_fail(GIMP_IS_CONFIG(config), FALSE);
 ...
 * Since: 2.8
 **/
gboolean gimp_config_deserialize(GimpConfig *config, GScanner *scanner,
                                 gint nest_level, gpointer data) {
  g_return_val_if_fail(GIMP_IS_CONFIG(config), FALSE);

  return GIMP_CONFIG_GET_IFACE(config)->deserialize(config, scanner, nest_level,
                                                    data);
}
 ...
 * Since: 2.6
 **/
gboolean gimp_config_copy(GimpConfig *src, GimpConfig *dest,
                          GParamFlags flags) {
  gboolean changed;
