...
#define GIMP_COLOR_PROFILE(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_PROFILE, GimpColorProfile))
#define GIMP_COLOR_PROFILE_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_PROFILE,                   \
                           GimpColorProfileClass))
#define GIMP_IS_COLOR_PROFILE(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_PROFILE))
#define GIMP_IS_COLOR_PROFILE_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_PROFILE))
#define GIMP_COLOR_PROFILE_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_PROFILE,                   \
                             GimpColorProfileClass))
...
GimpColorProfile *gimp_color_profile_new_from_icc_profile(const guint8 *data,
                                                          ...
                                                          GError **error);
GimpColorProfile *
gimp_color_profile_new_from_lcms_profile(gpointer lcms_profile, GError **error);
