...
#define GIMP_VALUE_HOLDS_RGB(value)                                            \
  (G_TYPE_CHECK_VALUE_TYPE((value), GIMP_TYPE_RGB))
...
#define GIMP_IS_PARAM_SPEC_RGB(pspec)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((pspec), GIMP_TYPE_PARAM_RGB))
...
void gimp_rgb_get_pixel(const GimpRGB *rgb, const Babl *format, gpointer pixel);
...
void gimp_rgba_set(GimpRGB *rgba, gdouble red, gdouble green, gdouble blue,
                   gdouble alpha);
...
void gimp_rgba_set_uchar(GimpRGB *rgba, guchar red, guchar green, guchar blue,
                         guchar alpha);
void gimp_rgba_get_uchar(const GimpRGB *rgba, guchar *red, guchar *green,
...
#define GIMP_RGB_LUMINANCE(r, g, b)                                            \
  ((r)*GIMP_RGB_LUMINANCE_RED + (g)*GIMP_RGB_LUMINANCE_GREEN +                 \
