...
#define GIMP_COLOR_TRANSFORM(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_TRANSFORM,                \
                              GimpColorTransform))
#define GIMP_COLOR_TRANSFORM_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_TRANSFORM,                 \
                           GimpColorTransformClass))
#define GIMP_IS_COLOR_TRANSFORM(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_TRANSFORM))
#define GIMP_IS_COLOR_TRANSFORM_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_TRANSFORM))
#define GIMP_COLOR_TRANSFORM_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_TRANSFORM,                 \
                             GimpColorTransformClass))
...
struct _GimpColorTransformClass {
  ...
  /* signals */
  void (*progress)(GimpColorTransform *transform, gdouble fraction);
