...
#define CDISPLAY_TYPE_COLORBLIND_DEFICIENCY_TYPE                               \
  (cdisplay_colorblind_deficiency_type_type)
static GType
cdisplay_colorblind_deficiency_type_register_type(GTypeModule *module);

static const GEnumValue enum_values[] = {
    {COLORBLIND_DEFICIENCY_PROTANOPIA, "COLORBLIND_DEFICIENCY_PROTANOPIA",
     "protanopia"},
    {COLORBLIND_DEFICIENCY_DEUTERANOPIA, "COLORBLIND_DEFICIENCY_DEUTERANOPIA",
     "deuteranopia"},
...
static const GimpEnumDesc enum_descs[] = {
    {COLORBLIND_DEFICIENCY_PROTANOPIA, N_("Protanopia (insensitivity to red)"),
     NULL},
    {COLORBLIND_DEFICIENCY_DEUTERANOPIA,
     N_("Deuteranopia (insensitivity to green)"), NULL},
    {COLORBLIND_DEFICIENCY_TRITANOPIA, N_("Tritanopia (insensitivity to blue)"),
     NULL},
    {0, NULL, NULL}};
...
#define CDISPLAY_COLORBLIND(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CDISPLAY_TYPE_COLORBLIND,                 \
                              CdisplayColorblind))
#define CDISPLAY_COLORBLIND_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), CDISPLAY_TYPE_COLORBLIND,                  \
                           CdisplayColorblindClass))
#define CDISPLAY_IS_COLORBLIND(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CDISPLAY_TYPE_COLORBLIND))
#define CDISPLAY_IS_COLORBLIND_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CDISPLAY_TYPE_COLORBLIND))
...
enum { PROP_0, PROP_TYPE };

static GType cdisplay_colorblind_get_type(void);

static void cdisplay_colorblind_set_property(GObject *object, guint property_id,
                                             const GValue *value,
                                             GParamSpec *pspec);
static void cdisplay_colorblind_get_property(GObject *object, guint property_id,
 ...
 * for LCDs!
 */
static const gfloat rgb2lms[9] = {0.05059983, 0.08585369, 0.00952420,

                                  0.01893033, 0.08925308, 0.01370054,

                                  0.00292202, 0.00975732, 0.07145979};

static const gfloat lms2rgb[9] = {30.830854, -29.832659, 1.610474,
...
cdisplay_colorblind_deficiency_type_register_type(GTypeModule *module) {
  if (!cdisplay_colorblind_deficiency_type_type) {
    cdisplay_colorblind_deficiency_type_type = g_type_module_register_enum(
        module, "CDisplayColorblindDeficiencyType", enum_values);
...
static void cdisplay_colorblind_class_init(CdisplayColorblindClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_TYPE, "type", _("Type"),
                        _("Color vision deficiency type"),
                        CDISPLAY_TYPE_COLORBLIND_DEFICIENCY_TYPE,
                        DEFAULT_DEFICIENCY_TYPE, 0);
...
static void cdisplay_colorblind_class_finalize(CdisplayColorblindClass *klass) {
}
