...
#define CDISPLAY_CONTRAST(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CDISPLAY_TYPE_CONTRAST, CdisplayContrast))
#define CDISPLAY_CONTRAST_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), CDISPLAY_TYPE_CONTRAST,                    \
                           CdisplayContrastClass))
#define CDISPLAY_IS_CONTRAST(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CDISPLAY_TYPE_CONTRAST))
#define CDISPLAY_IS_CONTRAST_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CDISPLAY_TYPE_CONTRAST))
...
enum { PROP_0, PROP_CONTRAST };

static GType cdisplay_contrast_get_type(void);

static void cdisplay_contrast_set_property(GObject *object, guint property_id,
                                           const GValue *value,
                                           GParamSpec *pspec);
static void cdisplay_contrast_get_property(GObject *object, guint property_id,
...
static void cdisplay_contrast_class_init(CdisplayContrastClass *klass) {
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_CONTRAST, "contrast",
                          _("Contrast cycles"), NULL, 0.01, 10.0,
                          DEFAULT_CONTRAST, 0);
...
static void cdisplay_contrast_class_finalize(CdisplayContrastClass *klass) {}
