...
static void gimp_busy_box_set_property(GObject *object, guint property_id,
                                       const GValue *value, GParamSpec *pspec);
static void gimp_busy_box_get_property(GObject *object, guint property_id,
...
static void gimp_busy_box_class_init(GimpBusyBoxClass *klass) {
  ...
  g_object_class_install_property(
      ...
      g_param_spec_string("message", "Message", "The message to display", NULL,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}

static void gimp_busy_box_init(GimpBusyBox *box) {
  GtkWidget *spinner;
  GtkWidget *label;
...
GtkWidget *gimp_busy_box_new(const gchar *message) {
  ...
  return g_object_new(GIMP_TYPE_BUSY_BOX, "message", message, NULL);
}
...
void gimp_busy_box_set_message(GimpBusyBox *box, const gchar *message) {
  ...
  g_object_set(box, "message", message, NULL);
}
