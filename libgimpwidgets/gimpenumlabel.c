...
enum { PROP_0, PROP_ENUM_TYPE, PROP_ENUM_VALUE };
...
static void gimp_enum_label_get_property(GObject *object, guint property_id,
                                         GValue *value, GParamSpec *pspec);
static void gimp_enum_label_set_property(GObject *object, guint property_id,
                                         const GValue *value,
                                         GParamSpec *pspec);
...
static void gimp_enum_label_class_init(GimpEnumLabelClass *klass) {
  ...
  g_object_class_install_property(
      ...
      g_param_spec_gtype("enum-type", "Enum Type",
                         "The type of the displayed enum", G_TYPE_NONE,
   ...
   **/
  g_object_class_install_property(
      object_class, PROP_ENUM_VALUE,
      g_param_spec_int("enum-value", "Enum Value", "The enum value to display",
                       G_MININT, G_MAXINT, 0,
                       GIMP_PARAM_WRITABLE | G_PARAM_CONSTRUCT));
}

static void gimp_enum_label_init(GimpEnumLabel *enum_label) {
...
static void gimp_enum_label_set_property(GObject *object, guint property_id,
  ...
  case PROP_ENUM_TYPE:
  private
    ->enum_class = g_type_class_ref(g_value_get_gtype(value));
    break;
 ...
 * Since: 2.4
 **/
GtkWidget *gimp_enum_label_new(GType enum_type, gint value) {
  g_return_val_if_fail(G_TYPE_IS_ENUM(enum_type), NULL);

  return g_object_new(GIMP_TYPE_ENUM_LABEL, "enum-type", enum_type,
 ...
 * Since: 2.4
 **/
void gimp_enum_label_set_value(GimpEnumLabel *label, gint value) {
...
private
  ...
  if (!gimp_enum_get_value(G_TYPE_FROM_CLASS(private->enum_class), value, NULL,
                           &nick, &desc, NULL)) {
    g_warning("%s: %d is not valid for enum of type '%s'", G_STRLOC, value,
