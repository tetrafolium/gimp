...
enum { EXTENDED_CLICKED, LAST_SIGNAL };
...
static void gimp_button_class_init(GimpButtonClass *klass) {
   ...
   * key pressed.
   **/
  button_signals[EXTENDED_CLICKED] = g_signal_new(
      "extended-clicked", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpButtonClass, extended_clicked), NULL, NULL, NULL,
