...
GType gimp_color_selector_channel_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_COLOR_SELECTOR_SATURATION, "GIMP_COLOR_SELECTOR_SATURATION",
       "saturation"},
      ...
      {GIMP_COLOR_SELECTOR_LCH_LIGHTNESS, "GIMP_COLOR_SELECTOR_LCH_LIGHTNESS",
       "lch-lightness"},
      {GIMP_COLOR_SELECTOR_LCH_CHROMA, "GIMP_COLOR_SELECTOR_LCH_CHROMA",
       "lch-chroma"},
      {GIMP_COLOR_SELECTOR_LCH_HUE, "GIMP_COLOR_SELECTOR_LCH_HUE", "lch-hue"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_COLOR_SELECTOR_HUE, NC_("color-selector-channel", "_H"),
       N_("HSV Hue")},
      {GIMP_COLOR_SELECTOR_SATURATION, NC_("color-selector-channel", "_S"),
       N_("HSV Saturation")},
      {GIMP_COLOR_SELECTOR_VALUE, NC_("color-selector-channel", "_V"),
       N_("HSV Value")},
      {GIMP_COLOR_SELECTOR_RED, NC_("color-selector-channel", "_R"), N_("Red")},
      {GIMP_COLOR_SELECTOR_GREEN, NC_("color-selector-channel", "_G"),
       N_("Green")},
      {GIMP_COLOR_SELECTOR_BLUE, NC_("color-selector-channel", "_B"),
       N_("Blue")},
      {GIMP_COLOR_SELECTOR_ALPHA, NC_("color-selector-channel", "_A"),
       N_("Alpha")},
      {GIMP_COLOR_SELECTOR_LCH_LIGHTNESS, NC_("color-selector-channel", "_L"),
       N_("LCh Lightness")},
      {GIMP_COLOR_SELECTOR_LCH_CHROMA, NC_("color-selector-channel", "_C"),
       N_("LCh Chroma")},
      {GIMP_COLOR_SELECTOR_LCH_HUE, NC_("color-selector-channel", "_h"),
       N_("LCh Hue")},
      {0, NULL, NULL}};
...
GType gimp_color_selector_model_get_type(void) {
  ...
  static const GimpEnumDesc descs[] = {
      {GIMP_COLOR_SELECTOR_MODEL_RGB, NC_("color-selector-model", "RGB"),
       N_("RGB color model")},
      {GIMP_COLOR_SELECTOR_MODEL_LCH, NC_("color-selector-model", "LCH"),
       N_("CIE LCh color model")},
      {GIMP_COLOR_SELECTOR_MODEL_HSV, NC_("color-selector-model", "HSV"),
       N_("HSV color model")},
      {0, NULL, NULL}};
...
GType gimp_int_combo_box_layout_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_INT_COMBO_BOX_LAYOUT_ICON_ONLY,
       "GIMP_INT_COMBO_BOX_LAYOUT_ICON_ONLY", "icon-only"},
      {GIMP_INT_COMBO_BOX_LAYOUT_ABBREVIATED,
       "GIMP_INT_COMBO_BOX_LAYOUT_ABBREVIATED", "abbreviated"},
      {GIMP_INT_COMBO_BOX_LAYOUT_FULL, "GIMP_INT_COMBO_BOX_LAYOUT_FULL",
       "full"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_INT_COMBO_BOX_LAYOUT_ICON_ONLY,
       "GIMP_INT_COMBO_BOX_LAYOUT_ICON_ONLY", NULL},
      {GIMP_INT_COMBO_BOX_LAYOUT_ABBREVIATED,
       "GIMP_INT_COMBO_BOX_LAYOUT_ABBREVIATED", NULL},
...
GType gimp_page_selector_target_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_PAGE_SELECTOR_TARGET_LAYERS, "GIMP_PAGE_SELECTOR_TARGET_LAYERS",
       "layers"},
      {GIMP_PAGE_SELECTOR_TARGET_IMAGES, "GIMP_PAGE_SELECTOR_TARGET_IMAGES",
       "images"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_PAGE_SELECTOR_TARGET_LAYERS, NC_("page-selector-target", "Layers"),
       NULL},
      {GIMP_PAGE_SELECTOR_TARGET_IMAGES, NC_("page-selector-target", "Images"),
       NULL},
      {0, NULL, NULL}};
...
GType gimp_zoom_type_get_type(void) {
  static const GEnumValue values[] = {{GIMP_ZOOM_IN, "GIMP_ZOOM_IN", "in"},
