...
#define GIMP_SIZE_ENTRY(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SIZE_ENTRY, GimpSizeEntry))
#define GIMP_SIZE_ENTRY_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SIZE_ENTRY, GimpSizeEntryClass))
#define GIMP_IS_SIZE_ENTRY(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_SIZE_ENTRY))
#define GIMP_IS_SIZE_ENTRY_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SIZE_ENTRY))
#define GIMP_SIZE_ENTRY_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SIZE_ENTRY, GimpSizeEntryClass))
...
GimpSizeEntryUpdatePolicy gimp_size_entry_get_update_policy(GimpSizeEntry *gse);
