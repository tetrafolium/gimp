...
#define GIMP_COLOR_DISPLAY_STACK(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_DISPLAY_STACK,            \
                              GimpColorDisplayStack))
#define GIMP_COLOR_DISPLAY_STACK_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_DISPLAY_STACK,             \
                           GimpColorDisplayStackClass))
#define GIMP_IS_COLOR_DISPLAY_STACK(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_DISPLAY_STACK))
#define GIMP_IS_COLOR_DISPLAY_STACK_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_DISPLAY_STACK))
#define GIMP_COLOR_DISPLAY_STACK_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_DISPLAY_STACK,             \
                             GimpColorDisplayStackClass))
...
struct _GimpColorDisplayStackClass {
  ...
  void (*added)(GimpColorDisplayStack *stack, GimpColorDisplay *display,
                gint position);
  void (*removed)(GimpColorDisplayStack *stack, GimpColorDisplay *display);
  void (*reordered)(GimpColorDisplayStack *stack, GimpColorDisplay *display,
                    gint position);
