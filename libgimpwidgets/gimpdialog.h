...
#define GIMP_DIALOG(obj)                                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DIALOG, GimpDialog))
#define GIMP_DIALOG_CLASS(klass)                                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DIALOG, GimpDialogClass))
#define GIMP_IS_DIALOG(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DIALOG))
#define GIMP_IS_DIALOG_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DIALOG))
#define GIMP_DIALOG_GET_CLASS(obj)                                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DIALOG, GimpDialogClass))
...
GtkWidget *gimp_dialog_add_button(GimpDialog *dialog, const gchar *button_text,
                                  gint response_id);
void gimp_dialog_add_buttons(GimpDialog *dialog, ...) G_GNUC_NULL_TERMINATED;
