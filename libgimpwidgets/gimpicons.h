...
#define GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_RTL                                \
  "gimp-text-dir-ttb-rtl" /* use FDO */
#define GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_RTL_UPRIGHT                        \
  "gimp-text-dir-ttb-rtl-upright" /* use FDO */
#define GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_LTR                                \
  "gimp-text-dir-ttb-ltr" /* use FDO */
#define GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_LTR_UPRIGHT                        \
  "gimp-text-dir-ttb-ltr-upright" /* use FDO */
...
#define GIMP_ICON_GRADIENT_SHAPEBURST_SPHERICAL                                \
...
#define GIMP_ICON_GRADIENT_SPIRAL_ANTICLOCKWISE                                \
