...
#define GIMP_FRAME(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FRAME, GimpFrame))
#define GIMP_FRAME_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FRAME, GimpFrameClass))
#define GIMP_IS_FRAME(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FRAME))
#define GIMP_IS_FRAME_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FRAME))
#define GIMP_FRAME_GET_CLASS(obj)                                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FRAME, GimpFrameClass))
