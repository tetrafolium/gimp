...
#define GIMP_INT_COMBO_BOX(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_INT_COMBO_BOX, GimpIntComboBox))
#define GIMP_INT_COMBO_BOX_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_INT_COMBO_BOX,                   \
                           GimpIntComboBoxClass))
#define GIMP_IS_INT_COMBO_BOX(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_INT_COMBO_BOX))
#define GIMP_IS_INT_COMBO_BOX_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_INT_COMBO_BOX))
#define GIMP_INT_COMBO_BOX_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_INT_COMBO_BOX,                   \
                             GimpIntComboBoxClass))
 ...
 * @data: (closure):
 */
typedef gboolean (*GimpIntSensitivityFunc)(gint value, gpointer data);
...
GimpIntComboBoxLayout gimp_int_combo_box_get_layout(GimpIntComboBox *combo_box);
