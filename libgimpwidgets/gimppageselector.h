...
#define GIMP_PAGE_SELECTOR(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PAGE_SELECTOR, GimpPageSelector))
#define GIMP_PAGE_SELECTOR_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PAGE_SELECTOR,                   \
                           GimpPageSelectorClass))
#define GIMP_IS_PAGE_SELECTOR(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PAGE_SELECTOR))
#define GIMP_IS_PAGE_SELECTOR_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PAGE_SELECTOR))
#define GIMP_PAGE_SELECTOR_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PAGE_SELECTOR,                   \
                             GimpPageSelectorClass))
