...
#define GIMP_COLOR_DISPLAY(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_DISPLAY, GimpColorDisplay))
#define GIMP_COLOR_DISPLAY_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_DISPLAY,                   \
                           GimpColorDisplayClass))
#define GIMP_IS_COLOR_DISPLAY(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_DISPLAY))
#define GIMP_IS_COLOR_DISPLAY_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_DISPLAY))
#define GIMP_COLOR_DISPLAY_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_DISPLAY,                   \
                             GimpColorDisplayClass))
...
struct _GimpColorDisplayClass {
  ...
  /*  virtual functions  */
  void (*convert_buffer)(GimpColorDisplay *display, GeglBuffer *buffer,
                         GeglRectangle *area);
...
void gimp_color_display_convert_buffer(GimpColorDisplay *display,
                                       GeglBuffer *buffer, GeglRectangle *area);
