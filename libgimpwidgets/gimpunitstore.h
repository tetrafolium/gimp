...
#define GIMP_UNIT_STORE(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_UNIT_STORE, GimpUnitStore))
#define GIMP_UNIT_STORE_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_UNIT_STORE, GimpUnitStoreClass))
#define GIMP_IS_UNIT_STORE(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_UNIT_STORE))
#define GIMP_IS_UNIT_STORE_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_UNIT_STORE))
#define GIMP_UNIT_STORE_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_UNIT_STORE, GimpUnitStoreClass))
