...
static void gimp_pick_button_class_init(GimpPickButtonClass *klass) {
  ...
  pick_button_signals[COLOR_PICKED] =
      g_signal_new("color-picked", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpPickButtonClass, color_picked), NULL,
                   NULL, NULL, G_TYPE_NONE, 1, GIMP_TYPE_RGB);
...
static void gimp_pick_button_init(GimpPickButton *button) {
  GtkWidget *image;
