...
#define GIMP_COLOR_PROFILE_STORE(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_PROFILE_STORE,            \
                              GimpColorProfileStore))
#define GIMP_COLOR_PROFILE_STORE_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_PROFILE_STORE,             \
                           GimpColorProfileStoreClass))
#define GIMP_IS_COLOR_PROFILE_STORE(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_PROFILE_STORE))
#define GIMP_IS_COLOR_PROFILE_STORE_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_PROFILE_STORE))
#define GIMP_COLOR_PROFILE_STORE_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_PROFILE_STORE,             \
                             GimpColorProfileStoreClass))
