...
static gint units_get_number_of_units(void) { return G_N_ELEMENTS(unit_defs); }

static gint units_get_number_of_built_in_units(void) {
  return G_N_ELEMENTS(unit_defs);
}

static gdouble units_unit_get_factor(GimpUnit unit) {
  return unit_defs[unit].factor;
}

static gint units_unit_get_digits(GimpUnit unit) {
  return unit_defs[unit].digits;
}

static const gchar *units_unit_get_identifier(GimpUnit unit) {
  return unit_defs[unit].identifier;
}

static const gchar *units_unit_get_symbol(GimpUnit unit) {
  return unit_defs[unit].symbol;
}

static const gchar *units_unit_get_abbreviation(GimpUnit unit) {
  return unit_defs[unit].abbreviation;
}

static const gchar *units_unit_get_singular(GimpUnit unit) {
  return unit_defs[unit].singular;
}

static const gchar *units_unit_get_plural(GimpUnit unit) {
