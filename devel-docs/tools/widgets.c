...
static WidgetInfo *new_widget_info(const char *name, GtkWidget *widget,
                                   gboolean show_all, WidgetSize size) {
  WidgetInfo *info;
...
static void color_init(GimpRGB *rgb) {
  gimp_rgb_parse_name(rgb, "goldenrod", -1);
  gimp_rgb_set_alpha(rgb, 0.7);
}

static GdkPixbuf *load_image(const gchar *name) {
  GdkPixbuf *pixbuf;
  gchar *filename;
...
static WidgetInfo *create_browser(void) {
  GtkWidget *vbox;
  GtkWidget *browser;
  ...
  gimp_browser_add_search_types(GIMP_BROWSER(browser), "by name", 1, NULL);
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Browser"), FALSE, FALSE, 0);

  return new_widget_info("gimp-widget-browser", vbox, TRUE, MEDIUM);
}

static WidgetInfo *create_busy_box(void) {
  GtkWidget *widget;
...
static WidgetInfo *create_button(void) {
  GtkWidget *widget;
...
static WidgetInfo *create_chain_button(void) {
  GtkWidget *vbox;
  GtkWidget *grid;
  GtkWidget *label;
  GtkWidget *chain;
  ...
  gtk_box_pack_end(GTK_BOX(vbox), gtk_label_new("Chain Button"), FALSE, FALSE,
                   0);

  return new_widget_info("gimp-widget-chain-button", vbox, TRUE, MEDIUM);
}

static WidgetInfo *create_color_area(void) {
  GtkWidget *vbox;
  GtkWidget *area;
  GimpRGB color;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Area"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-color-area", vbox, TRUE, SMALL);
}

static WidgetInfo *create_color_button(void) {
  GtkWidget *vbox;
  GtkWidget *button;
  GimpRGB color;
  ...
  button = gimp_color_button_new("Color Button", 80, 20, &color,
                                 GIMP_COLOR_AREA_SMALL_CHECKS);
  gtk_widget_set_halign(button, GTK_ALIGN_CENTER);
  gtk_widget_set_valign(button, GTK_ALIGN_CENTER);
  gtk_container_add(GTK_CONTAINER(vbox), button);

  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Button"), FALSE, FALSE,
                     0);
...
static WidgetInfo *create_color_hex_entry(void) {
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Hex Entry"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-color-hex-entry", vbox, TRUE, SMALL);
}

static WidgetInfo *create_color_notebook(void) {
  GtkWidget *vbox;
  GtkWidget *notebook;
  GtkWidget *label;
  GimpRGB rgb;
  ...
  notebook = gimp_color_selector_new(GIMP_TYPE_COLOR_NOTEBOOK, &rgb, &hsv,
...
static WidgetInfo *create_color_profile_combo_box(void) {
  GtkWidget *vbox;
  GtkWidget *combo;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Profile Combo Box"),
                     FALSE, FALSE, 0);

  return new_widget_info("gimp-widget-color-profile-combo-box", vbox, TRUE,
                         SMALL);
}

static WidgetInfo *create_color_profile_view(void) {
  GtkWidget *vbox;
  GtkWidget *view;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Profile View"), FALSE,
                     FALSE, 0);
...
static WidgetInfo *create_color_scale(void) {
  ...
  scale =
      gimp_color_scale_new(GTK_ORIENTATION_HORIZONTAL, GIMP_COLOR_SELECTOR_HUE);
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Color Scale"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-color-scale", vbox, TRUE, SMALL);
}

static WidgetInfo *create_color_scales(void) {
  GtkWidget *vbox;
  GtkWidget *scales;
  GtkWidget *label;
  GimpRGB rgb;
  ...
  scales = gimp_color_selector_new(GIMP_TYPE_COLOR_SCALES, &rgb, &hsv,
                                   GIMP_COLOR_SELECTOR_HUE);
...
static WidgetInfo *create_color_select(void) {
  GtkWidget *vbox;
  GtkWidget *select;
  GtkWidget *label;
  GimpRGB rgb;
  ...
  select = gimp_color_selector_new(GIMP_TYPE_COLOR_SELECT, &rgb, &hsv,
                                   GIMP_COLOR_SELECTOR_HUE);
...
static WidgetInfo *create_color_selection(void) {
  GtkWidget *vbox;
  GtkWidget *selection;
  GtkWidget *label;
  GimpRGB color;
...
static WidgetInfo *create_dialog(void) {
  WidgetInfo *info;
  GtkWidget *widget;
  GtkWidget *content;
  GtkWidget *label;
  ...
  widget =
      gimp_dialog_new("Gimp Dialog", "gimp-widget-dialog", NULL, 0, NULL, NULL,
                      "_Cancel", GTK_RESPONSE_CANCEL, "_OK", GTK_RESPONSE_OK,
...
static WidgetInfo *create_enum_combo_box(void) {
  GtkWidget *vbox;
  GtkWidget *combo;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Enum Combo Box"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-enum-combo-box", vbox, TRUE, SMALL);
}

static WidgetInfo *create_enum_label(void) {
  GtkWidget *vbox;
  GtkWidget *label;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Enum Label"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-enum-label", vbox, TRUE, SMALL);
}

static WidgetInfo *create_file_entry(void) {
  GtkWidget *vbox;
  GtkWidget *entry;

  vbox = gtk_box_new(GTK_ORIENTATION_VERTICAL, 12);

  entry = gimp_file_entry_new("File Entry", "wilber.png", FALSE, TRUE);
  gtk_widget_set_halign(entry, GTK_ALIGN_FILL);
  gtk_widget_set_valign(entry, GTK_ALIGN_CENTER);
  gtk_box_pack_start(GTK_BOX(vbox), entry, TRUE, TRUE, 0);

  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("File Entry"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-file-entry", vbox, TRUE, SMALL);
}

static WidgetInfo *create_frame(void) {
  GtkWidget *frame;
  GtkWidget *content;
...
static WidgetInfo *create_number_pair_entry(void) {
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Number Pair Entry"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-number-pair-entry", vbox, TRUE, SMALL);
}

static WidgetInfo *create_int_combo_box(void) {
  GtkWidget *vbox;
  GtkWidget *combo;
  ...
  combo =
      gimp_int_combo_box_new("Sobel", 1, "Prewitt", 2, "Gradient", 3, "Roberts",
                             4, "Differential", 5, "Laplace", 6, NULL);
  gtk_widget_set_halign(combo, GTK_ALIGN_FILL);
  gtk_widget_set_valign(combo, GTK_ALIGN_CENTER);
  gimp_int_combo_box_set_active(GIMP_INT_COMBO_BOX(combo), 1);
  gtk_box_pack_start(GTK_BOX(vbox), combo, TRUE, TRUE, 0);

  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Int Combo Box"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-int-combo-box", vbox, TRUE, SMALL);
}

static WidgetInfo *create_memsize_entry(void) {
  GtkWidget *vbox;
  GtkWidget *entry;
  ...
  entry =
      gimp_memsize_entry_new((3 * 1024 + 512) * 1024, 0, 1024 * 1024 * 1024);
  gtk_widget_set_halign(entry, GTK_ALIGN_CENTER);
  gtk_widget_set_valign(entry, GTK_ALIGN_CENTER);
  gtk_box_pack_start(GTK_BOX(vbox), entry, TRUE, TRUE, 0);

  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Memsize Entry"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-memsize-entry", vbox, TRUE, SMALL);
}

static WidgetInfo *create_offset_area(void) {
  GtkWidget *vbox;
  GtkWidget *frame;
  GtkWidget *area;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Offset Area"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-offset-area", vbox, TRUE, LARGE);
}

static WidgetInfo *create_page_selector(void) {
  GtkWidget *vbox;
  GtkWidget *selector;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Page Selector"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-page-selector", vbox, TRUE, ASIS);
}

static WidgetInfo *create_path_editor(void) {
  GtkWidget *vbox;
  GtkWidget *editor;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Path Editor"), FALSE, FALSE,
                     0);
...
static WidgetInfo *create_pick_button(void) {
  GtkWidget *vbox;
  GtkWidget *button;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Pick Button"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-pick-button", vbox, TRUE, SMALL);
}

static WidgetInfo *create_preview_area(void) {
  GtkWidget *vbox;
  GtkWidget *area;
  GdkPixbuf *pixbuf;
  ...
  gimp_preview_area_draw(
      GIMP_PREVIEW_AREA(area), 0, 0, gdk_pixbuf_get_width(pixbuf),
      gdk_pixbuf_get_height(pixbuf), GIMP_RGBA_IMAGE,
      gdk_pixbuf_get_pixels(pixbuf), gdk_pixbuf_get_rowstride(pixbuf));
  gtk_box_pack_start(GTK_BOX(vbox), area, TRUE, TRUE, 0);

  g_object_unref(pixbuf);

  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Preview Area"), FALSE, FALSE,
                     0);

  return new_widget_info("gimp-widget-preview-area", vbox, TRUE, MEDIUM);
}

static WidgetInfo *create_ruler(void) {
  GtkWidget *grid;
  GtkWidget *ruler;
...
static WidgetInfo *create_string_combo_box(void) {
  GtkWidget *vbox;
  GtkWidget *combo;
  GtkListStore *store;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("String Combo Box"), FALSE,
                     FALSE, 0);

  return new_widget_info("gimp-widget-string-combo-box", vbox, TRUE, SMALL);
}

static WidgetInfo *create_unit_combo_box(void) {
  GtkWidget *vbox;
  GtkWidget *combo;
  ...
  gtk_box_pack_start(GTK_BOX(vbox), gtk_label_new("Unit Combo Box"), FALSE,
                     FALSE, 0);
