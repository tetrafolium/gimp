...
#define GIMP_TOOL_GYROSCOPE(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_GYROSCOPE,                 \
                              GimpToolGyroscope))
#define GIMP_TOOL_GYROSCOPE_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_GYROSCOPE,                  \
                           GimpToolGyroscopeClass))
#define GIMP_IS_TOOL_GYROSCOPE(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_GYROSCOPE))
#define GIMP_IS_TOOL_GYROSCOPE_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_GYROSCOPE))
#define GIMP_TOOL_GYROSCOPE_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_GYROSCOPE,                  \
                             GimpToolGyroscopeClass))
