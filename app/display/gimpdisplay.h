...
#define GIMP_DISPLAY_IMPL(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DISPLAY_IMPL, GimpDisplayImpl))
#define GIMP_DISPLAY_IMPL_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DISPLAY_IMPL,                    \
                           GimpDisplayImplClass))
#define GIMP_IS_DISPLAY_IMPL(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DISPLAY_IMPL))
#define GIMP_IS_DISPLAY_IMPL_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DISPLAY_IMPL))
#define GIMP_DISPLAY_IMPL_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DISPLAY_IMPL,                    \
                             GimpDisplayImplClass))
