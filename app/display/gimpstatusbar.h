...
#define GIMP_STATUSBAR(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_STATUSBAR, GimpStatusbar))
#define GIMP_STATUSBAR_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_STATUSBAR, GimpStatusbarClass))
#define GIMP_IS_STATUSBAR(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_STATUSBAR))
#define GIMP_IS_STATUSBAR_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_STATUSBAR))
#define GIMP_STATUSBAR_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_STATUSBAR, GimpStatusbarClass))
