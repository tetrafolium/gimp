...
#define GIMP_CANVAS_PASSE_PARTOUT(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CANVAS_PASSE_PARTOUT,           \
                              GimpCanvasPassePartout))
#define GIMP_CANVAS_PASSE_PARTOUT_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CANVAS_PASSE_PARTOUT,            \
                           GimpCanvasPassePartoutClass))
#define GIMP_IS_CANVAS_PASSE_PARTOUT(obj)                                      \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CANVAS_PASSE_PARTOUT))
#define GIMP_IS_CANVAS_PASSE_PARTOUT_CLASS(klass)                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CANVAS_PASSE_PARTOUT))
#define GIMP_CANVAS_PASSE_PARTOUT_GET_CLASS(obj)                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CANVAS_PASSE_PARTOUT,            \
                             GimpCanvasPassePartoutClass))
