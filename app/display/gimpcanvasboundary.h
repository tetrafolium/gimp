...
#define GIMP_CANVAS_BOUNDARY(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CANVAS_BOUNDARY,                \
                              GimpCanvasBoundary))
#define GIMP_CANVAS_BOUNDARY_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CANVAS_BOUNDARY,                 \
                           GimpCanvasBoundaryClass))
#define GIMP_IS_CANVAS_BOUNDARY(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CANVAS_BOUNDARY))
#define GIMP_IS_CANVAS_BOUNDARY_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CANVAS_BOUNDARY))
#define GIMP_CANVAS_BOUNDARY_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CANVAS_BOUNDARY,                 \
                             GimpCanvasBoundaryClass))
