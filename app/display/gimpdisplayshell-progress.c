...
static GimpProgress *gimp_display_shell_progress_start(GimpProgress *progress,
                                                       gboolean cancellable,
                                                       const gchar *message) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);

  return gimp_progress_start(GIMP_PROGRESS(statusbar), cancellable, "%s",
                             message);
}

static void gimp_display_shell_progress_end(GimpProgress *progress) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static gboolean gimp_display_shell_progress_is_active(GimpProgress *progress) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static void gimp_display_shell_progress_set_text(GimpProgress *progress,
                                                 const gchar *message) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static void gimp_display_shell_progress_set_value(GimpProgress *progress,
                                                  gdouble percentage) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static gdouble gimp_display_shell_progress_get_value(GimpProgress *progress) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static void gimp_display_shell_progress_pulse(GimpProgress *progress) {
  GimpDisplayShell *shell = GIMP_DISPLAY_SHELL(progress);
  GimpStatusbar *statusbar = gimp_display_shell_get_statusbar(shell);
...
static gboolean
gimp_display_shell_progress_message(GimpProgress *progress, Gimp *gimp,
  ...
  case GIMP_MESSAGE_WARNING:
    ...
    if (!gimp_statusbar_get_visible(statusbar))
      ...
      return gimp_progress_message(GIMP_PROGRESS(statusbar), gimp, severity,
                                   domain, message);
  ...
  case GIMP_MESSAGE_INFO:
     ...
     */
    gimp_progress_message(GIMP_PROGRESS(statusbar), gimp, severity, domain,
                          message);
    return TRUE;
  }
