...
void gimp_display_shell_appearance_update(GimpDisplayShell *shell) {
  ...
  if (window) {
    ...
    gimp_display_shell_set_action_active(shell, "view-fullscreen", fullscreen);
  }
  ...
  gimp_display_shell_set_show_canvas(shell, options->show_canvas_boundary);
  ...
  gimp_display_shell_set_padding(shell, options->padding_mode,
...
void gimp_display_shell_set_show_canvas(GimpDisplayShell *shell,
  ...
  gimp_canvas_item_set_visible(shell->canvas_boundary, show && shell->show_all);

  gimp_display_shell_set_action_active(shell, "view-show-canvas-boundary",
                                       show);
}
...
void gimp_display_shell_update_show_canvas(GimpDisplayShell *shell) {
  ...
  gimp_canvas_item_set_visible(
      shell->canvas_boundary, options->show_canvas_boundary && shell->show_all);
}
...
void gimp_display_shell_set_padding(GimpDisplayShell *shell,
  ...
  g_object_set(options, "padding-mode", padding_mode, "padding-color", &color,
               NULL);
  ...
  if (padding_mode != GIMP_CANVAS_PADDING_MODE_DEFAULT)
    ...
    gimp_display_shell_set_action_color(shell, "view-padding-color-menu", NULL);
}
...
void gimp_display_shell_set_padding_in_show_all(GimpDisplayShell *shell,
  ...
  if (options->padding_in_show_all != keep) {
    ...
    gimp_display_shell_set_action_active(
        shell, "view-padding-color-in-show-all", keep);
