...
#define GIMP_CANVAS_POLYGON(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CANVAS_POLYGON,                 \
                              GimpCanvasPolygon))
#define GIMP_CANVAS_POLYGON_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CANVAS_POLYGON,                  \
                           GimpCanvasPolygonClass))
#define GIMP_IS_CANVAS_POLYGON(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CANVAS_POLYGON))
#define GIMP_IS_CANVAS_POLYGON_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CANVAS_POLYGON))
#define GIMP_CANVAS_POLYGON_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CANVAS_POLYGON,                  \
                             GimpCanvasPolygonClass))
