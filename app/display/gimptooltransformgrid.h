...
#define GIMP_TOOL_TRANSFORM_GRID(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_TRANSFORM_GRID,            \
                              GimpToolTransformGrid))
#define GIMP_TOOL_TRANSFORM_GRID_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_TRANSFORM_GRID,             \
                           GimpToolTransformGridClass))
#define GIMP_IS_TOOL_TRANSFORM_GRID(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_TRANSFORM_GRID))
#define GIMP_IS_TOOL_TRANSFORM_GRID_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_TRANSFORM_GRID))
#define GIMP_TOOL_TRANSFORM_GRID_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_TRANSFORM_GRID,             \
                             GimpToolTransformGridClass))
