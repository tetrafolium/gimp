 ...
 **/
void gimp_display_shell_zoom_xy(GimpDisplayShell *shell, gdouble x, gdouble y,
                                gint *nx, gint *ny) {
  gint64 tx;
  gint64 ty;
 ...
 * in the image.
 **/
void gimp_display_shell_unzoom_xy(GimpDisplayShell *shell, gint x, gint y,
                                  gint *nx, gint *ny, gboolean round) {
  gint64 tx;
  gint64 ty;
 ...
 * coordinates.
 **/
void gimp_display_shell_zoom_xy_f(GimpDisplayShell *shell, gdouble x, gdouble y,
                                  gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
 ...
 **/
void gimp_display_shell_unzoom_xy_f(GimpDisplayShell *shell, gdouble x,
                                    gdouble y, gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
...
void gimp_display_shell_zoom_segments(GimpDisplayShell *shell,
                                      ...
                                      GimpSegment *dest_segs, gint n_segs,
...
void gimp_display_shell_rotate_coords(GimpDisplayShell *shell,
  ...
  *rotated_coords = *unrotated_coords;
  ...
  if (shell->rotate_transform)
    cairo_matrix_transform_point(shell->rotate_transform, &rotated_coords->x,
                                 &rotated_coords->y);
}
  ...
  *unrotated_coords = *rotated_coords;
  ...
  if (shell->rotate_untransform)
    cairo_matrix_transform_point(shell->rotate_untransform,
                                 &unrotated_coords->x, &unrotated_coords->y);
}
 ...
 **/
void gimp_display_shell_rotate_xy(GimpDisplayShell *shell, gdouble x, gdouble y,
                                  gint *nx, gint *ny) {
  gint64 tx;
  gint64 ty;
 ...
 * coordinates.
 **/
void gimp_display_shell_unrotate_xy(GimpDisplayShell *shell, gint x, gint y,
                                    gint *nx, gint *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
 ...
 * coordinates.
 **/
void gimp_display_shell_rotate_xy_f(GimpDisplayShell *shell, gdouble x,
                                    gdouble y, gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
 ...
 * than ints.
 **/
void gimp_display_shell_unrotate_xy_f(GimpDisplayShell *shell, gdouble x,
                                      gdouble y, gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
...
void gimp_display_shell_rotate_bounds(GimpDisplayShell *shell, gdouble x1,
                                      gdouble y1, gdouble x2, gdouble y2,
                                      gdouble *nx1, gdouble *ny1, gdouble *nx2,
                                      gdouble *ny2) {
...
void gimp_display_shell_unrotate_bounds(GimpDisplayShell *shell, gdouble x1,
                                        gdouble y1, gdouble x2, gdouble y2,
                                        gdouble *nx1, gdouble *ny1,
                                        gdouble *nx2, gdouble *ny2) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
...
void gimp_display_shell_transform_coords(GimpDisplayShell *shell,
  ...
  *display_coords = *image_coords;
  ...
  if (shell->rotate_transform)
    cairo_matrix_transform_point(shell->rotate_transform, &display_coords->x,
                                 &display_coords->y);
}
...
void gimp_display_shell_untransform_coords(GimpDisplayShell *shell,
  ...
  *image_coords = *display_coords;
  ...
  if (shell->rotate_untransform)
    cairo_matrix_transform_point(shell->rotate_untransform, &image_coords->x,
                                 &image_coords->y);
 ...
 **/
void gimp_display_shell_transform_xy(GimpDisplayShell *shell, gdouble x,
                                     gdouble y, gint *nx, gint *ny) {
  gint64 tx;
  gint64 ty;
 ...
 * in the image.
 **/
void gimp_display_shell_untransform_xy(GimpDisplayShell *shell, gint x, gint y,
                                       gint *nx, gint *ny, gboolean round) {
  gint64 tx;
  gint64 ty;
 ...
 * coordinates.
 **/
void gimp_display_shell_transform_xy_f(GimpDisplayShell *shell, gdouble x,
                                       gdouble y, gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
 ...
 * ints, and consequently there is no option related to rounding.
 **/
void gimp_display_shell_untransform_xy_f(GimpDisplayShell *shell, gdouble x,
                                         gdouble y, gdouble *nx, gdouble *ny) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
  g_return_if_fail(nx != NULL);
  g_return_if_fail(ny != NULL);
...
void gimp_display_shell_transform_bounds(GimpDisplayShell *shell, gdouble x1,
                                         gdouble y1, gdouble x2, gdouble y2,
                                         gdouble *nx1, gdouble *ny1,
                                         gdouble *nx2, gdouble *ny2) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
...
void gimp_display_shell_untransform_bounds(GimpDisplayShell *shell, gdouble x1,
                                           gdouble y1, gdouble x2, gdouble y2,
                                           gdouble *nx1, gdouble *ny1,
                                           gdouble *nx2, gdouble *ny2) {
  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));
 ...
 */
void gimp_display_shell_transform_bounds_with_scale(
    GimpDisplayShell *shell, gdouble scale, gdouble x1, gdouble y1, gdouble x2,
    gdouble y2, gdouble *nx1, gdouble *ny1, gdouble *nx2, gdouble *ny2) {
  gdouble factor_x;
  gdouble factor_y;
  ...
  gimp_display_shell_rotate_bounds(shell, x1, y1, x2, y2, nx1, ny1, nx2, ny2);
}
 ...
 */
void gimp_display_shell_untransform_bounds_with_scale(
    GimpDisplayShell *shell, gdouble scale, gdouble x1, gdouble y1, gdouble x2,
    gdouble y2, gdouble *nx1, gdouble *ny1, gdouble *nx2, gdouble *ny2) {
  gdouble factor_x;
  gdouble factor_y;
  ...
  gimp_display_shell_unrotate_bounds(shell, x1, y1, x2, y2, nx1, ny1, nx2, ny2);
...
void gimp_display_shell_untransform_viewport(GimpDisplayShell *shell,
                                             gboolean clip, gint *x, gint *y,
                                             gint *width, gint *height) {
  gdouble x1, y1, x2, y2;

  g_return_if_fail(GIMP_IS_DISPLAY_SHELL(shell));

  gimp_display_shell_untransform_bounds(shell, 0, 0, shell->disp_width,
