...
typedef enum { AXIS_NONE, AXIS_X, AXIS_Y } Axis;
...
static gint gimp_tool_transform_3d_grid_button_press(
...
static void gimp_tool_transform_3d_grid_hover_modifier(GimpToolWidget *widget,
                                                       ...
                                                       gboolean press,
                                                       GdkModifierType state);
static gboolean gimp_tool_transform_3d_grid_get_cursor(
...
static gboolean
gimp_tool_transform_3d_grid_constrain(GimpToolTransform3DGrid *grid, gdouble x,
                                      gdouble y, gdouble ox, gdouble oy,
                                      gdouble *tx, gdouble *ty);

static gboolean gimp_tool_transform_3d_grid_motion_vanishing_point(
    GimpToolTransform3DGrid *grid, gdouble x, gdouble y);
static gboolean
...
gimp_tool_transform_3d_grid_class_init(GimpToolTransform3DGridClass *klass) {
  ...
  g_object_class_install_property(
      ...
      g_param_spec_enum("mode", NULL, NULL, GIMP_TYPE_TRANSFORM_3D_MODE,
                        GIMP_TRANSFORM_3D_MODE_CAMERA,
                        GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_UNIFIED,
      g_param_spec_boolean("unified", NULL, NULL, FALSE,
                           GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_CONSTRAIN_AXIS,
      g_param_spec_boolean("constrain-axis", NULL, NULL, FALSE,
                           GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_Z_AXIS,
      g_param_spec_boolean("z-axis", NULL, NULL, FALSE,
                           GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_LOCAL_FRAME,
      g_param_spec_boolean("local-frame", NULL, NULL, FALSE,
                           GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_CAMERA_X,
      g_param_spec_double("camera-x", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_CAMERA_Y,
      g_param_spec_double("camera-y", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_CAMERA_Z,
      g_param_spec_double("camera-z", NULL, NULL, -(1.0 / 0.0), 1.0 / 0.0, 0.0,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_OFFSET_X,
      g_param_spec_double("offset-x", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_OFFSET_Y,
      g_param_spec_double("offset-y", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_OFFSET_Z,
      g_param_spec_double("offset-z", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_ROTATION_ORDER,
      g_param_spec_int("rotation-order", NULL, NULL, 0, 6, 0,
                       GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_ANGLE_X,
      g_param_spec_double("angle-x", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_ANGLE_Y,
      g_param_spec_double("angle-y", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_ANGLE_Z,
      g_param_spec_double("angle-z", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE, 0.0,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_PIVOT_3D_X,
      g_param_spec_double("pivot-3d-x", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_PIVOT_3D_Y,
      g_param_spec_double("pivot-3d-y", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_PIVOT_3D_Z,
      g_param_spec_double("pivot-3d-z", NULL, NULL, -G_MAXDOUBLE, G_MAXDOUBLE,
                          0.0, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}

static void gimp_tool_transform_3d_grid_init(GimpToolTransform3DGrid *grid) {
...
static void gimp_tool_transform_3d_grid_constructed(GObject *object) {
  ...
  g_object_set(object, "clip-guides", TRUE, "dynamic-handle-size", FALSE, NULL);
}
...
static void gimp_tool_transform_3d_grid_set_property(GObject *object,
  ...
  case PROP_CAMERA_X:
    ...
    g_object_set(grid, "pivot-x", priv->camera_x, NULL);
    break;
  case PROP_CAMERA_Y:
    priv->camera_y = g_value_get_double(value);
    g_object_set(grid, "pivot-y", priv->camera_y, NULL);
    break;
  case PROP_CAMERA_Z:
...
static gint gimp_tool_transform_3d_grid_button_press(
  ...
  priv->handle = GIMP_TOOL_WIDGET_CLASS(parent_class)
                     ->button_press(widget, coords, time, state, press_type);
...
void gimp_tool_transform_3d_grid_motion(GimpToolWidget *widget,
  ...
  case GIMP_TRANSFORM_HANDLE_PIVOT:
    update = gimp_tool_transform_3d_grid_motion_vanishing_point(grid, coords->x,
                                                                coords->y);
    break;

  case GIMP_TRANSFORM_HANDLE_CENTER:
    update =
        gimp_tool_transform_3d_grid_motion_move(grid, coords->x, coords->y);
    break;

  case GIMP_TRANSFORM_HANDLE_ROTATION:
    update =
        gimp_tool_transform_3d_grid_motion_rotate(grid, coords->x, coords->y);
    break;
  ...
  if (update) {
    gimp_transform_3d_matrix(&transform,
                             ...
                             priv->camera_x, priv->camera_y, priv->camera_z,

                             priv->offset_x, priv->offset_y, priv->offset_z,

                             priv->rotation_order, priv->angle_x, priv->angle_y,
                             priv->angle_z,

                             priv->pivot_x, priv->pivot_y, priv->pivot_z);

    g_object_set(widget, "transform", &transform, NULL);
  }
}
...
static void gimp_tool_transform_3d_grid_hover(GimpToolWidget *widget,
                                              ...
                                              GdkModifierType state,
                                              gboolean proximity) {
  GIMP_TOOL_WIDGET_CLASS(parent_class)->hover(widget, coords, state, proximity);

  if (proximity && gimp_tool_transform_grid_get_handle(GIMP_TOOL_TRANSFORM_GRID(
                       widget)) == GIMP_TRANSFORM_HANDLE_PIVOT) {
...
static void gimp_tool_transform_3d_grid_hover_modifier(GimpToolWidget *widget,
  ...
  GIMP_TOOL_WIDGET_CLASS(parent_class)
      ->hover_modifier(widget, key, press, state);
...
static gboolean gimp_tool_transform_3d_grid_get_cursor(
    ...
    GimpCursorType *cursor, GimpToolCursorType *tool_cursor,
    GimpCursorModifier *modifier) {
  if (!GIMP_TOOL_WIDGET_CLASS(parent_class)
           ->get_cursor(widget, coords, state, cursor, tool_cursor, modifier)) {
    return FALSE;
  }
...
gimp_tool_transform_3d_grid_update_mode(GimpToolTransform3DGrid *grid) {
  ...
  if (priv->unified) {
    g_object_set(grid, "inside-function", GIMP_TRANSFORM_FUNCTION_MOVE,
                 "outside-function", GIMP_TRANSFORM_FUNCTION_ROTATE,
                 "use-pivot-handle", TRUE, NULL);
  } else {
    switch (priv->mode) {
    case GIMP_TRANSFORM_3D_MODE_CAMERA:
      g_object_set(grid, "inside-function", GIMP_TRANSFORM_FUNCTION_NONE,
    ...
    case GIMP_TRANSFORM_3D_MODE_MOVE:
      g_object_set(grid, "inside-function", GIMP_TRANSFORM_FUNCTION_MOVE,
                   ...
                   "use-pivot-handle", FALSE, NULL);
      break;

    case GIMP_TRANSFORM_3D_MODE_ROTATE:
      g_object_set(grid, "inside-function", GIMP_TRANSFORM_FUNCTION_ROTATE,
                   "outside-function", GIMP_TRANSFORM_FUNCTION_ROTATE,
                   "use-pivot-handle", FALSE, NULL);
      break;
    }
...
gimp_tool_transform_3d_grid_reset_motion(GimpToolTransform3DGrid *grid) {
  ...
  g_object_get(grid, "transform", &transform, NULL);
...
gimp_tool_transform_3d_grid_constrain(GimpToolTransform3DGrid *grid, gdouble x,
  ...
  if (priv->constrained_axis == AXIS_NONE) {
    ...
    gimp_display_shell_transform_xy_f(shell, priv->last_x, priv->last_y, &x1,
                                      &y1);
    gimp_display_shell_transform_xy_f(shell, x, y, &x2, &y2);
...
static gboolean gimp_tool_transform_3d_grid_motion_vanishing_point(
  ...
  if (!gimp_tool_transform_3d_grid_constrain(grid, x, y, priv->last_x,
                                             priv->last_y, &x, &y)) {
    return FALSE;
  }
  ...
  GIMP_TOOL_WIDGET_CLASS(parent_class)
      ->motion(GIMP_TOOL_WIDGET(grid), &c, 0, 0);

  g_object_get(grid, "pivot-x", &pivot_x, "pivot-y", &pivot_y, NULL);

  g_object_set(grid, "camera-x", pivot_x, "camera-y", pivot_y, NULL);
...
gimp_tool_transform_3d_grid_motion_move(GimpToolTransform3DGrid *grid,
  ...
  if (!priv->z_axis) {
    ...
    w1 = gimp_matrix4_transform_point(&matrix, priv->last_x, priv->last_y, 0.0,
                                      &x1, &y1, &z1);
    w2 = gimp_matrix4_transform_point(&matrix, x, y, 0.0, &x2, &y2, &z2);

    if (w1 <= 0.0)
      return FALSE;

    if (!gimp_tool_transform_3d_grid_constrain(grid, x, y, x1, y1, &x2, &y2)) {
      return FALSE;
    }
    ...
    if (priv->local_frame) {
      ...
      gimp_transform_3d_matrix4_rotate_euler(&matrix, priv->rotation_order,
                                             priv->angle_x, priv->angle_y,
                                             priv->angle_z, 0.0, 0.0, 0.0);

      gimp_matrix4_transform_point(&matrix, x1, y1, z1, &x1, &y1, &z1);
      gimp_matrix4_transform_point(&matrix, x2, y2, z2, &x2, &y2, &z2);
    }

    if (w2 > 0.0) {
      g_object_set(grid, "offset-x", priv->offset_x + (x2 - x1), "offset-y",
                   priv->offset_y + (y2 - y1), "offset-z",
                   priv->offset_z + (z2 - z1), NULL);

      priv->last_x = x;
      priv->last_y = y;
    } else {
      g_object_set(grid, "offset-x", priv->orig_offset_x, "offset-y",
                   priv->orig_offset_y, "offset-z", priv->orig_offset_z, NULL);
    ...
    g_object_set(grid, "offset-x", priv->offset_x + axis.x * amount, "offset-y",
                 priv->offset_y + axis.y * amount, "offset-z",
                 priv->offset_z + axis.z * amount, NULL);
...
gimp_tool_transform_3d_grid_motion_rotate(GimpToolTransform3DGrid *grid,
  ...
  if (!local_frame) {
  ...
  } else {
    {
      ...
      gimp_transform_3d_matrix4_rotate_euler(
          &matrix, priv->rotation_order, priv->angle_x, priv->angle_y,
          priv->angle_z, priv->pivot_x, priv->pivot_y, priv->pivot_z);

      gimp_transform_3d_matrix4_translate(&matrix, priv->offset_x,
                                          priv->offset_y, priv->offset_z);

      gimp_matrix4_transform_point(&matrix, 0.0, 0.0, 0.0, &o.x, &o.y, &o.z);
      gimp_matrix4_transform_point(&matrix, 0.0, 0.0, 1.0, &n.x, &n.y, &n.z);
...

    {
      ...
      gimp_matrix3_transform_point(&priv->orig_transform, priv->pivot_x,
                                   priv->pivot_y, &o.x, &o.y);
      gimp_matrix3_transform_point(&priv->orig_transform, priv->pivot_x + 1.0,
                                   priv->pivot_y, &u.x, &u.y);
      gimp_matrix3_transform_point(&priv->orig_transform, priv->pivot_x,
                                   priv->pivot_y + 1.0, &v.x, &v.y);
  ...
  if (!priv->z_axis) {
    ...
    gimp_matrix2_transform_point(&basis_inv, -(y - priv->last_y),
                                 x - priv->last_x, &omega.x, &omega.y);

    omega.z = 0.0;

    if (!gimp_tool_transform_3d_grid_constrain(grid, x, y, 0.0, 0.0, &omega.x,
                                               &omega.y)) {
      return FALSE;
    }
  ...
  g_object_set(grid, "angle-x", priv->angle_x, "angle-y", priv->angle_y,
               "angle-z", priv->angle_z, NULL);
...
GimpToolWidget *
gimp_tool_transform_3d_grid_new(GimpDisplayShell *shell, gdouble x1, gdouble y1,
                                gdouble x2, gdouble y2, gdouble camera_x,
                                gdouble camera_y, gdouble camera_z) {
  g_return_val_if_fail(GIMP_IS_DISPLAY_SHELL(shell), NULL);

  return g_object_new(GIMP_TYPE_TOOL_TRANSFORM_3D_GRID, "shell", shell, "x1",
                      x1, "y1", y1, "x2", x2, "y2", y2, "camera-x", camera_x,
                      "camera-y", camera_y, "camera-z", camera_z, "pivot-3d-x",
                      (x1 + x2) / 2.0, "pivot-3d-y", (y1 + y2) / 2.0,
                      "pivot-3d-z", 0.0, NULL);
}
