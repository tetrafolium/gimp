...
#define GIMP_CANVAS_EVENT_MASK                                                 \
  (GDK_EXPOSURE_MASK | GDK_POINTER_MOTION_MASK | GDK_BUTTON_PRESS_MASK |       \
   ...
   GDK_STRUCTURE_MASK | GDK_ENTER_NOTIFY_MASK | GDK_LEAVE_NOTIFY_MASK |        \
   GDK_FOCUS_CHANGE_MASK | GDK_KEY_PRESS_MASK | GDK_KEY_RELEASE_MASK |         \
   GDK_PROXIMITY_OUT_MASK)

#define GIMP_TYPE_CANVAS (gimp_canvas_get_type())
#define GIMP_CANVAS(obj)                                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CANVAS, GimpCanvas))
#define GIMP_CANVAS_CLASS(klass)                                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CANVAS, GimpCanvasClass))
#define GIMP_IS_CANVAS(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CANVAS))
#define GIMP_IS_CANVAS_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CANVAS))
#define GIMP_CANVAS_GET_CLASS(obj)                                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CANVAS, GimpCanvasClass))
...
PangoLayout *gimp_canvas_get_layout(GimpCanvas *canvas, const gchar *format,
                                    ...) G_GNUC_PRINTF(2, 3);
