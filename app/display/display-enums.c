...
GType gimp_button_release_type_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_BUTTON_RELEASE_NO_MOTION, "GIMP_BUTTON_RELEASE_NO_MOTION",
       "no-motion"},
      {0, NULL, NULL}};
...
GType gimp_compass_orientation_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_COMPASS_ORIENTATION_HORIZONTAL,
       "GIMP_COMPASS_ORIENTATION_HORIZONTAL", "horizontal"},
      {GIMP_COMPASS_ORIENTATION_VERTICAL, "GIMP_COMPASS_ORIENTATION_VERTICAL",
       "vertical"},
      {0, NULL, NULL}};
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_COMPASS_ORIENTATION_HORIZONTAL,
       NC_("compass-orientation", "Horizontal"), NULL},
      {GIMP_COMPASS_ORIENTATION_VERTICAL,
       NC_("compass-orientation", "Vertical"), NULL},
      {0, NULL, NULL}};
...
GType gimp_cursor_precision_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_CURSOR_PRECISION_PIXEL_CENTER, "GIMP_CURSOR_PRECISION_PIXEL_CENTER",
       "pixel-center"},
...
GType gimp_handle_type_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_HANDLE_DASHED_DIAMOND, "GIMP_HANDLE_DASHED_DIAMOND",
       "dashed-diamond"},
...
GType gimp_handle_anchor_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_HANDLE_ANCHOR_NORTH_WEST, "GIMP_HANDLE_ANCHOR_NORTH_WEST",
       "north-west"},
      {GIMP_HANDLE_ANCHOR_NORTH_EAST, "GIMP_HANDLE_ANCHOR_NORTH_EAST",
       "north-east"},
      {GIMP_HANDLE_ANCHOR_SOUTH, "GIMP_HANDLE_ANCHOR_SOUTH", "south"},
      {GIMP_HANDLE_ANCHOR_SOUTH_WEST, "GIMP_HANDLE_ANCHOR_SOUTH_WEST",
       "south-west"},
      {GIMP_HANDLE_ANCHOR_SOUTH_EAST, "GIMP_HANDLE_ANCHOR_SOUTH_EAST",
       "south-east"},
...
GType gimp_rectangle_constraint_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_RECTANGLE_CONSTRAIN_IMAGE, "GIMP_RECTANGLE_CONSTRAIN_IMAGE",
       "image"},
      {GIMP_RECTANGLE_CONSTRAIN_DRAWABLE, "GIMP_RECTANGLE_CONSTRAIN_DRAWABLE",
       "drawable"},
      {0, NULL, NULL}};
...
GType gimp_rectangle_fixed_rule_get_type(void) {
  ...
  static const GimpEnumDesc descs[] = {
      {GIMP_RECTANGLE_FIXED_ASPECT, NC_("rectangle-fixed-rule", "Aspect ratio"),
       NULL},
      {GIMP_RECTANGLE_FIXED_WIDTH, NC_("rectangle-fixed-rule", "Width"), NULL},
      {GIMP_RECTANGLE_FIXED_HEIGHT, NC_("rectangle-fixed-rule", "Height"),
       NULL},
...
GType gimp_rectangle_precision_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_RECTANGLE_PRECISION_DOUBLE, "GIMP_RECTANGLE_PRECISION_DOUBLE",
       "double"},
      {0, NULL, NULL}};
...
GType gimp_transform_3d_mode_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_TRANSFORM_3D_MODE_CAMERA, "GIMP_TRANSFORM_3D_MODE_CAMERA",
       "camera"},
      {GIMP_TRANSFORM_3D_MODE_MOVE, "GIMP_TRANSFORM_3D_MODE_MOVE", "move"},
      {GIMP_TRANSFORM_3D_MODE_ROTATE, "GIMP_TRANSFORM_3D_MODE_ROTATE",
       "rotate"},
      {0, NULL, NULL}};
...
GType gimp_transform_function_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_TRANSFORM_FUNCTION_PERSPECTIVE,
       "GIMP_TRANSFORM_FUNCTION_PERSPECTIVE", "perspective"},
      {0, NULL, NULL}};
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_TRANSFORM_FUNCTION_PERSPECTIVE,
       "GIMP_TRANSFORM_FUNCTION_PERSPECTIVE", NULL},
      {0, NULL, NULL}};
...
GType gimp_transform_handle_mode_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_HANDLE_MODE_ADD_TRANSFORM, "GIMP_HANDLE_MODE_ADD_TRANSFORM",
       "add-transform"},
  ...
  static const GimpEnumDesc descs[] = {
      {GIMP_HANDLE_MODE_ADD_TRANSFORM,
       NC_("transform-handle-mode", "Add / Transform"), NULL},
...
GType gimp_vector_mode_get_type(void) {
  static const GEnumValue values[] = {
...
GType gimp_zoom_focus_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_ZOOM_FOCUS_IMAGE_CENTER, "GIMP_ZOOM_FOCUS_IMAGE_CENTER",
       "image-center"},
      {GIMP_ZOOM_FOCUS_RETAIN_CENTERING_ELSE_BEST_GUESS,
       "GIMP_ZOOM_FOCUS_RETAIN_CENTERING_ELSE_BEST_GUESS",
       "retain-centering-else-best-guess"},
      {0, NULL, NULL}};
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_ZOOM_FOCUS_RETAIN_CENTERING_ELSE_BEST_GUESS,
       "GIMP_ZOOM_FOCUS_RETAIN_CENTERING_ELSE_BEST_GUESS", NULL},
      {0, NULL, NULL}};
