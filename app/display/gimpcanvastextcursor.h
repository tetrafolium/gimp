...
#define GIMP_CANVAS_TEXT_CURSOR(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CANVAS_TEXT_CURSOR,             \
                              GimpCanvasTextCursor))
#define GIMP_CANVAS_TEXT_CURSOR_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CANVAS_TEXT_CURSOR,              \
                           GimpCanvasTextCursorClass))
#define GIMP_IS_CANVAS_TEXT_CURSOR(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CANVAS_TEXT_CURSOR))
#define GIMP_IS_CANVAS_TEXT_CURSOR_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CANVAS_TEXT_CURSOR))
#define GIMP_CANVAS_TEXT_CURSOR_GET_CLASS(obj)                                 \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CANVAS_TEXT_CURSOR,              \
                             GimpCanvasTextCursorClass))
