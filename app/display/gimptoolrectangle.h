...
#define GIMP_TOOL_RECTANGLE(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_RECTANGLE,                 \
                              GimpToolRectangle))
#define GIMP_TOOL_RECTANGLE_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_RECTANGLE,                  \
                           GimpToolRectangleClass))
#define GIMP_IS_TOOL_RECTANGLE(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_RECTANGLE))
#define GIMP_IS_TOOL_RECTANGLE_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_RECTANGLE))
#define GIMP_TOOL_RECTANGLE_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_RECTANGLE,                  \
                             GimpToolRectangleClass))
...
void gimp_tool_rectangle_get_public_rect(GimpToolRectangle *rectangle,
                                         gdouble *pub_x1, gdouble *pub_y1,
                                         gdouble *pub_x2, gdouble *pub_y2);
