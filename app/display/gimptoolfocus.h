...
#define GIMP_TOOL_FOCUS(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_FOCUS, GimpToolFocus))
#define GIMP_TOOL_FOCUS_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_FOCUS, GimpToolFocusClass))
#define GIMP_IS_TOOL_FOCUS(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_FOCUS))
#define GIMP_IS_TOOL_FOCUS_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_FOCUS))
#define GIMP_TOOL_FOCUS_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_FOCUS, GimpToolFocusClass))
