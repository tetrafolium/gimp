...
GimpImageType gimp_babl_format_get_image_type(const Babl *format) {
  ...
  } else if (!strcmp(name, "YA") || !strcmp(name, "Y'A") ||
             !strcmp(name, "Y~A")) {
    return GIMP_GRAYA_IMAGE;
  } else if (!strcmp(name, "RGB") || !strcmp(name, "R'G'B'") ||
             !strcmp(name, "R~G~B~")) {
    return GIMP_RGB_IMAGE;
  } else if (!strcmp(name, "RGBA") || !strcmp(name, "R'G'B'A") ||
             !strcmp(name, "R~G~B~A")) {
...
const Babl *gimp_babl_compat_u8_format(const Babl *format) {
  ...
  return gimp_babl_format(
      gimp_babl_format_get_base_type(format), GIMP_PRECISION_U8_NON_LINEAR,
...
const Babl *gimp_babl_compat_u8_mask_format(const Babl *format) {
  ...
  return gimp_babl_format(gimp_babl_format_get_base_type(format),
                          GIMP_PRECISION_U8_LINEAR, FALSE, NULL);
}
