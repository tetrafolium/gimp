...
#define GIMP_APPLICATOR(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_APPLICATOR, GimpApplicator))
#define GIMP_APPLICATOR_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_APPLICATOR, GimpApplicatorClass))
#define GIMP_IS_APPLICATOR(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_APPLICATOR))
#define GIMP_IS_APPLICATOR_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_APPLICATOR))
#define GIMP_APPLICATOR_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_APPLICATOR, GimpApplicatorClass))
...
void gimp_applicator_set_apply_offset(GimpApplicator *applicator,
                                      gint apply_offset_x, gint apply_offset_y);
