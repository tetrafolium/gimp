...
#define GIMP_TYPE_OPERATION_CAGE_TRANSFORM                                     \
  (gimp_operation_cage_transform_get_type())
#define GIMP_OPERATION_CAGE_TRANSFORM(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_OPERATION_CAGE_TRANSFORM,       \
                              GimpOperationCageTransform))
#define GIMP_OPERATION_CAGE_TRANSFORM_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_OPERATION_CAGE_TRANSFORM,        \
                           GimpOperationCageTransformClass))
#define GIMP_IS_OPERATION_CAGE_TRANSFORM(obj)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_OPERATION_CAGE_TRANSFORM))
#define GIMP_IS_OPERATION_CAGE_TRANSFORM_CLASS(klass)                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_OPERATION_CAGE_TRANSFORM))
#define GIMP_OPERATION_CAGE_TRANSFORM_GET_CLASS(obj)                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_OPERATION_CAGE_TRANSFORM,        \
                             GimpOperationCageTransformClass))
