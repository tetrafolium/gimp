...
typedef enum {
  ...
  GIMP_LAYER_MODE_NORMAL_LEGACY,      /*< desc="Normal (legacy)",      abbrev="Normal
                                         (l)"            >*/
  GIMP_LAYER_MODE_DISSOLVE,           /*< desc="Dissolve"           >*/
  GIMP_LAYER_MODE_BEHIND_LEGACY,      /*< desc="Behind (legacy)",      abbrev="Behind
                                         (l)"            >*/
  GIMP_LAYER_MODE_MULTIPLY_LEGACY,    /*< desc="Multiply (legacy)",
                                         abbrev="Multiply (l)"          >*/
  GIMP_LAYER_MODE_SCREEN_LEGACY,      /*< desc="Screen (legacy)",      abbrev="Screen
                                         (l)"            >*/
  GIMP_LAYER_MODE_OVERLAY_LEGACY,     /*< desc="Old broken Overlay",     abbrev="Old
                                         Overlay"           >*/
  ...
  GIMP_LAYER_MODE_DARKEN_ONLY_LEGACY, /*< desc="Darken only (legacy)",
                                         abbrev="Darken only (l)"       >*/
  GIMP_LAYER_MODE_LIGHTEN_ONLY_LEGACY, /*< desc="Lighten only (legacy)",
                                          abbrev="Lighten only (l)"      >*/
  GIMP_LAYER_MODE_HSV_HUE_LEGACY, /*< desc="HSV Hue (legacy)", abbrev="HSV Hue
                                     (l)"           >*/
  GIMP_LAYER_MODE_HSV_SATURATION_LEGACY, /*< desc="HSV Saturation (legacy)",
                                            abbrev="HSV Saturation (l)"    >*/
  GIMP_LAYER_MODE_HSL_COLOR_LEGACY, /*< desc="HSL Color (legacy)", abbrev="HSL
                                       Color (l)"         >*/
  GIMP_LAYER_MODE_HSV_VALUE_LEGACY, /*< desc="HSV Value (legacy)", abbrev="HSV
                                       Value (l)"         >*/
  GIMP_LAYER_MODE_DIVIDE_LEGACY,    /*< desc="Divide (legacy)",    abbrev="Divide
                                       (l)"            >*/
  GIMP_LAYER_MODE_DODGE_LEGACY, /*< desc="Dodge (legacy)", abbrev="Dodge (l)"
                                   >*/
  GIMP_LAYER_MODE_BURN_LEGACY,  /*< desc="Burn (legacy)",           abbrev="Burn
                                   (l)"              >*/
...
{ GIMP_LAYER_MODE_CONTEXT_LAYER = 1 << 0,
  ...
  GIMP_LAYER_MODE_CONTEXT_ALL =
      (GIMP_LAYER_MODE_CONTEXT_LAYER | GIMP_LAYER_MODE_CONTEXT_GROUP |
       GIMP_LAYER_MODE_CONTEXT_PAINT | GIMP_LAYER_MODE_CONTEXT_FILTER)
...
{ GIMP_LAYER_MODE_FLAG_LEGACY = 1 << 0,
  ...
  GIMP_LAYER_MODE_FLAG_TRIVIAL = 1 << 6 } GimpLayerModeFlags;
