...
#define GIMP_OPERATION_SETTINGS(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_OPERATION_SETTINGS,             \
                              GimpOperationSettings))
#define GIMP_OPERATION_SETTINGS_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_OPERATION_SETTINGS,              \
                           GimpOperationSettingsClass))
#define GIMP_IS_OPERATION_SETTINGS(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_OPERATION_SETTINGS))
#define GIMP_IS_OPERATION_SETTINGS_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_OPERATION_SETTINGS))
#define GIMP_OPERATION_SETTINGS_GET_CLASS(obj)                                 \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_OPERATION_SETTINGS,              \
                             GimpOperationSettingsClass))
