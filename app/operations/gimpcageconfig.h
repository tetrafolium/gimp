...
#define GIMP_CAGE_CONFIG(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CAGE_CONFIG, GimpCageConfig))
#define GIMP_CAGE_CONFIG_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CAGE_CONFIG, GimpCageConfigClass))
#define GIMP_IS_CAGE_CONFIG(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CAGE_CONFIG))
#define GIMP_IS_CAGE_CONFIG_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CAGE_CONFIG))
#define GIMP_CAGE_CONFIG_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CAGE_CONFIG, GimpCageConfigClass))
...
void gimp_cage_config_add_cage_point(GimpCageConfig *gcc, gdouble x, gdouble y);
...
void gimp_cage_config_remove_cage_point(GimpCageConfig *gcc, gint point_number);
...
gboolean gimp_cage_config_point_inside(GimpCageConfig *gcc, gfloat x, gfloat y);
