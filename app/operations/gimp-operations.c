...
static void set_compat_file(GType type, const gchar *basename) {
...
static void set_settings_folder(GType type, const gchar *basename) {
...
void gimp_operations_init(Gimp *gimp) {
  ...
  gimp_operation_config_register(gimp, "gimp:brightness-contrast",
  ...
  gimp_operation_config_register(gimp, "gimp:color-balance",
                                 GIMP_TYPE_COLOR_BALANCE_CONFIG);
  set_compat_file(GIMP_TYPE_COLOR_BALANCE_CONFIG,
                  "gimp-color-balance-tool.settings");
  set_settings_folder(GIMP_TYPE_COLOR_BALANCE_CONFIG, "color-balance");

  gimp_operation_config_register(gimp, "gimp:curves", GIMP_TYPE_CURVES_CONFIG);
  set_compat_file(GIMP_TYPE_CURVES_CONFIG, "gimp-curves-tool.settings");
  set_settings_folder(GIMP_TYPE_CURVES_CONFIG, "curves");

  gimp_operation_config_register(gimp, "gimp:hue-saturation",
                                 GIMP_TYPE_HUE_SATURATION_CONFIG);
  set_compat_file(GIMP_TYPE_HUE_SATURATION_CONFIG,
                  "gimp-hue-saturation-tool.settings");
  set_settings_folder(GIMP_TYPE_HUE_SATURATION_CONFIG, "hue-saturation");

  gimp_operation_config_register(gimp, "gimp:levels", GIMP_TYPE_LEVELS_CONFIG);
  set_compat_file(GIMP_TYPE_LEVELS_CONFIG, "gimp-levels-tool.settings");
  set_settings_folder(GIMP_TYPE_LEVELS_CONFIG, "levels");
}
