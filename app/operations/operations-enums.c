...
GType gimp_layer_color_space_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_LAYER_COLOR_SPACE_RGB_PERCEPTUAL,
       "GIMP_LAYER_COLOR_SPACE_RGB_PERCEPTUAL", "rgb-perceptual"},
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_LAYER_COLOR_SPACE_RGB_LINEAR,
       NC_("layer-color-space", "RGB (linear)"), NULL},
      {GIMP_LAYER_COLOR_SPACE_RGB_PERCEPTUAL,
       NC_("layer-color-space", "RGB (perceptual)"), NULL},
...
GType gimp_layer_composite_mode_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP,
       "GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP", "clip-to-backdrop"},
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP,
       NC_("layer-composite-mode", "Clip to backdrop"), NULL},
      {GIMP_LAYER_COMPOSITE_CLIP_TO_LAYER,
       NC_("layer-composite-mode", "Clip to layer"), NULL},
      {GIMP_LAYER_COMPOSITE_INTERSECTION,
       NC_("layer-composite-mode", "Intersection"), NULL},
      {0, NULL, NULL}};
...
GType gimp_layer_mode_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_LAYER_MODE_LIGHTEN_ONLY_LEGACY,
       "GIMP_LAYER_MODE_LIGHTEN_ONLY_LEGACY", "lighten-only-legacy"},
      {GIMP_LAYER_MODE_HSV_HUE_LEGACY, "GIMP_LAYER_MODE_HSV_HUE_LEGACY",
       "hsv-hue-legacy"},
      {GIMP_LAYER_MODE_HSV_SATURATION_LEGACY,
       "GIMP_LAYER_MODE_HSV_SATURATION_LEGACY", "hsv-saturation-legacy"},
      ...
      {GIMP_LAYER_MODE_GRAIN_EXTRACT_LEGACY,
       "GIMP_LAYER_MODE_GRAIN_EXTRACT_LEGACY", "grain-extract-legacy"},
  ...
  static const GimpEnumDesc descs[] = {
      {GIMP_LAYER_MODE_NORMAL_LEGACY, NC_("layer-mode", "Normal (legacy)"),
       NULL},
      ...
      {GIMP_LAYER_MODE_BEHIND_LEGACY, NC_("layer-mode", "Behind (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "Behind (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_BEHIND_LEGACY, NC_("layer-mode", "Behind (l)"), NULL},
      {GIMP_LAYER_MODE_MULTIPLY_LEGACY, NC_("layer-mode", "Multiply (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "Multiply (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_MULTIPLY_LEGACY, NC_("layer-mode", "Multiply (l)"),
       NULL},
      {GIMP_LAYER_MODE_SCREEN_LEGACY, NC_("layer-mode", "Screen (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "Screen (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_SCREEN_LEGACY, NC_("layer-mode", "Screen (l)"), NULL},
      {GIMP_LAYER_MODE_OVERLAY_LEGACY, NC_("layer-mode", "Old broken Overlay"),
       NULL},
      /* Translators: this is an abbreviated version of "Old broken Overlay".
         Keep it short. */
      {GIMP_LAYER_MODE_OVERLAY_LEGACY, NC_("layer-mode", "Old Overlay"), NULL},
      {GIMP_LAYER_MODE_DIFFERENCE_LEGACY,
       NC_("layer-mode", "Difference (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Difference (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_DIFFERENCE_LEGACY, NC_("layer-mode", "Difference (l)"),
       NULL},
      {GIMP_LAYER_MODE_ADDITION_LEGACY, NC_("layer-mode", "Addition (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "Addition (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_ADDITION_LEGACY, NC_("layer-mode", "Addition (l)"),
       NULL},
      {GIMP_LAYER_MODE_SUBTRACT_LEGACY, NC_("layer-mode", "Subtract (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "Subtract (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_SUBTRACT_LEGACY, NC_("layer-mode", "Subtract (l)"),
       NULL},
      {GIMP_LAYER_MODE_DARKEN_ONLY_LEGACY,
       NC_("layer-mode", "Darken only (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Darken only (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_DARKEN_ONLY_LEGACY, NC_("layer-mode", "Darken only (l)"),
       NULL},
      {GIMP_LAYER_MODE_LIGHTEN_ONLY_LEGACY,
       NC_("layer-mode", "Lighten only (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Lighten only (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_LIGHTEN_ONLY_LEGACY,
       NC_("layer-mode", "Lighten only (l)"), NULL},
      {GIMP_LAYER_MODE_HSV_HUE_LEGACY, NC_("layer-mode", "HSV Hue (legacy)"),
       NULL},
      /* Translators: this is an abbreviated version of "HSV Hue (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_HSV_HUE_LEGACY, NC_("layer-mode", "HSV Hue (l)"), NULL},
      {GIMP_LAYER_MODE_HSV_SATURATION_LEGACY,
       NC_("layer-mode", "HSV Saturation (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "HSV Saturation
         (legacy)". Keep it short. */
      {GIMP_LAYER_MODE_HSV_SATURATION_LEGACY,
       NC_("layer-mode", "HSV Saturation (l)"), NULL},
      {GIMP_LAYER_MODE_HSL_COLOR_LEGACY,
       NC_("layer-mode", "HSL Color (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "HSL Color (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_HSL_COLOR_LEGACY, NC_("layer-mode", "HSL Color (l)"),
       NULL},
      {GIMP_LAYER_MODE_HSV_VALUE_LEGACY,
       NC_("layer-mode", "HSV Value (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "HSV Value (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_HSV_VALUE_LEGACY, NC_("layer-mode", "HSV Value (l)"),
       NULL},
      {GIMP_LAYER_MODE_DIVIDE_LEGACY, NC_("layer-mode", "Divide (legacy)"),
       NULL},
      ...
      {GIMP_LAYER_MODE_HARDLIGHT_LEGACY,
       NC_("layer-mode", "Hard light (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Hard light (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_HARDLIGHT_LEGACY, NC_("layer-mode", "Hard light (l)"),
       NULL},
      {GIMP_LAYER_MODE_SOFTLIGHT_LEGACY,
       NC_("layer-mode", "Soft light (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Soft light (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_SOFTLIGHT_LEGACY, NC_("layer-mode", "Soft light (l)"),
       NULL},
      {GIMP_LAYER_MODE_GRAIN_EXTRACT_LEGACY,
       NC_("layer-mode", "Grain extract (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Grain extract
         (legacy)". Keep it short. */
      {GIMP_LAYER_MODE_GRAIN_EXTRACT_LEGACY,
       NC_("layer-mode", "Grain extract (l)"), NULL},
      {GIMP_LAYER_MODE_GRAIN_MERGE_LEGACY,
       NC_("layer-mode", "Grain merge (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Grain merge (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_GRAIN_MERGE_LEGACY, NC_("layer-mode", "Grain merge (l)"),
       NULL},
      {GIMP_LAYER_MODE_COLOR_ERASE_LEGACY,
       NC_("layer-mode", "Color erase (legacy)"), NULL},
      /* Translators: this is an abbreviated version of "Color erase (legacy)".
         Keep it short. */
      {GIMP_LAYER_MODE_COLOR_ERASE_LEGACY, NC_("layer-mode", "Color erase (l)"),
       NULL},
      ...
      {GIMP_LAYER_MODE_HSV_SATURATION, NC_("layer-mode", "HSV Saturation"),
       NULL},
      ...
      {GIMP_LAYER_MODE_LUMA_DARKEN_ONLY,
       NC_("layer-mode", "Luma/Luminance darken only"), NULL},
      /* Translators: this is an abbreviated version of "Luma/Luminance darken
         only". Keep it short. */
      {GIMP_LAYER_MODE_LUMA_DARKEN_ONLY, NC_("layer-mode", "Luma darken only"),
       NULL},
      {GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY,
       NC_("layer-mode", "Luma/Luminance lighten only"), NULL},
      /* Translators: this is an abbreviated version of "Luma/Luminance lighten
         only". Keep it short. */
      {GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY,
       NC_("layer-mode", "Luma lighten only"), NULL},
...
GType gimp_layer_mode_group_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_LAYER_MODE_GROUP_DEFAULT, "GIMP_LAYER_MODE_GROUP_DEFAULT",
       "default"},
