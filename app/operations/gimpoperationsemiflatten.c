...
gimp_operation_semi_flatten_class_init(GimpOperationSemiFlattenClass *klass) {
  ...
  gegl_operation_class_set_keys(
      operation_class, "name", "gimp:semi-flatten", "categories", "color",
      "description", _("Replace partial transparency with a color"), NULL);
  ...
  g_object_class_install_property(
      ...
      gimp_param_spec_rgb("color", _("Color"), _("The color"), FALSE, &white,
                          G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}

static void gimp_operation_semi_flatten_init(GimpOperationSemiFlatten *self) {}
