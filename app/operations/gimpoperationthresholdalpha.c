...
static gboolean
gimp_operation_threshold_alpha_process(GeglOperation *operation, void *in_buf,
...
static void gimp_operation_threshold_alpha_class_init(
    GimpOperationThresholdAlphaClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:threshold-alpha",
  ...
  g_object_class_install_property(
      ...
      g_param_spec_double("value", _("Value"), _("The alpha value"), 0.0, 1.0,
                          0.5, G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}
