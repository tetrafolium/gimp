...
static gboolean
gimp_operation_hsv_hue_legacy_process(GeglOperation *op, void *in, void *layer,
...
static void gimp_operation_hsv_hue_legacy_class_init(
    GimpOperationHsvHueLegacyClass *klass) {
  GeglOperationClass *operation_class = GEGL_OPERATION_CLASS(klass);
  GimpOperationLayerModeClass *layer_mode_class =
      GIMP_OPERATION_LAYER_MODE_CLASS(klass);

  gegl_operation_class_set_keys(operation_class, "name", "gimp:hsv-hue-legacy",
                                "description", "GIMP hue mode operation", NULL);
...
static gboolean gimp_operation_hsv_hue_legacy_process(
