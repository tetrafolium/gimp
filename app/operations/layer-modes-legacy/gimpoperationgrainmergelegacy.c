...
static gboolean gimp_operation_grain_merge_legacy_process(
...
static void gimp_operation_grain_merge_legacy_class_init(
    GimpOperationGrainMergeLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name",
                                "gimp:grain-merge-legacy", "description",
                                "GIMP grain merge mode operation", NULL);
