...
static gboolean gimp_operation_hsv_value_legacy_process(
...
static void gimp_operation_hsv_value_legacy_class_init(
    GimpOperationHsvValueLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name",
                                "gimp:hsv-value-legacy", "description",
                                "GIMP value mode operation", NULL);
