...
static gboolean gimp_operation_hsv_saturation_legacy_process(
    GeglOperation *op, void *in, void *layer, void *mask, void *out,
    glong samples, const GeglRectangle *roi, gint level);

G_DEFINE_TYPE(GimpOperationHsvSaturationLegacy,
              gimp_operation_hsv_saturation_legacy,
              GIMP_TYPE_OPERATION_LAYER_MODE)

static void gimp_operation_hsv_saturation_legacy_class_init(
    GimpOperationHsvSaturationLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name",
                                "gimp:hsv-saturation-legacy", "description",
                                "GIMP saturation mode operation", NULL);

  layer_mode_class->process = gimp_operation_hsv_saturation_legacy_process;
}

static void gimp_operation_hsv_saturation_legacy_init(
    GimpOperationHsvSaturationLegacy *self) {}
