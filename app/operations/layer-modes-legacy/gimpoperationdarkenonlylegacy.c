...
static gboolean gimp_operation_darken_only_legacy_process(
...
static void gimp_operation_darken_only_legacy_class_init(
    GimpOperationDarkenOnlyLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name",
                                "gimp:darken-only-legacy", "description",
                                "GIMP darken only mode operation", NULL);
