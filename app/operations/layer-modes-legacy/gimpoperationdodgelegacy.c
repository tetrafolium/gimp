...
static gboolean gimp_operation_dodge_legacy_process(GeglOperation *op, void *in,
...
gimp_operation_dodge_legacy_class_init(GimpOperationDodgeLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:dodge-legacy",
...
static void gimp_operation_dodge_legacy_init(GimpOperationDodgeLegacy *self) {}

static gboolean gimp_operation_dodge_legacy_process(
