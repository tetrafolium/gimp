...
static gboolean
gimp_operation_screen_legacy_process(GeglOperation *op, void *in, void *layer,
...
gimp_operation_screen_legacy_class_init(GimpOperationScreenLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:screen-legacy",
...
static void gimp_operation_screen_legacy_init(GimpOperationScreenLegacy *self) {
}

static gboolean gimp_operation_screen_legacy_process(
