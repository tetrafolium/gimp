...
static gboolean
gimp_operation_divide_legacy_process(GeglOperation *op, void *in, void *layer,
...
gimp_operation_divide_legacy_class_init(GimpOperationDivideLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:divide-legacy",
...
static void gimp_operation_divide_legacy_init(GimpOperationDivideLegacy *self) {
}

static gboolean gimp_operation_divide_legacy_process(
