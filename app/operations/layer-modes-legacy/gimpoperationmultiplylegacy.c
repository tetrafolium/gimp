...
static gboolean
gimp_operation_multiply_legacy_process(GeglOperation *op, void *in, void *layer,
...
static void gimp_operation_multiply_legacy_class_init(
    GimpOperationMultiplyLegacyClass *klass) {
  GeglOperationClass *operation_class = GEGL_OPERATION_CLASS(klass);
  GimpOperationLayerModeClass *layer_mode_class =
      GIMP_OPERATION_LAYER_MODE_CLASS(klass);

  gegl_operation_class_set_keys(operation_class, "name", "gimp:multiply-legacy",
...
static gboolean gimp_operation_multiply_legacy_process(
