...
static gboolean gimp_operation_softlight_legacy_process(
...
static void gimp_operation_softlight_legacy_class_init(
    GimpOperationSoftlightLegacyClass *klass) {
  GeglOperationClass *operation_class = GEGL_OPERATION_CLASS(klass);
  GimpOperationLayerModeClass *layer_mode_class =
      GIMP_OPERATION_LAYER_MODE_CLASS(klass);

  gegl_operation_class_set_keys(
      operation_class, "name", "gimp:softlight-legacy", "description",
      "GIMP softlight mode operation", "reference-image", "soft-light-mode.png",
