...
static gboolean gimp_operation_burn_legacy_process(GeglOperation *op, void *in,
...
gimp_operation_burn_legacy_class_init(GimpOperationBurnLegacyClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:burn-legacy",
...
static void gimp_operation_burn_legacy_init(GimpOperationBurnLegacy *self) {}

static gboolean
gimp_operation_burn_legacy_process(GeglOperation *op, void *in_p, void *layer_p,
                                   void *mask_p, void *out_p, glong samples,
