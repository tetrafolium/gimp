...
gimp_operation_set_alpha_class_init(GimpOperationSetAlphaClass *klass) {
  ...
  gegl_operation_class_set_keys(
      operation_class, "name", "gimp:set-alpha", "categories", "color",
      "description", "Set a buffer's alpha channel to a value", NULL);
  ...
  g_object_class_install_property(
      ...
      g_param_spec_double("value", "Value", "The alpha value", 0.0, 1.0, 1.0,
                          G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}

static void gimp_operation_set_alpha_init(GimpOperationSetAlpha *self) {}
