...
static gboolean gimp_operation_dissolve_process(GeglOperation *op, void *in,
...
gimp_operation_dissolve_class_init(GimpOperationDissolveClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:dissolve",
                                "description", "GIMP dissolve mode operation",
                                "categories", "compositors", NULL);

  layer_mode_class->process = gimp_operation_dissolve_process;
  layer_mode_class->get_affected_region =
      gimp_operation_dissolve_get_affected_region;
...
static void gimp_operation_dissolve_init(GimpOperationDissolve *self) {}

static gboolean gimp_operation_dissolve_process(GeglOperation *op, void *in_p,
...
static GimpLayerCompositeRegion gimp_operation_dissolve_get_affected_region(
