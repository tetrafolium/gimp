...
static const GimpLayerModeInfo layer_mode_infos[] = {
...

    {
        ...
        .composite_mode = GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP,
        .composite_space = GIMP_LAYER_COLOR_SPACE_RGB_LINEAR
        /* no blend_space: reuse composite space, no conversion thus fewer
           copies */
    },
    ...
    {GIMP_LAYER_MODE_ERASE,
     ...
     .flags = GIMP_LAYER_MODE_FLAG_BLEND_SPACE_IMMUTABLE |
              GIMP_LAYER_MODE_FLAG_SUBTRACTIVE |
              GIMP_LAYER_MODE_FLAG_ALPHA_ONLY | GIMP_LAYER_MODE_FLAG_TRIVIAL,
     .context = GIMP_LAYER_MODE_CONTEXT_ALL,
     .paint_composite_mode = GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP,
     .composite_mode = GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP,
     .composite_space = GIMP_LAYER_COLOR_SPACE_RGB_LINEAR},
...
static const GimpLayerMode layer_mode_group_default[] = {
    ...
    GIMP_LAYER_MODE_BEHIND,       GIMP_LAYER_MODE_COLOR_ERASE,
    GIMP_LAYER_MODE_ERASE,        GIMP_LAYER_MODE_ANTI_ERASE,
    GIMP_LAYER_MODE_MERGE,        GIMP_LAYER_MODE_SPLIT,

    GIMP_LAYER_MODE_SEPARATOR,

    GIMP_LAYER_MODE_LIGHTEN_ONLY, GIMP_LAYER_MODE_LUMA_LIGHTEN_ONLY,
    GIMP_LAYER_MODE_SCREEN,       GIMP_LAYER_MODE_DODGE,
    GIMP_LAYER_MODE_ADDITION,

    GIMP_LAYER_MODE_SEPARATOR,

    GIMP_LAYER_MODE_DARKEN_ONLY,  GIMP_LAYER_MODE_LUMA_DARKEN_ONLY,
    GIMP_LAYER_MODE_MULTIPLY,     GIMP_LAYER_MODE_BURN,
    GIMP_LAYER_MODE_LINEAR_BURN,

    GIMP_LAYER_MODE_SEPARATOR,

    GIMP_LAYER_MODE_OVERLAY,      GIMP_LAYER_MODE_SOFTLIGHT,
    GIMP_LAYER_MODE_HARDLIGHT,    GIMP_LAYER_MODE_VIVID_LIGHT,
    GIMP_LAYER_MODE_PIN_LIGHT,    GIMP_LAYER_MODE_LINEAR_LIGHT,
    GIMP_LAYER_MODE_HARD_MIX,

    GIMP_LAYER_MODE_SEPARATOR,

    GIMP_LAYER_MODE_DIFFERENCE,   GIMP_LAYER_MODE_EXCLUSION,
    GIMP_LAYER_MODE_SUBTRACT,     GIMP_LAYER_MODE_GRAIN_EXTRACT,
    GIMP_LAYER_MODE_GRAIN_MERGE,  GIMP_LAYER_MODE_DIVIDE,

    GIMP_LAYER_MODE_SEPARATOR,

    GIMP_LAYER_MODE_HSV_HUE,      GIMP_LAYER_MODE_HSV_SATURATION,
    GIMP_LAYER_MODE_HSL_COLOR,    GIMP_LAYER_MODE_HSV_VALUE,
...
static const GimpLayerModeInfo *gimp_layer_mode_info(GimpLayerMode mode) {
...
GeglOperation *gimp_layer_mode_get_operation(GimpLayerMode mode) {
  ...
  if (!ops[mode]) {
    ...
    node = gegl_node_new_child(NULL, "operation", op_name, NULL);
    ...
    if (GIMP_IS_OPERATION_LAYER_MODE(operation)) {
      ...
      layer_mode->function =
          GIMP_OPERATION_LAYER_MODE_GET_CLASS(operation)->process;
      ...
      layer_mode->composite_mode =
          gimp_layer_mode_get_paint_composite_mode(mode);
    }
  }
...
static gboolean is_mode_in_array(const GimpLayerMode *modes, gint n_modes,
                                 GimpLayerMode mode) {
  gint i;
