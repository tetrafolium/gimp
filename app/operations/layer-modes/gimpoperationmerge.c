...
static gboolean gimp_operation_merge_process(GeglOperation *op, void *in,
...
static void gimp_operation_merge_class_init(GimpOperationMergeClass *klass) {
  GeglOperationClass *operation_class = GEGL_OPERATION_CLASS(klass);
  GimpOperationLayerModeClass *layer_mode_class =
      GIMP_OPERATION_LAYER_MODE_CLASS(klass);

  gegl_operation_class_set_keys(operation_class, "name", "gimp:merge",
...
static void gimp_operation_merge_init(GimpOperationMerge *self) {}

static gboolean gimp_operation_merge_process(GeglOperation *op, void *in_p,
