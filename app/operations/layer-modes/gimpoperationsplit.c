...
static gboolean gimp_operation_split_process(GeglOperation *op, void *in,
...
static void gimp_operation_split_class_init(GimpOperationSplitClass *klass) {
  GeglOperationClass *operation_class = GEGL_OPERATION_CLASS(klass);
  GimpOperationLayerModeClass *layer_mode_class =
      GIMP_OPERATION_LAYER_MODE_CLASS(klass);

  gegl_operation_class_set_keys(operation_class, "name", "gimp:split",
...
static void gimp_operation_split_init(GimpOperationSplit *self) {}

static gboolean gimp_operation_split_process(GeglOperation *op, void *in_p,
