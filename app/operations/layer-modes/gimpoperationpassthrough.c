...
gimp_operation_pass_through_class_init(GimpOperationPassThroughClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:pass-through",
                                "description",
                                "GIMP pass through mode operation", NULL);
...
static void gimp_operation_pass_through_init(GimpOperationPassThrough *self) {}
