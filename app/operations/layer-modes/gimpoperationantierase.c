...
static gboolean gimp_operation_anti_erase_process(GeglOperation *op, void *in,
                                                  void *layer, void *mask,
                                                  void *out, glong samples,
                                                  const GeglRectangle *roi,
                                                  gint level);
static GimpLayerCompositeRegion gimp_operation_anti_erase_get_affected_region(
...
gimp_operation_anti_erase_class_init(GimpOperationAntiEraseClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:anti-erase",
  ...
  layer_mode_class->get_affected_region =
      gimp_operation_anti_erase_get_affected_region;
}

static void gimp_operation_anti_erase_init(GimpOperationAntiErase *self) {}

static gboolean gimp_operation_anti_erase_process(GeglOperation *op, void *in_p,
