...
enum { PROP_0, PROP_RADIUS_X, PROP_RADIUS_Y, PROP_EDGE_LOCK };
...
static GeglRectangle gimp_operation_shrink_get_required_for_output(
...
static void gimp_operation_shrink_class_init(GimpOperationShrinkClass *klass) {
  ...
  gegl_operation_class_set_keys(operation_class, "name", "gimp:shrink",
                                "categories", "gimp", "description",
                                "GIMP Shrink operation", NULL);

  operation_class->prepare = gimp_operation_shrink_prepare;
  operation_class->get_required_for_output =
      gimp_operation_shrink_get_required_for_output;
  ...
  g_object_class_install_property(
      ...
      g_param_spec_int("radius-x", "Radius X", "Shrink radius in X diection", 1,
                       2342, 1, G_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_RADIUS_Y,
      g_param_spec_int("radius-y", "Radius Y", "Shrink radius in Y diection", 1,
                       2342, 1, G_PARAM_READWRITE | G_PARAM_CONSTRUCT));
...
static void gimp_operation_shrink_init(GimpOperationShrink *self) {}
