...
#define GIMP_PLUG_IN_PROCEDURE(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PLUG_IN_PROCEDURE,              \
                              GimpPlugInProcedure))
#define GIMP_PLUG_IN_PROCEDURE_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PLUG_IN_PROCEDURE,               \
                           GimpPlugInProcedureClass))
#define GIMP_IS_PLUG_IN_PROCEDURE(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PLUG_IN_PROCEDURE))
#define GIMP_IS_PLUG_IN_PROCEDURE_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PLUG_IN_PROCEDURE))
#define GIMP_PLUG_IN_PROCEDURE_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PLUG_IN_PROCEDURE,               \
                             GimpPlugInProcedureClass))
