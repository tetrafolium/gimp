...
#define GIMP_PLUG_IN_MANAGER(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PLUG_IN_MANAGER,                \
                              GimpPlugInManager))
#define GIMP_PLUG_IN_MANAGER_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PLUG_IN_MANAGER,                 \
                           GimpPlugInManagerClass))
#define GIMP_IS_PLUG_IN_MANAGER(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PLUG_IN_MANAGER))
#define GIMP_IS_PLUG_IN_MANAGER_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PLUG_IN_MANAGER))
...
struct _GimpPlugInManagerClass {
  ...
  void (*plug_in_opened)(GimpPlugInManager *manager, GimpPlugIn *plug_in);
  void (*plug_in_closed)(GimpPlugInManager *manager, GimpPlugIn *plug_in);

  void (*menu_branch_added)(GimpPlugInManager *manager, GFile *file,
                            const gchar *menu_path, const gchar *menu_label);
};
