...
static guint gimp_environ_table_str_hash(gconstpointer v) {
#ifdef G_OS_WIN32
...
static gboolean gimp_environ_table_str_equal(gconstpointer v1,
                                             gconstpointer v2) {
#ifdef G_OS_WIN32
...
void gimp_environ_table_load(GimpEnvironTable *environ_table, GList *path) {
  GList *list;
  ...
  environ_table->vars = g_hash_table_new_full(
      gimp_environ_table_str_hash, gimp_environ_table_str_equal, g_free,
...
void gimp_environ_table_add(GimpEnvironTable *environ_table, const gchar *name,
                            const gchar *value, const gchar *separator) {
  GimpEnvironValue *val;
...
static void gimp_environ_table_populate(GimpEnvironTable *environ_table) {
  ...
  if (environ_table->vars)
    g_hash_table_foreach(environ_table->vars,
                         (GHFunc)gimp_environ_table_populate_one, env_array);
...
static gboolean gimp_environ_table_pass_through(GimpEnvironTable *environ_table,
  ...
  vars = environ_table->vars && g_hash_table_lookup(environ_table->vars, name);
