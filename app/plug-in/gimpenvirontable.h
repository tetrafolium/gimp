...
#define GIMP_ENVIRON_TABLE(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ENVIRON_TABLE, GimpEnvironTable))
#define GIMP_ENVIRON_TABLE_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_ENVIRON_TABLE,                   \
                           GimpEnvironTableClass))
#define GIMP_IS_ENVIRON_TABLE(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_ENVIRON_TABLE))
#define GIMP_IS_ENVIRON_TABLE_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_ENVIRON_TABLE))
#define GIMP_ENVIRON_TABLE_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_ENVIRON_TABLE,                   \
                             GimpEnvironTableClass))
