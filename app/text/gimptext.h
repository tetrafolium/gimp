...
#define GIMP_TEXT(obj)                                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TEXT, GimpText))
#define GIMP_TEXT_CLASS(klass)                                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TEXT, GimpTextClass))
#define GIMP_IS_TEXT(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TEXT))
#define GIMP_IS_TEXT_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TEXT))
#define GIMP_TEXT_GET_CLASS(obj)                                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TEXT, GimpTextClass))
