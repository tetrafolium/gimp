...
static const GimpActionEntry mypaint_brushes_actions[] = {
    ...
    {"mypaint-brushes-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     data_new_cmd_callback, GIMP_HELP_MYPAINT_BRUSH_NEW},
    ...
    {"mypaint-brushes-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_MYPAINT_BRUSH_DUPLICATE},

    {"mypaint-brushes-copy-location", GIMP_ICON_EDIT_COPY,
     NC_("mypaint-brushes-action", "Copy MyPaint Brush _Location"), NULL,
     NC_("mypaint-brushes-action",
         "Copy MyPaint brush file location to clipboard"),
     data_copy_location_cmd_callback, GIMP_HELP_MYPAINT_BRUSH_COPY_LOCATION},
    ...
    {"mypaint-brushes-delete", GIMP_ICON_EDIT_DELETE,
     ...
     data_delete_cmd_callback, GIMP_HELP_MYPAINT_BRUSH_DELETE},
    ...
    {"mypaint-brushes-refresh", GIMP_ICON_VIEW_REFRESH,
     ...
     data_refresh_cmd_callback, GIMP_HELP_MYPAINT_BRUSH_REFRESH}};
...
static const GimpStringActionEntry mypaint_brushes_edit_actions[] = {
    {"mypaint-brushes-edit", GIMP_ICON_EDIT,
     ...
     NC_("mypaint-brushes-action", "Edit MyPaint brush"), "gimp-mybrush-editor",
...
void mypaint_brushes_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_string_actions(
      ...
      G_N_ELEMENTS(mypaint_brushes_edit_actions), data_edit_cmd_callback);
}
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("mypaint-brushes-duplicate",
                brush && gimp_data_is_duplicatable(data));
  SET_SENSITIVE("mypaint-brushes-copy-location", file);
  SET_SENSITIVE("mypaint-brushes-show-in-file-manager", file);
  SET_SENSITIVE("mypaint-brushes-delete",
                brush && gimp_data_is_deletable(data));
