...
static const GimpActionEntry buffers_actions[] = {
    {"buffers-popup", GIMP_ICON_BUFFER, NC_("buffers-action", "Buffers Menu"),
     NULL, NULL, NULL, GIMP_HELP_BUFFER_DIALOG},
    ...
    {"buffers-delete", GIMP_ICON_EDIT_DELETE,
     ...
     buffers_delete_cmd_callback, GIMP_HELP_BUFFER_DELETE}};
...
static const GimpEnumActionEntry buffers_paste_actions[] = {
    {"buffers-paste", GIMP_ICON_EDIT_PASTE,
     ...
     GIMP_PASTE_TYPE_FLOATING, FALSE, GIMP_HELP_BUFFER_PASTE},
    ...
    {"buffers-paste-in-place", GIMP_ICON_EDIT_PASTE,
     ...
     GIMP_PASTE_TYPE_FLOATING_IN_PLACE, FALSE, GIMP_HELP_BUFFER_PASTE_IN_PLACE},
    ...
    {"buffers-paste-into", GIMP_ICON_EDIT_PASTE_INTO,
     ...
     GIMP_PASTE_TYPE_FLOATING_INTO, FALSE, GIMP_HELP_BUFFER_PASTE_INTO},

    {"buffers-paste-into-in-place", GIMP_ICON_EDIT_PASTE_INTO,
     NC_("buffers-action", "Paste Buffer Into The Selection In Place"), NULL,
     NC_("buffers-action", "Paste the selected buffer into the selection at "
    ...
    {"buffers-paste-as-new-layer", GIMP_ICON_EDIT_PASTE_AS_NEW,
     ...
     GIMP_PASTE_TYPE_NEW_LAYER, FALSE, GIMP_HELP_BUFFER_PASTE_AS_NEW_LAYER},
...
void buffers_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "buffers-action", buffers_actions,
                                G_N_ELEMENTS(buffers_actions));

  gimp_action_group_add_enum_actions(
      group, "buffers-action", buffers_paste_actions,
      G_N_ELEMENTS(buffers_paste_actions), buffers_paste_cmd_callback);
}

void buffers_actions_update(GimpActionGroup *group, gpointer data) {
