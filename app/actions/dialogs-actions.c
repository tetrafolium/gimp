...
const GimpStringActionEntry dialogs_dockable_actions[] = {
    ...
    {"dialogs-tool-options", GIMP_ICON_DIALOG_TOOL_OPTIONS,
     ...
     NC_("dialogs-action", "Open the tool options dialog"), "gimp-tool-options",
    ...
    {"dialogs-symmetry", GIMP_ICON_SYMMETRY,
     ...
     NC_("dialogs-action", "Open the symmetry dialog"), "gimp-symmetry-editor",
    ...
    {"dialogs-channels", GIMP_ICON_DIALOG_CHANNELS,
     ...
     NC_("dialogs-action", "Open the channels dialog"), "gimp-channel-list",
     GIMP_HELP_CHANNEL_DIALOG},

    {"dialogs-vectors", GIMP_ICON_DIALOG_PATHS, NC_("dialogs-action", "_Paths"),
     NULL, NC_("dialogs-action", "Open the paths dialog"), "gimp-vectors-list",
     GIMP_HELP_PATH_DIALOG},

    {"dialogs-indexed-palette", GIMP_ICON_COLORMAP,
     NC_("dialogs-action", "Color_map"), NULL,
     NC_("dialogs-action", "Open the colormap dialog"), "gimp-indexed-palette",
    ...
    {"dialogs-histogram", GIMP_ICON_HISTOGRAM,
     ...
     "gimp-histogram-editor", GIMP_HELP_HISTOGRAM_DIALOG},
    ...
    {"dialogs-navigation", GIMP_ICON_DIALOG_NAVIGATION,
     ...
     "gimp-navigation-view", GIMP_HELP_NAVIGATION_DIALOG},

    {"dialogs-undo-history", GIMP_ICON_DIALOG_UNDO_HISTORY,
     NC_("dialogs-action", "Undo _History"), NULL,
     NC_("dialogs-action", "Open the undo history dialog"), "gimp-undo-history",
     GIMP_HELP_UNDO_DIALOG},

    {"dialogs-cursor", GIMP_ICON_CURSOR, NC_("dialogs-action", "_Pointer"),
    ...
    {"dialogs-sample-points", GIMP_ICON_SAMPLE_POINT,
     ...
     "gimp-sample-point-editor", GIMP_HELP_SAMPLE_POINT_DIALOG},

    {"dialogs-colors", GIMP_ICON_COLORS_DEFAULT,
     NC_("dialogs-action", "Colo_rs"), NULL,
     NC_("dialogs-action", "Open the FG/BG color dialog"), "gimp-color-editor",
    ...
    {"dialogs-brush-editor", GIMP_ICON_BRUSH,
     ...
     NC_("dialogs-action", "Open the brush editor"), "gimp-brush-editor",
    ...
    {"dialogs-dynamics", GIMP_ICON_DYNAMICS,
     ...
     "gimp-dynamics-list|gimp-dynamics-grid", GIMP_HELP_DYNAMICS_DIALOG},
    ...
    {"dialogs-dynamics-editor", GIMP_ICON_DYNAMICS,
     ...
     "gimp-dynamics-editor", GIMP_HELP_DYNAMICS_EDITOR_DIALOG},
    ...
    {"dialogs-patterns", GIMP_ICON_PATTERN, NC_("dialogs-action", "P_atterns"),
     "<primary><shift>P", NC_("dialogs-action", "Open the patterns dialog"),
     "gimp-pattern-grid|gimp-pattern-list", GIMP_HELP_PATTERN_DIALOG},

    {"dialogs-gradients", GIMP_ICON_GRADIENT,
     NC_("dialogs-action", "_Gradients"), "<primary>G",
     NC_("dialogs-action", "Open the gradients dialog"),
     "gimp-gradient-list|gimp-gradient-grid", GIMP_HELP_GRADIENT_DIALOG},

    {"dialogs-gradient-editor", GIMP_ICON_GRADIENT,
     NC_("dialogs-action", "Gradient Editor"), NULL,
     NC_("dialogs-action", "Open the gradient editor"), "gimp-gradient-editor",
     GIMP_HELP_GRADIENT_EDIT},

    {"dialogs-palettes", GIMP_ICON_PALETTE, NC_("dialogs-action", "Pal_ettes"),
     NULL, NC_("dialogs-action", "Open the palettes dialog"),
     "gimp-palette-list|gimp-palette-grid", GIMP_HELP_PALETTE_DIALOG},
    ...
    {"dialogs-fonts", GIMP_ICON_FONT, NC_("dialogs-action", "_Fonts"), NULL,
     NC_("dialogs-action", "Open the fonts dialog"),
     "gimp-font-list|gimp-font-grid", GIMP_HELP_FONT_DIALOG},

    {"dialogs-buffers", GIMP_ICON_BUFFER, NC_("dialogs-action", "B_uffers"), "",
    ...
    {"dialogs-document-history", GIMP_ICON_DOCUMENT_OPEN_RECENT,
     ...
     "gimp-document-list|gimp-document-grid", GIMP_HELP_DOCUMENT_DIALOG},

    {"dialogs-templates", GIMP_ICON_TEMPLATE,
     NC_("dialogs-action", "_Templates"), "",
     NC_("dialogs-action", "Open the image templates dialog"),
     "gimp-template-list|gimp-template-grid", GIMP_HELP_TEMPLATE_DIALOG},
    ...
    {"dialogs-dashboard", GIMP_ICON_DIALOG_DASHBOARD,
     ...
     NC_("dialogs-action", "Open the dashboard"), "gimp-dashboard",
     GIMP_HELP_ERRORS_DIALOG}};
...
static const GimpStringActionEntry dialogs_toplevel_actions[] = {
    {"dialogs-preferences", GIMP_ICON_PREFERENCES_SYSTEM,
     ...
     "gimp-preferences-dialog", GIMP_HELP_PREFS_DIALOG},
    ...
    {"dialogs-input-devices", GIMP_ICON_INPUT_DEVICE,
     ...
     "gimp-input-devices-dialog", GIMP_HELP_INPUT_DEVICES},
    ...
    {"dialogs-keyboard-shortcuts", GIMP_ICON_CHAR_PICKER,
     ...
     "gimp-keyboard-shortcuts-dialog", GIMP_HELP_KEYBOARD_SHORTCUTS},
    ...
    {"dialogs-module-dialog", GIMP_ICON_SYSTEM_RUN,
     ...
     "gimp-module-dialog", GIMP_HELP_MODULE_DIALOG},
...
#endif
     NULL, NC_("dialogs-action", "About GIMP"), "gimp-about-dialog",
    ...
    {"dialogs-action-search", GIMP_ICON_TOOL_ZOOM,
     ...
     "gimp-action-search-dialog", GIMP_HELP_ACTION_SEARCH_DIALOG},

    {"dialogs-extensions", GIMP_ICON_PLUGIN,
     NC_("dialogs-action", "Manage _Extensions"), NULL,
     NC_("dialogs-action",
         "Manage Extensions: search, install, uninstall, update."),
     "gimp-extensions-dialog", GIMP_HELP_EXTENSIONS_DIALOG}};
...
void dialogs_actions_update(GimpActionGroup *group, gpointer data) {
