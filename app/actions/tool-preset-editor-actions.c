...
static const GimpActionEntry tool_preset_editor_actions[] = {
    {"tool-preset-editor-popup", GIMP_ICON_TOOL_PRESET,
     NC_("tool-preset-editor-action", "Tool Preset Editor Menu"), NULL, NULL,
     NULL, GIMP_HELP_TOOL_PRESET_EDITOR_DIALOG},
    ...
    {"tool-preset-editor-save", GIMP_ICON_DOCUMENT_SAVE,
     ...
     NC_("tool-preset-editor-action", "Save the active tool options to this "
                                      "tool preset"),
     tool_preset_editor_save_cmd_callback, GIMP_HELP_TOOL_PRESET_SAVE},
    ...
    {"tool-preset-editor-restore", GIMP_ICON_DOCUMENT_REVERT,
     ...
     tool_preset_editor_restore_cmd_callback, GIMP_HELP_TOOL_PRESET_RESTORE}};
...
void tool_preset_editor_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_toggle_actions(
      group, "tool-preset-editor-action", tool_preset_editor_toggle_actions,
