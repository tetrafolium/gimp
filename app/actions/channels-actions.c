...
static const GimpActionEntry channels_actions[] = {
    ...
    {"channels-color-tag-menu", NULL, NC_("channels-action", "Color Tag"), NULL,
     NULL, NULL, GIMP_HELP_CHANNEL_COLOR_TAG},
    ...
    {"channels-raise", GIMP_ICON_GO_UP,
     ...
     channels_raise_cmd_callback, GIMP_HELP_CHANNEL_RAISE},

    {"channels-raise-to-top", GIMP_ICON_GO_TOP,
     NC_("channels-action", "Raise Channel to _Top"), NULL,
     NC_("channels-action",
         "Raise this channel to the top of the channel stack"),
     channels_raise_to_top_cmd_callback, GIMP_HELP_CHANNEL_RAISE_TO_TOP},
    ...
    {"channels-lower", GIMP_ICON_GO_DOWN,
     ...
     channels_lower_cmd_callback, GIMP_HELP_CHANNEL_LOWER},

    {"channels-lower-to-bottom", GIMP_ICON_GO_BOTTOM,
     NC_("channels-action", "Lower Channel to _Bottom"), NULL,
     NC_("channels-action",
         "Lower this channel to the bottom of the channel stack"),
     channels_lower_to_bottom_cmd_callback, GIMP_HELP_CHANNEL_LOWER_TO_BOTTOM}};
...
static const GimpEnumActionEntry channels_color_tag_actions[] = {
    {"channels-color-tag-none", GIMP_ICON_EDIT_CLEAR,
     ...
     NC_("channels-action", "Channel Color Tag: Clear"), GIMP_COLOR_TAG_NONE,
     FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-blue", NULL, NC_("channels-action", "Blue"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Blue"),
     GIMP_COLOR_TAG_BLUE, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-green", NULL, NC_("channels-action", "Green"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Green"),
     GIMP_COLOR_TAG_GREEN, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-yellow", NULL, NC_("channels-action", "Yellow"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Yellow"),
     GIMP_COLOR_TAG_YELLOW, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-orange", NULL, NC_("channels-action", "Orange"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Orange"),
     GIMP_COLOR_TAG_ORANGE, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-brown", NULL, NC_("channels-action", "Brown"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Brown"),
     GIMP_COLOR_TAG_BROWN, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-red", NULL, NC_("channels-action", "Red"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Red"),
     GIMP_COLOR_TAG_RED, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-violet", NULL, NC_("channels-action", "Violet"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Violet"),
     GIMP_COLOR_TAG_VIOLET, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG},

    {"channels-color-tag-gray", NULL, NC_("channels-action", "Gray"), NULL,
     NC_("channels-action", "Channel Color Tag: Set to Gray"),
     GIMP_COLOR_TAG_GRAY, FALSE, GIMP_HELP_CHANNEL_COLOR_TAG}};
...
static const GimpEnumActionEntry channels_to_selection_actions[] = {
    {"channels-selection-replace", GIMP_ICON_SELECTION_REPLACE,
     ...
     GIMP_CHANNEL_OP_REPLACE, FALSE, GIMP_HELP_CHANNEL_SELECTION_REPLACE},
    ...
    {"channels-selection-add", GIMP_ICON_SELECTION_ADD,
     ...
     GIMP_CHANNEL_OP_ADD, FALSE, GIMP_HELP_CHANNEL_SELECTION_ADD},
    ...
    {"channels-selection-subtract", GIMP_ICON_SELECTION_SUBTRACT,
     ...
     GIMP_CHANNEL_OP_SUBTRACT, FALSE, GIMP_HELP_CHANNEL_SELECTION_SUBTRACT},
    ...
    {"channels-selection-intersect", GIMP_ICON_SELECTION_INTERSECT,
     ...
     GIMP_CHANNEL_OP_INTERSECT, FALSE, GIMP_HELP_CHANNEL_SELECTION_INTERSECT}};

static const GimpEnumActionEntry channels_select_actions[] = {
    {"channels-select-top", NULL, NC_("channels-action", "Select _Top Channel"),
     NULL, NC_("channels-action", "Select the topmost channel"),
     GIMP_ACTION_SELECT_FIRST, FALSE, GIMP_HELP_CHANNEL_TOP},
    ...
    {"channels-select-bottom", NULL,
     ...
     GIMP_ACTION_SELECT_LAST, FALSE, GIMP_HELP_CHANNEL_BOTTOM},
    ...
    {"channels-select-previous", NULL,
     ...
     GIMP_ACTION_SELECT_PREVIOUS, FALSE, GIMP_HELP_CHANNEL_PREVIOUS},
    ...
    {"channels-select-next", NULL,
     ...
     GIMP_ACTION_SELECT_NEXT, FALSE, GIMP_HELP_CHANNEL_NEXT}};

void channels_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "channels-action", channels_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "channels-action", channels_to_selection_actions,
      G_N_ELEMENTS(channels_to_selection_actions),
      channels_to_selection_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "channels-action", channels_select_actions,
      G_N_ELEMENTS(channels_select_actions), channels_select_cmd_callback);
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("channels-selection-replace",
                !fs && (n_channels == 1 || component));
  SET_SENSITIVE("channels-selection-add",
                !fs && (n_channels == 1 || component));
  SET_SENSITIVE("channels-selection-subtract",
                !fs && (n_channels == 1 || component));
  SET_SENSITIVE("channels-selection-intersect",
                !fs && (n_channels == 1 || component));
