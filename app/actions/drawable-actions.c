...
static const GimpActionEntry drawable_actions[] = {
    {"drawable-equalize", NULL, NC_("drawable-action", "_Equalize"), NULL,
     NC_("drawable-action", "Automatic contrast enhancement"),
     drawable_equalize_cmd_callback, GIMP_HELP_LAYER_EQUALIZE},
    ...
    {"drawable-levels-stretch", NULL, NC_("drawable-action", "_White Balance"),
     ...
     drawable_levels_stretch_cmd_callback, GIMP_HELP_LAYER_WHITE_BALANCE}};
...
static const GimpToggleActionEntry drawable_toggle_actions[] = {
    {"drawable-visible", GIMP_ICON_VISIBLE,
     ...
     drawable_visible_cmd_callback, FALSE, GIMP_HELP_LAYER_VISIBLE},

    {"drawable-linked", GIMP_ICON_LINKED,
     NC_("drawable-action", "Toggle Drawable _Linked State"), NULL, NULL,
     drawable_linked_cmd_callback, FALSE, GIMP_HELP_LAYER_LINKED},
    ...
    {"drawable-lock-content", NULL /* GIMP_ICON_LOCK */,
     ...
     drawable_lock_content_cmd_callback, FALSE, GIMP_HELP_LAYER_LOCK_PIXELS},
    ...
    {"drawable-lock-position", GIMP_ICON_TOOL_MOVE,
     ...
     drawable_lock_position_cmd_callback, FALSE, GIMP_HELP_LAYER_LOCK_POSITION},
};
...
static const GimpEnumActionEntry drawable_flip_actions[] = {
    {"drawable-flip-horizontal", GIMP_ICON_OBJECT_FLIP_HORIZONTAL,
     ...
     GIMP_ORIENTATION_HORIZONTAL, FALSE, GIMP_HELP_LAYER_FLIP_HORIZONTAL},
    ...
    {"drawable-flip-vertical", GIMP_ICON_OBJECT_FLIP_VERTICAL,
     ...
     GIMP_ORIENTATION_VERTICAL, FALSE, GIMP_HELP_LAYER_FLIP_VERTICAL}};
...
static const GimpEnumActionEntry drawable_rotate_actions[] = {
    {"drawable-rotate-90", GIMP_ICON_OBJECT_ROTATE_90,
     ...
     GIMP_ROTATE_90, FALSE, GIMP_HELP_LAYER_ROTATE_90},

    {"drawable-rotate-180", GIMP_ICON_OBJECT_ROTATE_180,
     NC_("drawable-action", "Rotate _180°"), NULL,
     NC_("drawable-action", "Turn drawable upside-down"), GIMP_ROTATE_180,
     FALSE, GIMP_HELP_LAYER_ROTATE_180},
    ...
    {"drawable-rotate-270", GIMP_ICON_OBJECT_ROTATE_270,
     ...
     GIMP_ROTATE_270, FALSE, GIMP_HELP_LAYER_ROTATE_270}};

void drawable_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "drawable-action", drawable_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "drawable-action", drawable_flip_actions,
      G_N_ELEMENTS(drawable_flip_actions), drawable_flip_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "drawable-action", drawable_rotate_actions,
      G_N_ELEMENTS(drawable_rotate_actions), drawable_rotate_cmd_callback);
