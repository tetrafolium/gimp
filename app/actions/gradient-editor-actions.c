...
static const GimpActionEntry gradient_editor_actions[] = {
    ...
    {"gradient-editor-flip", GIMP_ICON_OBJECT_FLIP_HORIZONTAL, "flip", NULL,
     NULL, gradient_editor_flip_cmd_callback, GIMP_HELP_GRADIENT_EDITOR_FLIP},

    {"gradient-editor-replicate", GIMP_ICON_OBJECT_DUPLICATE, "replicate", NULL,
     NULL, gradient_editor_replicate_cmd_callback,
     GIMP_HELP_GRADIENT_EDITOR_FLIP},

    {"gradient-editor-split-midpoint", NULL, "splitmidpoint", NULL, NULL,
     gradient_editor_split_midpoint_cmd_callback,
     GIMP_HELP_GRADIENT_EDITOR_SPLIT_MIDPOINT},

    {"gradient-editor-split-uniform", NULL, "splituniform", NULL, NULL,
     gradient_editor_split_uniformly_cmd_callback,
     GIMP_HELP_GRADIENT_EDITOR_SPLIT_UNIFORM},

    {"gradient-editor-delete", GIMP_ICON_EDIT_DELETE, "delete", "", NULL,
     gradient_editor_delete_cmd_callback, GIMP_HELP_GRADIENT_EDITOR_DELETE},

    {"gradient-editor-recenter", NULL, "recenter", NULL, NULL,
     gradient_editor_recenter_cmd_callback, GIMP_HELP_GRADIENT_EDITOR_RECENTER},

    {"gradient-editor-redistribute", NULL, "redistribute", NULL, NULL,
...
static const GimpToggleActionEntry gradient_editor_toggle_actions[] = {
    {"gradient-editor-edit-active", GIMP_ICON_LINKED,
     ...
     data_editor_edit_active_cmd_callback, FALSE,
     GIMP_HELP_GRADIENT_EDITOR_EDIT_ACTIVE}};

#define LOAD_LEFT_FROM(num, magic)                                             \
  {                                                                            \
    "gradient-editor-load-left-" num, NULL, num, NULL, NULL, (magic), FALSE,   \
        GIMP_HELP_GRADIENT_EDITOR_LEFT_LOAD                                    \
  }
#define SAVE_LEFT_TO(num, magic)                                               \
  {                                                                            \
    "gradient-editor-save-left-" num, NULL, num, NULL, NULL, (magic), FALSE,   \
        GIMP_HELP_GRADIENT_EDITOR_LEFT_SAVE                                    \
  }
#define LOAD_RIGHT_FROM(num, magic)                                            \
  {                                                                            \
    "gradient-editor-load-right-" num, NULL, num, NULL, NULL, (magic), FALSE,  \
        GIMP_HELP_GRADIENT_EDITOR_RIGHT_LOAD                                   \
  }
#define SAVE_RIGHT_TO(num, magic)                                              \
  {                                                                            \
    "gradient-editor-save-right-" num, NULL, num, NULL, NULL, (magic), FALSE,  \
...
static const GimpEnumActionEntry gradient_editor_load_left_actions[] = {
    {"gradient-editor-load-left-left-neighbor", NULL,
     NC_("gradient-editor-action", "_Left Neighbor's Right Endpoint"), NULL,
     NULL, GRADIENT_EDITOR_COLOR_NEIGHBOR_ENDPOINT, FALSE,
     GIMP_HELP_GRADIENT_EDITOR_LEFT_LOAD},
...
static const GimpEnumActionEntry gradient_editor_save_left_actions[] = {
    SAVE_LEFT_TO("01", 0), SAVE_LEFT_TO("02", 1), SAVE_LEFT_TO("03", 2),
    SAVE_LEFT_TO("04", 3), SAVE_LEFT_TO("05", 4), SAVE_LEFT_TO("06", 5),
    SAVE_LEFT_TO("07", 6), SAVE_LEFT_TO("08", 7), SAVE_LEFT_TO("09", 8),
    SAVE_LEFT_TO("10", 9)};

static const GimpEnumActionEntry gradient_editor_load_right_actions[] = {
    {"gradient-editor-load-right-right-neighbor", NULL,
     NC_("gradient-editor-action", "_Right Neighbor's Left Endpoint"), NULL,
     NULL, GRADIENT_EDITOR_COLOR_NEIGHBOR_ENDPOINT, FALSE,
     GIMP_HELP_GRADIENT_EDITOR_RIGHT_LOAD},
...
static const GimpEnumActionEntry gradient_editor_save_right_actions[] = {
    SAVE_RIGHT_TO("01", 0), SAVE_RIGHT_TO("02", 1), SAVE_RIGHT_TO("03", 2),
    SAVE_RIGHT_TO("04", 3), SAVE_RIGHT_TO("05", 4), SAVE_RIGHT_TO("06", 5),
    SAVE_RIGHT_TO("07", 6), SAVE_RIGHT_TO("08", 7), SAVE_RIGHT_TO("09", 8),
    SAVE_RIGHT_TO("10", 9)};
...
static const GimpRadioActionEntry gradient_editor_left_color_type_actions[] = {
    {"gradient-editor-left-color-fixed", NULL,
     ...
     GIMP_GRADIENT_COLOR_FIXED, GIMP_HELP_GRADIENT_EDITOR_LEFT_COLOR},

    {"gradient-editor-left-color-foreground", NULL,
     NC_("gradient-editor-color-type", "F_oreground Color"), NULL, NULL,
     GIMP_GRADIENT_COLOR_FOREGROUND, GIMP_HELP_GRADIENT_EDITOR_LEFT_COLOR},

    {"gradient-editor-left-color-foreground-transparent", NULL,
     NC_("gradient-editor-color-type", "Fo_reground Color (Transparent)"), NULL,
     NULL, GIMP_GRADIENT_COLOR_FOREGROUND_TRANSPARENT,
     GIMP_HELP_GRADIENT_EDITOR_LEFT_COLOR},

    {"gradient-editor-left-color-background", NULL,
     NC_("gradient-editor-color-type", "_Background Color"), NULL, NULL,
     GIMP_GRADIENT_COLOR_BACKGROUND, GIMP_HELP_GRADIENT_EDITOR_LEFT_COLOR},

    {"gradient-editor-left-color-background-transparent", NULL,
     NC_("gradient-editor-color-type", "B_ackground Color (Transparent)"), NULL,
     NULL, GIMP_GRADIENT_COLOR_BACKGROUND_TRANSPARENT,
     GIMP_HELP_GRADIENT_EDITOR_LEFT_COLOR}};

static const GimpRadioActionEntry gradient_editor_right_color_type_actions[] = {
    {"gradient-editor-right-color-fixed", NULL,
     NC_("gradient-editor-color-type", "_Fixed"), NULL, NULL,
     GIMP_GRADIENT_COLOR_FIXED, GIMP_HELP_GRADIENT_EDITOR_RIGHT_COLOR},

    {"gradient-editor-right-color-foreground", NULL,
     NC_("gradient-editor-color-type", "F_oreground Color"), NULL, NULL,
     GIMP_GRADIENT_COLOR_FOREGROUND, GIMP_HELP_GRADIENT_EDITOR_RIGHT_COLOR},
    ...
    {"gradient-editor-right-color-background", NULL,
     NC_("gradient-editor-color-type", "_Background Color"), NULL, NULL,
     GIMP_GRADIENT_COLOR_BACKGROUND, GIMP_HELP_GRADIENT_EDITOR_RIGHT_COLOR},
...
static const GimpRadioActionEntry gradient_editor_blending_actions[] = {
    {"gradient-editor-blending-linear", NULL,
     ...
     GIMP_GRADIENT_SEGMENT_LINEAR, GIMP_HELP_GRADIENT_EDITOR_BLENDING},

    {"gradient-editor-blending-curved", NULL,
     NC_("gradient-editor-blending", "_Curved"), NULL, NULL,
     GIMP_GRADIENT_SEGMENT_CURVED, GIMP_HELP_GRADIENT_EDITOR_BLENDING},

    {"gradient-editor-blending-sine", NULL,
     NC_("gradient-editor-blending", "_Sinusoidal"), NULL, NULL,
     GIMP_GRADIENT_SEGMENT_SINE, GIMP_HELP_GRADIENT_EDITOR_BLENDING},
    ...
    {"gradient-editor-blending-step", NULL,
     ...
     GIMP_GRADIENT_SEGMENT_STEP, GIMP_HELP_GRADIENT_EDITOR_BLENDING},

    {"gradient-editor-blending-varies", NULL,
     NC_("gradient-editor-blending", "(Varies)"), NULL, NULL, -1,
     GIMP_HELP_GRADIENT_EDITOR_BLENDING}};
...
static const GimpRadioActionEntry gradient_editor_coloring_actions[] = {
    {"gradient-editor-coloring-rgb", NULL,
     ...
     GIMP_GRADIENT_SEGMENT_RGB, GIMP_HELP_GRADIENT_EDITOR_COLORING},

    {"gradient-editor-coloring-hsv-ccw", NULL,
     NC_("gradient-editor-coloring", "HSV (_counter-clockwise hue)"), NULL,
     NULL, GIMP_GRADIENT_SEGMENT_HSV_CCW, GIMP_HELP_GRADIENT_EDITOR_COLORING},

    {"gradient-editor-coloring-hsv-cw", NULL,
     NC_("gradient-editor-coloring", "HSV (clockwise _hue)"), NULL, NULL,
     GIMP_GRADIENT_SEGMENT_HSV_CW, GIMP_HELP_GRADIENT_EDITOR_COLORING},

    {"gradient-editor-coloring-varies", NULL,
     NC_("gradient-editor-coloring", "(Varies)"), NULL, NULL, -1,
     GIMP_HELP_GRADIENT_EDITOR_COLORING}};

static const GimpEnumActionEntry gradient_editor_zoom_actions[] = {
    {"gradient-editor-zoom-in", GIMP_ICON_ZOOM_IN, N_("Zoom In"), NULL,
     N_("Zoom in"), GIMP_ZOOM_IN, FALSE, GIMP_HELP_GRADIENT_EDITOR_ZOOM_IN},

    {"gradient-editor-zoom-out", GIMP_ICON_ZOOM_OUT, N_("Zoom Out"), NULL,
     N_("Zoom out"), GIMP_ZOOM_OUT, FALSE, GIMP_HELP_GRADIENT_EDITOR_ZOOM_OUT},

    {"gradient-editor-zoom-all", GIMP_ICON_ZOOM_FIT_BEST, N_("Zoom All"), NULL,
     N_("Zoom all"), GIMP_ZOOM_OUT_MAX, FALSE,
...
void gradient_editor_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_radio_actions(
      group, "gradient-editor-color-type",
      gradient_editor_left_color_type_actions,
      G_N_ELEMENTS(gradient_editor_left_color_type_actions), NULL, 0,
      gradient_editor_left_color_type_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "gradient-editor-color-type",
      gradient_editor_right_color_type_actions,
      G_N_ELEMENTS(gradient_editor_right_color_type_actions), NULL, 0,
      gradient_editor_right_color_type_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "gradient-editor-blending", gradient_editor_blending_actions,
      G_N_ELEMENTS(gradient_editor_blending_actions), NULL, 0,
      gradient_editor_blending_func_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "gradient-editor-coloring", gradient_editor_coloring_actions,
      G_N_ELEMENTS(gradient_editor_coloring_actions), NULL, 0,
      gradient_editor_coloring_type_cmd_callback);

  gimp_action_group_add_enum_actions(group, NULL, gradient_editor_zoom_actions,
                                     G_N_ELEMENTS(gradient_editor_zoom_actions),
                                     gradient_editor_zoom_cmd_callback);
}

void gradient_editor_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  if (gradient) {
    ...
    gimp_gradient_segment_get_left_flat_color(
        gradient, data_editor->context, editor->control_sel_l, &left_color);
    ...
    gimp_gradient_segment_get_right_flat_color(gradient, data_editor->context,
                                               left_seg, &left_seg_color);

    gimp_gradient_segment_get_right_flat_color(
        gradient, data_editor->context, editor->control_sel_r, &right_color);
    ...
    gimp_gradient_segment_get_left_flat_color(gradient, data_editor->context,
                                              right_seg, &right_seg_color);
...
#define SET_VISIBLE(action, condition)                                         \
  ...
  if (gradient) {
    ...
    SET_COLOR("gradient-editor-load-left-left-neighbor", &left_seg_color,
              FALSE);
  ...
  SET_COLOR("gradient-editor-load-left-fg", data_editor->context ? &fg : NULL,
            FALSE);
  SET_COLOR("gradient-editor-load-left-bg", data_editor->context ? &bg : NULL,
            FALSE);
  ...
  if (gradient) {
    ...
    SET_COLOR("gradient-editor-load-right-right-neighbor", &right_seg_color,
              FALSE);
  ...
  SET_COLOR("gradient-editor-load-right-fg", data_editor->context ? &fg : NULL,
            FALSE);
  SET_COLOR("gradient-editor-load-right-bg", data_editor->context ? &bg : NULL,
            FALSE);
  ...
  if (!selection) {
    ...
    SET_LABEL("gradient-editor-coloring-type", _("Coloring _Type for Segment"));

    SET_LABEL("gradient-editor-flip", _("_Flip Segment"));
    SET_LABEL("gradient-editor-replicate", _("_Replicate Segment..."));
    ...
    SET_LABEL("gradient-editor-delete", _("_Delete Segment"));
    SET_LABEL("gradient-editor-recenter", _("Re-_center Segment's Midpoint"));
    ...
    SET_LABEL("gradient-editor-flip", _("_Flip Selection"));
    SET_LABEL("gradient-editor-replicate", _("_Replicate Selection..."));
    SET_LABEL("gradient-editor-split-midpoint",
              _("Split Segments at _Midpoints"));
    SET_LABEL("gradient-editor-split-uniform",
              _("Split Segments _Uniformly..."));
    SET_LABEL("gradient-editor-delete", _("_Delete Selection"));
