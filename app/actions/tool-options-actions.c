...
static void tool_options_actions_update_presets(
    ...
    GimpActionCallback callback, const gchar *help_id, GimpContainer *presets,
    gboolean need_writable, gboolean need_deletable);
...
static const GimpActionEntry tool_options_actions[] = {
    ...
    {"tool-options-save-new-preset", GIMP_ICON_DOCUMENT_NEW,
     ...
     tool_options_save_new_preset_cmd_callback, GIMP_HELP_TOOL_OPTIONS_SAVE},
    ...
    {"tool-options-reset", GIMP_ICON_RESET,
     ...
     tool_options_reset_cmd_callback, GIMP_HELP_TOOL_OPTIONS_RESET},
    ...
    {"tool-options-reset-all", GIMP_ICON_RESET,
     ...
     tool_options_reset_all_cmd_callback, GIMP_HELP_TOOL_OPTIONS_RESET}};
...
void tool_options_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  tool_options_actions_update_presets(
      group, "tool-options-save-preset", tool_options_save_preset_cmd_callback,
      GIMP_HELP_TOOL_OPTIONS_SAVE, tool_info->presets, TRUE /* writable */,
      FALSE /* deletable */);

  tool_options_actions_update_presets(
      group, "tool-options-restore-preset",
      tool_options_restore_preset_cmd_callback, GIMP_HELP_TOOL_OPTIONS_RESTORE,
      tool_info->presets, FALSE /* writable */, FALSE /* deletable */);

  tool_options_actions_update_presets(
      group, "tool-options-edit-preset", tool_options_edit_preset_cmd_callback,
      GIMP_HELP_TOOL_OPTIONS_EDIT, tool_info->presets, FALSE /* writable */,
      FALSE /* deletable */);

  tool_options_actions_update_presets(
      group, "tool-options-delete-preset",
      tool_options_delete_preset_cmd_callback, GIMP_HELP_TOOL_OPTIONS_DELETE,
...
static void tool_options_actions_update_presets(
  ...
  if (n_children > 0) {
    ...
    for (list = GIMP_LIST(presets)->queue->head, i = 0; list;
      ...
      if (need_writable)
        SET_SENSITIVE(entry.name, gimp_data_is_writable(GIMP_DATA(preset)));

      if (need_deletable)
        SET_SENSITIVE(entry.name, gimp_data_is_deletable(GIMP_DATA(preset)));
