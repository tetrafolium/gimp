...
static const GimpActionEntry quick_mask_actions[] = {
    {"quick-mask-popup", NULL, NC_("quick-mask-action", "Quick Mask Menu"),
     NULL, NULL, NULL, GIMP_HELP_QUICK_MASK},

    {"quick-mask-configure", NULL,
     NC_("quick-mask-action", "_Configure Color and Opacity..."), NULL, NULL,
     quick_mask_configure_cmd_callback, GIMP_HELP_QUICK_MASK_EDIT}};
...
static const GimpToggleActionEntry quick_mask_toggle_actions[] = {
    {"quick-mask-toggle", GIMP_ICON_QUICK_MASK_ON,
     ...
     quick_mask_toggle_cmd_callback, FALSE, GIMP_HELP_QUICK_MASK_TOGGLE}};

static const GimpRadioActionEntry quick_mask_invert_actions[] = {
    {"quick-mask-invert-on", NULL,
     NC_("quick-mask-action", "Mask _Selected Areas"), NULL, NULL, TRUE,
     GIMP_HELP_QUICK_MASK_INVERT},

    {"quick-mask-invert-off", NULL,
     NC_("quick-mask-action", "Mask _Unselected Areas"), NULL, NULL, FALSE,
     GIMP_HELP_QUICK_MASK_INVERT}};

void quick_mask_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "quick-mask-action", quick_mask_actions,
  ...
  gimp_action_group_add_radio_actions(
      group, "quick-mask-action", quick_mask_invert_actions,
      G_N_ELEMENTS(quick_mask_invert_actions), NULL, FALSE,
