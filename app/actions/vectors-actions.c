...
static const GimpActionEntry vectors_actions[] = {
    ...
    {"vectors-color-tag-menu", NULL, NC_("vectors-action", "Color Tag"), NULL,
     NULL, NULL, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-edit", GIMP_ICON_TOOL_PATH, NC_("vectors-action", "Edit Pa_th"),
     NULL, NC_("vectors-action", "Edit the active path"),
     vectors_edit_cmd_callback, GIMP_HELP_TOOL_VECTORS},
    ...
    {"vectors-edit-attributes", GIMP_ICON_EDIT,
     ...
     vectors_edit_attributes_cmd_callback, GIMP_HELP_PATH_EDIT},

    {"vectors-new", GIMP_ICON_DOCUMENT_NEW,
     NC_("vectors-action", "_New Path..."), NULL,
     NC_("vectors-action", "Create a new path..."), vectors_new_cmd_callback,
     GIMP_HELP_PATH_NEW},
    ...
    {"vectors-new-last-values", GIMP_ICON_DOCUMENT_NEW,
     ...
     vectors_new_last_vals_cmd_callback, GIMP_HELP_PATH_NEW},
    ...
    {"vectors-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     vectors_duplicate_cmd_callback, GIMP_HELP_PATH_DUPLICATE},

    {"vectors-delete", GIMP_ICON_EDIT_DELETE,
     NC_("vectors-action", "_Delete Path"), NULL,
     NC_("vectors-action", "Delete this path"), vectors_delete_cmd_callback,
     GIMP_HELP_PATH_DELETE},

    {"vectors-merge-visible", NULL,
     NC_("vectors-action", "Merge _Visible Paths"), NULL, NULL,
     vectors_merge_visible_cmd_callback, GIMP_HELP_PATH_MERGE_VISIBLE},

    {"vectors-raise", GIMP_ICON_GO_UP, NC_("vectors-action", "_Raise Path"),
     NULL, NC_("vectors-action", "Raise this path"), vectors_raise_cmd_callback,
    ...
    {"vectors-raise-to-top", GIMP_ICON_GO_TOP,
     ...
     vectors_raise_to_top_cmd_callback, GIMP_HELP_PATH_RAISE_TO_TOP},

    {"vectors-lower", GIMP_ICON_GO_DOWN, NC_("vectors-action", "_Lower Path"),
     NULL, NC_("vectors-action", "Lower this path"), vectors_lower_cmd_callback,
    ...
    {"vectors-lower-to-bottom", GIMP_ICON_GO_BOTTOM,
     ...
     vectors_lower_to_bottom_cmd_callback, GIMP_HELP_PATH_LOWER_TO_BOTTOM},

    {"vectors-fill", GIMP_ICON_TOOL_BUCKET_FILL,
     NC_("vectors-action", "Fill Pat_h..."), NULL,
     NC_("vectors-action", "Fill the path"), vectors_fill_cmd_callback,
     GIMP_HELP_PATH_FILL},
    ...
    {"vectors-fill-last-values", GIMP_ICON_TOOL_BUCKET_FILL,
     ...
     vectors_fill_last_vals_cmd_callback, GIMP_HELP_PATH_FILL},

    {"vectors-stroke", GIMP_ICON_PATH_STROKE,
     NC_("vectors-action", "Stro_ke Path..."), NULL,
     NC_("vectors-action", "Paint along the path"), vectors_stroke_cmd_callback,
    ...
    {"vectors-copy", GIMP_ICON_EDIT_COPY, NC_("vectors-action", "Co_py Path"),
     "", NULL, vectors_copy_cmd_callback, GIMP_HELP_PATH_COPY},

    {"vectors-paste", GIMP_ICON_EDIT_PASTE,
     NC_("vectors-action", "Paste Pat_h"), "", NULL, vectors_paste_cmd_callback,
     GIMP_HELP_PATH_PASTE},

    {"vectors-export", GIMP_ICON_DOCUMENT_SAVE,
     NC_("vectors-action", "E_xport Path..."), "", NULL,
     vectors_export_cmd_callback, GIMP_HELP_PATH_EXPORT},

    {"vectors-import", GIMP_ICON_DOCUMENT_OPEN,
     NC_("vectors-action", "I_mport Path..."), "", NULL,
     vectors_import_cmd_callback, GIMP_HELP_PATH_IMPORT}};
...
static const GimpEnumActionEntry vectors_color_tag_actions[] = {
    {"vectors-color-tag-none", GIMP_ICON_EDIT_CLEAR,
     ...
     NC_("vectors-action", "Path Color Tag: Clear"), GIMP_COLOR_TAG_NONE, FALSE,
     GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-blue", NULL, NC_("vectors-action", "Blue"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Blue"), GIMP_COLOR_TAG_BLUE,
     FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-green", NULL, NC_("vectors-action", "Green"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Green"),
     GIMP_COLOR_TAG_GREEN, FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-yellow", NULL, NC_("vectors-action", "Yellow"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Yellow"),
     GIMP_COLOR_TAG_YELLOW, FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-orange", NULL, NC_("vectors-action", "Orange"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Orange"),
     GIMP_COLOR_TAG_ORANGE, FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-brown", NULL, NC_("vectors-action", "Brown"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Brown"),
     GIMP_COLOR_TAG_BROWN, FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-red", NULL, NC_("vectors-action", "Red"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Red"), GIMP_COLOR_TAG_RED,
     FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-violet", NULL, NC_("vectors-action", "Violet"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Violet"),
     GIMP_COLOR_TAG_VIOLET, FALSE, GIMP_HELP_PATH_COLOR_TAG},

    {"vectors-color-tag-gray", NULL, NC_("vectors-action", "Gray"), NULL,
     NC_("vectors-action", "Path Color Tag: Set to Gray"), GIMP_COLOR_TAG_GRAY,
     FALSE, GIMP_HELP_PATH_COLOR_TAG}};
...
static const GimpEnumActionEntry vectors_to_selection_actions[] = {
    {"vectors-selection-replace", GIMP_ICON_SELECTION_REPLACE,
     ...
     NC_("vectors-action", "Path to selection"), GIMP_CHANNEL_OP_REPLACE, FALSE,
    ...
    {"vectors-selection-from-vectors", GIMP_ICON_SELECTION_REPLACE,
     ...
     GIMP_CHANNEL_OP_REPLACE, FALSE, GIMP_HELP_PATH_SELECTION_REPLACE},

    {"vectors-selection-add", GIMP_ICON_SELECTION_ADD,
     NC_("vectors-action", "_Add to Selection"), NULL,
     NC_("vectors-action", "Add path to selection"), GIMP_CHANNEL_OP_ADD, FALSE,
    ...
    {"vectors-selection-subtract", GIMP_ICON_SELECTION_SUBTRACT,
     ...
     GIMP_CHANNEL_OP_SUBTRACT, FALSE, GIMP_HELP_PATH_SELECTION_SUBTRACT},
    ...
    {"vectors-selection-intersect", GIMP_ICON_SELECTION_INTERSECT,
     ...
     GIMP_CHANNEL_OP_INTERSECT, FALSE, GIMP_HELP_PATH_SELECTION_INTERSECT}};
...
static const GimpEnumActionEntry vectors_selection_to_vectors_actions[] = {
    {"vectors-selection-to-vectors", GIMP_ICON_SELECTION_TO_PATH,
     ...
     NC_("vectors-action", "Selection to path"), FALSE, FALSE,
    ...
    {"vectors-selection-to-vectors-advanced", GIMP_ICON_SELECTION_TO_PATH,
     ...
     NC_("vectors-action", "Advanced options"), TRUE, FALSE,
     GIMP_HELP_SELECTION_TO_PATH}};

static const GimpEnumActionEntry vectors_select_actions[] = {
    {"vectors-select-top", NULL, NC_("vectors-action", "Select _Top Path"),
     NULL, NC_("vectors-action", "Select the topmost path"),
     GIMP_ACTION_SELECT_FIRST, FALSE, GIMP_HELP_PATH_TOP},

    {"vectors-select-bottom", NULL,
     NC_("vectors-action", "Select _Bottom Path"), NULL,
     NC_("vectors-action", "Select the bottommost path"),
     GIMP_ACTION_SELECT_LAST, FALSE, GIMP_HELP_PATH_BOTTOM},
    ...
    {"vectors-select-previous", NULL,
     ...
     GIMP_ACTION_SELECT_PREVIOUS, FALSE, GIMP_HELP_PATH_PREVIOUS},

    {"vectors-select-next", NULL, NC_("vectors-action", "Select _Next Path"),
     NULL, NC_("vectors-action", "Select the vector below the current path"),
     GIMP_ACTION_SELECT_NEXT, FALSE, GIMP_HELP_PATH_NEXT}};

void vectors_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "vectors-action", vectors_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "vectors-action", vectors_color_tag_actions,
      G_N_ELEMENTS(vectors_color_tag_actions), vectors_color_tag_cmd_callback);
  ...
  gimp_action_group_add_enum_actions(
      group, "vectors-action", vectors_selection_to_vectors_actions,
      G_N_ELEMENTS(vectors_selection_to_vectors_actions),
      vectors_selection_to_vectors_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "vectors-action", vectors_select_actions,
      G_N_ELEMENTS(vectors_select_actions), vectors_select_cmd_callback);
...
void vectors_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  if (image) {
    ...
    if (n_selected_vectors == 1) {
      ...
      vectors_list =
          gimp_item_get_container_iter(GIMP_ITEM(selected_vectors->data));
...
#define SET_ACTIVE(action, condition)                                          \
  ...
  SET_SENSITIVE("vectors-fill",
                n_selected_vectors == 1 && dr_writable && !dr_children);
  SET_SENSITIVE("vectors-fill-last-values",
                n_selected_vectors == 1 && dr_writable && !dr_children);
  SET_SENSITIVE("vectors-stroke",
                n_selected_vectors == 1 && dr_writable && !dr_children);
  SET_SENSITIVE("vectors-stroke-last-values",
                n_selected_vectors == 1 && dr_writable && !dr_children);
