...
void window_close_cmd_callback(GimpAction *action, GVariant *value,
                               gpointer data) {
  GtkWidget *widget;
...
void window_open_display_cmd_callback(GimpAction *action, GVariant *value,
                                      gpointer data) {
  GtkWidget *widget;
  GtkWidget *dialog;
  GtkWidget *entry;
  ...
  dialog = gimp_message_dialog_new("Open Display", GIMP_ICON_WILBER_EEK, widget,
  ...
  gtk_box_pack_start(GTK_BOX(GIMP_MESSAGE_DIALOG(dialog)->box), entry, TRUE,
                     TRUE, 0);
...
void window_move_to_screen_cmd_callback(GimpAction *action, GVariant *value,
                                        gpointer data) {
  GtkWidget *widget;
#if 0
	GdkScreen *screen;
