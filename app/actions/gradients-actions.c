...
static const GimpActionEntry gradients_actions[] = {
    ...
    {"gradients-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     NC_("gradients-action", "Create a new gradient"), data_new_cmd_callback,
    ...
    {"gradients-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_GRADIENT_DUPLICATE},
    ...
    {"gradients-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     data_copy_location_cmd_callback, GIMP_HELP_GRADIENT_COPY_LOCATION},
    ...
    {"gradients-delete", GIMP_ICON_EDIT_DELETE,
     ...
     NC_("gradients-action", "Delete this gradient"), data_delete_cmd_callback,
     GIMP_HELP_GRADIENT_DELETE},

    {"gradients-refresh", GIMP_ICON_VIEW_REFRESH,
     NC_("gradients-action", "_Refresh Gradients"), NULL,
     NC_("gradients-action", "Refresh gradients"), data_refresh_cmd_callback,
...
static const GimpStringActionEntry gradients_edit_actions[] = {
    {"gradients-edit", GIMP_ICON_EDIT,
     ...
     NC_("gradients-action", "Edit this gradient"), "gimp-gradient-editor",
     GIMP_HELP_GRADIENT_EDIT}};

void gradients_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "gradients-action", gradients_actions,
                                G_N_ELEMENTS(gradients_actions));

  gimp_action_group_add_string_actions(
      group, "gradients-action", gradients_edit_actions,
      G_N_ELEMENTS(gradients_edit_actions), data_edit_cmd_callback);
}
