...
static const GimpRadioActionEntry text_editor_direction_actions[] = {
    {"text-editor-direction-ltr", GIMP_ICON_FORMAT_TEXT_DIRECTION_LTR,
     ...
     NC_("text-editor-action", "From left to right"), GIMP_TEXT_DIRECTION_LTR,
     NULL},

    {"text-editor-direction-rtl", GIMP_ICON_FORMAT_TEXT_DIRECTION_RTL,
     NC_("text-editor-action", "RTL"), NULL,
     NC_("text-editor-action", "From right to left"), GIMP_TEXT_DIRECTION_RTL,
     NULL},
    ...
    {"text-editor-direction-ttb-rtl", GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_RTL,
     ...
     GIMP_TEXT_DIRECTION_TTB_RTL, NULL},

    {"text-editor-direction-ttb-rtl-upright",
     ...
     GIMP_TEXT_DIRECTION_TTB_RTL_UPRIGHT, NULL},
    ...
    {"text-editor-direction-ttb-ltr", GIMP_ICON_FORMAT_TEXT_DIRECTION_TTB_LTR,
     ...
     GIMP_TEXT_DIRECTION_TTB_LTR, NULL},

    {"text-editor-direction-ttb-ltr-upright",
     ...
     GIMP_TEXT_DIRECTION_TTB_LTR_UPRIGHT, NULL},
};
...
void text_editor_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_radio_actions(
      group, "text-editor-action", text_editor_direction_actions,
      G_N_ELEMENTS(text_editor_direction_actions), NULL,
      GIMP_TEXT_DIRECTION_LTR, text_editor_direction_cmd_callback);
}
