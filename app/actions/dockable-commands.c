...
void dockable_add_tab_cmd_callback(GimpAction *action, GVariant *value,
                                   gpointer data) {
...
void dockable_close_tab_cmd_callback(GimpAction *action, GVariant *value,
                                     gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
...
void dockable_detach_tab_cmd_callback(GimpAction *action, GVariant *value,
                                      gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
  GimpDockable *dockable = dockable_get_current(dockbook);
...
void dockable_toggle_view_cmd_callback(GimpAction *action, GVariant *value,
                                       gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
  ...
  if (dockable) {
    ...
    if (entry) {
      ...
      if (substring) {
        ...
        new_dockable = gimp_dialog_factory_dockable_new(
            gimp_dock_get_dialog_factory(dock), dock, identifier, view_size);
        ...
        if (new_dockable) {
          ...
          if (!gimp_dockable_get_dockbook(GIMP_DOCKABLE(new_dockable))) {
            gtk_notebook_insert_page(GTK_NOTEBOOK(dockbook), new_dockable, NULL,
                                     page_num);
...
void dockable_view_size_cmd_callback(GimpAction *action, GVariant *value,
                                     gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
  GimpDockable *dockable = dockable_get_current(dockbook);
  gint view_size;
...
void dockable_tab_style_cmd_callback(GimpAction *action, GVariant *value,
                                     gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
  GimpDockable *dockable = dockable_get_current(dockbook);
  ...
  if (dockable && gimp_dockable_get_tab_style(dockable) != tab_style) {
    ...
    gtk_notebook_set_tab_label(GTK_NOTEBOOK(dockbook), GTK_WIDGET(dockable),
                               tab_widget);
  }
}

void dockable_show_button_bar_cmd_callback(GimpAction *action, GVariant *value,
                                           gpointer data) {
  GimpDockbook *dockbook = GIMP_DOCKBOOK(data);
  GimpDockable *dockable = dockable_get_current(dockbook);
