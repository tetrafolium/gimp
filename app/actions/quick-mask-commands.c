...
static void quick_mask_configure_callback(
...
#define CONFIGURE_DIALOG_KEY "gimp-image-quick-mask-configure-dialog"
  ...
  if (!dialog) {
    ...
    dialog = channel_options_dialog_new(
        image, NULL, action_data_get_context(data), widget,
        _("Quick Mask Attributes"), "gimp-quick-mask-edit",
        GIMP_ICON_QUICK_MASK_ON, _("Edit Quick Mask Attributes"),
        GIMP_HELP_QUICK_MASK_EDIT, _("Edit Quick Mask Color"),
        _("_Mask opacity:"), FALSE, NULL, &color, FALSE, FALSE,
        GIMP_COLOR_TAG_NONE, FALSE, FALSE, quick_mask_configure_callback, NULL);
