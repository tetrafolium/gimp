...
static const GimpActionEntry dock_actions[] = {
    ...
    {"dock-close", GIMP_ICON_WINDOW_CLOSE, NC_("dock-action", "Close Dock"), "",
     NULL, window_close_cmd_callback, GIMP_HELP_DOCK_CLOSE},

    {"dock-open-display", NULL, NC_("dock-action", "_Open Display..."), NULL,
...
static const GimpToggleActionEntry dock_toggle_actions[] = {
    {"dock-show-image-menu", NULL, NC_("dock-action", "_Show Image Selection"),
     NULL, NULL, dock_toggle_image_menu_cmd_callback, TRUE,
     GIMP_HELP_DOCK_IMAGE_MENU},

    {"dock-auto-follow-active", NULL,
     NC_("dock-action", "Auto _Follow Active Image"), NULL, NULL,
     dock_toggle_auto_cmd_callback, TRUE, GIMP_HELP_DOCK_AUTO_BUTTON}};

void dock_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "dock-action", dock_actions,
