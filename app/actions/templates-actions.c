...
static const GimpActionEntry templates_actions[] = {
    ...
    {"templates-create-image", GIMP_ICON_IMAGE,
     ...
     templates_create_image_cmd_callback, GIMP_HELP_TEMPLATE_IMAGE_NEW},
    ...
    {"templates-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     templates_duplicate_cmd_callback, GIMP_HELP_TEMPLATE_DUPLICATE},

    {"templates-edit", GIMP_ICON_EDIT,
     NC_("templates-action", "_Edit Template..."), NULL,
     NC_("templates-action", "Edit this template"), templates_edit_cmd_callback,
    ...
    {"templates-delete", GIMP_ICON_EDIT_DELETE,
     ...
     templates_delete_cmd_callback, GIMP_HELP_TEMPLATE_DELETE}};

void templates_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "templates-action", templates_actions,
