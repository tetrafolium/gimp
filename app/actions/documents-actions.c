...
static const GimpActionEntry documents_actions[] = {
    ...
    {"documents-open", GIMP_ICON_DOCUMENT_OPEN,
     ...
     documents_open_cmd_callback, GIMP_HELP_DOCUMENT_OPEN},
    ...
    {"documents-raise-or-open", NULL,
     ...
     documents_raise_or_open_cmd_callback, GIMP_HELP_DOCUMENT_OPEN},

    {"documents-file-open-dialog", NULL,
     NC_("documents-action", "File Open _Dialog"), NULL,
     NC_("documents-action", "Open image dialog"),
     documents_file_open_dialog_cmd_callback, GIMP_HELP_DOCUMENT_OPEN},
    ...
    {"documents-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     documents_copy_location_cmd_callback, GIMP_HELP_DOCUMENT_COPY_LOCATION},
    ...
    {"documents-remove", GIMP_ICON_LIST_REMOVE,
     ...
     documents_remove_cmd_callback, GIMP_HELP_DOCUMENT_REMOVE},
    ...
    {"documents-clear", GIMP_ICON_SHRED,
     ...
     documents_clear_cmd_callback, GIMP_HELP_DOCUMENT_CLEAR},
    ...
    {"documents-recreate-preview", GIMP_ICON_VIEW_REFRESH,
     ...
     documents_recreate_preview_cmd_callback, GIMP_HELP_DOCUMENT_REFRESH},

    {"documents-reload-previews", NULL,
     NC_("documents-action", "Reload _all Previews"), NULL,
     NC_("documents-action", "Reload all previews"),
     documents_reload_previews_cmd_callback, GIMP_HELP_DOCUMENT_REFRESH},
    ...
    {"documents-remove-dangling", NULL,
     ...
     documents_remove_dangling_cmd_callback, GIMP_HELP_DOCUMENT_REFRESH}};

void documents_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "documents-action", documents_actions,
