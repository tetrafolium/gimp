...
static const GimpActionEntry dynamics_actions[] = {
    ...
    {"dynamics-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     NC_("dynamics-action", "Create a new dynamics"), data_new_cmd_callback,
    ...
    {"dynamics-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_DYNAMICS_DUPLICATE},
    ...
    {"dynamics-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     data_copy_location_cmd_callback, GIMP_HELP_DYNAMICS_COPY_LOCATION},
    ...
    {"dynamics-delete", GIMP_ICON_EDIT_DELETE,
     ...
     NC_("dynamics-action", "Delete this dynamics"), data_delete_cmd_callback,
     GIMP_HELP_DYNAMICS_DELETE},

    {"dynamics-refresh", GIMP_ICON_VIEW_REFRESH,
     NC_("dynamics-action", "_Refresh Dynamics"), NULL,
     NC_("dynamics-action", "Refresh dynamics"), data_refresh_cmd_callback,
...
static const GimpStringActionEntry dynamics_edit_actions[] = {
    {"dynamics-edit", GIMP_ICON_EDIT,
     ...
     NC_("dynamics-action", "Edit this dynamics"), "gimp-dynamics-editor",
     GIMP_HELP_DYNAMICS_EDIT}};

void dynamics_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "dynamics-action", dynamics_actions,
                                G_N_ELEMENTS(dynamics_actions));

  gimp_action_group_add_string_actions(
      group, "dynamics-action", dynamics_edit_actions,
      G_N_ELEMENTS(dynamics_edit_actions), data_edit_cmd_callback);
}
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("dynamics-duplicate",
                dynamics && gimp_data_is_duplicatable(data));
