...
static const GimpActionEntry palette_editor_actions[] = {
    ...
    {"palette-editor-edit-color", GIMP_ICON_EDIT,
     ...
     palette_editor_edit_color_cmd_callback, GIMP_HELP_PALETTE_EDITOR_EDIT},
...
static const GimpEnumActionEntry palette_editor_new_actions[] = {
    {"palette-editor-new-color-fg", GIMP_ICON_DOCUMENT_NEW,
     ...
     FALSE, FALSE, GIMP_HELP_PALETTE_EDITOR_NEW},
    ...
    {"palette-editor-new-color-bg", GIMP_ICON_DOCUMENT_NEW,
     ...
     TRUE, FALSE, GIMP_HELP_PALETTE_EDITOR_NEW}};

static const GimpEnumActionEntry palette_editor_zoom_actions[] = {
    {"palette-editor-zoom-in", GIMP_ICON_ZOOM_IN, N_("Zoom _In"), NULL,
     N_("Zoom in"), GIMP_ZOOM_IN, FALSE, GIMP_HELP_PALETTE_EDITOR_ZOOM_IN},

    {"palette-editor-zoom-out", GIMP_ICON_ZOOM_OUT, N_("Zoom _Out"), NULL,
     N_("Zoom out"), GIMP_ZOOM_OUT, FALSE, GIMP_HELP_PALETTE_EDITOR_ZOOM_OUT},

    {"palette-editor-zoom-all", GIMP_ICON_ZOOM_FIT_BEST, N_("Zoom _All"), NULL,
...
void palette_editor_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_toggle_actions(
      group, "palette-editor-action", palette_editor_toggle_actions,
  ...
  gimp_action_group_add_enum_actions(group, NULL, palette_editor_zoom_actions,
                                     G_N_ELEMENTS(palette_editor_zoom_actions),
                                     palette_editor_zoom_cmd_callback);
}

void palette_editor_actions_update(GimpActionGroup *group, gpointer user_data) {
