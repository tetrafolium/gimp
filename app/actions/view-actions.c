...
static const GimpActionEntry view_actions[] = {
    ...
    {"view-new", GIMP_ICON_WINDOW_NEW, NC_("view-action", "_New View"), NULL,
     NC_("view-action", "Create another view on this image"),
     view_new_cmd_callback, GIMP_HELP_VIEW_NEW},

    {"view-close", GIMP_ICON_WINDOW_CLOSE, NC_("view-action", "_Close View"),
     "<primary>W", NC_("view-action", "Close the active image view"),
     view_close_cmd_callback, GIMP_HELP_FILE_CLOSE},
    ...
    {"view-scroll-center", GIMP_ICON_CENTER,
     ...
     view_scroll_center_cmd_callback, GIMP_HELP_VIEW_SCROLL_CENTER},
    ...
    {"view-zoom-fit-in", GIMP_ICON_ZOOM_FIT_BEST,
     ...
     view_zoom_fit_in_cmd_callback, GIMP_HELP_VIEW_ZOOM_FIT_IN},
    ...
    {"view-zoom-fill", GIMP_ICON_ZOOM_FIT_BEST,
     ...
     view_zoom_fill_cmd_callback, GIMP_HELP_VIEW_ZOOM_FILL},
    ...
    {"view-zoom-selection", GIMP_ICON_SELECTION,
     ...
     view_zoom_selection_cmd_callback, GIMP_HELP_VIEW_ZOOM_SELECTION},

    {"view-zoom-revert", NULL, NC_("view-action", "Re_vert Zoom"), "grave",
     NC_("view-action", "Restore the previous zoom level"),
     view_zoom_revert_cmd_callback, GIMP_HELP_VIEW_ZOOM_REVERT},

    {"view-rotate-other", NULL, NC_("view-action", "Othe_r rotation angle..."),
     NULL, NC_("view-action", "Set a custom rotation angle"),
     view_rotate_other_cmd_callback, GIMP_HELP_VIEW_ROTATE_OTHER},
    ...
    {"view-display-filters", GIMP_ICON_DISPLAY_FILTER,
     ...
     view_display_filters_cmd_callback, GIMP_HELP_DISPLAY_FILTER_DIALOG},
    ...
    {"view-color-management-reset", GIMP_ICON_RESET,
     ...
     view_color_management_reset_cmd_callback, GIMP_HELP_VIEW_COLOR_MANAGEMENT},

    {"view-softproof-profile", NULL,
     NC_("view-action", "Soft-_Proofing Profile..."), NULL,
     NC_("view-action", "Set the soft-proofing profile"),
     view_softproof_profile_cmd_callback, GIMP_HELP_VIEW_COLOR_MANAGEMENT},
    ...
    {"view-shrink-wrap", GIMP_ICON_ZOOM_FIT_BEST,
     ...
     view_shrink_wrap_cmd_callback, GIMP_HELP_VIEW_SHRINK_WRAP},

    {"view-open-display", NULL, NC_("view-action", "_Open Display..."), NULL,
     NC_("view-action", "Connect to another display"),
     window_open_display_cmd_callback, NULL}};

static const GimpToggleActionEntry view_toggle_actions[] = {

    {"view-show-all", NULL, NC_("view-action", "Show _All"), NULL,
     NC_("view-action", "Show full image content"), view_show_all_cmd_callback,
     FALSE, GIMP_HELP_VIEW_SHOW_ALL},

    {"view-dot-for-dot", NULL, NC_("view-action", "_Dot for Dot"), NULL,
     NC_("view-action", "A pixel on the screen represents an image pixel"),
     view_dot_for_dot_cmd_callback, TRUE, GIMP_HELP_VIEW_DOT_FOR_DOT},
    ...
    {"view-color-management-enable", NULL,
     ...
     view_color_management_enable_cmd_callback, TRUE,
    ...
    {"view-color-management-softproof", NULL,
     ...
     view_color_management_softproof_cmd_callback, FALSE,
     GIMP_HELP_VIEW_COLOR_MANAGEMENT},
    ...
    {"view-display-black-point-compensation", NULL,
     ...
     view_display_bpc_cmd_callback, TRUE, GIMP_HELP_VIEW_COLOR_MANAGEMENT},

    {"view-softproof-black-point-compensation", NULL,
     NC_("view-action", "_Black Point Compensation"), NULL,
     NC_("view-action", "Use black point compensation for soft-proofing"),
     view_softproof_bpc_cmd_callback, TRUE, GIMP_HELP_VIEW_COLOR_MANAGEMENT},
    ...
    {"view-softproof-gamut-check", NULL,
     ...
     view_softproof_gamut_check_cmd_callback, FALSE,
     GIMP_HELP_VIEW_COLOR_MANAGEMENT},

    {"view-show-selection", NULL, NC_("view-action", "Show _Selection"),
     "<primary>T", NC_("view-action", "Display the selection outline"),
     view_toggle_selection_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_SELECTION},
    ...
    {"view-show-layer-boundary", NULL,
     ...
     view_toggle_layer_boundary_cmd_callback, TRUE,
    ...
    {"view-show-canvas-boundary", NULL,
     ...
     view_toggle_canvas_boundary_cmd_callback, TRUE,
     GIMP_HELP_VIEW_SHOW_CANVAS_BOUNDARY},

    {"view-show-guides", NULL, NC_("view-action", "Show _Guides"),
     "<primary><shift>T", NC_("view-action", "Display the image's guides"),
     view_toggle_guides_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_GUIDES},

    {"view-show-grid", NULL, NC_("view-action", "S_how Grid"), NULL,
     NC_("view-action", "Display the image's grid"),
     view_toggle_grid_cmd_callback, FALSE, GIMP_HELP_VIEW_SHOW_GRID},

    {"view-show-sample-points", NULL, NC_("view-action", "Sh_ow Sample Points"),
     NULL, NC_("view-action", "Display the image's color sample points"),
     view_toggle_sample_points_cmd_callback, TRUE,
     GIMP_HELP_VIEW_SHOW_SAMPLE_POINTS},

    {"view-snap-to-guides", NULL, NC_("view-action", "Snap to Gu_ides"), NULL,
     NC_("view-action", "Tool operations snap to guides"),
     view_snap_to_guides_cmd_callback, TRUE, GIMP_HELP_VIEW_SNAP_TO_GUIDES},

    {"view-snap-to-grid", NULL, NC_("view-action", "Sna_p to Grid"), NULL,
     NC_("view-action", "Tool operations snap to the grid"),
     view_snap_to_grid_cmd_callback, FALSE, GIMP_HELP_VIEW_SNAP_TO_GRID},

    {"view-snap-to-canvas", NULL, NC_("view-action", "Snap to _Canvas Edges"),
     NULL, NC_("view-action", "Tool operations snap to the canvas edges"),
     view_snap_to_canvas_cmd_callback, FALSE, GIMP_HELP_VIEW_SNAP_TO_CANVAS},

    {"view-snap-to-vectors", NULL, NC_("view-action", "Snap t_o Active Path"),
     NULL, NC_("view-action", "Tool operations snap to the active path"),
     view_snap_to_vectors_cmd_callback, FALSE, GIMP_HELP_VIEW_SNAP_TO_VECTORS},

    {"view-show-menubar", NULL, NC_("view-action", "Show _Menubar"), NULL,
     NC_("view-action", "Show this window's menubar"),
     view_toggle_menubar_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_MENUBAR},

    {"view-show-rulers", NULL, NC_("view-action", "Show R_ulers"),
     "<primary><shift>R", NC_("view-action", "Show this window's rulers"),
     view_toggle_rulers_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_RULERS},

    {"view-show-scrollbars", NULL, NC_("view-action", "Show Scroll_bars"), NULL,
     NC_("view-action", "Show this window's scrollbars"),
     view_toggle_scrollbars_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_SCROLLBARS},

    {"view-show-statusbar", NULL, NC_("view-action", "Show S_tatusbar"), NULL,
     NC_("view-action", "Show this window's statusbar"),
     view_toggle_statusbar_cmd_callback, TRUE, GIMP_HELP_VIEW_SHOW_STATUSBAR},

    {"view-fullscreen", GIMP_ICON_VIEW_FULLSCREEN,
     NC_("view-action", "Fullscr_een"), "F11",
     NC_("view-action", "Toggle fullscreen view"), view_fullscreen_cmd_callback,
     FALSE, GIMP_HELP_VIEW_FULLSCREEN}};

static const GimpEnumActionEntry view_zoom_actions[] = {
    {"view-zoom", NULL, NC_("view-zoom-action", "Set zoom factor"), NULL, NULL,
     GIMP_ACTION_SELECT_SET, TRUE, NULL},

    {"view-zoom-minimum", GIMP_ICON_ZOOM_OUT,
     NC_("view-zoom-action", "Zoom out as far as possible"), NULL, NULL,
     GIMP_ACTION_SELECT_FIRST, FALSE, GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-maximum", GIMP_ICON_ZOOM_IN,
     NC_("view-zoom-action", "Zoom in as far as possible"), NULL, NULL,
     GIMP_ACTION_SELECT_LAST, FALSE, GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-out", GIMP_ICON_ZOOM_OUT, NC_("view-zoom-action", "Zoom _Out"),
     "minus", NC_("view-zoom-action", "Zoom out"), GIMP_ACTION_SELECT_PREVIOUS,
     FALSE, GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-in", GIMP_ICON_ZOOM_IN, NC_("view-zoom-action", "Zoom _In"),
     "plus", NC_("view-zoom-action", "Zoom in"), GIMP_ACTION_SELECT_NEXT, FALSE,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-out-accel", GIMP_ICON_CHAR_PICKER,
     NC_("view-zoom-action", "Zoom Out"), "KP_Subtract",
     NC_("view-zoom-action", "Zoom out"), GIMP_ACTION_SELECT_PREVIOUS, FALSE,
     GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-in-accel", GIMP_ICON_CHAR_PICKER,
     NC_("view-zoom-action", "Zoom In"), "KP_Add",
     NC_("view-zoom-action", "Zoom in"), GIMP_ACTION_SELECT_NEXT, FALSE,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-out-skip", GIMP_ICON_ZOOM_OUT,
     NC_("view-zoom-action", "Zoom out a lot"), NULL, NULL,
     GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-in-skip", GIMP_ICON_ZOOM_IN,
     NC_("view-zoom-action", "Zoom in a lot"), NULL, NULL,
     GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, GIMP_HELP_VIEW_ZOOM_IN}};

static const GimpRadioActionEntry view_zoom_explicit_actions[] = {
    {"view-zoom-16-1", NULL, NC_("view-zoom-action", "1_6:1  (1600%)"), "5",
     NC_("view-zoom-action", "Zoom 16:1"), 160000, GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-16-1-accel", NULL, NC_("view-zoom-action", "1_6:1  (1600%)"),
     "KP_5", NC_("view-zoom-action", "Zoom 16:1"), 160000,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-8-1", NULL, NC_("view-zoom-action", "_8:1  (800%)"), "4",
     NC_("view-zoom-action", "Zoom 8:1"), 80000, GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-8-1-accel", NULL, NC_("view-zoom-action", "_8:1  (800%)"),
     "KP_4", NC_("view-zoom-action", "Zoom 8:1"), 80000,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-4-1", NULL, NC_("view-zoom-action", "_4:1  (400%)"), "3",
     NC_("view-zoom-action", "Zoom 4:1"), 40000, GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-4-1-accel", NULL, NC_("view-zoom-action", "_4:1  (400%)"),
     "KP_3", NC_("view-zoom-action", "Zoom 4:1"), 40000,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-2-1", NULL, NC_("view-zoom-action", "_2:1  (200%)"), "2",
     NC_("view-zoom-action", "Zoom 2:1"), 20000, GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-2-1-accel", NULL, NC_("view-zoom-action", "_2:1  (200%)"),
     "KP_2", NC_("view-zoom-action", "Zoom 2:1"), 20000,
     GIMP_HELP_VIEW_ZOOM_IN},

    {"view-zoom-1-1", GIMP_ICON_ZOOM_ORIGINAL,
     NC_("view-zoom-action", "_1:1  (100%)"), "1",
     NC_("view-zoom-action", "Zoom 1:1"), 10000, GIMP_HELP_VIEW_ZOOM_100},

    {"view-zoom-1-1-accel", GIMP_ICON_ZOOM_ORIGINAL,
     NC_("view-zoom-action", "_1:1  (100%)"), "KP_1",
     NC_("view-zoom-action", "Zoom 1:1"), 10000, GIMP_HELP_VIEW_ZOOM_100},

    {"view-zoom-1-2", NULL, NC_("view-zoom-action", "1:_2  (50%)"), "<shift>2",
     NC_("view-zoom-action", "Zoom 1:2"), 5000, GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-1-4", NULL, NC_("view-zoom-action", "1:_4  (25%)"), "<shift>3",
     NC_("view-zoom-action", "Zoom 1:4"), 2500, GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-1-8", NULL, NC_("view-zoom-action", "1:_8  (12.5%)"),
     "<shift>4", NC_("view-zoom-action", "Zoom 1:8"), 1250,
     GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-1-16", NULL, NC_("view-zoom-action", "1:1_6  (6.25%)"),
     "<shift>5", NC_("view-zoom-action", "Zoom 1:16"), 625,
     GIMP_HELP_VIEW_ZOOM_OUT},

    {"view-zoom-other", NULL, NC_("view-zoom-action", "Othe_r zoom factor..."),
     NULL, NC_("view-zoom-action", "Set a custom zoom factor"), 0,
...
static const GimpToggleActionEntry view_flip_actions[] = {
    {"view-flip-horizontally", GIMP_ICON_OBJECT_FLIP_HORIZONTAL,
     ...
     view_flip_horizontally_cmd_callback, FALSE, GIMP_HELP_VIEW_FLIP},
    ...
    {"view-flip-vertically", GIMP_ICON_OBJECT_FLIP_VERTICAL,
     ...
     view_flip_vertically_cmd_callback, FALSE, GIMP_HELP_VIEW_FLIP}};

static const GimpEnumActionEntry view_rotate_absolute_actions[] = {
    {"view-rotate-set-absolute", NULL, "Display Rotation Absolute Angle Set",
     NULL, NULL, GIMP_ACTION_SELECT_SET, TRUE, NULL},
    ...
    {"view-rotate-reset", GIMP_ICON_RESET,
     ...
     GIMP_ACTION_SELECT_SET_TO_DEFAULT, FALSE, GIMP_HELP_VIEW_ROTATE_RESET},
};
...
static const GimpEnumActionEntry view_rotate_relative_actions[] = {
    {"view-rotate-15", GIMP_ICON_OBJECT_ROTATE_90,
     ...
     GIMP_ACTION_SELECT_NEXT, FALSE, GIMP_HELP_VIEW_ROTATE_15},
    ...
    {"view-rotate-90", GIMP_ICON_OBJECT_ROTATE_90,
     ...
     GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, GIMP_HELP_VIEW_ROTATE_90},

    {"view-rotate-180", GIMP_ICON_OBJECT_ROTATE_180,
     NC_("view-action", "Rotate _180°"), NULL,
     NC_("view-action", "Turn the view upside-down"), GIMP_ACTION_SELECT_LAST,
     FALSE, GIMP_HELP_VIEW_ROTATE_180},
    ...
    {"view-rotate-270", GIMP_ICON_OBJECT_ROTATE_270,
     ...
     GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, GIMP_HELP_VIEW_ROTATE_270},
    ...
    {"view-rotate-345", GIMP_ICON_OBJECT_ROTATE_270,
     ...
     GIMP_ACTION_SELECT_PREVIOUS, FALSE, GIMP_HELP_VIEW_ROTATE_345}};

static const GimpRadioActionEntry view_display_intent_actions[] = {
    {"view-display-intent-perceptual", NULL, NC_("view-action", "_Perceptual"),
     NULL, NC_("view-action", "Display rendering intent is perceptual"),
     GIMP_COLOR_RENDERING_INTENT_PERCEPTUAL, GIMP_HELP_VIEW_COLOR_MANAGEMENT},
    ...
    {"view-display-intent-saturation", NULL, NC_("view-action", "_Saturation"),
     NULL, NC_("view-action", "Display rendering intent is saturation"),
     GIMP_COLOR_RENDERING_INTENT_SATURATION, GIMP_HELP_VIEW_COLOR_MANAGEMENT},
...
static const GimpRadioActionEntry view_softproof_intent_actions[] = {
    ...
    {"view-softproof-intent-relative-colorimetric", NULL,
     NC_("view-action", "_Relative Colorimetric"), NULL,
     NC_("view-action",
         "Soft-proofing rendering intent is relative colorimetric"),
     GIMP_COLOR_RENDERING_INTENT_RELATIVE_COLORIMETRIC,
     GIMP_HELP_VIEW_COLOR_MANAGEMENT},
...
static const GimpEnumActionEntry view_padding_color_actions[] = {
    {"view-padding-color-theme", NULL, NC_("view-padding-color", "From _Theme"),
     NULL,
     NC_("view-padding-color", "Use the current theme's background color"),
     GIMP_CANVAS_PADDING_MODE_DEFAULT, FALSE, GIMP_HELP_VIEW_PADDING_COLOR},
    ...
    {"view-padding-color-light-check", NULL,
     ...
     GIMP_CANVAS_PADDING_MODE_LIGHT_CHECK, FALSE, GIMP_HELP_VIEW_PADDING_COLOR},
    ...
    {"view-padding-color-dark-check", NULL,
     ...
     GIMP_CANVAS_PADDING_MODE_DARK_CHECK, FALSE, GIMP_HELP_VIEW_PADDING_COLOR},
    ...
    {"view-padding-color-custom", GIMP_ICON_PALETTE,
     ...
     GIMP_CANVAS_PADDING_MODE_CUSTOM, FALSE, GIMP_HELP_VIEW_PADDING_COLOR},
    ...
    {"view-padding-color-prefs", GIMP_ICON_RESET,
     ...
     GIMP_CANVAS_PADDING_MODE_RESET, FALSE, GIMP_HELP_VIEW_PADDING_COLOR}};
...
static const GimpToggleActionEntry view_padding_color_toggle_actions[] = {
    {"view-padding-color-in-show-all", NULL,
     ...
     view_padding_color_in_show_all_cmd_callback, FALSE,
...
static const GimpEnumActionEntry view_scroll_horizontal_actions[] = {
    ...
    {"view-scroll-left-border", NULL,
     ...
     GIMP_ACTION_SELECT_FIRST, FALSE, NULL},

    {"view-scroll-right-border", NULL,
     NC_("view-action", "Scroll to right border"), NULL, NULL,
     GIMP_ACTION_SELECT_LAST, FALSE, NULL},

    {"view-scroll-left", NULL, NC_("view-action", "Scroll left"), NULL, NULL,
     GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},

    {"view-scroll-right", NULL, NC_("view-action", "Scroll right"), NULL, NULL,
     GIMP_ACTION_SELECT_NEXT, FALSE, NULL},

    {"view-scroll-page-left", NULL, NC_("view-action", "Scroll page left"),
     NULL, NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},

    {"view-scroll-page-right", NULL, NC_("view-action", "Scroll page right"),
     NULL, NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry view_scroll_vertical_actions[] = {
    ...
    {"view-scroll-top-border", NULL, NC_("view-action", "Scroll to top border"),
     NULL, NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},

    {"view-scroll-bottom-border", NULL,
     NC_("view-action", "Scroll to bottom border"), NULL, NULL,
     GIMP_ACTION_SELECT_LAST, FALSE, NULL},

    {"view-scroll-up", NULL, NC_("view-action", "Scroll up"), NULL, NULL,
     GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},

    {"view-scroll-down", NULL, NC_("view-action", "Scroll down"), NULL, NULL,
     GIMP_ACTION_SELECT_NEXT, FALSE, NULL},

    {"view-scroll-page-up", NULL, NC_("view-action", "Scroll page up"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},

    {"view-scroll-page-down", NULL, NC_("view-action", "Scroll page down"),
     NULL, NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};

void view_actions_setup(GimpActionGroup *group) {
  GimpAction *action;

  gimp_action_group_add_actions(group, "view-action", view_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "view-zoom-action", view_zoom_actions,
      G_N_ELEMENTS(view_zoom_actions), view_zoom_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "view-zoom-action", view_zoom_explicit_actions,
      G_N_ELEMENTS(view_zoom_explicit_actions), NULL, 10000,
      view_zoom_explicit_cmd_callback);

  gimp_action_group_add_toggle_actions(group, "view-action", view_flip_actions,
  ...
  gimp_action_group_add_radio_actions(
      group, "view-action", view_display_intent_actions,
      G_N_ELEMENTS(view_display_intent_actions), NULL,
      GIMP_COLOR_MANAGEMENT_DISPLAY, view_display_intent_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "view-action", view_softproof_intent_actions,
      G_N_ELEMENTS(view_softproof_intent_actions), NULL,
      GIMP_COLOR_MANAGEMENT_DISPLAY, view_softproof_intent_cmd_callback);
  ...
  gimp_action_group_add_toggle_actions(
      group, "view-padding-color", view_padding_color_toggle_actions,
      G_N_ELEMENTS(view_padding_color_toggle_actions));

  gimp_action_group_add_enum_actions(
      group, "view-action", view_scroll_horizontal_actions,
  ...
  g_signal_connect(action, "activate", G_CALLBACK(view_zoom_other_cmd_callback),
                   group->user_data);

  g_signal_connect_object(group->gimp->config, "notify::check-type",
                          G_CALLBACK(view_actions_check_type_notify), group, 0);
  view_actions_check_type_notify(GIMP_DISPLAY_CONFIG(group->gimp->config), NULL,
                                 group);
...
void view_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  if (display) {
    ...
    options = (image ? (fullscreen ? shell->fullscreen_options : shell->options)
...
#define SET_COLOR(action, color)                                               \
  ...
  SET_ACTIVE("view-show-layer-boundary",
             display && options->show_layer_boundary);
  SET_SENSITIVE("view-show-canvas-boundary", image && shell->show_all);
  SET_ACTIVE("view-show-canvas-boundary",
             display && options->show_canvas_boundary);
  ...
  SET_ACTIVE("view-padding-color-in-show-all",
             display && options->padding_in_show_all);
...
static void view_actions_set_zoom(GimpActionGroup *group,
  ...
  g_object_get(shell->zoom, "percentage", &str, NULL);

  scale = ROUND(gimp_zoom_model_get_factor(shell->zoom) * 1000);

  switch (scale) {
  case 16000:
    action = "view-zoom-16-1";
    break;
  case 8000:
    action = "view-zoom-8-1";
    break;
  case 4000:
    action = "view-zoom-4-1";
    break;
  case 2000:
    action = "view-zoom-2-1";
    break;
  case 1000:
    action = "view-zoom-1-1";
    break;
  case 500:
    action = "view-zoom-1-2";
    break;
  case 250:
    action = "view-zoom-1-4";
    break;
  case 125:
    action = "view-zoom-1-8";
    break;
  case 63:
  case 62:
    action = "view-zoom-1-16";
    break;
  }
...
static void view_actions_set_rotate(GimpActionGroup *group,
  ...
  label = g_strdup_printf(_("_Flip %s& Rotate (%d°)"), flip,
                          (gint)shell->rotate_angle);
