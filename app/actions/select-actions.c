...
static const GimpActionEntry select_actions[] = {
    ...
    {"select-all", GIMP_ICON_SELECTION_ALL, NC_("select-action", "_All"),
     "<primary>A", NC_("select-action", "Select everything"),
     select_all_cmd_callback, GIMP_HELP_SELECTION_ALL},

    {"select-none", GIMP_ICON_SELECTION_NONE, NC_("select-action", "_None"),
     "<primary><shift>A", NC_("select-action", "Dismiss the selection"),
     select_none_cmd_callback, GIMP_HELP_SELECTION_NONE},

    {"select-invert", GIMP_ICON_INVERT, NC_("select-action", "_Invert"),
     "<primary>I", NC_("select-action", "Invert the selection"),
     select_invert_cmd_callback, GIMP_HELP_SELECTION_INVERT},
    ...
    {"select-sharpen", NULL, NC_("select-action", "_Sharpen"), NULL,
     NC_("select-action", "Remove fuzziness from the selection"),
     select_sharpen_cmd_callback, GIMP_HELP_SELECTION_SHARPEN},

    {"select-shrink", GIMP_ICON_SELECTION_SHRINK,
     NC_("select-action", "S_hrink..."), NULL,
     NC_("select-action", "Contract the selection"), select_shrink_cmd_callback,
     GIMP_HELP_SELECTION_SHRINK},

    {"select-grow", GIMP_ICON_SELECTION_GROW, NC_("select-action", "_Grow..."),
     NULL, NC_("select-action", "Enlarge the selection"),
     select_grow_cmd_callback, GIMP_HELP_SELECTION_GROW},
    ...
    {"select-border", GIMP_ICON_SELECTION_BORDER,
     ...
     select_border_cmd_callback, GIMP_HELP_SELECTION_BORDER},

    {"select-flood", NULL, NC_("select-action", "Re_move Holes"), NULL,
     NC_("select-action", "Remove holes from the selection"),
     select_flood_cmd_callback, GIMP_HELP_SELECTION_FLOOD},
    ...
    {"select-save", GIMP_ICON_SELECTION_TO_CHANNEL,
     ...
     select_save_cmd_callback, GIMP_HELP_SELECTION_TO_CHANNEL},
    ...
    {"select-fill", GIMP_ICON_TOOL_BUCKET_FILL,
     ...
     select_fill_cmd_callback, GIMP_HELP_SELECTION_FILL},
    ...
    {"select-fill-last-values", GIMP_ICON_TOOL_BUCKET_FILL,
     ...
     select_fill_last_vals_cmd_callback, GIMP_HELP_SELECTION_FILL},
    ...
    {"select-stroke", GIMP_ICON_SELECTION_STROKE,
     ...
     select_stroke_cmd_callback, GIMP_HELP_SELECTION_STROKE},
    ...
    {"select-stroke-last-values", GIMP_ICON_SELECTION_STROKE,
     ...
     select_stroke_last_vals_cmd_callback, GIMP_HELP_SELECTION_STROKE}};

void select_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "select-action", select_actions,
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("select-fill-last-values",
                drawables && all_writable && no_groups && sel);
  SET_SENSITIVE("select-stroke", drawables && all_writable && no_groups && sel);
  SET_SENSITIVE("select-stroke-last-values",
                drawables && all_writable && no_groups && sel);
