...
static const GimpActionEntry context_actions[] = {
    {"context-menu", NULL, NC_("context-action", "_Context")},
    {"context-colors-menu", GIMP_ICON_COLORS_DEFAULT,
     NC_("context-action", "_Colors")},
    {"context-opacity-menu", GIMP_ICON_TRANSPARENCY,
     NC_("context-action", "_Opacity")},
    {"context-paint-mode-menu", GIMP_ICON_TOOL_PENCIL,
     NC_("context-action", "Paint _Mode")},
    {"context-tool-menu", GIMP_ICON_DIALOG_TOOLS,
     NC_("context-action", "_Tool")},
    {"context-brush-menu", GIMP_ICON_BRUSH, NC_("context-action", "_Brush")},
    {"context-pattern-menu", GIMP_ICON_PATTERN,
     NC_("context-action", "_Pattern")},
    {"context-palette-menu", GIMP_ICON_PALETTE,
     NC_("context-action", "_Palette")},
    {"context-gradient-menu", GIMP_ICON_GRADIENT,
     NC_("context-action", "_Gradient")},
    {"context-font-menu", GIMP_ICON_FONT, NC_("context-action", "_Font")},

    {"context-brush-shape-menu", NULL, NC_("context-action", "_Shape")},
    {"context-brush-radius-menu", NULL, NC_("context-action", "_Radius")},
    {"context-brush-spikes-menu", NULL, NC_("context-action", "S_pikes")},
    {"context-brush-hardness-menu", NULL, NC_("context-action", "_Hardness")},
    {"context-brush-aspect-menu", NULL, NC_("context-action", "_Aspect Ratio")},
    {"context-brush-angle-menu", NULL, NC_("context-action", "A_ngle")},
    ...
    {"context-colors-default", GIMP_ICON_COLORS_DEFAULT,
     ...
     context_colors_default_cmd_callback, GIMP_HELP_TOOLBOX_DEFAULT_COLORS},
    ...
    {"context-colors-swap", GIMP_ICON_COLORS_SWAP,
     ...
     context_colors_swap_cmd_callback, GIMP_HELP_TOOLBOX_SWAP_COLORS}};
...
static GimpEnumActionEntry context_palette_foreground_actions[] = {
    {"context-palette-foreground-set", GIMP_ICON_PALETTE,
     ...
     GIMP_ACTION_SELECT_SET, FALSE, NULL},
    ...
    {"context-palette-foreground-previous", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Use Previous Palette Color"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    ...
    {"context-palette-foreground-previous-skip", GIMP_ICON_PALETTE,
     ...
     GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-palette-foreground-next-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Skip Forward Palette Color"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static GimpEnumActionEntry context_palette_background_actions[] = {
    ...
    {"context-palette-background-previous", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Use Previous Palette Color"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    ...
    {"context-palette-background-next-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Skip Forward Palette Color"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static GimpEnumActionEntry context_colormap_foreground_actions[] = {
    ...
    {"context-colormap-foreground-first", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Use First Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-colormap-foreground-last", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Use Last Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-colormap-foreground-previous", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Use Previous Color From Colormap"),
     NULL, NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-colormap-foreground-next", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Use Next Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-colormap-foreground-previous-skip", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Skip Back Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-colormap-foreground-next-skip", GIMP_ICON_COLORMAP,
     NC_("context-action", "Foreground: Skip Forward Color From Colormap"),
...
static GimpEnumActionEntry context_colormap_background_actions[] = {
    ...
    {"context-colormap-background-first", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Use First Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-colormap-background-last", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Use Last Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-colormap-background-previous", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Use Previous Color From Colormap"),
     NULL, NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-colormap-background-next", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Use Next Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-colormap-background-previous-skip", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Skip Back Color From Colormap"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-colormap-background-next-skip", GIMP_ICON_COLORMAP,
     NC_("context-action", "Background: Skip Forward Color From Colormap"),
     NULL, NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static GimpEnumActionEntry context_swatch_foreground_actions[] = {
    ...
    {"context-swatch-foreground-first", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Use First Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-swatch-foreground-last", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Use Last Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-swatch-foreground-previous", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Use Previous Color From Swatch"), "9",
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    ...
    {"context-swatch-foreground-previous-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Skip Back Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-swatch-foreground-next-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Foreground: Skip Forward Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static GimpEnumActionEntry context_swatch_background_actions[] = {
    ...
    {"context-swatch-background-first", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Use First Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-swatch-background-last", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Use Last Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-swatch-background-previous", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Use Previous Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-swatch-background-next", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Use Next Color From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-swatch-background-previous-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Skip Color Back From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-swatch-background-next-skip", GIMP_ICON_PALETTE,
     NC_("context-action", "Background: Skip Color Forward From Swatch"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_foreground_red_actions[] = {
    ...
    {"context-foreground-red-increase-skip", GIMP_ICON_CHANNEL_RED,
     ...
     GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_foreground_saturation_actions[] = {
    ...
    {"context-foreground-saturation-increase", GIMP_ICON_TOOL_HUE_SATURATION,
     ...
     GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-foreground-saturation-decrease-skip",
     GIMP_ICON_TOOL_HUE_SATURATION,
     NC_("context-action", "Foreground Saturation: Decrease by 10%"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-foreground-saturation-increase-skip",
     GIMP_ICON_TOOL_HUE_SATURATION,
     NC_("context-action", "Foreground Saturation: Increase by 10%"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_background_saturation_actions[] = {
    ...
    {"context-background-saturation-increase", GIMP_ICON_TOOL_HUE_SATURATION,
     ...
     GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-background-saturation-decrease-skip",
     GIMP_ICON_TOOL_HUE_SATURATION,
     NC_("context-action", "Background Saturation: Decrease by 10%"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-background-saturation-increase-skip",
     GIMP_ICON_TOOL_HUE_SATURATION,
     NC_("context-action", "Background Saturation: Increase by 10%"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_opacity_actions[] = {
    ...
    {"context-opacity-transparent", GIMP_ICON_TRANSPARENCY,
     NC_("context-action", "Tool Opacity: Make Completely Transparent"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    ...
    {"context-opacity-decrease", GIMP_ICON_TRANSPARENCY,
     NC_("context-action", "Tool Opacity: Make 1% More Transparent"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    ...
    {"context-opacity-decrease-skip", GIMP_ICON_TRANSPARENCY,
     NC_("context-action", "Tool Opacity: Make 10% More Transparent"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
...
static const GimpEnumActionEntry context_gradient_select_actions[] = {
    ...
    {"context-gradient-select-previous", GIMP_ICON_GRADIENT,
     NC_("context-action", "Gradient Selection: Switch to Previous"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
...
static const GimpEnumActionEntry context_brush_spacing_actions[] = {
    ...
    {"context-brush-spacing-minimum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Spacing (Editor): Set to Minimum"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-brush-spacing-maximum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Spacing (Editor): Set to Maximum"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    ...
    {"context-brush-spacing-decrease-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Spacing (Editor): Decrease by 10"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-brush-spacing-increase-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Spacing (Editor): Increase by 10"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_brush_radius_actions[] = {
    ...
    {"context-brush-radius-decrease-less", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Radius (Editor): Decrease by 0.1"), NULL,
     NULL, GIMP_ACTION_SELECT_SMALL_PREVIOUS, FALSE, NULL},
    {"context-brush-radius-increase-less", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Radius (Editor): Increase by 0.1"), NULL,
     NULL, GIMP_ACTION_SELECT_SMALL_NEXT, FALSE, NULL},
    ...
    {"context-brush-radius-decrease-percent", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Radius (Editor): Decrease Relative"), NULL,
     NULL, GIMP_ACTION_SELECT_PERCENT_PREVIOUS, FALSE, NULL},
    {"context-brush-radius-increase-percent", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Radius (Editor): Increase Relative"), NULL,
     NULL, GIMP_ACTION_SELECT_PERCENT_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_brush_hardness_actions[] = {
    ...
    {"context-brush-hardness-minimum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Set to Minimum"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-brush-hardness-maximum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Set to Maximum"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-brush-hardness-decrease", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Decrease by 0.01"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-brush-hardness-increase", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Increase by 0.01"), NULL,
     NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-brush-hardness-decrease-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Decrease by 0.1"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-brush-hardness-increase-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Hardness (Editor): Increase by 0.1"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_brush_aspect_actions[] = {
    ...
    {"context-brush-aspect-minimum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Set to Minimum"), NULL,
     NULL, GIMP_ACTION_SELECT_FIRST, FALSE, NULL},
    {"context-brush-aspect-maximum", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Set to Maximum"), NULL,
     NULL, GIMP_ACTION_SELECT_LAST, FALSE, NULL},
    {"context-brush-aspect-decrease", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Decrease by 0.1"),
     NULL, NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-brush-aspect-increase", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Increase by 0.1"),
     NULL, NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-brush-aspect-decrease-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Decrease by 1"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-brush-aspect-increase-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Aspect Ratio (Editor): Increase by 1"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};
...
static const GimpEnumActionEntry context_brush_angle_actions[] = {
    ...
    {"context-brush-angle-decrease", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Angle (Editor): Rotate Right by 1°"), NULL,
     NULL, GIMP_ACTION_SELECT_PREVIOUS, FALSE, NULL},
    {"context-brush-angle-increase", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Angle (Editor): Rotate Left by 1°"), NULL,
     NULL, GIMP_ACTION_SELECT_NEXT, FALSE, NULL},
    {"context-brush-angle-decrease-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Angle (Editor): Rotate Right by 15°"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_PREVIOUS, FALSE, NULL},
    {"context-brush-angle-increase-skip", GIMP_ICON_BRUSH,
     NC_("context-action", "Brush Angle (Editor): Rotate Left by 15°"), NULL,
     NULL, GIMP_ACTION_SELECT_SKIP_NEXT, FALSE, NULL}};

void context_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "context-action", context_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "context-action", context_palette_background_actions,
      G_N_ELEMENTS(context_palette_background_actions),
      context_palette_background_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "context-action", context_colormap_foreground_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "context-action", context_opacity_actions,
      G_N_ELEMENTS(context_opacity_actions), context_opacity_cmd_callback);
  ...
  gimp_action_group_add_enum_actions(
      group, "context-action", context_palette_select_actions,
      G_N_ELEMENTS(context_palette_select_actions),
      context_palette_select_cmd_callback);
  gimp_action_group_add_enum_actions(
      group, "context-action", context_gradient_select_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "context-action", context_brush_spacing_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "context-action", context_brush_hardness_actions,
...
#define SET_SENSITIVE(action, condition)                                       \
  gimp_action_group_set_action_sensitive(group, "context-" action,             \
                                         (condition) != 0)
