...
static const GimpActionEntry brushes_actions[] = {
    {"brushes-popup", GIMP_ICON_BRUSH, NC_("brushes-action", "Brushes Menu"),
     NULL, NULL, NULL, GIMP_HELP_BRUSH_DIALOG},
    ...
    {"brushes-open-as-image", GIMP_ICON_DOCUMENT_OPEN,
     ...
     data_open_as_image_cmd_callback, GIMP_HELP_BRUSH_OPEN_AS_IMAGE},

    {"brushes-new", GIMP_ICON_DOCUMENT_NEW, NC_("brushes-action", "_New Brush"),
     NULL, NC_("brushes-action", "Create a new brush"), data_new_cmd_callback,
     GIMP_HELP_BRUSH_NEW},

    {"brushes-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     NC_("brushes-action", "D_uplicate Brush"), NULL,
     NC_("brushes-action", "Duplicate this brush"), data_duplicate_cmd_callback,
    ...
    {"brushes-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     data_copy_location_cmd_callback, GIMP_HELP_BRUSH_COPY_LOCATION},
    ...
    {"brushes-delete", GIMP_ICON_EDIT_DELETE,
     ...
     NC_("brushes-action", "Delete this brush"), data_delete_cmd_callback,
     GIMP_HELP_BRUSH_DELETE},

    {"brushes-refresh", GIMP_ICON_VIEW_REFRESH,
     NC_("brushes-action", "_Refresh Brushes"), NULL,
     NC_("brushes-action", "Refresh brushes"), data_refresh_cmd_callback,
     GIMP_HELP_BRUSH_REFRESH}};

static const GimpStringActionEntry brushes_edit_actions[] = {
    {"brushes-edit", GIMP_ICON_EDIT, NC_("brushes-action", "_Edit Brush..."),
     NULL, NC_("brushes-action", "Edit this brush"), "gimp-brush-editor",
     GIMP_HELP_BRUSH_EDIT}};

void brushes_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "brushes-action", brushes_actions,
                                G_N_ELEMENTS(brushes_actions));

  gimp_action_group_add_string_actions(
      group, "brushes-action", brushes_edit_actions,
      G_N_ELEMENTS(brushes_edit_actions), data_edit_cmd_callback);
}

void brushes_actions_update(GimpActionGroup *group, gpointer user_data) {
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("brushes-open-as-image",
                file && !GIMP_IS_BRUSH_GENERATED(brush));
