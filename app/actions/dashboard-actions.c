...
static const GimpActionEntry dashboard_actions[] = {
    ...
    {"dashboard-groups", NULL, NC_("dashboard-action", "_Groups")},
    ...
    {"dashboard-log-record", GIMP_ICON_RECORD,
     ...
     dashboard_log_record_cmd_callback, GIMP_HELP_DASHBOARD_LOG_RECORD},
    {"dashboard-log-add-marker", GIMP_ICON_MARKER,
     ...
     dashboard_log_add_marker_cmd_callback, GIMP_HELP_DASHBOARD_LOG_ADD_MARKER},
    ...
    {"dashboard-reset", GIMP_ICON_RESET, NC_("dashboard-action", "_Reset"),
     NULL, NC_("dashboard-action", "Reset cumulative data"),
     dashboard_reset_cmd_callback, GIMP_HELP_DASHBOARD_RESET},
};
...
static const GimpToggleActionEntry dashboard_toggle_actions[] = {
    {"dashboard-low-swap-space-warning", NULL,
     ...
     dashboard_low_swap_space_warning_cmd_callback, FALSE,
...
static const GimpRadioActionEntry dashboard_update_interval_actions[] = {
    ...
    {"dashboard-update-interval-1-sec", NULL,
     ...
     GIMP_DASHBOARD_UPDATE_INTERVAL_1_SEC, GIMP_HELP_DASHBOARD_UPDATE_INTERVAL},

    {"dashboard-update-interval-2-sec", NULL,
     NC_("dashboard-update-interval", "2 Seconds"), NULL, NULL,
     GIMP_DASHBOARD_UPDATE_INTERVAL_2_SEC, GIMP_HELP_DASHBOARD_UPDATE_INTERVAL},
...
void dashboard_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "dashboard-action", dashboard_actions,
  ...
  gimp_action_group_add_radio_actions(
      ...
      G_N_ELEMENTS(dashboard_update_interval_actions), NULL, 0,
      dashboard_update_interval_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "dashboard-history-duration", dashboard_history_duration_actions,
      G_N_ELEMENTS(dashboard_history_duration_actions), NULL, 0,
