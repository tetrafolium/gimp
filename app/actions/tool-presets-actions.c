...
static const GimpActionEntry tool_presets_actions[] = {
    ...
    {"tool-presets-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     data_new_cmd_callback, GIMP_HELP_TOOL_PRESET_NEW},
    ...
    {"tool-presets-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_TOOL_PRESET_DUPLICATE},
    ...
    {"tool-presets-save", GIMP_ICON_DOCUMENT_SAVE,
     ...
     NC_("tool-presets-action", "Save the active tool options to this "
                                "tool preset"),
     tool_presets_save_cmd_callback, GIMP_HELP_TOOL_PRESET_SAVE},
    ...
    {"tool-presets-restore", GIMP_ICON_DOCUMENT_REVERT,
     ...
     tool_presets_restore_cmd_callback, GIMP_HELP_TOOL_PRESET_RESTORE},
    ...
    {"tool-presets-delete", GIMP_ICON_EDIT_DELETE,
     ...
     data_delete_cmd_callback, GIMP_HELP_TOOL_PRESET_DELETE},
    ...
    {"tool-presets-refresh", GIMP_ICON_VIEW_REFRESH,
     ...
     data_refresh_cmd_callback, GIMP_HELP_TOOL_PRESET_REFRESH}};
...
static const GimpStringActionEntry tool_presets_edit_actions[] = {
    {"tool-presets-edit", GIMP_ICON_EDIT,
     ...
     "gimp-tool-preset-editor", GIMP_HELP_TOOL_PRESET_EDIT}};
...
void tool_presets_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_string_actions(
      group, "tool-presets-action", tool_presets_edit_actions,
      G_N_ELEMENTS(tool_presets_edit_actions), data_edit_cmd_callback);
}

void tool_presets_actions_update(GimpActionGroup *group, gpointer user_data) {
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("tool-presets-duplicate",
                tool_preset && gimp_data_is_duplicatable(data));
  ...
  SET_SENSITIVE("tool-presets-delete",
                tool_preset && gimp_data_is_deletable(data));
