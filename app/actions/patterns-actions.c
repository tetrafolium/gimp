...
static const GimpActionEntry patterns_actions[] = {
    ...
    {"patterns-open-as-image", GIMP_ICON_DOCUMENT_OPEN,
     ...
     data_open_as_image_cmd_callback, GIMP_HELP_PATTERN_OPEN_AS_IMAGE},

    {"patterns-new", GIMP_ICON_DOCUMENT_NEW,
     NC_("patterns-action", "_New Pattern"), NULL,
     NC_("patterns-action", "Create a new pattern"), data_new_cmd_callback,
    ...
    {"patterns-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_PATTERN_DUPLICATE},
    ...
    {"patterns-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     data_copy_location_cmd_callback, GIMP_HELP_PATTERN_COPY_LOCATION},
    ...
    {"patterns-delete", GIMP_ICON_EDIT_DELETE,
     ...
     NC_("patterns-action", "Delete this pattern"), data_delete_cmd_callback,
     GIMP_HELP_PATTERN_DELETE},

    {"patterns-refresh", GIMP_ICON_VIEW_REFRESH,
     NC_("patterns-action", "_Refresh Patterns"), NULL,
     NC_("patterns-action", "Refresh patterns"), data_refresh_cmd_callback,
...
static const GimpStringActionEntry patterns_edit_actions[] = {
    {"patterns-edit", GIMP_ICON_EDIT,
     ...
     NC_("patterns-action", "Edit pattern"), "gimp-pattern-editor",
     GIMP_HELP_PATTERN_EDIT}};

void patterns_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "patterns-action", patterns_actions,
                                G_N_ELEMENTS(patterns_actions));

  gimp_action_group_add_string_actions(
      group, "patterns-action", patterns_edit_actions,
      G_N_ELEMENTS(patterns_edit_actions), data_edit_cmd_callback);
}

void patterns_actions_update(GimpActionGroup *group, gpointer user_data) {
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("patterns-duplicate",
                pattern && gimp_data_is_duplicatable(data));
