...
static const GimpActionEntry edit_actions[] = {
    ...
    {"undo-popup", "edit-undo", NC_("edit-action", "Undo History Menu"), NULL,
     NULL, NULL, GIMP_HELP_UNDO_DIALOG},

    {"edit-undo", GIMP_ICON_EDIT_UNDO, NC_("edit-action", "_Undo"),
     "<primary>Z", NC_("edit-action", "Undo the last operation"),
     edit_undo_cmd_callback, GIMP_HELP_EDIT_UNDO},

    {"edit-redo", GIMP_ICON_EDIT_REDO, NC_("edit-action", "_Redo"),
     "<primary>Y",
     NC_("edit-action", "Redo the last operation that was undone"),
     edit_redo_cmd_callback, GIMP_HELP_EDIT_REDO},

    {"edit-strong-undo", GIMP_ICON_EDIT_UNDO, NC_("edit-action", "Strong Undo"),
     "<primary><shift>Z",
     NC_("edit-action", "Undo the last operation, skipping visibility changes"),
     edit_strong_undo_cmd_callback, GIMP_HELP_EDIT_STRONG_UNDO},

    {"edit-strong-redo", GIMP_ICON_EDIT_REDO, NC_("edit-action", "Strong Redo"),
     "<primary><shift>Y",
     NC_("edit-action", "Redo the last operation that was undone, skipping "
                        "visibility changes"),
    ...
    {"edit-undo-clear", GIMP_ICON_SHRED,
     ...
     edit_undo_clear_cmd_callback, GIMP_HELP_EDIT_UNDO_CLEAR},

    {"edit-cut", GIMP_ICON_EDIT_CUT, NC_("edit-action", "Cu_t"), "<primary>X",
     NC_("edit-action", "Move the selected pixels to the clipboard"),
     edit_cut_cmd_callback, GIMP_HELP_EDIT_CUT},

    {"edit-copy", GIMP_ICON_EDIT_COPY, NC_("edit-action", "_Copy"),
     "<primary>C",
     NC_("edit-action", "Copy the selected pixels to the clipboard"),
     edit_copy_cmd_callback, GIMP_HELP_EDIT_COPY},
    ...
    {"edit-copy-visible", NULL, /* GIMP_ICON_COPY_VISIBLE, */
     ...
     edit_copy_visible_cmd_callback, GIMP_HELP_EDIT_COPY_VISIBLE},
    ...
    {"edit-paste-as-new-image", GIMP_ICON_EDIT_PASTE_AS_NEW,
     ...
     edit_paste_as_new_image_cmd_callback, GIMP_HELP_EDIT_PASTE_AS_NEW_IMAGE},
    ...
    {"edit-named-cut", GIMP_ICON_EDIT_CUT, NC_("edit-action", "Cu_t Named..."),
     NULL, NC_("edit-action", "Move the selected pixels to a named buffer"),
     edit_named_cut_cmd_callback, GIMP_HELP_BUFFER_CUT},
    ...
    {"edit-named-copy", GIMP_ICON_EDIT_COPY,
     ...
     edit_named_copy_cmd_callback, GIMP_HELP_BUFFER_COPY},
    ...
    {"edit-named-copy-visible", NULL, /* GIMP_ICON_COPY_VISIBLE, */
     ...
     edit_named_copy_visible_cmd_callback, GIMP_HELP_BUFFER_COPY},
    ...
    {"edit-named-paste", GIMP_ICON_EDIT_PASTE,
     ...
     edit_named_paste_cmd_callback, GIMP_HELP_BUFFER_PASTE},

    {"edit-clear", GIMP_ICON_EDIT_CLEAR, NC_("edit-action", "Cl_ear"), "Delete",
     NC_("edit-action", "Clear the selected pixels"), edit_clear_cmd_callback,
     GIMP_HELP_EDIT_CLEAR}};

static const GimpEnumActionEntry edit_paste_actions[] = {
    {"edit-paste", GIMP_ICON_EDIT_PASTE, NC_("edit-action", "_Paste"),
     "<primary>V", NC_("edit-action", "Paste the content of the clipboard"),
     GIMP_PASTE_TYPE_FLOATING, FALSE, GIMP_HELP_EDIT_PASTE},
    ...
    {"edit-paste-in-place", GIMP_ICON_EDIT_PASTE,
     ...
     GIMP_PASTE_TYPE_FLOATING_IN_PLACE, FALSE, GIMP_HELP_EDIT_PASTE_IN_PLACE},

    {"edit-paste-into", GIMP_ICON_EDIT_PASTE_INTO,
     NC_("edit-action", "Paste _Into Selection"), NULL,
     NC_("edit-action",
         "Paste the content of the clipboard into the current selection"),
     GIMP_PASTE_TYPE_FLOATING_INTO, FALSE, GIMP_HELP_EDIT_PASTE_INTO},
    ...
    {"edit-paste-as-new-layer", GIMP_ICON_EDIT_PASTE_AS_NEW,
     ...
     GIMP_PASTE_TYPE_NEW_LAYER, FALSE, GIMP_HELP_EDIT_PASTE_AS_NEW_LAYER},
...
static const GimpEnumActionEntry edit_fill_actions[] = {
    {"edit-fill-fg", GIMP_ICON_TOOL_BUCKET_FILL,
     ...
     GIMP_FILL_FOREGROUND, FALSE, GIMP_HELP_EDIT_FILL_FG},
    ...
    {"edit-fill-bg", GIMP_ICON_TOOL_BUCKET_FILL,
     ...
     GIMP_FILL_BACKGROUND, FALSE, GIMP_HELP_EDIT_FILL_BG},
    ...
    {"edit-fill-pattern", GIMP_ICON_PATTERN,
     ...
     GIMP_FILL_PATTERN, FALSE, GIMP_HELP_EDIT_FILL_PATTERN}};
...
void edit_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_actions(group, "edit-action", edit_actions,
                                G_N_ELEMENTS(edit_actions));

  gimp_action_group_add_enum_actions(group, "edit-action", edit_paste_actions,
                                     G_N_ELEMENTS(edit_paste_actions),
                                     edit_paste_cmd_callback);

  gimp_action_group_add_enum_actions(group, "edit-action", edit_fill_actions,
                                     G_N_ELEMENTS(edit_fill_actions),
                                     edit_fill_cmd_callback);

  action = gimp_action_group_get_action(group, "edit-paste-as-new-image-short");
  gimp_action_set_accel_path(action, "<Actions>/edit/edit-paste-as-new-image");
  ...
  g_signal_connect_object(context, "foreground-changed",
                          G_CALLBACK(edit_actions_foreground_changed), group,
                          0);
  g_signal_connect_object(context, "background-changed",
                          G_CALLBACK(edit_actions_background_changed), group,
                          0);
  g_signal_connect_object(context, "pattern-changed",
                          G_CALLBACK(edit_actions_pattern_changed), group, 0);
...
void edit_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  if (image) {
    ...
    if (undo_enabled) {
      ...
      if (tool_undo)
        ...
        undo_name = g_strdup_printf(_("_Undo %s"), gimp_object_get_name(undo));

      if (tool_redo)
        redo_name = g_strdup_printf(_("_Redo %s"), tool_redo);
      else if (redo)
        redo_name = g_strdup_printf(_("_Redo %s"), gimp_object_get_name(redo));
    }
  }
