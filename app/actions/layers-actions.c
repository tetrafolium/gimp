...
static const GimpActionEntry layers_actions[] = {
    ...
    {"layers-blend-space-menu", NULL, NC_("layers-action", "Blend Space"), NULL,
     NULL, NULL, NULL},

    {"layers-composite-space-menu", NULL,
     NC_("layers-action", "Composite Space"), NULL, NULL, NULL, NULL},

    {"layers-composite-mode-menu", NULL, NC_("layers-action", "Composite Mode"),
     NULL, NULL, NULL, NULL},

    {"layers-color-tag-menu", NULL, NC_("layers-action", "Color Tag"), NULL,
     NULL, NULL, GIMP_HELP_LAYER_COLOR_TAG},
    ...
    {"layers-edit", GIMP_ICON_EDIT, NC_("layers-action", "Default Edit Action"),
     NULL,
     NC_("layers-action",
         "Activate the default edit action for this type of layer"),
     layers_edit_cmd_callback, GIMP_HELP_LAYER_EDIT},
    ...
    {"layers-edit-text", GIMP_ICON_EDIT,
     ...
     layers_edit_text_cmd_callback, GIMP_HELP_LAYER_EDIT},
    ...
    {"layers-edit-attributes", GIMP_ICON_EDIT,
     ...
     layers_edit_attributes_cmd_callback, GIMP_HELP_LAYER_EDIT},
    ...
    {"layers-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     layers_new_cmd_callback, GIMP_HELP_LAYER_NEW},
    ...
    {"layers-new-last-values", GIMP_ICON_DOCUMENT_NEW,
     ...
     layers_new_last_vals_cmd_callback, GIMP_HELP_LAYER_NEW},

    {"layers-new-from-visible", NULL, NC_("layers-action", "New from _Visible"),
     NULL,
     NC_("layers-action",
         "Create a new layer from what is visible in this image"),
     layers_new_from_visible_cmd_callback, GIMP_HELP_LAYER_NEW_FROM_VISIBLE},
    ...
    {"layers-new-group", GIMP_ICON_FOLDER_NEW,
     ...
     layers_new_group_cmd_callback, GIMP_HELP_LAYER_NEW},
    ...
    {"layers-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     layers_duplicate_cmd_callback, GIMP_HELP_LAYER_DUPLICATE},

    {"layers-delete", GIMP_ICON_EDIT_DELETE,
     NC_("layers-action", "_Delete Layers"), NULL,
     NC_("layers-action", "Delete selected layers"), layers_delete_cmd_callback,
     GIMP_HELP_LAYER_DELETE},

    {"layers-raise", GIMP_ICON_GO_UP, NC_("layers-action", "_Raise Layer"),
     NULL, NC_("layers-action", "Raise this layer one step in the layer stack"),
    ...
    {"layers-raise-to-top", GIMP_ICON_GO_TOP,
     ...
     layers_raise_to_top_cmd_callback, GIMP_HELP_LAYER_RAISE_TO_TOP},

    {"layers-lower", GIMP_ICON_GO_DOWN, NC_("layers-action", "_Lower Layer"),
     NULL, NC_("layers-action", "Lower this layer one step in the layer stack"),
     layers_lower_cmd_callback, GIMP_HELP_LAYER_LOWER},
    ...
    {"layers-lower-to-bottom", GIMP_ICON_GO_BOTTOM,
     ...
     layers_lower_to_bottom_cmd_callback, GIMP_HELP_LAYER_LOWER_TO_BOTTOM},

    {"layers-anchor", GIMP_ICON_LAYER_ANCHOR,
     NC_("layers-action", "_Anchor Layer"), "<primary>H",
     NC_("layers-action", "Anchor the floating layer"),
     layers_anchor_cmd_callback, GIMP_HELP_LAYER_ANCHOR},

    {"layers-merge-down", GIMP_ICON_LAYER_MERGE_DOWN,
     NC_("layers-action", "Merge Do_wn"), NULL,
     NC_("layers-action",
         "Merge these layers with the first visible layer below each"),
     layers_merge_down_cmd_callback, GIMP_HELP_LAYER_MERGE_DOWN},
    ...
    {"layers-merge-group", NULL, NC_("layers-action", "Merge Layer Groups"),
     NULL,
     NC_("layers-action",
         "Merge the layer groups' layers into one normal layer"),
     layers_merge_group_cmd_callback, GIMP_HELP_LAYER_MERGE_GROUP},
    ...
    {"layers-merge-layers", NULL,
     ...
     image_merge_layers_cmd_callback, GIMP_HELP_IMAGE_MERGE_LAYERS},

    {"layers-merge-layers-last-values", NULL,
     NC_("layers-action", "Merge _Visible Layers"), NULL,
     NC_("layers-action", "Merge all visible layers with last used values"),
     image_merge_layers_last_vals_cmd_callback, GIMP_HELP_IMAGE_MERGE_LAYERS},

    {"layers-flatten-image", NULL, NC_("layers-action", "_Flatten Image"), NULL,
     NC_("layers-action", "Merge all layers into one and remove transparency"),
     image_flatten_image_cmd_callback, GIMP_HELP_IMAGE_FLATTEN},
    ...
    {"layers-text-discard", GIMP_ICON_TOOL_TEXT,
     ...
     layers_text_discard_cmd_callback, GIMP_HELP_LAYER_TEXT_DISCARD},
    ...
    {"layers-text-along-vectors", GIMP_ICON_TOOL_TEXT,
     ...
     layers_text_along_vectors_cmd_callback, GIMP_HELP_LAYER_TEXT_ALONG_PATH},
    ...
    {"layers-resize", GIMP_ICON_OBJECT_RESIZE,
     ...
     layers_resize_cmd_callback, GIMP_HELP_LAYER_RESIZE},
    ...
    {"layers-resize-to-image", GIMP_ICON_LAYER_TO_IMAGESIZE,
     ...
     layers_resize_to_image_cmd_callback, GIMP_HELP_LAYER_RESIZE_TO_IMAGE},
    ...
    {"layers-scale", GIMP_ICON_OBJECT_SCALE,
     ...
     layers_scale_cmd_callback, GIMP_HELP_LAYER_SCALE},
    ...
    {"layers-crop-to-selection", GIMP_ICON_TOOL_CROP,
     ...
     layers_crop_to_selection_cmd_callback, GIMP_HELP_LAYER_CROP},

    {"layers-crop-to-content", GIMP_ICON_TOOL_CROP,
     NC_("layers-action", "Crop to C_ontent"), NULL,
     NC_("layers-action", "Crop the layers to the extents of their content "
                          "(remove empty borders from the layer)"),
     layers_crop_to_content_cmd_callback, GIMP_HELP_LAYER_CROP},

    {"layers-mask-add", GIMP_ICON_LAYER_MASK,
     NC_("layers-action", "Add La_yer Masks..."), NULL,
     NC_("layers-action", "Add masks to selected layers that allows "
                          "non-destructive editing of transparency"),
     layers_mask_add_cmd_callback, GIMP_HELP_LAYER_MASK_ADD},
    ...
    {"layers-mask-add-last-values", GIMP_ICON_LAYER_MASK,
     NC_("layers-action", "Add La_yer Masks"), NULL,
     NC_("layers-action", "Add mask to selected layers with last used values"),
     layers_mask_add_last_vals_cmd_callback, GIMP_HELP_LAYER_MASK_ADD},
    ...
    {"layers-alpha-add", GIMP_ICON_TRANSPARENCY,
     ...
     layers_alpha_add_cmd_callback, GIMP_HELP_LAYER_ALPHA_ADD},

    {"layers-alpha-remove", NULL, NC_("layers-action", "_Remove Alpha Channel"),
     NULL,
     NC_("layers-action", "Remove transparency information from the layer"),
     layers_alpha_remove_cmd_callback, GIMP_HELP_LAYER_ALPHA_REMOVE}};
...
static const GimpToggleActionEntry layers_toggle_actions[] = {
    {"layers-mask-edit", GIMP_ICON_EDIT,
     ...
     layers_mask_edit_cmd_callback, FALSE, GIMP_HELP_LAYER_MASK_EDIT},

    {"layers-mask-show", GIMP_ICON_VISIBLE,
     NC_("layers-action", "S_how Layer Masks"), NULL, NULL,
     layers_mask_show_cmd_callback, FALSE, GIMP_HELP_LAYER_MASK_SHOW},

    {"layers-mask-disable", NULL, NC_("layers-action", "_Disable Layer Masks"),
     NULL, NC_("layers-action", "Dismiss the effect of the layer mask"),
     layers_mask_disable_cmd_callback, FALSE, GIMP_HELP_LAYER_MASK_DISABLE},

    {"layers-visible", GIMP_ICON_VISIBLE,
     NC_("layers-action", "Toggle Layer _Visibility"), NULL, NULL,
     layers_visible_cmd_callback, FALSE, GIMP_HELP_LAYER_VISIBLE},

    {"layers-linked", GIMP_ICON_LINKED,
     NC_("layers-action", "Toggle Layer _Linked State"), NULL, NULL,
     layers_linked_cmd_callback, FALSE, GIMP_HELP_LAYER_LINKED},

    {"layers-lock-content", NULL /* GIMP_ICON_LOCK */,
     NC_("layers-action", "L_ock Pixels of Layer"), NULL, NULL,
     layers_lock_content_cmd_callback, FALSE, GIMP_HELP_LAYER_LOCK_PIXELS},

    {"layers-lock-position", GIMP_ICON_TOOL_MOVE,
     NC_("layers-action", "L_ock Position of Layer"), NULL, NULL,
     layers_lock_position_cmd_callback, FALSE, GIMP_HELP_LAYER_LOCK_POSITION},
...
static const GimpRadioActionEntry layers_blend_space_actions[] = {
    ...
    {"layers-blend-space-rgb-perceptual", NULL,
     ...
     GIMP_LAYER_COLOR_SPACE_RGB_PERCEPTUAL, NULL}};

static const GimpRadioActionEntry layers_composite_space_actions[] = {
    {"layers-composite-space-auto", NULL, NC_("layers-action", "Auto"), NULL,
...
static const GimpRadioActionEntry layers_composite_mode_actions[] = {
    {"layers-composite-mode-auto", NULL, NC_("layers-action", "Auto"), NULL,
     NC_("layers-action", "Layer Composite Mode: Auto"),
     GIMP_LAYER_COMPOSITE_AUTO, NULL},

    {"layers-composite-mode-union", NULL, NC_("layers-action", "Union"), NULL,
     NC_("layers-action", "Layer Composite Mode: Union"),
     GIMP_LAYER_COMPOSITE_UNION, NULL},
    ...
    {"layers-composite-mode-clip-to-backdrop", NULL,
     ...
     GIMP_LAYER_COMPOSITE_CLIP_TO_BACKDROP, NULL},
    ...
    {"layers-composite-mode-clip-to-layer", NULL,
     ...
     GIMP_LAYER_COMPOSITE_CLIP_TO_LAYER, NULL},
    ...
    {"layers-composite-mode-intersection", NULL,
     ...
     GIMP_LAYER_COMPOSITE_INTERSECTION, NULL}};
...
static const GimpEnumActionEntry layers_color_tag_actions[] = {
    {"layers-color-tag-none", GIMP_ICON_EDIT_CLEAR,
     ...
     NC_("layers-action", "Layer Color Tag: Clear"), GIMP_COLOR_TAG_NONE, FALSE,
     GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-blue", NULL, NC_("layers-action", "Blue"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Blue"), GIMP_COLOR_TAG_BLUE,
     FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-green", NULL, NC_("layers-action", "Green"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Green"),
     GIMP_COLOR_TAG_GREEN, FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-yellow", NULL, NC_("layers-action", "Yellow"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Yellow"),
     GIMP_COLOR_TAG_YELLOW, FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-orange", NULL, NC_("layers-action", "Orange"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Orange"),
     GIMP_COLOR_TAG_ORANGE, FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-brown", NULL, NC_("layers-action", "Brown"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Brown"),
     GIMP_COLOR_TAG_BROWN, FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-red", NULL, NC_("layers-action", "Red"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Red"), GIMP_COLOR_TAG_RED,
     FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-violet", NULL, NC_("layers-action", "Violet"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Violet"),
     GIMP_COLOR_TAG_VIOLET, FALSE, GIMP_HELP_LAYER_COLOR_TAG},

    {"layers-color-tag-gray", NULL, NC_("layers-action", "Gray"), NULL,
     NC_("layers-action", "Layer Color Tag: Set to Gray"), GIMP_COLOR_TAG_GRAY,
     FALSE, GIMP_HELP_LAYER_COLOR_TAG}};

static const GimpEnumActionEntry layers_mask_apply_actions[] = {
    {"layers-mask-apply", NULL, NC_("layers-action", "Apply Layer _Mask"), NULL,
     NC_("layers-action", "Apply the effect of the layer mask and remove it"),
     GIMP_MASK_APPLY, FALSE, GIMP_HELP_LAYER_MASK_APPLY},
    ...
    {"layers-mask-delete", GIMP_ICON_EDIT_DELETE,
     ...
     GIMP_MASK_DISCARD, FALSE, GIMP_HELP_LAYER_MASK_DELETE}};
...
static const GimpEnumActionEntry layers_mask_to_selection_actions[] = {
    {"layers-mask-selection-replace", GIMP_ICON_SELECTION_REPLACE,
     ...
     GIMP_CHANNEL_OP_REPLACE, FALSE, GIMP_HELP_LAYER_MASK_SELECTION_REPLACE},
    ...
    {"layers-mask-selection-add", GIMP_ICON_SELECTION_ADD,
     ...
     GIMP_CHANNEL_OP_ADD, FALSE, GIMP_HELP_LAYER_MASK_SELECTION_ADD},

    {"layers-mask-selection-subtract", GIMP_ICON_SELECTION_SUBTRACT,
     NC_("layers-action", "_Subtract Masks from Selection"), NULL,
     NC_("layers-action",
         "Subtract the layer masks from the current selection"),
     GIMP_CHANNEL_OP_SUBTRACT, FALSE, GIMP_HELP_LAYER_MASK_SELECTION_SUBTRACT},

    {"layers-mask-selection-intersect", GIMP_ICON_SELECTION_INTERSECT,
     NC_("layers-action", "_Intersect Masks with Selection"), NULL,
     NC_("layers-action",
         "Intersect the layer masks with the current selection"),
...
static const GimpEnumActionEntry layers_alpha_to_selection_actions[] = {
    {"layers-alpha-selection-replace", GIMP_ICON_SELECTION_REPLACE,
     ...
     GIMP_CHANNEL_OP_REPLACE, FALSE, GIMP_HELP_LAYER_ALPHA_SELECTION_REPLACE},
    ...
    {"layers-alpha-selection-add", GIMP_ICON_SELECTION_ADD,
     ...
     GIMP_CHANNEL_OP_ADD, FALSE, GIMP_HELP_LAYER_ALPHA_SELECTION_ADD},
    ...
    {"layers-alpha-selection-subtract", GIMP_ICON_SELECTION_SUBTRACT,
     ...
     GIMP_CHANNEL_OP_SUBTRACT, FALSE, GIMP_HELP_LAYER_ALPHA_SELECTION_SUBTRACT},
...
static const GimpEnumActionEntry layers_select_actions[] = {
    {"layers-select-top", NULL, NC_("layers-action", "Select _Top Layers"),
     "Home", NC_("layers-action", "Select the topmost layers"),
     GIMP_ACTION_SELECT_FIRST, FALSE, GIMP_HELP_LAYER_TOP},

    {"layers-select-bottom", NULL,
     NC_("layers-action", "Select _Bottom Layers"), "End",
     NC_("layers-action", "Select the bottommost layers"),
     GIMP_ACTION_SELECT_LAST, FALSE, GIMP_HELP_LAYER_BOTTOM},
    ...
    {"layers-select-next", NULL, NC_("layers-action", "Select _Next Layers"),
     "Next", NC_("layers-action", "Select the layers below the current layers"),
     GIMP_ACTION_SELECT_NEXT, FALSE, GIMP_HELP_LAYER_NEXT}};
 ...
 * least in theory.
 **/
static void layers_actions_fix_tooltip(GimpActionGroup *group,
                                       const gchar *action,
                                       GdkModifierType modifiers) {
  const gchar *old_hint;
  gchar *new_hint;

  old_hint = gimp_action_group_get_action_tooltip(group, action);
  new_hint = g_strconcat(old_hint, "\n",
                         /* Will be followed with e.g. "Shift-Click
                            on thumbnail"
                          */
                         _("Shortcut: "), gimp_get_mod_string(modifiers),
                         /* Will be prepended with a modifier key
                            string, e.g. "Shift"
                          */
                         _("-Click on thumbnail in Layers dockable"), NULL);
...
void layers_actions_setup(GimpActionGroup *group) {
  ...
  gimp_action_group_add_actions(group, "layers-action", layers_actions,
  ...
  gimp_action_group_add_radio_actions(group, "layers-action",
                                      ...
                                      NULL, 0, layers_blend_space_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "layers-action", layers_composite_space_actions,
      G_N_ELEMENTS(layers_composite_space_actions), NULL, 0,
      layers_composite_space_cmd_callback);

  gimp_action_group_add_radio_actions(
      group, "layers-action", layers_composite_mode_actions,
      G_N_ELEMENTS(layers_composite_mode_actions), NULL, 0,
      layers_composite_mode_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_color_tag_actions,
      G_N_ELEMENTS(layers_color_tag_actions), layers_color_tag_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_mask_apply_actions,
      G_N_ELEMENTS(layers_mask_apply_actions), layers_mask_apply_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_mask_to_selection_actions,
      G_N_ELEMENTS(layers_mask_to_selection_actions),
      layers_mask_to_selection_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_alpha_to_selection_actions,
  ...
  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_select_actions,
      G_N_ELEMENTS(layers_select_actions), layers_select_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_opacity_actions,
      G_N_ELEMENTS(layers_opacity_actions), layers_opacity_cmd_callback);

  gimp_action_group_add_enum_actions(
      group, "layers-action", layers_mode_actions,
      G_N_ELEMENTS(layers_mode_actions), layers_mode_cmd_callback);
...
void layers_actions_update(GimpActionGroup *group, gpointer data) {
  ...
  gboolean bs_mutable =
      FALSE; /* At least 1 selected layers' blend space is mutable.     */
  gboolean cs_mutable =
      FALSE; /* At least 1 selected layers' composite space is mutable. */
  gboolean cm_mutable =
      FALSE; /* At least 1 selected layers' composite mode is mutable.  */
  ...
  gboolean have_no_groups =
      FALSE; /* At least 1 selected layer is not a group.         */
  gboolean have_writable =
      FALSE; /* At least 1 selected layer has no contents lock.   */
  gboolean have_prev =
      FALSE; /* At least 1 selected layer has a previous sibling. */
  gboolean have_next =
      FALSE; /* At least 1 selected layer has a next sibling.     */
  gboolean have_alpha =
      FALSE; /* At least 1 selected layer has an alpha channel.   */
  gboolean have_no_alpha =
      FALSE; /* At least 1 selected layer has no alpha channel.   */
  ...
  if (image) {
    ...
    for (iter = layers; iter; iter = iter->next) {
      ...
      modes = gimp_layer_mode_get_context_array(
          mode, GIMP_LAYER_MODE_CONTEXT_LAYER, &n_modes);
      ...
      if (iter2) {
        ...
        for (next_visible = g_list_next(iter2); next_visible;
      ...
      if (have_masks && have_no_masks && have_groups && have_no_groups &&
          have_writable && !all_writable && !all_movable && !all_masks_shown &&
          !all_masks_disabled && !lock_alpha && can_lock_alpha && !prev_mode &&
          !next_mode && have_prev && have_next && bs_mutable && cs_mutable &&
          cm_mutable && !all_visible && !all_next_visible && have_alpha &&
          have_no_alpha)
        break;
    }
...
#define SET_LABEL(action, label)                                               \
  ...
  SET_SENSITIVE("layers-select-bottom",
                n_layers > 0 && !fs && !ac && have_next);
  SET_SENSITIVE("layers-select-previous",
                n_layers > 0 && !fs && !ac && have_prev);
  ...
  SET_SENSITIVE("layers-lower-to-bottom",
                n_layers > 0 && !fs && !ac && have_next);

  SET_VISIBLE("layers-anchor", fs && !ac);
  SET_VISIBLE("layers-merge-down", !fs);
  SET_SENSITIVE("layers-merge-down",
                n_layers > 0 && !fs && !ac && all_visible && all_next_visible);
  ...
  SET_SENSITIVE("layers-resize",
                n_layers == 1 && all_writable && all_movable && !ac);
  SET_SENSITIVE("layers-resize-to-image", all_writable && all_movable && !ac);
  SET_SENSITIVE("layers-scale",
                n_layers == 1 && all_writable && all_movable && !ac);
  ...
  SET_SENSITIVE("layers-alpha-add",
                all_writable && have_no_groups && !fs && have_no_alpha);
  SET_SENSITIVE("layers-alpha-remove",
                all_writable && have_no_groups && !fs && have_alpha);
  ...
  SET_SENSITIVE("layers-composite-space-rgb-perceptual",
                n_layers && cs_mutable);
  ...
  SET_SENSITIVE("layers-composite-mode-clip-to-backdrop",
                n_layers && cm_mutable);
  ...
  SET_SENSITIVE("layers-mask-add-last-values",
                n_layers > 0 && !fs && !ac && have_no_masks);

  SET_SENSITIVE("layers-mask-apply",
                have_writable && !fs && !ac && have_masks && have_no_groups);
  ...
  SET_SENSITIVE("layers-mask-disable",
                n_layers > 0 && !fs && !ac && have_masks);

  SET_ACTIVE("layers-mask-edit", n_layers == 1 && have_masks &&
  ...
  SET_SENSITIVE("layers-mask-selection-replace",
                n_layers && !fs && !ac && have_masks);
  SET_SENSITIVE("layers-mask-selection-add",
                n_layers && !fs && !ac && have_masks);
  SET_SENSITIVE("layers-mask-selection-subtract",
                n_layers && !fs && !ac && have_masks);
  SET_SENSITIVE("layers-mask-selection-intersect",
                n_layers && !fs && !ac && have_masks);
