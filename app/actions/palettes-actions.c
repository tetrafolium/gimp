...
static const GimpActionEntry palettes_actions[] = {
    ...
    {"palettes-new", GIMP_ICON_DOCUMENT_NEW,
     ...
     NC_("palettes-action", "Create a new palette"), data_new_cmd_callback,
     GIMP_HELP_PALETTE_NEW},

    {"palettes-import", "gtk-convert",
     NC_("palettes-action", "_Import Palette..."), NULL,
     NC_("palettes-action", "Import palette"), palettes_import_cmd_callback,
    ...
    {"palettes-duplicate", GIMP_ICON_OBJECT_DUPLICATE,
     ...
     data_duplicate_cmd_callback, GIMP_HELP_PALETTE_DUPLICATE},

    {"palettes-merge", NULL, NC_("palettes-action", "_Merge Palettes..."), NULL,
     NC_("palettes-action", "Merge palettes"), palettes_merge_cmd_callback,
    ...
    {"palettes-copy-location", GIMP_ICON_EDIT_COPY,
     ...
     data_copy_location_cmd_callback, GIMP_HELP_PALETTE_COPY_LOCATION},
    ...
    {"palettes-delete", GIMP_ICON_EDIT_DELETE,
     ...
     NC_("palettes-action", "Delete this palette"), data_delete_cmd_callback,
     GIMP_HELP_PALETTE_DELETE},

    {"palettes-refresh", GIMP_ICON_VIEW_REFRESH,
     NC_("palettes-action", "_Refresh Palettes"), NULL,
     NC_("palettes-action", "Refresh palettes"), data_refresh_cmd_callback,
...
static const GimpStringActionEntry palettes_edit_actions[] = {
    {"palettes-edit", GIMP_ICON_EDIT,
     ...
     NC_("palettes-action", "Edit this palette"), "gimp-palette-editor",
     GIMP_HELP_PALETTE_EDIT}};

void palettes_actions_setup(GimpActionGroup *group) {
  gimp_action_group_add_actions(group, "palettes-action", palettes_actions,
                                G_N_ELEMENTS(palettes_actions));

  gimp_action_group_add_string_actions(
      group, "palettes-action", palettes_edit_actions,
      G_N_ELEMENTS(palettes_edit_actions), data_edit_cmd_callback);
}
...
#define SET_SENSITIVE(action, condition)                                       \
  ...
  SET_SENSITIVE("palettes-duplicate",
                palette && gimp_data_is_duplicatable(data));
