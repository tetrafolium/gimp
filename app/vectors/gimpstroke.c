...
enum { PROP_0, PROP_CONTROL_POINTS, PROP_CLOSED };

/* Prototypes */

static void gimp_stroke_set_property(GObject *object, guint property_id,
                                     const GValue *value, GParamSpec *pspec);
static void gimp_stroke_get_property(GObject *object, guint property_id,
                                     GValue *value, GParamSpec *pspec);
static void gimp_stroke_finalize(GObject *object);

static gint64 gimp_stroke_get_memsize(GimpObject *object, gint64 *gui_size);
...
static void gimp_stroke_real_anchor_select(GimpStroke *stroke,
                                           ...
                                           gboolean exclusive);
static void
gimp_stroke_real_anchor_move_relative(GimpStroke *stroke, GimpAnchor *anchor,
                                      const GimpCoords *delta,
                                      GimpAnchorFeatureType feature);
static void
gimp_stroke_real_anchor_move_absolute(GimpStroke *stroke, GimpAnchor *anchor,
                                      const GimpCoords *delta,
                                      GimpAnchorFeatureType feature);
...
static void gimp_stroke_real_anchor_delete(GimpStroke *stroke,
                                           GimpAnchor *anchor);
static gboolean gimp_stroke_real_point_is_movable(GimpStroke *stroke,
                                                  GimpAnchor *predec,
                                                  gdouble position);
static void gimp_stroke_real_point_move_relative(GimpStroke *stroke,
                                                 GimpAnchor *predec,
                                                 gdouble position,
                                                 const GimpCoords *deltacoord,
                                                 GimpAnchorFeatureType feature);
static void gimp_stroke_real_point_move_absolute(GimpStroke *stroke,
                                                 GimpAnchor *predec,
                                                 gdouble position,
                                                 const GimpCoords *coord,
                                                 GimpAnchorFeatureType feature);
...
static gboolean gimp_stroke_real_anchor_is_insertable(GimpStroke *stroke,
                                                      GimpAnchor *predec,
                                                      gdouble position);
...
gboolean gimp_stroke_real_connect_stroke(GimpStroke *stroke, GimpAnchor *anchor,
...
static void gimp_stroke_real_translate(GimpStroke *stroke, gdouble offset_x,
                                       gdouble offset_y);
static void gimp_stroke_real_scale(GimpStroke *stroke, gdouble scale_x,
                                   gdouble scale_y);
static void gimp_stroke_real_rotate(GimpStroke *stroke, gdouble center_x,
...
static void gimp_stroke_real_flip_free(GimpStroke *stroke, gdouble x1,
...
static void gimp_stroke_class_init(GimpStrokeClass *klass) {
  ...
  param_spec = g_param_spec_boxed(
      "gimp-anchor", "Gimp Anchor", "The control points of a Stroke",
      GIMP_TYPE_ANCHOR, GIMP_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY);
  g_object_class_install_property(
      object_class, PROP_CONTROL_POINTS,
      gimp_param_spec_value_array(
          ...
          "control points of "
          "the new Stroke",
          param_spec, GIMP_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY));

  g_object_class_install_property(
      object_class, PROP_CLOSED,
      g_param_spec_boolean("closed", "Close Flag",
                           "this flag indicates "
                           "whether the stroke "
                           "is closed or not",
                           FALSE,
...
void gimp_stroke_set_id(GimpStroke *stroke, gint id) {
...
gdouble
gimp_stroke_nearest_point_get(GimpStroke *stroke, const GimpCoords *coord,
                              const gdouble precision, GimpCoords *ret_point,
  ...
  if (GIMP_STROKE_GET_CLASS(stroke)->nearest_point_get)
    return GIMP_STROKE_GET_CLASS(stroke)->nearest_point_get(
        stroke, coord, precision, ret_point, ret_segment_start, ret_segment_end,
        ret_pos);
  return -1;
}

gdouble gimp_stroke_nearest_tangent_get(
    GimpStroke *stroke, const GimpCoords *coords1, const GimpCoords *coords2,
  ...
  if (GIMP_STROKE_GET_CLASS(stroke)->nearest_tangent_get)
    return GIMP_STROKE_GET_CLASS(stroke)->nearest_tangent_get(
        stroke, coords1, coords2, precision, nearest, ret_segment_start,
        ret_segment_end, ret_pos);
  return -1;
}

gdouble gimp_stroke_nearest_intersection_get(
    GimpStroke *stroke, const GimpCoords *coords1, const GimpCoords *direction,
    gdouble precision, GimpCoords *nearest, GimpAnchor **ret_segment_start,
    GimpAnchor **ret_segment_end, gdouble *ret_pos) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);
  g_return_val_if_fail(coords1 != NULL, FALSE);
  ...
  if (GIMP_STROKE_GET_CLASS(stroke)->nearest_intersection_get)
    return GIMP_STROKE_GET_CLASS(stroke)->nearest_intersection_get(
        stroke, coords1, direction, precision, nearest, ret_segment_start,
        ret_segment_end, ret_pos);
  return -1;
}
...
void gimp_stroke_anchor_select(GimpStroke *stroke, GimpAnchor *anchor,
                               gboolean selected, gboolean exclusive) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));

  GIMP_STROKE_GET_CLASS(stroke)->anchor_select(stroke, anchor, selected,
                                               exclusive);
}
...
void gimp_stroke_anchor_move_relative(GimpStroke *stroke, GimpAnchor *anchor,
                                      const GimpCoords *delta,
                                      GimpAnchorFeatureType feature) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
  ...
  GIMP_STROKE_GET_CLASS(stroke)->anchor_move_relative(stroke, anchor, delta,
                                                      feature);
}
...
void gimp_stroke_anchor_move_absolute(GimpStroke *stroke, GimpAnchor *anchor,
                                      const GimpCoords *coord,
                                      GimpAnchorFeatureType feature) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
  g_return_if_fail(anchor != NULL);
  ...
  GIMP_STROKE_GET_CLASS(stroke)->anchor_move_absolute(stroke, anchor, coord,
                                                      feature);
}
...
gboolean gimp_stroke_point_is_movable(GimpStroke *stroke, GimpAnchor *predec,
                                      gdouble position) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);
...
void gimp_stroke_point_move_relative(GimpStroke *stroke, GimpAnchor *predec,
                                     gdouble position,
                                     const GimpCoords *deltacoord,
                                     GimpAnchorFeatureType feature) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));

  GIMP_STROKE_GET_CLASS(stroke)->point_move_relative(stroke, predec, position,
                                                     deltacoord, feature);
}
...
void gimp_stroke_point_move_absolute(GimpStroke *stroke, GimpAnchor *predec,
                                     gdouble position, const GimpCoords *coord,
                                     GimpAnchorFeatureType feature) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));

  GIMP_STROKE_GET_CLASS(stroke)->point_move_absolute(stroke, predec, position,
                                                     coord, feature);
}

static void
gimp_stroke_real_point_move_absolute(GimpStroke *stroke, GimpAnchor *predec,
                                     gdouble position, const GimpCoords *coord,
                                     GimpAnchorFeatureType feature) {
...
void gimp_stroke_anchor_convert(GimpStroke *stroke, GimpAnchor *anchor,
                                GimpAnchorFeatureType feature) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
void gimp_stroke_anchor_delete(GimpStroke *stroke, GimpAnchor *anchor) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
GimpStroke *gimp_stroke_open(GimpStroke *stroke, GimpAnchor *end_anchor) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), NULL);
  g_return_val_if_fail(end_anchor && end_anchor->type == GIMP_ANCHOR_ANCHOR,
                       NULL);
...
gboolean gimp_stroke_anchor_is_insertable(GimpStroke *stroke,
  ...
  return GIMP_STROKE_GET_CLASS(stroke)->anchor_is_insertable(stroke, predec,
                                                             position);
}
...
GimpAnchor *gimp_stroke_anchor_insert(GimpStroke *stroke, GimpAnchor *predec,
                                      gdouble position) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), NULL);
  g_return_val_if_fail(predec->type == GIMP_ANCHOR_ANCHOR, NULL);

  return GIMP_STROKE_GET_CLASS(stroke)->anchor_insert(stroke, predec, position);
}
...
gboolean gimp_stroke_is_extendable(GimpStroke *stroke, GimpAnchor *neighbor) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);
...
GimpAnchor *gimp_stroke_extend(GimpStroke *stroke, const GimpCoords *coords,
                               GimpAnchor *neighbor,
                               GimpVectorExtendMode extend_mode) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), NULL);
  g_return_val_if_fail(!stroke->closed, NULL);

  return GIMP_STROKE_GET_CLASS(stroke)->extend(stroke, coords, neighbor,
                                               extend_mode);
}
...
gboolean gimp_stroke_connect_stroke(GimpStroke *stroke, GimpAnchor *anchor,
                                    GimpStroke *extension,
                                    GimpAnchor *neighbor) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);
  g_return_val_if_fail(GIMP_IS_STROKE(extension), FALSE);
  g_return_val_if_fail(stroke->closed == FALSE && extension->closed == FALSE,
                       FALSE);
...
gboolean gimp_stroke_shift_start(GimpStroke *stroke, GimpAnchor *new_start) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);
...
gdouble gimp_stroke_get_length(GimpStroke *stroke, gdouble precision) {
...
gdouble gimp_stroke_get_distance(GimpStroke *stroke, const GimpCoords *coord) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), 0.0);
...
GArray *gimp_stroke_interpolate(GimpStroke *stroke, gdouble precision,
                                gboolean *ret_closed) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), NULL);
...
static GimpStroke *gimp_stroke_real_duplicate(GimpStroke *stroke) {
  ...
  new_stroke = g_object_new(G_TYPE_FROM_INSTANCE(stroke), "name",
                            gimp_object_get_name(stroke), NULL);
...
void gimp_stroke_translate(GimpStroke *stroke, gdouble offset_x,
                           gdouble offset_y) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
void gimp_stroke_scale(GimpStroke *stroke, gdouble scale_x, gdouble scale_y) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
void gimp_stroke_rotate(GimpStroke *stroke, gdouble center_x, gdouble center_y,
                        gdouble angle) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
void gimp_stroke_flip(GimpStroke *stroke, GimpOrientationType flip_type,
                      gdouble axis) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
void gimp_stroke_flip_free(GimpStroke *stroke, gdouble x1, gdouble y1,
...
static void gimp_stroke_real_flip_free(GimpStroke *stroke, gdouble x1,
                                       gdouble y1, gdouble x2, gdouble y2) {
  /* x, y, width and height parameter in gimp_transform_matrix_flip_free are
   * unused */
  GimpMatrix3 matrix;
 ...
 */
void gimp_stroke_transform(GimpStroke *stroke, const GimpMatrix3 *matrix,
                           GQueue *ret_strokes) {
  g_return_if_fail(GIMP_IS_STROKE(stroke));
...
static void gimp_stroke_real_transform(GimpStroke *stroke,
  ...
  for (list = stroke->anchors->head; list; list = g_list_next(list)) {
    ...
    gimp_matrix3_transform_point(matrix, anchor->position.x, anchor->position.y,
...
GArray *gimp_stroke_control_points_get(GimpStroke *stroke,
  ...
  return GIMP_STROKE_GET_CLASS(stroke)->control_points_get(stroke, ret_closed);
}
...
static GArray *gimp_stroke_real_control_points_get(GimpStroke *stroke,
  ...
  ret_array = g_array_sized_new(FALSE, FALSE, sizeof(GimpAnchor), num_anchors);
...
gboolean gimp_stroke_get_point_at_dist(GimpStroke *stroke, gdouble dist,
                                       gdouble precision, GimpCoords *position,
                                       gdouble *slope) {
  g_return_val_if_fail(GIMP_IS_STROKE(stroke), FALSE);

  return GIMP_STROKE_GET_CLASS(stroke)->get_point_at_dist(
      stroke, dist, precision, position, slope);
}
...
static gboolean gimp_stroke_real_get_point_at_dist(GimpStroke *stroke,
  ...
  for (i = 0; i < points->len - 1; i++) {
    ...
    if (segment_length == 0 || length + segment_length < dist) {
      ...
      gimp_coords_mix(1 - u, &(g_array_index(points, GimpCoords, i)), u,
                      &(g_array_index(points, GimpCoords, i + 1)), position);
