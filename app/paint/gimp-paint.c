...
static void gimp_paint_register(Gimp *gimp, GType paint_type,
...
void gimp_paint_init(Gimp *gimp) {
  GimpPaintRegisterFunc register_funcs[] = {
      gimp_dodge_burn_register,   gimp_smudge_register,
      gimp_convolve_register,     gimp_perspective_clone_register,
      gimp_heal_register,         gimp_clone_register,
      gimp_mybrush_core_register, gimp_ink_register,
      gimp_airbrush_register,     gimp_eraser_register,
...
void gimp_paint_exit(Gimp *gimp) {
  ...
  if (gimp->paint_info_list) {
    gimp_container_foreach(gimp->paint_info_list, (GFunc)g_object_run_dispose,
                           NULL);
...
static void gimp_paint_register(Gimp *gimp, GType paint_type,
  ...
  paint_info = gimp_paint_info_new(gimp, paint_type, paint_options_type,
                                   identifier, blurb, icon_name);
