...
static void gimp_paint_core_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
                                     GimpUndoAccumulator *accum);
static void gimp_paint_core_undo_free(GimpUndo *undo, GimpUndoMode undo_mode);

G_DEFINE_TYPE(GimpPaintCoreUndo, gimp_paint_core_undo, GIMP_TYPE_UNDO)

#define parent_class gimp_paint_core_undo_parent_class

static void gimp_paint_core_undo_class_init(GimpPaintCoreUndoClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_PAINT_CORE,
      g_param_spec_object("paint-core", NULL, NULL, GIMP_TYPE_PAINT_CORE,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));
}

static void gimp_paint_core_undo_init(GimpPaintCoreUndo *undo) {}
