...
void gimp_dodge_burn_register(Gimp *gimp, GimpPaintRegisterCallback callback) {
  (*callback)(gimp, GIMP_TYPE_DODGE_BURN, GIMP_TYPE_DODGE_BURN_OPTIONS,
              "gimp-dodge-burn", _("Dodge/Burn"), "gimp-tool-dodge");
}
...
static void gimp_dodge_burn_motion(GimpPaintCore *paint_core,
  ...
  for (i = 0; i < n_strokes; i++) {
    ...
    gimp_gegl_dodgeburn(src_buffer,
                        ...
                        paint_buffer, GEGL_RECTANGLE(0, 0, 0, 0),
                        options->exposure / 100.0, options->type,
                        options->mode);
