...
static void gimp_ink_options_set_property(GObject *object, guint property_id,
                                          const GValue *value,
                                          GParamSpec *pspec);
static void gimp_ink_options_get_property(GObject *object, guint property_id,
...
static void gimp_ink_options_class_init(GimpInkOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_SIZE, "size", _("Size"),
                          _("Ink Blob Size"), 0.0, 200.0, 16.0,
                          GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_TILT_ANGLE, "tilt-angle",
                          _("Angle"), NULL, -90.0, 90.0, 0.0,
                          GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_SIZE_SENSITIVITY,
                          "size-sensitivity", _("Size"), NULL, 0.0, 1.0, 1.0,
                          GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_VEL_SENSITIVITY, "vel-sensitivity",
                          _("Speed"), NULL, 0.0, 1.0, 0.8,
                          GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_TILT_SENSITIVITY,
                          "tilt-sensitivity", _("Tilt"), NULL, 0.0, 1.0, 0.4,
                          GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_ENUM(object_class, PROP_BLOB_TYPE, "blob-type", _("Shape"),
                        NULL, GIMP_TYPE_INK_BLOB_TYPE,
                        GIMP_INK_BLOB_TYPE_CIRCLE, GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_BLOB_ASPECT, "blob-aspect",
                          _("Aspect ratio"), _("Ink Blob Aspect Ratio"), 1.0,
                          10.0, 1.0, GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_BLOB_ANGLE, "blob-angle",
                          _("Angle"), _("Ink Blob Angle"), -G_PI, G_PI, 0.0,
                          GIMP_PARAM_STATIC_STRINGS);
}
