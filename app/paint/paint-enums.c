...
GType gimp_perspective_clone_mode_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_PERSPECTIVE_CLONE_MODE_ADJUST, "GIMP_PERSPECTIVE_CLONE_MODE_ADJUST",
       "adjust"},
      {GIMP_PERSPECTIVE_CLONE_MODE_PAINT, "GIMP_PERSPECTIVE_CLONE_MODE_PAINT",
       "paint"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_PERSPECTIVE_CLONE_MODE_ADJUST,
       NC_("perspective-clone-mode", "Modify Perspective"), NULL},
      {GIMP_PERSPECTIVE_CLONE_MODE_PAINT,
       NC_("perspective-clone-mode", "Perspective Clone"), NULL},
      {0, NULL, NULL}};
...
GType gimp_source_align_mode_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_SOURCE_ALIGN_REGISTERED, "GIMP_SOURCE_ALIGN_REGISTERED",
       "registered"},
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_SOURCE_ALIGN_REGISTERED, NC_("source-align-mode", "Registered"),
       NULL},
