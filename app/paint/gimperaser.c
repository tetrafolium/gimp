...
static gboolean gimp_eraser_get_color_history_color(
    GimpPaintbrush *paintbrush, GimpDrawable *drawable,
    GimpPaintOptions *paint_options, GimpRGB *color);
static void gimp_eraser_get_paint_params(
    GimpPaintbrush *paintbrush, GimpDrawable *drawable,
...
void gimp_eraser_register(Gimp *gimp, GimpPaintRegisterCallback callback) {
  (*callback)(gimp, GIMP_TYPE_ERASER, GIMP_TYPE_ERASER_OPTIONS, "gimp-eraser",
              _("Eraser"), "gimp-tool-eraser");
}

static void gimp_eraser_class_init(GimpEraserClass *klass) {
  GimpPaintbrushClass *paintbrush_class = GIMP_PAINTBRUSH_CLASS(klass);

  paintbrush_class->get_color_history_color =
      gimp_eraser_get_color_history_color;
