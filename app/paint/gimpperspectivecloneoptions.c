...
static void gimp_perspective_clone_options_class_init(
    GimpPerspectiveCloneOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_CLONE_MODE, "clone-mode", NULL, NULL,
