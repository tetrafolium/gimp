...
#define GIMP_PAINT_OPTIONS(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PAINT_OPTIONS, GimpPaintOptions))
#define GIMP_PAINT_OPTIONS_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PAINT_OPTIONS,                   \
                           GimpPaintOptionsClass))
#define GIMP_IS_PAINT_OPTIONS(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PAINT_OPTIONS))
#define GIMP_IS_PAINT_OPTIONS_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PAINT_OPTIONS))
#define GIMP_PAINT_OPTIONS_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PAINT_OPTIONS,                   \
                             GimpPaintOptionsClass))
...
gdouble gimp_paint_options_get_fade(GimpPaintOptions *options, GimpImage *image,
                                    gdouble pixel_dist);
...
void gimp_paint_options_set_default_brush_size(GimpPaintOptions *options,
                                               GimpBrush *brush);
void gimp_paint_options_set_default_brush_angle(GimpPaintOptions *options,
                                                GimpBrush *brush);
void gimp_paint_options_set_default_brush_aspect_ratio(
    GimpPaintOptions *options, GimpBrush *brush);
void gimp_paint_options_set_default_brush_spacing(GimpPaintOptions *options,
                                                  GimpBrush *brush);

void gimp_paint_options_set_default_brush_hardness(GimpPaintOptions *options,
                                                   GimpBrush *brush);
