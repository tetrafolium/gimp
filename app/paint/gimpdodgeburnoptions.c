...
enum { PROP_0, PROP_TYPE, PROP_MODE, PROP_EXPOSURE };
...
gimp_dodge_burn_options_class_init(GimpDodgeBurnOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_TYPE, "type", _("Type"), NULL,
                        GIMP_TYPE_DODGE_BURN_TYPE, DODGE_BURN_DEFAULT_TYPE,
                        GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_ENUM(object_class, PROP_MODE, "mode", _("Range"), NULL,
                        GIMP_TYPE_TRANSFER_MODE, DODGE_BURN_DEFAULT_MODE,
                        GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_DOUBLE(
      object_class, PROP_EXPOSURE, "exposure", _("Exposure"), NULL, 0.0, 100.0,
      DODGE_BURN_DEFAULT_EXPOSURE, GIMP_PARAM_STATIC_STRINGS);
}
