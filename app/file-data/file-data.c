...
void file_data_init(Gimp *gimp) {
  ...
  gimp_procedure_set_static_help(procedure, "Loads GIMP brushes",
  ...
  gimp_procedure_add_argument(
      procedure,
      gimp_param_spec_enum("dummy-param", "Dummy Param", "Dummy parameter",
                           GIMP_TYPE_RUN_MODE, GIMP_RUN_INTERACTIVE,
                           GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, g_param_spec_object("file", "File", "The file to load",
                                     G_TYPE_FILE, GIMP_PARAM_READWRITE));

  gimp_procedure_add_return_value(
      procedure, gimp_param_spec_image("image", "Image", "Output image", FALSE,
                                       GIMP_PARAM_READWRITE));
  ...
  gimp_object_set_static_name(GIMP_OBJECT(procedure), "file-gbr-save-internal");
  gimp_procedure_set_static_help(procedure, "Exports Gimp brush file (.GBR)",
                                 "Exports Gimp brush file (.GBR)", NULL);
  gimp_procedure_set_static_attribution(
      procedure, "Tim Newsome, Michael Natterer",
      "Tim Newsome, Michael Natterer", "1995-2019");
  ...
  gimp_procedure_add_argument(
      ...
      gimp_param_spec_enum("dummy-param", "Dummy Param", "Dummy parameter",
                           ...
                           GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, gimp_param_spec_image("image", "Image", "Input image", FALSE,
                                       GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, gimp_param_spec_drawable("drawable", "Drawable",
                                          "Active drawable "
                                          "of input image",
                                          FALSE, GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, g_param_spec_object("file", "File", "The file to export",
                                     G_TYPE_FILE, GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, g_param_spec_int("spacing", "spacing", "Spacing of the brush",
                                  1, 1000, 10, GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure, gimp_param_spec_string("name", "name",
                                        "The name of the "
                                        "brush",
                                        FALSE, FALSE, TRUE, "GIMP Brush",
                                        GIMP_PARAM_READWRITE));
  ...
  gimp_procedure_set_static_help(procedure, "Loads GIMP animated brushes",
                                 "This procedure loads a GIMP brush "
                                 "pipe as an image.",
                                 NULL);
  gimp_procedure_set_static_attribution(
      procedure, "Tor Lillqvist, Michael Natterer",
      "Tor Lillqvist, Michael Natterer", "1999-2019");
  ...
  gimp_object_set_static_name(GIMP_OBJECT(procedure), "file-gih-save-internal");
  gimp_procedure_set_static_help(
      procedure, "Exports Gimp animated brush file (.gih)",
      "Exports Gimp animated brush file (.gih)", NULL);
  gimp_procedure_set_static_attribution(
      procedure, "Tor Lillqvist, Michael Natterer",
      "Tor Lillqvist, Michael Natterer", "1999-2019");
  ...
  gimp_procedure_add_argument(
      procedure, g_param_spec_int("num-drawables", "num drawables",
                                  "The number of drawables to save", 1,
                                  G_MAXINT32, 1, GIMP_PARAM_READWRITE));
  gimp_procedure_add_argument(
      procedure,
      gimp_param_spec_object_array(
          "drawables", "drawables", "Drawables to save", GIMP_TYPE_DRAWABLE,
  ...
  gimp_procedure_add_argument(
      procedure,
      gimp_param_spec_string("params", "params", "The pipe's parameters", FALSE,
                             FALSE, TRUE, NULL, GIMP_PARAM_READWRITE));
  ...
  gimp_plug_in_procedure_set_icon(proc, GIMP_ICON_TYPE_ICON_NAME,
                                  ...
                                  strlen("gimp-pattern") + 1, NULL);
  gimp_plug_in_procedure_set_image_types(proc, NULL);
  gimp_plug_in_procedure_set_file_proc(proc, "pat", "", "20,string,GPAT");
  ...
  gimp_procedure_set_static_help(procedure, "Loads GIMP patterns",
                                 "Loads GIMP patterns", NULL);
  gimp_procedure_set_static_attribution(
      procedure, "Tim Newsome, Michael Natterer",
      "Tim Newsome, Michael Natterer", "1997-2019");
  ...
  gimp_object_set_static_name(GIMP_OBJECT(procedure), "file-pat-save-internal");
  gimp_procedure_set_static_help(procedure, "Exports Gimp pattern file (.PAT)",
                                 "Exports Gimp pattern file (.PAT)", NULL);
  gimp_procedure_set_static_attribution(
      procedure, "Tim Newsome, Michael Natterer",
      "Tim Newsome, Michael Natterer", "1995-2019");
  ...
  gimp_plug_in_procedure_set_icon(proc, GIMP_ICON_TYPE_ICON_NAME,
                                  ...
                                  strlen("gimp-plugin") + 1, NULL);
  gimp_plug_in_procedure_set_file_proc(proc, "gex", "", "20, string, GIMP");
  ...
  gimp_procedure_set_static_help(procedure, "Loads GIMP extension",
                                 "Loads GIMP extension", NULL);
  gimp_procedure_set_static_attribution(procedure, "Jehan", "Jehan", "2019");
  ...
  gimp_procedure_add_return_value(
      procedure,
      gimp_param_spec_string("extension-id", "ID of installed extension",
                             "Identifier of the newly installed extension",
                             FALSE, TRUE, FALSE, NULL, GIMP_PARAM_READWRITE));

  gimp_plug_in_manager_add_procedure(gimp->plug_in_manager, proc);
  g_object_unref(procedure);
}

void file_data_exit(Gimp *gimp) { g_return_if_fail(GIMP_IS_GIMP(gimp)); }
