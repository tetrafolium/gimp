 ...
 **/
static void new_dockable_not_in_new_window(gconstpointer data) {
  Gimp *gimp = GIMP(data);
...
int main(int argc, char **argv) {
  ...
  g_setenv("GIMP_TESTING_SESSIONRC_NAME", "sessionrc-2-8-single-window",
           TRUE /*overwrite*/);
