...
#define ADD_TEST(function)                                                     \
  g_test_add("/gimpidtable/" #function, GimpTestFixture, NULL,                 \
             gimp_test_id_table_setup, gimp_test_id_table_##function,          \
...
static void gimp_test_id_table_setup(GimpTestFixture *fixture,
                                     gconstpointer data) {
  fixture->id_table = gimp_id_table_new();
}

static void gimp_test_id_table_teardown(GimpTestFixture *fixture,
                                        gconstpointer data) {
 ...
 **/
static void gimp_test_id_table_insert_and_lookup(GimpTestFixture *f,
                                                 gconstpointer data) {
 ...
 **/
static void gimp_test_id_table_insert_twice(GimpTestFixture *f,
                                            gconstpointer data) {
  gint ret_id = gimp_id_table_insert(f->id_table, data1);
  gpointer ret_data = gimp_id_table_lookup(f->id_table, ret_id);
 ...
 **/
static void gimp_test_id_table_insert_with_id(GimpTestFixture *f,
                                              gconstpointer data) {
  const int id = 10;
 ...
 **/
static void gimp_test_id_table_insert_with_id_existing(GimpTestFixture *f,
                                                       gconstpointer data) {
  const int id = 10;
 ...
 * different data.
 **/
static void gimp_test_id_table_replace(GimpTestFixture *f, gconstpointer data) {
 ...
 * replace.
 **/
static void gimp_test_id_table_replace_as_insert(GimpTestFixture *f,
                                                 gconstpointer data) {
  const int id = 10;
 ...
 **/
static void gimp_test_id_table_remove(GimpTestFixture *f, gconstpointer data) {
  gint ret_id = gimp_id_table_insert(f->id_table, data1);
 ...
 **/
static void gimp_test_id_table_remove_non_existing(GimpTestFixture *f,
                                                   gconstpointer data) {
  const int id = 10;
