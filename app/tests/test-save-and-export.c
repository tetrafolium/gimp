 ...
 **/
static void new_file_has_no_files(gconstpointer data) {
  Gimp *gimp = GIMP(data);
 ...
 * been opened.
 **/
static void opened_xcf_file_files(gconstpointer data) {
  Gimp *gimp = GIMP(data);
  GimpImage *image;
  GFile *file;
  gchar *filename;
  ...
  image = file_open_image(gimp, gimp_get_user_context(gimp), NULL /*progress*/,
                          file, FALSE /*as_new*/, NULL /*file_proc*/,
                          GIMP_RUN_NONINTERACTIVE, &status, NULL /*mime_type*/,
                          NULL /*error*/);
 ...
 **/
static void imported_file_files(gconstpointer data) {
  Gimp *gimp = GIMP(data);
  GimpImage *image;
  GFile *file;
  gchar *filename;
 ...
 * and then saved.
 **/
static void saved_imported_file_files(gconstpointer data) {
  Gimp *gimp = GIMP(data);
  GimpImage *image;
  GFile *import_file;
  ...
  /* Import */
  image = file_open_image(gimp, gimp_get_user_context(gimp), NULL /*progress*/,
                          import_file, FALSE /*as_new*/, NULL /*file_proc*/,
                          GIMP_RUN_NONINTERACTIVE, &status, NULL /*mime_type*/,
                          NULL /*error*/);
  ...
  proc = gimp_plug_in_manager_file_procedure_find(
      image->gimp->plug_in_manager, GIMP_FILE_PROCEDURE_GROUP_SAVE, save_file,
      NULL /*error*/);
  file_save(gimp, image, NULL /*progress*/, save_file, proc,
            GIMP_RUN_NONINTERACTIVE, TRUE /*change_saved_state*/,
            FALSE /*export_backward*/, FALSE /*export_forward*/,
            NULL /*error*/);
 ...
 * correct.
 **/
static void exported_file_files(gconstpointer data) {
  GFile *save_file;
  gchar *save_filename;
  GimpPlugInProcedure *proc;
  Gimp *gimp = GIMP(data);
  ...
  proc = gimp_plug_in_manager_file_procedure_find(
      image->gimp->plug_in_manager, GIMP_FILE_PROCEDURE_GROUP_EXPORT, save_file,
      NULL /*error*/);
  file_save(gimp, image, NULL /*progress*/, save_file, proc,
            GIMP_RUN_NONINTERACTIVE, FALSE /*change_saved_state*/,
            FALSE /*export_backward*/, TRUE /*export_forward*/, NULL /*error*/);
 ...
 **/
static void clear_import_file_after_export(gconstpointer data) {
  Gimp *gimp = GIMP(data);
  GimpImage *image;
  GFile *file;
  gchar *filename;
