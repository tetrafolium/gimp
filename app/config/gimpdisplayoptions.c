...
G_DEFINE_TYPE_WITH_CODE(GimpDisplayOptions, gimp_display_options, G_TYPE_OBJECT,
...
static void gimp_display_options_class_init(GimpDisplayOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_MENUBAR, "show-menubar",
                           "Show menubar", SHOW_MENUBAR_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_STATUSBAR, "show-statusbar",
                           "Show statusbar", SHOW_STATUSBAR_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_RULERS, "show-rulers",
                           "Show rulers", SHOW_RULERS_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(
      object_class, PROP_SHOW_SCROLLBARS, "show-scrollbars", "Show scrollbars",
      SHOW_SCROLLBARS_BLURB, TRUE, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_SELECTION, "show-selection",
                           "Show selection", SHOW_SELECTION_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_LAYER_BOUNDARY,
                           "show-layer-boundary", "Show layer boundary",
                           SHOW_LAYER_BOUNDARY_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_CANVAS_BOUNDARY,
                           "show-canvas-boundary", "Show canvas boundary",
                           SHOW_CANVAS_BOUNDARY_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_GUIDES, "show-guides",
                           "Show guides", SHOW_GUIDES_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_GRID, "show-grid",
                           "Show grid", SHOW_GRID_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_SAMPLE_POINTS,
                           "show-sample-points", "Show sample points",
                           SHOW_SAMPLE_POINTS_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_GUIDES, "snap-to-guides",
                           "Snap to guides", SNAP_TO_GUIDES_BLURB, TRUE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_GRID, "snap-to-grid",
                           "Snap to grid", SNAP_TO_GRID_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_CANVAS, "snap-to-canvas",
                           "Snap to canvas", SNAP_TO_CANVAS_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_PATH, "snap-to-path",
                           "Snap to path", SNAP_TO_PATH_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_ENUM(
      object_class, PROP_PADDING_MODE, "padding-mode", "Padding mode",
      CANVAS_PADDING_MODE_BLURB, GIMP_TYPE_CANVAS_PADDING_MODE,
      GIMP_CANVAS_PADDING_MODE_DEFAULT, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_RGB(object_class, PROP_PADDING_COLOR, "padding-color",
                       "Padding color", CANVAS_PADDING_COLOR_BLURB, FALSE,
                       &white, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(
      object_class, PROP_PADDING_IN_SHOW_ALL, "padding-in-show-all",
      "Keep padding in \"Show All\" mode", CANVAS_PADDING_IN_SHOW_ALL_BLURB,
      FALSE, GIMP_PARAM_STATIC_STRINGS);
}

static void gimp_display_options_fullscreen_class_init(
    GimpDisplayOptionsFullscreenClass *klass) {
  GObjectClass *object_class = G_OBJECT_CLASS(klass);
  GimpRGB black;
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_MENUBAR, "show-menubar",
                           "Show menubar", SHOW_MENUBAR_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_STATUSBAR, "show-statusbar",
                           "Show statusbar", SHOW_STATUSBAR_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_RULERS, "show-rulers",
                           "Show rulers", SHOW_RULERS_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(
      object_class, PROP_SHOW_SCROLLBARS, "show-scrollbars", "Show scrollbars",
      SHOW_SCROLLBARS_BLURB, FALSE, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_SELECTION, "show-selection",
                           "Show selection", SHOW_SELECTION_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_LAYER_BOUNDARY,
                           "show-layer-boundary", "Show layer boundary",
                           SHOW_LAYER_BOUNDARY_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_CANVAS_BOUNDARY,
                           "show-canvas-boundary", "Show canvas boundary",
                           SHOW_CANVAS_BOUNDARY_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SHOW_SAMPLE_POINTS,
                           "show-sample-points", "Show sample points",
                           SHOW_SAMPLE_POINTS_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_GRID, "snap-to-grid",
                           "Snap to grid", SHOW_SCROLLBARS_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
  ...
  GIMP_CONFIG_PROP_ENUM(
      object_class, PROP_PADDING_MODE, "padding-mode", "Padding mode",
      CANVAS_PADDING_MODE_BLURB, GIMP_TYPE_CANVAS_PADDING_MODE,
      GIMP_CANVAS_PADDING_MODE_CUSTOM, GIMP_PARAM_STATIC_STRINGS);
...
static void gimp_display_options_no_image_class_init(
    GimpDisplayOptionsNoImageClass *klass) {
  GObjectClass *object_class = G_OBJECT_CLASS(klass);
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SNAP_TO_PATH, "snap-to-path",
                           "Snap tp path", SNAP_TO_PATH_BLURB, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
}
