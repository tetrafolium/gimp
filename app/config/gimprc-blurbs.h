...
#define BRUSH_PATH_BLURB "Sets the brush search path."

#define BRUSH_PATH_WRITABLE_BLURB ""

#define DYNAMICS_PATH_BLURB _("Sets the dynamics search path.")

#define DYNAMICS_PATH_WRITABLE_BLURB ""

#define TOOL_PRESET_PATH_BLURB _("Sets the dynamics search path.")
...
#define CHECK_UPDATES_BLURB                                                    \
  _("Check for availability of GIMP updates through background internet "      \
    "queries.")

#define CHECK_UPDATE_TIMESTAMP_BLURB _("Timestamp of the last update check.")

#define COLOR_MANAGEMENT_BLURB "Defines the color management behavior."
...
#define CURSOR_MODE_BLURB _("Sets the type of mouse pointers to use.")

#define CURSOR_HANDEDNESS_BLURB _("Sets the handedness for cursor positioning.")
...
#define DEFAULT_SHOW_ALL_BLURB _("Show full image content by default.")
...
#define DEFAULT_FONT_BLURB "Specify a default font."

#define DEFAULT_GRADIENT_BLURB "Specify a default gradient."

#define DEFAULT_GRID_BLURB "Specify a default image grid."

#define DEFAULT_IMAGE_BLURB "Sets the default image in the \"File/New\" dialog."

#define DEFAULT_MYPAINT_BRUSH_BLURB "Specify a default MyPaint brush."

#define DEFAULT_PATTERN_BLURB "Specify a default pattern."

#define DEFAULT_PALETTE_BLURB "Specify a default palette."
...
#define DEFAULT_VIEW_BLURB "Sets the default settings for the image view."
...
#define ENVIRON_PATH_BLURB "Sets the environ search path."
...
#define GRADIENT_PATH_BLURB "Sets the gradient search path."
...
#define HELP_BROWSER_BLURB _("Sets the browser used by the help system.")
...
#define EXPORT_FILE_TYPE_BLURB _("Export file type used by default.")

#define EXPORT_COLOR_PROFILE_BLURB                                             \
  _("Export the image's color profile by default.")

#define EXPORT_COMMENT_BLURB _("Export the image's comment by default.")

/* Translators: tooltip for configuration option (checkbox).
 * It determines how file export plug-ins handle Exif by default.
 */
#define EXPORT_METADATA_EXIF_BLURB _("Export Exif metadata by default.")

/* Translators: tooltip for configuration option (checkbox).
 * It determines how file export plug-ins handle XMP by default.
 */
#define EXPORT_METADATA_XMP_BLURB _("Export XMP metadata by default.")

/* Translators: tooltip for configuration option (checkbox).
 * It determines how file export plug-ins handle IPTC by default.
 */
#define EXPORT_METADATA_IPTC_BLURB _("Export IPTC metadata by default.")
...
#define INTERPRETER_PATH_BLURB "Sets the interpreter search path."

#define LANGUAGE_BLURB                                                         \
  _("Specifies the language to use for the user interface.")

#define LAST_KNOWN_RELEASE_BLURB                                               \
  _("The last known release version of GIMP as queried from official "         \
    "website.")
...
#define LAST_REVISION_BLURB _("The last revision number for the release.")
...
#define MODULE_PATH_BLURB "Sets the module search path."
...
#define MYPAINT_BRUSH_PATH_BLURB "Sets the brush search path."
...
#define PALETTE_PATH_BLURB "Sets the palette search path."

#define PALETTE_PATH_WRITABLE_BLURB ""

#define PATTERN_PATH_BLURB "Sets the pattern search path."
...
#define PLUG_IN_PATH_BLURB "Sets the plug-in search path."

#define PLUGINRC_PATH_BLURB "Sets the pluginrc search path."
...
#define QUICK_MASK_COLOR_BLURB _("Sets the default quick mask color.")
...
#define SAVE_TOOL_OPTIONS_BLURB _("Save the tool options when GIMP exits.")
...
#define SHOW_SAMPLE_POINTS_BLURB                                               \
  _("When enabled, the sample points are visible by default. This can also "   \
    "be "                                                                      \
...
#define SINGLE_WINDOW_MODE_BLURB _("Use GIMP in a single-window mode.")

#define HIDE_DOCKS_BLURB                                                       \
  _("Hide docks and other windows, leaving only image windows.")

#define SHOW_TABS_BLURB _("Show the image tabs bar in single window mode.")

#define PLAYGROUND_NPD_TOOL_BLURB _("Enable the N-Point Deformation tool.")

#define PLAYGROUND_HANDLE_TRANSFORM_TOOL_BLURB                                 \
  _("Enable the Handle Transform tool.")

#define PLAYGROUND_SYMMETRY_BLURB _("Enable symmetry on painting.")

#define PLAYGROUND_MYBRUSH_TOOL_BLURB _("Enable the MyPaint Brush tool.")

#define PLAYGROUND_SEAMLESS_CLONE_TOOL_BLURB                                   \
  _("Enable the Seamless Clone tool.")

#define PLAYGROUND_PAINT_SELECT_TOOL_BLURB _("Enable the Paint Select tool.")
...
#define SAVE_ACCELS_BLURB _("Save changed keyboard shortcuts when GIMP exits.")
...
#define THEME_BLURB _("The name of the theme to use.")

#define THEME_PATH_BLURB "Sets the theme search path."

#define ICON_THEME_BLURB "The name of the icon theme to use."

#define PREFER_SYMBOLIC_ICONS_BLURB                                            \
  _("When enabled, symbolic icons will be preferred if available.")

#define ICON_THEME_PATH_BLURB "Sets the icon theme search path."

#define IMAGE_CONVERT_PROFILE_INTENT_BLURB                                     \
  _("Sets the default rendering intent for the 'Convert to Color Profile' "    \
    "dialog.")
...
#define IMAGE_CONVERT_PRECISION_LAYER_DITHER_METHOD_BLURB                      \
  _("Sets the default layer dithering method for the 'Convert Precision' "     \
    "dialog.")

#define IMAGE_CONVERT_PRECISION_TEXT_LAYER_DITHER_METHOD_BLURB                 \
  _("Sets the default text layer dithering method for the 'Convert "           \
    "Precision' dialog.")

#define IMAGE_CONVERT_PRECISION_CHANNEL_DITHER_METHOD_BLURB                    \
  _("Sets the default channel dithering method for the 'Convert Precision' "   \
    "dialog.")
...
#define IMAGE_CONVERT_INDEXED_MAX_COLORS_BLURB                                 \
  _("Sets the default maximum number of colors for the 'Convert to Indexed' "  \
    "dialog.")

#define IMAGE_CONVERT_INDEXED_REMOVE_DUPLICATES_BLURB                          \
  _("Sets the default 'Remove duplicate colors' state for the 'Convert to "    \
    "Indexed' dialog.")
...
#define IMAGE_CONVERT_INDEXED_DITHER_ALPHA_BLURB                               \
  _("Sets the default 'Dither alpha' state for the 'Convert to Indexed' "      \
    "dialog.")

#define IMAGE_CONVERT_INDEXED_DITHER_TEXT_LAYERS_BLURB                         \
  _("Sets the default 'Dither text layers' state for the 'Convert to "         \
    "Indexed' dialog.")
...
#define IMAGE_RESIZE_RESIZE_TEXT_LAYERS_BLURB                                  \
  _("Sets the default 'Resize text layers' state for the 'Canvas Size' "       \
    "dialog.")
...
#define LAYER_MERGE_ACTIVE_GROUP_ONLY_BLURB                                    \
  _("Sets the default 'Active group only' for the 'Merge Visible Layers' "     \
    "dialog.")

#define LAYER_MERGE_DISCARD_INVISIBLE_BLURB                                    \
  _("Sets the default 'Discard invisible' for the 'Merge Visible Layers' "     \
    "dialog.")
...
#define VECTORS_EXPORT_ACTIVE_ONLY_BLURB                                       \
  _("Sets the default 'Export the active path' state for the 'Export Path' "   \
    "dialog.")
...
#define VECTORS_IMPORT_MERGE_BLURB                                             \
  _("Sets the default 'Merge imported paths' state for the 'Import Path' "     \
    "dialog.")

#define VECTORS_IMPORT_SCALE_BLURB                                             \
  _("Sets the default 'Scale imported paths to fit size' state for the "       \
    "'Import Path' dialog.")
...
#define FILL_OPTIONS_BLURB "The default fill options for the fill dialogs."
...
#define TOOLBOX_GROUPS_BLURB _("Use a single toolbox button for grouped tools.")
...
#define USE_OPENCL_BLURB _("When enabled, uses OpenCL for some operations.")
