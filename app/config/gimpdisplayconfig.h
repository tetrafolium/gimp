...
#define GIMP_DISPLAY_CONFIG(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DISPLAY_CONFIG,                 \
                              GimpDisplayConfig))
#define GIMP_DISPLAY_CONFIG_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DISPLAY_CONFIG,                  \
                           GimpDisplayConfigClass))
#define GIMP_IS_DISPLAY_CONFIG(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DISPLAY_CONFIG))
#define GIMP_IS_DISPLAY_CONFIG_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DISPLAY_CONFIG))
