...
GType gimp_canvas_padding_mode_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_CANVAS_PADDING_MODE_DEFAULT, "GIMP_CANVAS_PADDING_MODE_DEFAULT",
       "default"},
      {GIMP_CANVAS_PADDING_MODE_LIGHT_CHECK,
       "GIMP_CANVAS_PADDING_MODE_LIGHT_CHECK", "light-check"},
      {GIMP_CANVAS_PADDING_MODE_DARK_CHECK,
       "GIMP_CANVAS_PADDING_MODE_DARK_CHECK", "dark-check"},
      {GIMP_CANVAS_PADDING_MODE_CUSTOM, "GIMP_CANVAS_PADDING_MODE_CUSTOM",
       "custom"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_CANVAS_PADDING_MODE_DEFAULT,
       NC_("canvas-padding-mode", "From theme"), NULL},
      {GIMP_CANVAS_PADDING_MODE_LIGHT_CHECK,
       NC_("canvas-padding-mode", "Light check color"), NULL},
      {GIMP_CANVAS_PADDING_MODE_DARK_CHECK,
       NC_("canvas-padding-mode", "Dark check color"), NULL},
      {GIMP_CANVAS_PADDING_MODE_CUSTOM,
       NC_("canvas-padding-mode", "Custom color"), NULL},
      {0, NULL, NULL}};
...
GType gimp_cursor_format_get_type(void) {
  static const GEnumValue values[] = {
...
GType gimp_cursor_mode_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_CURSOR_MODE_TOOL_CROSSHAIR, "GIMP_CURSOR_MODE_TOOL_CROSSHAIR",
       "tool-crosshair"},
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_CURSOR_MODE_TOOL_CROSSHAIR,
       NC_("cursor-mode", "Tool icon with crosshair"), NULL},
...
GType gimp_export_file_type_get_type(void) {
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_EXPORT_FILE_PDF,
       NC_("export-file-type", "Portable Document Format"), NULL},
      {GIMP_EXPORT_FILE_TIF, NC_("export-file-type", "TIFF Image"), NULL},
      {GIMP_EXPORT_FILE_BMP, NC_("export-file-type", "Windows BMP Image"),
       NULL},
...
GType gimp_help_browser_type_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_HELP_BROWSER_GIMP, "GIMP_HELP_BROWSER_GIMP", "gimp"},
      {GIMP_HELP_BROWSER_WEB_BROWSER, "GIMP_HELP_BROWSER_WEB_BROWSER",
       "web-browser"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_HELP_BROWSER_GIMP, NC_("help-browser-type", "GIMP help browser"),
       NULL},
      {GIMP_HELP_BROWSER_WEB_BROWSER, NC_("help-browser-type", "Web browser"),
       NULL},
      {0, NULL, NULL}};
...
GType gimp_space_bar_action_get_type(void) {
  ...
  static const GimpEnumDesc descs[] = {
      ...
      {GIMP_SPACE_BAR_ACTION_MOVE,
       NC_("space-bar-action", "Switch to Move tool"), NULL},
      {0, NULL, NULL}};
...
GType gimp_window_hint_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_WINDOW_HINT_KEEP_ABOVE, "GIMP_WINDOW_HINT_KEEP_ABOVE",
       "keep-above"},
      {0, NULL, NULL}};
