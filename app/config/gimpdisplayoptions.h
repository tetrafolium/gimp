...
#define GIMP_TYPE_DISPLAY_OPTIONS_FULLSCREEN                                   \
  (gimp_display_options_fullscreen_get_type())
#define GIMP_TYPE_DISPLAY_OPTIONS_NO_IMAGE                                     \
  (gimp_display_options_no_image_get_type())

#define GIMP_DISPLAY_OPTIONS(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DISPLAY_OPTIONS,                \
                              GimpDisplayOptions))
#define GIMP_DISPLAY_OPTIONS_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DISPLAY_OPTIONS,                 \
                           GimpDisplayOptionsClass))
#define GIMP_IS_DISPLAY_OPTIONS(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DISPLAY_OPTIONS))
#define GIMP_IS_DISPLAY_OPTIONS_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DISPLAY_OPTIONS))
#define GIMP_DISPLAY_OPTIONS_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DISPLAY_OPTIONS,                 \
                             GimpDisplayOptionsClass))
