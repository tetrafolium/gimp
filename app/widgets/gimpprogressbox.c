...
static GimpProgress *gimp_progress_box_progress_start(GimpProgress *progress,
...
G_DEFINE_TYPE_WITH_CODE(
    GimpProgressBox, gimp_progress_box, GTK_TYPE_BOX,
...
static void gimp_progress_box_init(GimpProgressBox *box) {
  ...
  gimp_label_set_attributes(GTK_LABEL(box->label), PANGO_ATTR_STYLE,
