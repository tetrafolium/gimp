...
#define GIMP_CONTROLLER_MOUSE(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CONTROLLER_MOUSE,               \
                              GimpControllerMouse))
#define GIMP_CONTROLLER_MOUSE_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CONTROLLER_MOUSE,                \
                           GimpControllerMouseClass))
#define GIMP_IS_CONTROLLER_MOUSE(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CONTROLLER_MOUSE))
#define GIMP_IS_CONTROLLER_MOUSE_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CONTROLLER_MOUSE))
#define GIMP_CONTROLLER_MOUSE_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CONTROLLER_MOUSE,                \
                             GimpControllerMouseClass))
