...
#define GIMP_SESSION_INFO(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SESSION_INFO, GimpSessionInfo))
#define GIMP_SESSION_INFO_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SESSION_INFO,                    \
                           GimpSessionInfoClass))
#define GIMP_IS_SESSION_INFO(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_SESSION_INFO))
#define GIMP_IS_SESSION_INFO_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SESSION_INFO))
#define GIMP_SESSION_INFO_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SESSION_INFO,                    \
                             GimpSessionInfoClass))
...
void gimp_session_info_restore(GimpSessionInfo *info,
                               GimpDialogFactory *factory, GdkMonitor *monitor);
