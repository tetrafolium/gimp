...
#define GIMP_FILE_DIALOG(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FILE_DIALOG, GimpFileDialog))
#define GIMP_FILE_DIALOG_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FILE_DIALOG, GimpFileDialogClass))
#define GIMP_IS_FILE_DIALOG(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FILE_DIALOG))
#define GIMP_IS_FILE_DIALOG_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FILE_DIALOG))
#define GIMP_FILE_DIALOG_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FILE_DIALOG, GimpFileDialogClass))
...
struct _GimpFileDialogClass {
  ...
  void (*save_state)(GimpFileDialog *dialog, const gchar *state_name);
  void (*load_state)(GimpFileDialog *dialog, const gchar *state_name);
};
...
void gimp_file_dialog_set_sensitive(GimpFileDialog *dialog, gboolean sensitive);
