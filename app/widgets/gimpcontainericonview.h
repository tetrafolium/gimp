...
#define GIMP_CONTAINER_ICON_VIEW(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CONTAINER_ICON_VIEW,            \
                              GimpContainerIconView))
#define GIMP_CONTAINER_ICON_VIEW_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CONTAINER_ICON_VIEW,             \
                           GimpContainerIconViewClass))
#define GIMP_IS_CONTAINER_ICON_VIEW(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CONTAINER_ICON_VIEW))
#define GIMP_IS_CONTAINER_ICON_VIEW_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CONTAINER_ICON_VIEW))
#define GIMP_CONTAINER_ICON_VIEW_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CONTAINER_ICON_VIEW,             \
                             GimpContainerIconViewClass))
