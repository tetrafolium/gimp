...
static void gimp_toggle_action_class_init(GimpToggleActionClass *klass) {
...
static void gimp_toggle_action_init(GimpToggleAction *action) {
...
GtkToggleAction *gimp_toggle_action_new(const gchar *name, const gchar *label,
  ...
  action = g_object_new(GIMP_TYPE_TOGGLE_ACTION, "name", name, "label", label,
