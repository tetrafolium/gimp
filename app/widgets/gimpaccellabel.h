...
#define GIMP_ACCEL_LABEL(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ACCEL_LABEL, GimpAccelLabel))
#define GIMP_ACCEL_LABEL_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_ACCEL_LABEL, GimpAccelLabelClass))
#define GIMP_IS_ACCEL_LABEL(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_ACCEL_LABEL))
#define GIMP_IS_ACCEL_LABEL_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_ACCEL_LABEL))
#define GIMP_ACCEL_LABEL_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_ACCEL_LABEL, GimpAccelLabelClass))
