...
enum { PROP_0, PROP_ORIENTATION, PROP_COLOR, PROP_CHANNEL };

/*  local function prototypes  */

static void gimp_color_bar_set_property(GObject *object, guint property_id,
                                        const GValue *value, GParamSpec *pspec);
static void gimp_color_bar_get_property(GObject *object, guint property_id,
                                        GValue *value, GParamSpec *pspec);

static gboolean gimp_color_bar_draw(GtkWidget *widget, cairo_t *cr);
...
static void gimp_color_bar_class_init(GimpColorBarClass *klass) {
  ...
  g_object_class_install_property(
      ...
      gimp_param_spec_rgb("color", NULL, NULL, FALSE, &white,
...
GtkWidget *gimp_color_bar_new(GtkOrientation orientation) {
  return g_object_new(GIMP_TYPE_COLOR_BAR, "orientation", orientation, NULL);
}
