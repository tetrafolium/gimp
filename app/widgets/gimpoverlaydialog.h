...
#define GIMP_OVERLAY_DIALOG(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_OVERLAY_DIALOG,                 \
                              GimpOverlayDialog))
#define GIMP_OVERLAY_DIALOG_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_OVERLAY_DIALOG,                  \
                           GimpOverlayDialogClass))
#define GIMP_IS_OVERLAY_DIALOG(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_OVERLAY_DIALOG))
#define GIMP_IS_OVERLAY_DIALOG_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_OVERLAY_DIALOG))
#define GIMP_OVERLAY_DIALOG_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_OVERLAY_DIALOG,                  \
                             GimpOverlayDialogClass))
...
struct _GimpOverlayDialogClass {
  ...
  void (*response)(GimpOverlayDialog *overlay, gint response_id);
