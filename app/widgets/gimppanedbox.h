...
#define GIMP_PANED_BOX(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PANED_BOX, GimpPanedBox))
#define GIMP_PANED_BOX_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PANED_BOX, GimpPanedBoxClass))
#define GIMP_IS_PANED_BOX(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PANED_BOX))
#define GIMP_IS_PANED_BOX_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PANED_BOX))
#define GIMP_PANED_BOX_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PANED_BOX, GimpPanedBoxClass))
