...
GType gimp_active_color_get_type(void) {
  static const GEnumValue values[] = {
      {GIMP_ACTIVE_COLOR_FOREGROUND, "GIMP_ACTIVE_COLOR_FOREGROUND",
       "foreground"},
      {GIMP_ACTIVE_COLOR_BACKGROUND, "GIMP_ACTIVE_COLOR_BACKGROUND",
       "background"},
      {0, NULL, NULL}};
...
GType gimp_color_pick_target_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_COLOR_PICK_TARGET_FOREGROUND, "GIMP_COLOR_PICK_TARGET_FOREGROUND",
       "foreground"},
      {GIMP_COLOR_PICK_TARGET_BACKGROUND, "GIMP_COLOR_PICK_TARGET_BACKGROUND",
       "background"},
      {GIMP_COLOR_PICK_TARGET_PALETTE, "GIMP_COLOR_PICK_TARGET_PALETTE",
       "palette"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_COLOR_PICK_TARGET_NONE, NC_("color-pick-target", "Pick only"),
       NULL},
      {GIMP_COLOR_PICK_TARGET_FOREGROUND,
       NC_("color-pick-target", "Set foreground color"), NULL},
      {GIMP_COLOR_PICK_TARGET_BACKGROUND,
       NC_("color-pick-target", "Set background color"), NULL},
      {GIMP_COLOR_PICK_TARGET_PALETTE,
       NC_("color-pick-target", "Add to palette"), NULL},
      {0, NULL, NULL}};
...
GType gimp_histogram_scale_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_HISTOGRAM_SCALE_LOGARITHMIC, "GIMP_HISTOGRAM_SCALE_LOGARITHMIC",
       "logarithmic"},
      {0, NULL, NULL}};

  static const GimpEnumDesc descs[] = {
      {GIMP_HISTOGRAM_SCALE_LINEAR, NC_("histogram-scale", "Linear histogram"),
       NULL},
      {GIMP_HISTOGRAM_SCALE_LOGARITHMIC,
       NC_("histogram-scale", "Logarithmic histogram"), NULL},
      {0, NULL, NULL}};
...
GType gimp_tab_style_get_type(void) {
  static const GEnumValue values[] = {
      ...
      {GIMP_TAB_STYLE_PREVIEW_NAME, "GIMP_TAB_STYLE_PREVIEW_NAME",
       "preview-name"},
      {GIMP_TAB_STYLE_PREVIEW_BLURB, "GIMP_TAB_STYLE_PREVIEW_BLURB",
       "preview-blurb"},
      {0, NULL, NULL}};
