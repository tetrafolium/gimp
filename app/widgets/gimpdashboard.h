...
#define GIMP_DASHBOARD(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DASHBOARD, GimpDashboard))
#define GIMP_DASHBOARD_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DASHBOARD, GimpDashboardClass))
#define GIMP_IS_DASHBOARD(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DASHBOARD))
#define GIMP_IS_DASHBOARD_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DASHBOARD))
#define GIMP_DASHBOARD_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DASHBOARD, GimpDashboardClass))
