...
void gimp_selection_data_set_uri_list(GtkSelectionData *selection, GList *uris);
...
void gimp_selection_data_set_xcf(GtkSelectionData *selection, GimpImage *image);
GimpImage *gimp_selection_data_get_xcf(GtkSelectionData *selection, Gimp *gimp);
...
GimpItem *gimp_selection_data_get_item(GtkSelectionData *selection, Gimp *gimp);
...
GimpPalette *gimp_selection_data_get_palette(GtkSelectionData *selection,
                                             Gimp *gimp);
GimpFont *gimp_selection_data_get_font(GtkSelectionData *selection, Gimp *gimp);
