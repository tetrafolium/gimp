...
#define GIMP_TEXT_BUFFER(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TEXT_BUFFER, GimpTextBuffer))
#define GIMP_IS_TEXT_BUFFER(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TEXT_BUFFER))
#define GIMP_TEXT_BUFFER_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TEXT_BUFFER, GimpTextBufferClass))
#define GIMP_IS_TEXT_BUFFER_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TEXT_BUFFER))
...
struct _GimpTextBufferClass {
  ...
  void (*color_applied)(GimpTextBuffer *buffer, const GimpRGB *color);
};
...
GtkTextTag *gimp_text_buffer_get_iter_size(GimpTextBuffer *buffer,
                                           const GtkTextIter *iter, gint *size);
...
void gimp_text_buffer_change_size(GimpTextBuffer *buffer,
                                  ...
                                  const GtkTextIter *end, gint amount);
