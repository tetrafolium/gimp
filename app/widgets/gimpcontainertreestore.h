...
#define GIMP_CONTAINER_TREE_STORE(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CONTAINER_TREE_STORE,           \
                              GimpContainerTreeStore))
#define GIMP_CONTAINER_TREE_STORE_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CONTAINER_TREE_STORE,            \
                           GimpContainerTreeStoreClass))
#define GIMP_IS_CONTAINER_TREE_STORE(obj)                                      \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CONTAINER_TREE_STORE))
#define GIMP_IS_CONTAINER_TREE_STORE_CLASS(klass)                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CONTAINER_TREE_STORE))
#define GIMP_CONTAINER_TREE_STORE_GET_CLASS(obj)                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CONTAINER_TREE_STORE,            \
                             GimpContainerTreeStoreClass))
