...
#define GIMP_IMAGE_EDITOR(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_IMAGE_EDITOR, GimpImageEditor))
#define GIMP_IMAGE_EDITOR_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_IMAGE_EDITOR,                    \
                           GimpImageEditorClass))
#define GIMP_IS_IMAGE_EDITOR(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_IMAGE_EDITOR))
#define GIMP_IS_IMAGE_EDITOR_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_IMAGE_EDITOR))
#define GIMP_IMAGE_EDITOR_GET_CLASS(obj)                                       \
...
void gimp_image_editor_set_image(GimpImageEditor *editor, GimpImage *image);
