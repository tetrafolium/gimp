...
typedef void (*GimpDndDragDataFunc)(GtkWidget *widget, GdkDragContext *context,
                                    GCallback get_data_func,
                                    gpointer get_data_data,
                                    GtkSelectionData *selection);
typedef gboolean (*GimpDndDropDataFunc)(GtkWidget *widget, gint x, gint y,
...
static GtkWidget *
gimp_dnd_get_viewable_list_icon(GtkWidget *widget, GdkDragContext *context,
...
static void gimp_dnd_get_uri_list_data(GtkWidget *widget,
                                       ...
                                       GtkSelectionData *selection);
static gboolean gimp_dnd_set_uri_list_data(GtkWidget *widget, gint x, gint y,
                                           GCallback set_uri_list_func,
                                           gpointer set_uri_list_data,
                                           GtkSelectionData *selection);

static void gimp_dnd_get_xds_data(GtkWidget *widget, GdkDragContext *context,
                                  GCallback get_image_func,
                                  gpointer get_image_data,
                                  GtkSelectionData *selection);

static void gimp_dnd_get_color_data(GtkWidget *widget, GdkDragContext *context,
                                    GCallback get_color_func,
                                    gpointer get_color_data,
                                    GtkSelectionData *selection);
static gboolean gimp_dnd_set_color_data(GtkWidget *widget, gint x, gint y,
                                        GCallback set_color_func,
                                        gpointer set_color_data,
                                        GtkSelectionData *selection);

static void gimp_dnd_get_stream_data(GtkWidget *widget, GdkDragContext *context,
                                     GCallback get_stream_func,
                                     gpointer get_stream_data,
                                     GtkSelectionData *selection);
static gboolean gimp_dnd_set_stream_data(GtkWidget *widget, gint x, gint y,
                                         GCallback set_stream_func,
                                         gpointer set_stream_data,
                                         GtkSelectionData *selection);

static void gimp_dnd_get_pixbuf_data(GtkWidget *widget, GdkDragContext *context,
                                     GCallback get_pixbuf_func,
                                     gpointer get_pixbuf_data,
                                     GtkSelectionData *selection);
static gboolean gimp_dnd_set_pixbuf_data(GtkWidget *widget, gint x, gint y,
...
static void gimp_dnd_get_component_data(GtkWidget *widget,
                                        ...
                                        gpointer get_comp_data,
                                        GtkSelectionData *selection);
static gboolean gimp_dnd_set_component_data(GtkWidget *widget, gint x, gint y,
                                            GCallback set_comp_func,
                                            gpointer set_comp_data,
                                            GtkSelectionData *selection);

static void gimp_dnd_get_image_data(GtkWidget *widget, GdkDragContext *context,
                                    GCallback get_image_func,
                                    gpointer get_image_data,
                                    GtkSelectionData *selection);
static gboolean gimp_dnd_set_image_data(GtkWidget *widget, gint x, gint y,
                                        GCallback set_image_func,
                                        gpointer set_image_data,
                                        GtkSelectionData *selection);

static void gimp_dnd_get_item_data(GtkWidget *widget, GdkDragContext *context,
                                   GCallback get_item_func,
                                   gpointer get_item_data,
                                   GtkSelectionData *selection);
static gboolean gimp_dnd_set_item_data(GtkWidget *widget, gint x, gint y,
...
static void gimp_dnd_get_item_list_data(GtkWidget *widget,
                                        ...
                                        gpointer get_item_data,
                                        GtkSelectionData *selection);
static gboolean gimp_dnd_set_item_list_data(GtkWidget *widget, gint x, gint y,
                                            GCallback set_item_func,
                                            gpointer set_item_data,
                                            GtkSelectionData *selection);

static void gimp_dnd_get_object_data(GtkWidget *widget, GdkDragContext *context,
                                     GCallback get_object_func,
                                     gpointer get_object_data,
                                     GtkSelectionData *selection);

static gboolean gimp_dnd_set_brush_data(GtkWidget *widget, gint x, gint y,
                                        GCallback set_brush_func,
                                        gpointer set_brush_data,
                                        GtkSelectionData *selection);
static gboolean gimp_dnd_set_pattern_data(GtkWidget *widget, gint x, gint y,
                                          GCallback set_pattern_func,
                                          gpointer set_pattern_data,
                                          GtkSelectionData *selection);
static gboolean gimp_dnd_set_gradient_data(GtkWidget *widget, gint x, gint y,
                                           GCallback set_gradient_func,
                                           gpointer set_gradient_data,
                                           GtkSelectionData *selection);
static gboolean gimp_dnd_set_palette_data(GtkWidget *widget, gint x, gint y,
                                          GCallback set_palette_func,
                                          gpointer set_palette_data,
                                          GtkSelectionData *selection);
static gboolean gimp_dnd_set_font_data(GtkWidget *widget, gint x, gint y,
                                       GCallback set_font_func,
                                       gpointer set_font_data,
                                       GtkSelectionData *selection);
static gboolean gimp_dnd_set_buffer_data(GtkWidget *widget, gint x, gint y,
                                         GCallback set_buffer_func,
                                         gpointer set_buffer_data,
                                         GtkSelectionData *selection);
static gboolean gimp_dnd_set_imagefile_data(GtkWidget *widget, gint x, gint y,
                                            GCallback set_imagefile_func,
                                            gpointer set_imagefile_data,
                                            GtkSelectionData *selection);
static gboolean gimp_dnd_set_template_data(GtkWidget *widget, gint x, gint y,
                                           GCallback set_template_func,
                                           gpointer set_template_data,
                                           GtkSelectionData *selection);
static gboolean gimp_dnd_set_tool_item_data(GtkWidget *widget, gint x, gint y,
...
static const GimpDndDataDef dnd_data_defs[] = {
    ...
    {GIMP_TARGET_URI_LIST,
     ...
     "gimp-dnd-get-uri-list-func", "gimp-dnd-get-uri-list-data",

     "gimp-dnd-set-uri-list-func", "gimp-dnd-set-uri-list-data",

     NULL, gimp_dnd_get_uri_list_data, gimp_dnd_set_uri_list_data},
    ...
    {GIMP_TARGET_TEXT_PLAIN,
     ...
     NULL, NULL, gimp_dnd_set_uri_list_data},
    ...
    {GIMP_TARGET_XDS,
     ...
     "gimp-dnd-get-xds-func", "gimp-dnd-get-xds-data",

     NULL, NULL,

     gimp_dnd_get_viewable_icon, gimp_dnd_get_xds_data, NULL},

    {GIMP_TARGET_COLOR,

     "gimp-dnd-get-color-func", "gimp-dnd-get-color-data",

     "gimp-dnd-set-color-func", "gimp-dnd-set-color-data",

     gimp_dnd_get_color_icon, gimp_dnd_get_color_data, gimp_dnd_set_color_data},

    {GIMP_TARGET_SVG,

     "gimp-dnd-get-svg-func", "gimp-dnd-get-svg-data",

     "gimp-dnd-set-svg-func", "gimp-dnd-set-svg-data",

     gimp_dnd_get_viewable_icon, gimp_dnd_get_stream_data,
     gimp_dnd_set_stream_data},

    {GIMP_TARGET_SVG_XML,

     "gimp-dnd-get-svg-xml-func", "gimp-dnd-get-svg-xml-data",
    ...
    {GIMP_TARGET_PIXBUF,
     ...
     "gimp-dnd-get-pixbuf-func", "gimp-dnd-get-pixbuf-data",

     "gimp-dnd-set-pixbuf-func", "gimp-dnd-set-pixbuf-data",

     gimp_dnd_get_viewable_icon, gimp_dnd_get_pixbuf_data,
    ...
    {GIMP_TARGET_BRUSH,
     ...
     "gimp-dnd-get-brush-func", "gimp-dnd-get-brush-data",

     "gimp-dnd-set-brush-func", "gimp-dnd-set-brush-data",

     gimp_dnd_get_viewable_icon, gimp_dnd_get_object_data,
     gimp_dnd_set_brush_data},

    {GIMP_TARGET_PATTERN,

     "gimp-dnd-get-pattern-func", "gimp-dnd-get-pattern-data",

     "gimp-dnd-set-pattern-func", "gimp-dnd-set-pattern-data",
    ...
    {GIMP_TARGET_GRADIENT,
     ...
     "gimp-dnd-get-gradient-func", "gimp-dnd-get-gradient-data",

     "gimp-dnd-set-gradient-func", "gimp-dnd-set-gradient-data",
    ...
    {GIMP_TARGET_PALETTE,
     ...
     "gimp-dnd-get-palette-func", "gimp-dnd-get-palette-data",

     "gimp-dnd-set-palette-func", "gimp-dnd-set-palette-data",
    ...
    {GIMP_TARGET_FONT,
     ...
     "gimp-dnd-get-font-func", "gimp-dnd-get-font-data",

     "gimp-dnd-set-font-func", "gimp-dnd-set-font-data",
    ...
    {GIMP_TARGET_BUFFER,
     ...
     "gimp-dnd-get-buffer-func", "gimp-dnd-get-buffer-data",
    ...
    {GIMP_TARGET_TEMPLATE,
     ...
     "gimp-dnd-get-template-func", "gimp-dnd-get-template-data",

     "gimp-dnd-set-template-func", "gimp-dnd-set-template-data",
    ...
    {GIMP_TARGET_TOOL_ITEM,
     ...
     "gimp-dnd-get-tool-item-func", "gimp-dnd-get-tool-item-data",

     "gimp-dnd-set-tool-item-func", "gimp-dnd-set-tool-item-data",
...
static void gimp_dnd_target_list_add(GtkTargetList *list,
...
static void gimp_dnd_data_drag_begin(GtkWidget *widget, GdkDragContext *context,
                                     gpointer data) {
  ...
  data_type = GPOINTER_TO_INT(
      g_object_get_data(G_OBJECT(widget), "gimp-dnd-get-data-type"));
  ...
  if (dnd_data->get_data_func_name)
    get_data_func =
        g_object_get_data(G_OBJECT(widget), dnd_data->get_data_func_name);

  if (dnd_data->get_data_data_name)
    get_data_data =
        g_object_get_data(G_OBJECT(widget), dnd_data->get_data_data_name);

  if (!get_data_func)
    return;

  icon_widget =
      dnd_data->get_icon_func(widget, context, get_data_func, get_data_data);
  ...
  if (icon_widget) {
    ...
    g_object_set_data_full(G_OBJECT(widget), "gimp-dnd-data-widget", window,
                           (GDestroyNotify)gtk_widget_destroy);

    gtk_drag_set_icon_widget(context, window, DRAG_ICON_OFFSET,
                             DRAG_ICON_OFFSET);
...
static void gimp_dnd_data_drag_end(GtkWidget *widget, GdkDragContext *context) {
  GimpDndType data_type;
  GtkWidget *icon_widget;
  ...
  if (icon_widget) {
     ...
     */
    if (g_object_get_data(G_OBJECT(icon_widget), "gimp-gdk-drag-context") ==
        (gpointer)context) {
...
static void gimp_dnd_data_drag_handle(GtkWidget *widget,
                                      GdkDragContext *context,
  ...
  for (data_type = GIMP_DND_TYPE_NONE + 1; data_type <= GIMP_DND_TYPE_LAST;
       data_type++) {
    ...
    if (dnd_data->target_entry.info == info) {
      ...
      dnd_data->get_data_func(widget, context, get_data_func, get_data_data,
                              selection_data);
...
static void gimp_dnd_data_drop_handle(GtkWidget *widget,
  ...
  for (data_type = GIMP_DND_TYPE_NONE + 1; data_type <= GIMP_DND_TYPE_LAST;
    ...
    if (dnd_data->target_entry.info == info) {
      ...
      if (dnd_data->set_data_func_name)
        set_data_func =
            g_object_get_data(G_OBJECT(widget), dnd_data->set_data_func_name);

      if (dnd_data->set_data_data_name)
        set_data_data =
            g_object_get_data(G_OBJECT(widget), dnd_data->set_data_data_name);

      if (set_data_func &&
          dnd_data->set_data_func(widget, x, y, set_data_func, set_data_data,
                                  selection_data)) {
...
static void gimp_dnd_data_source_add(GimpDndType data_type, GtkWidget *widget,
                                     GCallback get_data_func,
                                     gpointer get_data_data) {
  const GimpDndDataDef *dnd_data;
  ...
  if (!g_object_get_data(G_OBJECT(widget), "gtk-site-data"))
    gtk_drag_source_set(widget, GDK_BUTTON1_MASK | GDK_BUTTON2_MASK, NULL, 0,
                        GDK_ACTION_COPY | GDK_ACTION_MOVE);

  drag_connected = GPOINTER_TO_INT(
      g_object_get_data(G_OBJECT(widget), "gimp-dnd-drag-connected"));

  if (!drag_connected) {
    g_signal_connect(widget, "drag-begin", G_CALLBACK(gimp_dnd_data_drag_begin),
                     NULL);
    g_signal_connect(widget, "drag-end", G_CALLBACK(gimp_dnd_data_drag_end),
                     NULL);
    g_signal_connect(widget, "drag-data-get",
                     G_CALLBACK(gimp_dnd_data_drag_handle), NULL);
...
static gboolean gimp_dnd_data_source_remove(GimpDndType data_type,
                                            GtkWidget *widget) {
  const GimpDndDataDef *dnd_data;
  gboolean drag_connected;
  ...
  if (data_type == GPOINTER_TO_INT(g_object_get_data(G_OBJECT(widget),
...
static void gimp_dnd_data_dest_add(GimpDndType data_type, GtkWidget *widget,
  ...
  drop_connected = GPOINTER_TO_INT(
      g_object_get_data(G_OBJECT(widget), "gimp-dnd-drop-connected"));

  if (set_data_func && !drop_connected) {
    g_signal_connect(widget, "drag-data-received",
                     G_CALLBACK(gimp_dnd_data_drop_handle), NULL);
...
static void gimp_dnd_data_dest_remove(GimpDndType data_type,
                                      GtkWidget *widget) {
  const GimpDndDataDef *dnd_data;
...
static void gimp_dnd_get_uri_list_data(GtkWidget *widget,
  ...
  uri_list =
      (*(GimpDndDragUriListFunc)get_uri_list_func)(widget, get_uri_list_data);
...
void gimp_dnd_uri_list_source_add(GtkWidget *widget,
  ...
  gimp_dnd_data_source_add(GIMP_DND_TYPE_URI_LIST, widget,
                           G_CALLBACK(get_uri_list_func), data);
}
...
void gimp_dnd_uri_list_dest_add(GtkWidget *widget,
  ...
  gimp_dnd_data_dest_add(GIMP_DND_TYPE_URI_LIST, widget,
                         G_CALLBACK(set_uri_list_func), data);
...
static void gimp_dnd_get_xds_data(GtkWidget *widget, GdkDragContext *context,
  ...
  if (!image)
    image = (GimpImage *)(*(GimpDndDragViewableFunc)get_image_func)(
        widget, &gimp_context, get_image_data);
...
static void gimp_dnd_xds_drag_begin(GtkWidget *widget,
                                    GdkDragContext *context) {
  ...
  if (get_data_func) {
    ...
    image = (GimpImage *)(*(GimpDndDragViewableFunc)get_data_func)(
        widget, &gimp_context, get_data_data);
...
static void gimp_dnd_xds_drag_end(GtkWidget *widget, GdkDragContext *context) {
...
void gimp_dnd_xds_source_add(GtkWidget *widget,
  ...
  gimp_dnd_data_source_add(GIMP_DND_TYPE_XDS, widget,
                           G_CALLBACK(get_image_func), data);

  handler = GPOINTER_TO_UINT(
      g_object_get_data(G_OBJECT(widget), "gimp-dnd-xds-drag-begin"));

  if (!handler) {
    handler = g_signal_connect(widget, "drag-begin",
                               G_CALLBACK(gimp_dnd_xds_drag_begin), NULL);
    g_object_set_data(G_OBJECT(widget), "gimp-dnd-xds-drag-begin",
                      GUINT_TO_POINTER(handler));
  }

  handler = GPOINTER_TO_UINT(
      g_object_get_data(G_OBJECT(widget), "gimp-dnd-xds-drag-end"));

  if (!handler) {
    handler = g_signal_connect(widget, "drag-end",
                               G_CALLBACK(gimp_dnd_xds_drag_end), NULL);
...
static GtkWidget *gimp_dnd_get_color_icon(GtkWidget *widget,
  ...
  g_object_set_data_full(G_OBJECT(context), "gimp-dnd-color",
                         g_memdup(&color, sizeof(GimpRGB)),
...
static gboolean gimp_dnd_set_color_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropColorFunc)set_color_func)(widget, x, y, &color, set_color_data);
...
void gimp_dnd_color_source_add(GtkWidget *widget,
  ...
  gimp_dnd_data_source_add(GIMP_DND_TYPE_COLOR, widget,
                           G_CALLBACK(get_color_func), data);
}
...
void gimp_dnd_color_dest_add(GtkWidget *widget,
  ...
  gimp_dnd_data_dest_add(GIMP_DND_TYPE_COLOR, widget,
                         G_CALLBACK(set_color_func), data);
}
...
static gboolean gimp_dnd_set_stream_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropStreamFunc)set_stream_func)(widget, x, y, stream, stream_length,
                                            set_stream_data);
...
void gimp_dnd_svg_source_add(GtkWidget *widget,
  ...
  gimp_dnd_data_source_add(GIMP_DND_TYPE_SVG, widget, G_CALLBACK(get_svg_func),
                           data);
  gimp_dnd_data_source_add(GIMP_DND_TYPE_SVG_XML, widget,
                           G_CALLBACK(get_svg_func), data);
}
...
void gimp_dnd_svg_dest_add(GtkWidget *widget,
                           GimpDndDropStreamFunc set_svg_func, gpointer data) {
  g_return_if_fail(GTK_IS_WIDGET(widget));

  gimp_dnd_data_dest_add(GIMP_DND_TYPE_SVG, widget, G_CALLBACK(set_svg_func),
                         data);
  gimp_dnd_data_dest_add(GIMP_DND_TYPE_SVG_XML, widget,
                         G_CALLBACK(set_svg_func), data);
}
...
static void gimp_dnd_get_pixbuf_data(GtkWidget *widget, GdkDragContext *context,
  ...
  pixbuf = (*(GimpDndDragPixbufFunc)get_pixbuf_func)(widget, get_pixbuf_data);
...
static gboolean gimp_dnd_set_pixbuf_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropPixbufFunc)set_pixbuf_func)(widget, x, y, pixbuf,
                                            set_pixbuf_data);
...
void gimp_dnd_pixbuf_source_add(GtkWidget *widget,
  ...
  gimp_dnd_data_source_add(GIMP_DND_TYPE_PIXBUF, widget,
                           G_CALLBACK(get_pixbuf_func), data);
...
void gimp_dnd_pixbuf_dest_add(GtkWidget *widget,
  ...
  gimp_dnd_data_dest_add(GIMP_DND_TYPE_PIXBUF, widget,
                         G_CALLBACK(set_pixbuf_func), data);
...
static GtkWidget *gimp_dnd_get_component_icon(GtkWidget *widget,
  ...
  g_object_set_data_full(G_OBJECT(context), "gimp-dnd-viewable",
                         g_object_ref(image), (GDestroyNotify)g_object_unref);
  g_object_set_data(G_OBJECT(context), "gimp-dnd-component",
                    GINT_TO_POINTER(channel));

  view = gimp_view_new(gimp_context, GIMP_VIEWABLE(image), DRAG_PREVIEW_SIZE, 0,
                       TRUE);
...
static void gimp_dnd_get_component_data(GtkWidget *widget,
  ...
  image = g_object_get_data(G_OBJECT(context), "gimp-dnd-viewable");
  channel = GPOINTER_TO_INT(
      g_object_get_data(G_OBJECT(context), "gimp-dnd-component"));
...
static gboolean gimp_dnd_set_component_data(GtkWidget *widget, gint x, gint y,
  ...
  image = gimp_selection_data_get_component(selection, the_dnd_gimp, &channel);
  ...
  (*(GimpDndDropComponentFunc)set_comp_func)(widget, x, y, image, channel,
                                             set_comp_data);
...
static GtkWidget *gimp_dnd_get_viewable_icon(GtkWidget *widget,
  ...
  viewable = (*(GimpDndDragViewableFunc)get_viewable_func)(
      widget, &gimp_context, get_viewable_data);
  ...
  g_object_set_data_full(G_OBJECT(context), "gimp-dnd-viewable",
                         g_object_ref(viewable),
                         (GDestroyNotify)g_object_unref);

  view = gimp_view_new(gimp_context, viewable, DRAG_PREVIEW_SIZE, 0, TRUE);
  ...
  if (desc) {
    ...
    label = g_object_new(GTK_TYPE_LABEL, "label", desc, "xalign", 0.0, "yalign",
                         0.5, "max-width-chars", 30, "width-chars",
                         MIN(strlen(desc), 10), "ellipsize",
...
static GimpDndType gimp_dnd_data_type_get_by_g_type(GType type, gboolean list) {
...
gboolean gimp_dnd_drag_source_set_by_type(GtkWidget *widget,
  ...
  gtk_drag_source_set(widget, start_button_mask,
                      &dnd_data_defs[dnd_type].target_entry, 1, actions);

  return TRUE;
}

gboolean gimp_dnd_drag_dest_set_by_type(GtkWidget *widget,
                                        GtkDestDefaults flags, GType type,
  ...
  gtk_drag_dest_set(widget, flags, (const GtkTargetEntry *)&target_entries,
                    target_entries_n, actions);
 ...
 */
gboolean gimp_dnd_viewable_source_add(GtkWidget *widget, GType type,
  ...
  gimp_dnd_data_source_add(dnd_type, widget, G_CALLBACK(get_viewable_func),
                           data);

  return TRUE;
}

gboolean gimp_dnd_viewable_source_remove(GtkWidget *widget, GType type) {
  GimpDndType dnd_type;
...
gboolean gimp_dnd_viewable_dest_add(GtkWidget *widget, GType type,
  ...
  gimp_dnd_data_dest_add(dnd_type, widget, G_CALLBACK(set_viewable_func), data);

  return TRUE;
}

gboolean gimp_dnd_viewable_dest_remove(GtkWidget *widget, GType type) {
  GimpDndType dnd_type;
...
static GtkWidget *gimp_dnd_get_viewable_list_icon(GtkWidget *widget,
  ...
  viewables = (*(GimpDndDragViewableListFunc)get_list_func)(
      widget, &gimp_context, get_list_data);
  ...
  if (desc) {
    ...
    label = g_object_new(GTK_TYPE_LABEL, "label", desc, "use-markup",
                         desc_use_markup, "xalign", 0.0, "yalign", desc_yalign,
                         "max-width-chars", 30, "width-chars", desc_width_chars,
 ...
 * far).
 */
gboolean gimp_dnd_viewable_list_source_add(
    GtkWidget *widget, GType type,
    GimpDndDragViewableListFunc get_viewable_list_func, gpointer data) {
  GimpDndType dnd_type;
  ...
  gimp_dnd_data_source_add(dnd_type, widget, G_CALLBACK(get_viewable_list_func),
                           data);

  return TRUE;
}

gboolean gimp_dnd_viewable_list_source_remove(GtkWidget *widget, GType type) {
  GimpDndType dnd_type;
...
gboolean
gimp_dnd_viewable_list_dest_add(GtkWidget *widget, GType type,
...
gboolean gimp_dnd_viewable_list_dest_remove(GtkWidget *widget, GType type) {
  GimpDndType dnd_type;
...
static gboolean gimp_dnd_set_image_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropViewableFunc)set_image_func)(widget, x, y, GIMP_VIEWABLE(image),
                                             set_image_data);
...
static void gimp_dnd_get_item_data(GtkWidget *widget, GdkDragContext *context,
  ...
  if (!item)
    item = (GimpItem *)(*(GimpDndDragViewableFunc)get_item_func)(
        widget, &gimp_context, get_item_data);
...
static gboolean gimp_dnd_set_item_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropViewableFunc)set_item_func)(widget, x, y, GIMP_VIEWABLE(item),
                                            set_item_data);
...
static void gimp_dnd_get_object_data(GtkWidget *widget, GdkDragContext *context,
  ...
  if (!object)
    object = (GimpObject *)(*(GimpDndDragViewableFunc)get_object_func)(
        widget, &gimp_context, get_object_data);
...
static gboolean gimp_dnd_set_brush_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropViewableFunc)set_brush_func)(widget, x, y, GIMP_VIEWABLE(brush),
                                             set_brush_data);
...
static gboolean gimp_dnd_set_pattern_data(GtkWidget *widget, gint x, gint y,
                                          ...
                                          GtkSelectionData *selection) {
  GimpPattern *pattern =
      gimp_selection_data_get_pattern(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_pattern_func)(
      widget, x, y, GIMP_VIEWABLE(pattern), set_pattern_data);
...
static gboolean gimp_dnd_set_gradient_data(GtkWidget *widget, gint x, gint y,
  ...
  GimpGradient *gradient =
      gimp_selection_data_get_gradient(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_gradient_func)(
      widget, x, y, GIMP_VIEWABLE(gradient), set_gradient_data);
...
static gboolean gimp_dnd_set_palette_data(GtkWidget *widget, gint x, gint y,
                                          ...
                                          GtkSelectionData *selection) {
  GimpPalette *palette =
      gimp_selection_data_get_palette(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_palette_func)(
      widget, x, y, GIMP_VIEWABLE(palette), set_palette_data);
...
static gboolean gimp_dnd_set_font_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropViewableFunc)set_font_func)(widget, x, y, GIMP_VIEWABLE(font),
                                            set_font_data);
...
static gboolean gimp_dnd_set_buffer_data(GtkWidget *widget, gint x, gint y,
  ...
  (*(GimpDndDropViewableFunc)set_buffer_func)(
      widget, x, y, GIMP_VIEWABLE(buffer), set_buffer_data);
...
static gboolean gimp_dnd_set_imagefile_data(GtkWidget *widget, gint x, gint y,
  ...
  GimpImagefile *imagefile =
      gimp_selection_data_get_imagefile(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_imagefile_func)(
      widget, x, y, GIMP_VIEWABLE(imagefile), set_imagefile_data);
...
static gboolean gimp_dnd_set_template_data(GtkWidget *widget, gint x, gint y,
  ...
  GimpTemplate *template =
      gimp_selection_data_get_template(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_template_func)(
      widget, x, y, GIMP_VIEWABLE(template), set_template_data);
...
static gboolean gimp_dnd_set_tool_item_data(GtkWidget *widget, gint x, gint y,
  ...
  GimpToolItem *tool_item =
      gimp_selection_data_get_tool_item(selection, the_dnd_gimp);
  ...
  (*(GimpDndDropViewableFunc)set_tool_item_func)(
      widget, x, y, GIMP_VIEWABLE(tool_item), set_tool_item_data);
