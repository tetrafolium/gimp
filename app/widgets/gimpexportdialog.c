...
G_DEFINE_TYPE(GimpExportDialog, gimp_export_dialog, GIMP_TYPE_FILE_DIALOG)

#define parent_class gimp_export_dialog_parent_class

static void gimp_export_dialog_class_init(GimpExportDialogClass *klass) {}

static void gimp_export_dialog_init(GimpExportDialog *dialog) {}
...
GtkWidget *gimp_export_dialog_new(Gimp *gimp) {
  ...
  return g_object_new(GIMP_TYPE_EXPORT_DIALOG, "gimp", gimp, "title",
                      _("Export Image"), "role", "gimp-file-export", "help-id",
                      GIMP_HELP_FILE_EXPORT_AS, "ok-button-label", _("_Export"),
                      ...
                      GIMP_FILE_PROCEDURE_GROUP_EXPORT, "file-procs-all-images",
                      GIMP_FILE_PROCEDURE_GROUP_SAVE, "file-filter-label",
                      _("All export images"), NULL);
}
...
void gimp_export_dialog_set_image(GimpExportDialog *dialog, GimpImage *image) {
  ...
  if (ext_file) {
    ...
    gimp_enum_get_value(GIMP_TYPE_EXPORT_FILE_TYPE,
                        image->gimp->config->export_file_type, NULL, &extension,
                        NULL, NULL);

    uri = g_strconcat("file:///we/only/care/about/extension.", extension, NULL);
