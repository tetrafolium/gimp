...
static void gimp_pattern_select_init(GimpPatternSelect *select) {}
...
static void gimp_pattern_select_constructed(GObject *object) {
  ...
  dialog->view = gimp_pattern_factory_view_new(
      GIMP_VIEW_TYPE_GRID, dialog->context->gimp->pattern_factory,
...
static GimpValueArray *gimp_pattern_select_run_callback(GimpPdbDialog *dialog,
  ...
  format = gimp_babl_compat_u8_format(gimp_temp_buf_get_format(pattern->mask));
  ...
  return_vals = gimp_pdb_execute_procedure_by_name(
      ...
      gimp_temp_buf_get_width(pattern->mask), G_TYPE_INT,
      gimp_temp_buf_get_height(pattern->mask), G_TYPE_INT,
      babl_format_get_bytes_per_pixel(gimp_temp_buf_get_format(pattern->mask)),
