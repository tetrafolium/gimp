...
G_DECLARE_INTERFACE(GimpSessionManaged, gimp_session_managed, GIMP,
                    SESSION_MANAGED, GtkWidget)
...
struct _GimpSessionManagedInterface {
  ...
  void (*set_aux_info)(GimpSessionManaged *session_managed, GList *aux_info);
};
