...
#define GIMP_DIAL(obj)                                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DIAL, GimpDial))
#define GIMP_DIAL_CLASS(klass)                                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DIAL, GimpDialClass))
#define GIMP_IS_DIAL(obj) (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_DIAL))
#define GIMP_IS_DIAL_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DIAL))
#define GIMP_DIAL_GET_CLASS(obj)                                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DIAL, GimpDialClass))
