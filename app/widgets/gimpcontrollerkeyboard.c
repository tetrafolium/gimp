...
static KeyboardEvent keyboard_events[] = {
    {GDK_KEY_Up, NULL, 0, "cursor-up", N_("Cursor Up")},
    {GDK_KEY_Up, "<Shift>", 0, "cursor-up-shift", N_("Cursor Up")},
    {GDK_KEY_Up, "<Primary>", 0, "cursor-up-primary", N_("Cursor Up")},
    {GDK_KEY_Up, "<Alt>", 0, "cursor-up-alt", N_("Cursor Up")},
    {GDK_KEY_Up, "<Shift><Primary>", 0, "cursor-up-shift-primary",
     N_("Cursor Up")},
    {GDK_KEY_Up, "<Shift><Alt>", 0, "cursor-up-shift-alt", N_("Cursor Up")},
    {GDK_KEY_Up, "<Primary><Alt>", 0, "cursor-up-primary-alt", N_("Cursor Up")},
    {GDK_KEY_Up, "<Shift><Primary><Alt>", 0, "cursor-up-shift-primary-alt",
     N_("Cursor Up")},

    {GDK_KEY_Down, NULL, 0, "cursor-down", N_("Cursor Down")},
    {GDK_KEY_Down, "<Shift>", 0, "cursor-down-shift", N_("Cursor Down")},
    {GDK_KEY_Down, "<Primary>", 0, "cursor-down-primary", N_("Cursor Down")},
    {GDK_KEY_Down, "<Alt>", 0, "cursor-down-alt", N_("Cursor Down")},
    {GDK_KEY_Down, "<Shift><Primary>", 0, "cursor-down-shift-primary",
     N_("Cursor Down")},
    {GDK_KEY_Down, "<Shift><Alt>", 0, "cursor-down-shift-alt",
     N_("Cursor Down")},
    {GDK_KEY_Down, "<Primary><Alt>", 0, "cursor-down-primary-alt",
     N_("Cursor Down")},
    {GDK_KEY_Down, "<Shift><Primary><Alt>", 0, "cursor-down-shift-primary-alt",
     N_("Cursor Down")},

    {GDK_KEY_Left, NULL, 0, "cursor-left", N_("Cursor Left")},
    {GDK_KEY_Left, "<Shift>", 0, "cursor-left-shift", N_("Cursor Left")},
    {GDK_KEY_Left, "<Primary>", 0, "cursor-left-primary", N_("Cursor Left")},
    {GDK_KEY_Left, "<Alt>", 0, "cursor-left-alt", N_("Cursor Left")},
    {GDK_KEY_Left, "<Shift><Primary>", 0, "cursor-left-shift-primary",
     N_("Cursor Left")},
    {GDK_KEY_Left, "<Shift><Alt>", 0, "cursor-left-shift-alt",
     N_("Cursor Left")},
    {GDK_KEY_Left, "<Primary><Alt>", 0, "cursor-left-primary-alt",
     N_("Cursor Left")},
    {GDK_KEY_Left, "<Shift><Primary><Alt>", 0, "cursor-left-shift-primary-alt",
     N_("Cursor Left")},

    {GDK_KEY_Right, NULL, 0, "cursor-right", N_("Cursor Right")},
    {GDK_KEY_Right, "<Shift>", 0, "cursor-right-shift", N_("Cursor Right")},
    {GDK_KEY_Right, "<Primary>", 0, "cursor-right-primary", N_("Cursor Right")},
    {GDK_KEY_Right, "<Alt>", 0, "cursor-right-alt", N_("Cursor Right")},
    {GDK_KEY_Right, "<Shift><Primary>", 0, "cursor-right-shift-primary",
     N_("Cursor Right")},
    {GDK_KEY_Right, "<Shift><Alt>", 0, "cursor-right-shift-alt",
     N_("Cursor Right")},
    {GDK_KEY_Right, "<Primary><Alt>", 0, "cursor-right-primary-alt",
     N_("Cursor Right")},
    {GDK_KEY_Right, "<Shift><Primary><Alt>", 0,
     "cursor-right-shift-primary-alt", N_("Cursor Right")}};
  ...
  if (!event_names_initialized) {
    ...
    for (i = 0; i < G_N_ELEMENTS(keyboard_events); i++) {
      ...
      if (kevent->modifiers != 0) {
        kevent->blurb = g_strdup_printf("%s (%s)", gettext(kevent->blurb),
...
static void gimp_controller_keyboard_constructed(GObject *object) {
  ...
  g_object_set(object, "name", _("Keyboard Events"), "state", _("Ready"), NULL);
}
