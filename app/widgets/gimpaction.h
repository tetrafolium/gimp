...
#define GIMP_ACTION(obj)                                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ACTION, GimpAction))
#define GIMP_IS_ACTION(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_ACTION))
#define GIMP_ACTION_GET_INTERFACE(obj)                                         \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), GIMP_TYPE_ACTION, GimpActionInterface))
...
struct _GimpActionInterface {
  ...
  void (*activate)(GimpAction *action, GVariant *value);
  void (*change_state)(GimpAction *action, GVariant *value);
};
