...
#define GIMP_COLOR_FRAME(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLOR_FRAME, GimpColorFrame))
#define GIMP_COLOR_FRAME_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLOR_FRAME, GimpColorFrameClass))
#define GIMP_IS_COLOR_FRAME(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLOR_FRAME))
#define GIMP_IS_COLOR_FRAME_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLOR_FRAME))
#define GIMP_COLOR_FRAME_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLOR_FRAME, GimpColorFrameClass))
