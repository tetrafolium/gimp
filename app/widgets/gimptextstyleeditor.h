...
#define GIMP_TEXT_STYLE_EDITOR(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TEXT_STYLE_EDITOR,              \
                              GimpTextStyleEditor))
#define GIMP_TEXT_STYLE_EDITOR_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TEXT_STYLE_EDITOR,               \
                           GimpTextStyleEditorClass))
#define GIMP_IS_TEXT_STYLE_EDITOR(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TEXT_STYLE_EDITOR))
#define GIMP_IS_TEXT_STYLE_EDITOR_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TEXT_STYLE_EDITOR))
#define GIMP_TEXT_STYLE_EDITOR_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TEXT_STYLE_EDITOR,               \
                             GimpTextStyleEditorClass))
