...
typedef enum /*< skip >*/
{ GIMP_VIEW_BG_CHECKS,
  GIMP_VIEW_BG_WHITE } GimpViewBG;

typedef enum /*< skip >*/
{ GIMP_VIEW_BORDER_BLACK,
  GIMP_VIEW_BORDER_WHITE,
  GIMP_VIEW_BORDER_RED,
  GIMP_VIEW_BORDER_GREEN } GimpViewBorderType;
...
{ GIMP_DND_TYPE_NONE = 0,
  ...
  GIMP_DND_TYPE_LAST = GIMP_DND_TYPE_LAYER_LIST } GimpDndType;

typedef enum /*< skip >*/
{ GIMP_DROP_NONE,
  GIMP_DROP_ABOVE,
  GIMP_DROP_BELOW } GimpDropType;
...
{ GIMP_CURSOR_NONE = 1024, /* (GDK_LAST_CURSOR + 2) yes, this is insane */
  ...
  GIMP_CURSOR_LAST } GimpCursorType;
...
{ GIMP_TOOL_CURSOR_NONE,
  ...
  GIMP_TOOL_CURSOR_LAST } GimpToolCursorType;
...
{ GIMP_CURSOR_MODIFIER_NONE,
  ...
  GIMP_CURSOR_MODIFIER_LAST } GimpCursorModifier;
...
{ GIMP_DEVICE_VALUE_MODE = 1 << 0,
  ...
  GIMP_DEVICE_VALUE_GRADIENT = 1 << 8 } GimpDeviceValues;
...
{ GIMP_DASHBOARD_UPDATE_INTERVAL_0_25_SEC = 250,
  ...
  GIMP_DASHBOARD_UPDATE_INTERVAL_4_SEC = 4000 } GimpDashboardUpdateInteval;
