...
GtkWidget *gimp_prop_expanding_frame_new(GObject *config,
                                         ...
                                         GtkWidget *child, GtkWidget **button) {
  GParamSpec *param_spec;
  GtkWidget *frame;
  GtkWidget *toggle;
  ...
  g_object_bind_property(G_OBJECT(config), property_name, G_OBJECT(child),
...
GtkWidget *gimp_prop_boolean_icon_box_new(GObject *config,
  ...
  g_object_set_data(G_OBJECT(button), "gimp-item-data", GINT_TO_POINTER(TRUE));
  ...
  g_object_set_data(G_OBJECT(button), "gimp-item-data", GINT_TO_POINTER(FALSE));
...
GtkWidget *gimp_prop_layer_mode_box_new(GObject *config,
  ...
  g_object_bind_property(config, property_name, G_OBJECT(box), "layer-mode",
...
static void gimp_prop_color_button_callback(GtkWidget *widget, GObject *config);
...
GtkWidget *gimp_prop_color_button_new(GObject *config,
                                      const gchar *property_name,
                                      const gchar *title, gint width,
                                      gint height, GimpColorAreaType type) {
  GParamSpec *param_spec;
  GtkWidget *button;
  GimpRGB *value;
  ...
  connect_notify(config, property_name,
                 G_CALLBACK(gimp_prop_color_button_notify), button);
...
static void gimp_prop_color_button_callback(GtkWidget *button,
                                            GObject *config) {
  GParamSpec *param_spec;
  GimpRGB value;
  ...
  g_signal_handlers_block_by_func(config, gimp_prop_color_button_notify,
                                  button);

  g_object_set(config, param_spec->name, &value, NULL);

  g_signal_handlers_unblock_by_func(config, gimp_prop_color_button_notify,
                                    button);
}
...
static void gimp_prop_color_button_notify(GObject *config,
  ...
  g_signal_handlers_block_by_func(button, gimp_prop_color_button_callback,
                                  config);
  ...
  g_signal_handlers_unblock_by_func(button, gimp_prop_color_button_callback,
                                    config);
}
 ...
 * Since GIMP 2.8
 */
GtkWidget *gimp_prop_spin_scale_new(GObject *config, const gchar *property_name,
                                    const gchar *label, gdouble step_increment,
  ...
  if (!_gimp_prop_widgets_get_numeric_values(config, param_spec, &value, &lower,
                                             &upper, G_STRFUNC))
    return NULL;
  ...
  if (GEGL_IS_PARAM_SPEC_DOUBLE(param_spec)) {
    ...
    gimp_spin_scale_set_scale_limits(GIMP_SPIN_SCALE(scale), gspec->ui_minimum,
                                     gspec->ui_maximum);
...
void gimp_prop_widget_set_factor(GtkWidget *widget, gdouble factor,
  ...
  if (factor_store) {
    ...
    g_object_set_data_full(G_OBJECT(adjustment), "gimp-prop-adjustment-factor",
  ...
  *factor_store = factor;
  ...
  gtk_adjustment_configure(adjustment, f * gtk_adjustment_get_value(adjustment),
...
static gboolean deg_to_rad(GBinding *binding, const GValue *from_value,
...
static gboolean rad_to_deg(GBinding *binding, const GValue *from_value,
                           GValue *to_value, gpointer user_data) {
  gdouble *lower = user_data;
  gdouble value = g_value_get_double(from_value);
...
GtkWidget *gimp_prop_angle_dial_new(GObject *config,
  ...
  g_object_set(dial, "size", 32, "background", GIMP_CIRCLE_BACKGROUND_PLAIN,
               "draw-beta", FALSE, NULL);

  set_param_spec(G_OBJECT(dial), dial, param_spec);

  if (lower == 0.0 && upper == 2 * G_PI) {
    g_object_bind_property(config, property_name, dial, "alpha",
                           G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
    ...
    *l = lower;
    ...
    g_object_bind_property_full(config, property_name, dial, "alpha",
                                G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE,
                                deg_to_rad, rad_to_deg, l,
...
GtkWidget *gimp_prop_angle_range_dial_new(
    GObject *config, const gchar *alpha_property_name,
    const gchar *beta_property_name, const gchar *clockwise_property_name) {
  ...
  clockwise_param_spec =
      find_param_spec(config, clockwise_property_name, G_STRFUNC);
  if (!clockwise_param_spec)
    return NULL;

  dial = gimp_dial_new();

  g_object_set(dial, "size", 96, "border-width", 0, "background",
               GIMP_CIRCLE_BACKGROUND_HSV, NULL);

  g_object_bind_property_full(config, alpha_property_name, dial, "alpha",
                              G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE,
                              deg_to_rad, rad_to_deg, NULL, NULL);

  g_object_bind_property_full(config, beta_property_name, dial, "beta",
                              G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE,
                              deg_to_rad, rad_to_deg, NULL, NULL);

  g_object_bind_property(config, clockwise_property_name, dial,
                         "clockwise-delta",
                         G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
...
GtkWidget *gimp_prop_polar_new(GObject *config,
  ...
  g_object_set(polar, "size", 90, "border-width", 3, "background",
               GIMP_CIRCLE_BACKGROUND_HSV, NULL);

  g_object_bind_property_full(config, angle_property_name, polar, "angle",
                              G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE,
                              deg_to_rad, rad_to_deg, NULL, NULL);

  g_object_bind_property(config, radius_property_name, polar, "radius",
                         G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
...
GtkWidget *gimp_prop_range_new(GObject *config,
  ...
  spin_button = gimp_prop_spin_button_new(
      config, lower_property_name, step_increment, page_increment, digits);
  ...
  spin_button = gimp_prop_spin_button_new(
      config, upper_property_name, step_increment, page_increment, digits);
...
void gimp_prop_range_set_ui_limits(GtkWidget *widget, gdouble lower,
                                   gdouble upper) {
...
static void gimp_prop_view_drop(GtkWidget *menu, gint x, gint y,
                                GimpViewable *viewable, gpointer data);
static void gimp_prop_view_notify(GObject *config, GParamSpec *param_spec,
                                  GtkWidget *view);
 ...
 * Since GIMP 2.4
 */
GtkWidget *gimp_prop_view_new(GObject *config, const gchar *property_name,
                              GimpContext *context, gint size) {
  GParamSpec *param_spec;
  GtkWidget *view;
  GimpViewable *viewable;

  param_spec =
      check_param_spec_w(config, property_name, G_TYPE_PARAM_OBJECT, G_STRFUNC);
  if (!param_spec)
    return NULL;

  if (!g_type_is_a(param_spec->value_type, GIMP_TYPE_VIEWABLE)) {
    g_warning("%s: property '%s' of %s is not a GimpViewable", G_STRFUNC,
              property_name, g_type_name(G_TYPE_FROM_INSTANCE(config)));
    return NULL;
  }

  view = gimp_view_new_by_types(context, GIMP_TYPE_VIEW, param_spec->value_type,
                                size, 0, FALSE);

  if (!view) {
    g_warning("%s: cannot create view for type '%s'", G_STRFUNC,
              g_type_name(param_spec->value_type));
    return NULL;
  }

  g_object_get(config, property_name, &viewable, NULL);
  ...
  gimp_dnd_viewable_dest_add(view, param_spec->value_type, gimp_prop_view_drop,
                             config);

  connect_notify(config, property_name, G_CALLBACK(gimp_prop_view_notify),
                 view);
...
static void gimp_prop_view_drop(GtkWidget *view, gint x, gint y,
                                GimpViewable *viewable, gpointer data) {
  GObject *config;
  GParamSpec *param_spec;
  ...
  g_object_set(config, param_spec->name, viewable, NULL);
}
...
static void gimp_prop_view_notify(GObject *config, GParamSpec *param_spec,
  ...
  g_object_get(config, param_spec->name, &viewable, NULL);
...
static void gimp_prop_number_pair_entry_number_pair_numbers_changed(
    GtkWidget *widget, GimpPropNumberPairEntryData *data);
static void gimp_prop_number_pair_entry_number_pair_user_override_notify(
    GtkWidget *entry, GParamSpec *param_spec,
 ...
 * @default_left_number_property:  Name of double property for default left
 * number.
 * @default_right_number_property: Name of double property for default right
 * number.
 * @user_override_property:        Name of boolean property for user override
 * mode.
 * @connect_numbers_changed:       %TRUE to connect to the widgets
 * "numbers-changed" signal, %FALSE to not connect.
 * @connect_ratio_changed:         %TRUE to connect to the widgets
 * "ratio-changed" signal, %FALSE to not connect.
 * @separators:
...
GtkWidget *gimp_prop_number_pair_entry_new(
    GObject *config, const gchar *left_number_property,
    const gchar *right_number_property,
    const gchar *default_left_number_property,
    const gchar *default_right_number_property,
    const gchar *user_override_property, gboolean connect_numbers_changed,
    gboolean connect_ratio_changed, const gchar *separators,
    gboolean allow_simplification, gdouble min_valid_value,
  ...
  g_object_get(config, left_number_property, &left_number,
               ...
               user_override_property, &user_override, NULL);

  /* Create a GimpNumberPairEntry and setup with config property values */

  number_pair_entry = gimp_number_pair_entry_new(
      separators, allow_simplification, min_valid_value, max_valid_value);
  ...
  if (connect_ratio_changed)
    g_signal_connect(
        number_pair_entry, "ratio-changed",
        G_CALLBACK(gimp_prop_number_pair_entry_number_pair_numbers_changed),
        data);

  if (connect_numbers_changed)
    g_signal_connect(
        number_pair_entry, "numbers-changed",
        G_CALLBACK(gimp_prop_number_pair_entry_number_pair_numbers_changed),
        data);

  g_signal_connect(
      number_pair_entry, "notify::user-override",
...
static void gimp_prop_number_pair_entry_config_notify(
    GObject *config, GParamSpec *param_spec, GtkEntry *number_pair_entry) {
  GimpPropNumberPairEntryData *data = g_object_get_data(
      G_OBJECT(number_pair_entry), "gimp-prop-number-pair-entry-data");
  ...
  if (strcmp(param_spec->name, data->left_number_property) == 0 ||
    ...
    g_object_get(config, data->left_number_property, &left_number,
                 data->right_number_property, &right_number, NULL);

    gimp_number_pair_entry_set_values(GIMP_NUMBER_PAIR_ENTRY(number_pair_entry),
                                      left_number, right_number);
  } else if (strcmp(param_spec->name, data->default_left_number_property) ==
                 0 ||
             strcmp(param_spec->name, data->default_right_number_property) ==
                 0) {
    gdouble default_left_number;
    gdouble default_right_number;

    g_object_get(config, data->default_left_number_property,
                 &default_left_number, data->default_right_number_property,
                 &default_right_number, NULL);
    ...
    g_object_get(config, data->user_override_property, &user_override, NULL);
...
static void gimp_prop_number_pair_entry_number_pair_numbers_changed(
  ...
  g_object_set(data->config, data->left_number_property, left_number,
               data->right_number_property, right_number, NULL);
}

static void gimp_prop_number_pair_entry_number_pair_user_override_notify(
    GtkWidget *entry, GParamSpec *param_spec, GimpPropNumberPairEntryData *data)

{
  gboolean old_config_user_override;
  gboolean new_config_user_override;

  g_object_get(data->config, data->user_override_property,
               &old_config_user_override, NULL);
  ...
  if (new_config_user_override != old_config_user_override)
    g_object_set(data->config, data->user_override_property,
                 new_config_user_override, NULL);
}
...
GtkWidget *gimp_prop_language_combo_box_new(GObject *config,
  ...
  g_signal_connect(combo, "changed",
                   G_CALLBACK(gimp_prop_language_combo_box_callback), config);

  connect_notify(config, property_name,
                 G_CALLBACK(gimp_prop_language_combo_box_notify), combo);
...
static void gimp_prop_language_combo_box_callback(GtkWidget *combo,
  ...
  g_signal_handlers_block_by_func(config, gimp_prop_language_combo_box_notify,
                                  combo);

  g_object_set(config, param_spec->name, code, NULL);

  g_signal_handlers_unblock_by_func(config, gimp_prop_language_combo_box_notify,
                                    combo);
...
static void gimp_prop_language_combo_box_notify(GObject *config,
  ...
  g_signal_handlers_block_by_func(combo, gimp_prop_language_combo_box_callback,
                                  config);

  gimp_language_combo_box_set_code(GIMP_LANGUAGE_COMBO_BOX(combo), value);

  g_signal_handlers_unblock_by_func(
      combo, gimp_prop_language_combo_box_callback, config);
...
GtkWidget *gimp_prop_language_entry_new(GObject *config,
  ...
  g_signal_connect(entry, "changed",
                   G_CALLBACK(gimp_prop_language_entry_callback), config);

  connect_notify(config, property_name,
                 G_CALLBACK(gimp_prop_language_entry_notify), entry);
...
static void gimp_prop_language_entry_callback(GtkWidget *entry,
  ...
  g_signal_handlers_block_by_func(config, gimp_prop_language_entry_notify,
                                  entry);

  g_object_set(config, param_spec->name, code, NULL);

  g_signal_handlers_unblock_by_func(config, gimp_prop_language_entry_notify,
                                    entry);
}
...
static void gimp_prop_language_entry_notify(GObject *config,
  ...
  g_signal_handlers_block_by_func(entry, gimp_prop_language_entry_callback,
                                  config);

  gimp_language_entry_set_code(GIMP_LANGUAGE_ENTRY(entry), value);

  g_signal_handlers_unblock_by_func(entry, gimp_prop_language_entry_callback,
                                    config);
...
GtkWidget *gimp_prop_profile_combo_box_new(
    GObject *config, const gchar *property_name, GtkListStore *profile_store,
    const gchar *dialog_title, GObject *profile_path_config,
  ...
  if (G_IS_PARAM_SPEC_STRING(param_spec)) {
    param_spec = check_param_spec_w(config, property_name, G_TYPE_PARAM_STRING,
                                    G_STRFUNC);
  } else {
    param_spec = check_param_spec_w(config, property_name, G_TYPE_PARAM_OBJECT,
                                    G_STRFUNC);
  }
  ...
  if (profile_path_config && profile_path_property_name)
    gimp_color_profile_chooser_dialog_connect_path(dialog, profile_path_config,
  ...
  if (profile_store) {
    combo = gimp_color_profile_combo_box_new_with_model(
        dialog, GTK_TREE_MODEL(profile_store));
  } else {
    GFile *file;
  ...
  gimp_color_profile_combo_box_set_active_file(
      GIMP_COLOR_PROFILE_COMBO_BOX(combo), file, NULL);
  ...
  g_signal_connect(combo, "changed",
                   G_CALLBACK(gimp_prop_profile_combo_callback), config);

  connect_notify(config, property_name,
                 G_CALLBACK(gimp_prop_profile_combo_notify), combo);
...
static void gimp_prop_profile_combo_callback(GimpColorProfileComboBox *combo,
  ...
  if (!file)
    g_signal_handlers_block_by_func(config, gimp_prop_profile_combo_notify,
                                    combo);
  ...
  if (G_IS_PARAM_SPEC_STRING(param_spec)) {
    ...
    g_object_set(config, param_spec->name, path, NULL);
  ...
  if (!file)
    g_signal_handlers_unblock_by_func(config, gimp_prop_profile_combo_notify,
                                      combo);
...
static void gimp_prop_profile_combo_notify(GObject *config,
  ...
  if (G_IS_PARAM_SPEC_STRING(param_spec)) {
    ...
    g_object_get(config, param_spec->name, &path, NULL);
    ...
    g_object_get(config, param_spec->name, &file, NULL);
  }

  g_signal_handlers_block_by_func(combo, gimp_prop_profile_combo_callback,
                                  config);

  gimp_color_profile_combo_box_set_active_file(combo, file, NULL);

  g_signal_handlers_unblock_by_func(combo, gimp_prop_profile_combo_callback,
                                    config);
...
GtkWidget *gimp_prop_compression_combo_box_new(GObject *config,
  ...
  gimp_compression_combo_box_set_compression(GIMP_COMPRESSION_COMBO_BOX(combo),
                                             value);
  g_free(value);
  ...
  connect_notify(config, property_name,
                 G_CALLBACK(gimp_prop_compression_combo_box_notify), combo);
...
static void gimp_prop_compression_combo_box_callback(GtkWidget *combo,
  ...
  g_signal_handlers_block_by_func(
      config, gimp_prop_compression_combo_box_notify, combo);

  g_object_set(config, param_spec->name, compression, NULL);
...
static void gimp_prop_compression_combo_box_notify(GObject *config,
  ...
  g_signal_handlers_block_by_func(
      combo, gimp_prop_compression_combo_box_callback, config);
...
GtkWidget *gimp_prop_icon_picker_new(GimpViewable *viewable, Gimp *gimp) {
  ...
  g_object_get(object, "icon-name", &icon_name_value, "icon-pixbuf",
               &pixbuf_value, NULL);
  ...
  g_signal_connect(picker, "notify::icon-pixbuf",
                   G_CALLBACK(gimp_prop_icon_picker_callback), object);

  g_signal_connect(picker, "notify::icon-name",
                   G_CALLBACK(gimp_prop_icon_picker_callback), object);

  connect_notify(object, "icon-name", G_CALLBACK(gimp_prop_icon_picker_notify),
                 picker);

  connect_notify(object, "icon-pixbuf",
                 G_CALLBACK(gimp_prop_icon_picker_notify), picker);
...
static void gimp_prop_icon_picker_callback(GtkWidget *picker,
                                           GParamSpec *param_spec,
                                           GObject *config) {
  g_signal_handlers_block_by_func(config, gimp_prop_icon_picker_notify, picker);

  if (!strcmp(param_spec->name, "icon-name")) {
    const gchar *value =
        gimp_icon_picker_get_icon_name(GIMP_ICON_PICKER(picker));

    g_object_set(config, "icon-name", value, NULL);

  } else if (!strcmp(param_spec->name, "icon-pixbuf")) {
    GdkPixbuf *value =
        gimp_icon_picker_get_icon_pixbuf(GIMP_ICON_PICKER(picker));

    g_object_set(config, "icon-pixbuf", value, NULL);
  }

  g_signal_handlers_unblock_by_func(config, gimp_prop_icon_picker_notify,
                                    picker);
}
...
static void gimp_prop_icon_picker_notify(GObject *config,
                                         GParamSpec *param_spec,
                                         GtkWidget *picker) {
  g_signal_handlers_block_by_func(picker, gimp_prop_icon_picker_callback,
                                  config);

  if (!strcmp(param_spec->name, "icon-name")) {
    gchar *value = NULL;

    g_object_get(config, "icon-name", &value, NULL);
    ...
    g_object_get(config, "icon-pixbuf", &value, NULL);
  ...
  g_signal_handlers_unblock_by_func(picker, gimp_prop_icon_picker_callback,
                                    config);
}
