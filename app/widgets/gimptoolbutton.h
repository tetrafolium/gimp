...
#define GIMP_TOOL_BUTTON(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_BUTTON, GimpToolButton))
#define GIMP_TOOL_BUTTON_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_BUTTON, GimpToolButtonClass))
#define GIMP_IS_TOOL_BUTTON(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_TOOL_BUTTON))
#define GIMP_IS_TOOL_BUTTON_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_BUTTON))
#define GIMP_TOOL_BUTTON_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_BUTTON, GimpToolButtonClass))
