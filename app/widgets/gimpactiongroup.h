...
#define GIMP_ACTION_GROUP(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ACTION_GROUP, GimpActionGroup))
#define GIMP_ACTION_GROUP_CLASS(vtable)                                        \
  (G_TYPE_CHECK_CLASS_CAST((vtable), GIMP_TYPE_ACTION_GROUP,                   \
                           GimpActionGroupClass))
#define GIMP_IS_ACTION_GROUP(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_ACTION_GROUP))
#define GIMP_IS_ACTION_GROUP_CLASS(vtable)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((vtable), GIMP_TYPE_ACTION_GROUP))
#define GIMP_ACTION_GROUP_GET_CLASS(inst)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((inst), GIMP_TYPE_ACTION_GROUP,                   \
                             GimpActionGroupClass))
...
struct _GimpActionGroupClass {
  ...
  /* signals */
  void (*action_added)(GimpActionGroup *group, GimpAction *action);
};

typedef void (*GimpActionCallback)(GimpAction *action, GVariant *value,
                                   gpointer data);
