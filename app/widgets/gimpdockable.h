...
#define GIMP_DOCKABLE(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DOCKABLE, GimpDockable))
#define GIMP_DOCKABLE_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DOCKABLE, GimpDockableClass))
#define GIMP_IS_DOCKABLE(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DOCKABLE))
#define GIMP_IS_DOCKABLE_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DOCKABLE))
#define GIMP_DOCKABLE_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DOCKABLE, GimpDockableClass))
...
void gimp_dockable_set_dockbook(GimpDockable *dockable, GimpDockbook *dockbook);
