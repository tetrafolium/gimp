...
G_DECLARE_INTERFACE(GimpDockContainer, gimp_dock_container, GIMP,
                    DOCK_CONTAINER, GtkWidget)
...
struct _GimpDockContainerInterface {
  ...
  void (*add_dock)(GimpDockContainer *container, GimpDock *dock,
...
void gimp_dock_container_add_dock(GimpDockContainer *container, GimpDock *dock,
                                  GimpSessionInfoDock *dock_info);
GimpAlignmentType
gimp_dock_container_get_dock_side(GimpDockContainer *container, GimpDock *dock);
