...
#define GIMP_GRADIENT_EDITOR(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GRADIENT_EDITOR,                \
                              GimpGradientEditor))
#define GIMP_GRADIENT_EDITOR_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GRADIENT_EDITOR,                 \
                           GimpGradientEditorClass))
#define GIMP_IS_GRADIENT_EDITOR(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GRADIENT_EDITOR))
#define GIMP_IS_GRADIENT_EDITOR_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GRADIENT_EDITOR))
#define GIMP_GRADIENT_EDITOR_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_GRADIENT_EDITOR,                 \
                             GimpGradientEditorClass))
...
struct _GimpGradientEditor {
  ...
  /*  Gradient control  */
  GimpGradientSegment
      *control_drag_segment;                /* Segment which is being dragged */
