...
#define GIMP_CONTROLLER_WHEEL(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CONTROLLER_WHEEL,               \
                              GimpControllerWheel))
#define GIMP_CONTROLLER_WHEEL_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CONTROLLER_WHEEL,                \
                           GimpControllerWheelClass))
#define GIMP_IS_CONTROLLER_WHEEL(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CONTROLLER_WHEEL))
#define GIMP_IS_CONTROLLER_WHEEL_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CONTROLLER_WHEEL))
#define GIMP_CONTROLLER_WHEEL_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CONTROLLER_WHEEL,                \
                             GimpControllerWheelClass))
