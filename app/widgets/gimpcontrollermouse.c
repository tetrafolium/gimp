...
static const gchar *
gimp_controller_mouse_get_event_name(GimpController *controller, gint event_id);
static const gchar *
gimp_controller_mouse_get_event_blurb(GimpController *controller,
                                      gint event_id);

G_DEFINE_TYPE(GimpControllerMouse, gimp_controller_mouse, GIMP_TYPE_CONTROLLER)

#define parent_class gimp_controller_mouse_parent_class

static MouseEvent mouse_events[] = {
    {8, NULL, 0, "8", N_("Button 8")},
    {8, "<Shift>", 0, "8-shift", N_("Button 8")},
    {8, "<Primary>", 0, "8-primary", N_("Button 8")},
    {8, "<Alt>", 0, "8-alt", N_("Button 8")},
    {8, "<Shift><Primary>", 0, "8-shift-primary", N_("Button 8")},
    {8, "<Shift><Alt>", 0, "8-shift-alt", N_("Button 8")},
    {8, "<Primary><Alt>", 0, "8-primary-alt", N_("Button 8")},
    {8, "<Shift><Primary><Alt>", 0, "8-shift-primary-alt", N_("Button 8")},

    {9, NULL, 0, "9", N_("Button 9")},
    {9, "<Shift>", 0, "9-shift", N_("Button 9")},
    {9, "<Primary>", 0, "9-primary", N_("Button 9")},
    {9, "<Alt>", 0, "9-alt", N_("Button 9")},
    {9, "<Shift><Primary>", 0, "9-shift-primary", N_("Button 9")},
    {9, "<Shift><Alt>", 0, "9-shift-alt", N_("Button 9")},
    {9, "<Primary><Alt>", 0, "9-primary-alt", N_("Button 9")},
    {9, "<Shift><Primary><Alt>", 0, "9-shift-primary-alt", N_("Button 9")},

    {10, NULL, 0, "10", N_("Button 10")},
    {10, "<Shift>", 0, "10-shift", N_("Button 10")},
    {10, "<Primary>", 0, "10-primary", N_("Button 10")},
    {10, "<Alt>", 0, "10-alt", N_("Button 10")},
    {10, "<Shift><Primary>", 0, "10-shift-primary", N_("Button 10")},
    {10, "<Shift><Alt>", 0, "10-shift-alt", N_("Button 10")},
    {10, "<Primary><Alt>", 0, "10-primary-alt", N_("Button 10")},
    {10, "<Shift><Primary><Alt>", 0, "10-shift-primary-alt", N_("Button 10")},

    {11, NULL, 0, "11", N_("Button 11")},
    {11, "<Shift>", 0, "11-shift", N_("Button 11")},
    {11, "<Primary>", 0, "11-primary", N_("Button 11")},
    {11, "<Alt>", 0, "11-alt", N_("Button 11")},
    {11, "<Shift><Primary>", 0, "11-shift-primary", N_("Button 11")},
    {11, "<Shift><Alt>", 0, "11-shift-alt", N_("Button 11")},
    {11, "<Primary><Alt>", 0, "11-primary-alt", N_("Button 11")},
    {11, "<Shift><Primary><Alt>", 0, "11-shift-primary-alt", N_("Button 11")},

    {12, NULL, 0, "12", N_("Button 12")},
    {12, "<Shift>", 0, "12-shift", N_("Button 12")},
    {12, "<Primary>", 0, "12-primary", N_("Button 12")},
    {12, "<Alt>", 0, "12-alt", N_("Button 12")},
    {12, "<Shift><Primary>", 0, "12-shift-primary", N_("Button 12")},
    {12, "<Shift><Alt>", 0, "12-shift-alt", N_("Button 12")},
    {12, "<Primary><Alt>", 0, "12-primary-alt", N_("Button 12")},
    {12, "<Shift><Primary><Alt>", 0, "12-shift-primary-alt", N_("Button 12")},
};

static void gimp_controller_mouse_class_init(GimpControllerMouseClass *klass) {
...
static void gimp_controller_mouse_init(GimpControllerMouse *mouse) {
  ...
  if (!event_names_initialized) {
    ...
    for (i = 0; i < G_N_ELEMENTS(mouse_events); i++) {
      ...
      if (mevent->modifiers != 0) {
        mevent->blurb = g_strdup_printf("%s (%s)", gettext(mevent->blurb),
...
static void gimp_controller_mouse_constructed(GObject *object) {
  ...
  g_object_set(object, "name", _("Mouse Button Events"), "state", _("Ready"),
               NULL);
}
...
gboolean gimp_controller_mouse_button(GimpControllerMouse *mouse,
  ...
  for (i = G_N_ELEMENTS(mouse_events) - 1; i >= 0; i--) {
    if (mouse_events[i].button == bevent->button &&
      ...
      return gimp_controller_event(GIMP_CONTROLLER(mouse), &controller_event);
    }
  }
