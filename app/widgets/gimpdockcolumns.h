...
#define GIMP_DOCK_COLUMNS(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DOCK_COLUMNS, GimpDockColumns))
#define GIMP_DOCK_COLUMNS_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DOCK_COLUMNS,                    \
                           GimpDockColumnsClass))
#define GIMP_IS_DOCK_COLUMNS(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DOCK_COLUMNS))
#define GIMP_IS_DOCK_COLUMNS_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DOCK_COLUMNS))
#define GIMP_DOCK_COLUMNS_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DOCK_COLUMNS,                    \
                             GimpDockColumnsClass))
...
struct _GimpDockColumnsClass {
  ...
  void (*dock_added)(GimpDockColumns *dock_columns, GimpDock *dock);
  void (*dock_removed)(GimpDockColumns *dock_columns, GimpDock *dock);
};
