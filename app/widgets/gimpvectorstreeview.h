...
#define GIMP_VECTORS_TREE_VIEW(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_VECTORS_TREE_VIEW,              \
                              GimpVectorsTreeView))
#define GIMP_VECTORS_TREE_VIEW_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_VECTORS_TREE_VIEW,               \
                           GimpVectorsTreeViewClass))
#define GIMP_IS_VECTORS_TREE_VIEW(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_VECTORS_TREE_VIEW))
#define GIMP_IS_VECTORS_TREE_VIEW_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_VECTORS_TREE_VIEW))
#define GIMP_VECTORS_TREE_VIEW_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_VECTORS_TREE_VIEW,               \
                             GimpVectorsTreeViewClass))
