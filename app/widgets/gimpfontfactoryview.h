...
#define GIMP_FONT_FACTORY_VIEW(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FONT_FACTORY_VIEW,              \
                              GimpFontFactoryView))
#define GIMP_FONT_FACTORY_VIEW_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FONT_FACTORY_VIEW,               \
                           GimpFontFactoryViewClass))
#define GIMP_IS_FONT_FACTORY_VIEW(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FONT_FACTORY_VIEW))
#define GIMP_IS_FONT_FACTORY_VIEW_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FONT_FACTORY_VIEW))
#define GIMP_FONT_FACTORY_VIEW_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FONT_FACTORY_VIEW,               \
                             GimpFontFactoryViewClass))
