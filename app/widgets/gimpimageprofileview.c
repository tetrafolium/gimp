...
G_DEFINE_TYPE(GimpImageProfileView, gimp_image_profile_view,
...
static void gimp_image_profile_view_init(GimpImageProfileView *view) {
...
GtkWidget *gimp_image_profile_view_new(GimpImage *image) {
  ...
  return g_object_new(GIMP_TYPE_IMAGE_PROFILE_VIEW, "image", image, "parasite",
                      GIMP_ICC_PROFILE_PARASITE_NAME, NULL);
}
