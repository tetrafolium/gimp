...
#define GIMP_VIEW_RENDERER(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_VIEW_RENDERER, GimpViewRenderer))
#define GIMP_VIEW_RENDERER_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_VIEW_RENDERER,                   \
                           GimpViewRendererClass))
#define GIMP_IS_VIEW_RENDERER(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_VIEW_RENDERER))
#define GIMP_IS_VIEW_RENDERER_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_VIEW_RENDERER))
#define GIMP_VIEW_RENDERER_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_VIEW_RENDERER,                   \
                             GimpViewRendererClass))
...
struct _GimpViewRendererClass {
  ...
  /*  virtual functions  */
  void (*set_context)(GimpViewRenderer *renderer, GimpContext *context);
  void (*invalidate)(GimpViewRenderer *renderer);
  void (*draw)(GimpViewRenderer *renderer, GtkWidget *widget, cairo_t *cr,
               gint available_width, gint available_height);
  void (*render)(GimpViewRenderer *renderer, GtkWidget *widget);
};
...
void gimp_view_renderer_set_viewable(GimpViewRenderer *renderer,
                                     GimpViewable *viewable);
void gimp_view_renderer_set_size(GimpViewRenderer *renderer, gint size,
                                 gint border_width);
