...
enum { TITLE_CHANGED, LAST_SIGNAL };

/*  local function prototypes  */

static void gimp_docked_iface_set_aux_info(GimpDocked *docked, GList *aux_info);
...
static void gimp_docked_default_init(GimpDockedInterface *iface) {
  docked_signals[TITLE_CHANGED] =
      g_signal_new("title-changed", GIMP_TYPE_DOCKED, G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpDockedInterface, title_changed), NULL,
...
void gimp_docked_set_aux_info(GimpDocked *docked, GList *aux_info) {
...
GtkWidget *gimp_docked_get_preview(GimpDocked *docked, GimpContext *context,
                                   GtkIconSize size) {
  GimpDockedInterface *docked_iface;
...
void gimp_docked_set_context(GimpDocked *docked, GimpContext *context) {
  GimpDockedInterface *docked_iface;
...
void gimp_docked_set_show_button_bar(GimpDocked *docked, gboolean show) {
  GimpDockedInterface *docked_iface;
