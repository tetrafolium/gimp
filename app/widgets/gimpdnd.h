...
#define GIMP_TARGET_COMPONENT                                                  \
  {                                                                            \
    "application/x-gimp-component", GTK_TARGET_SAME_APP,                       \
...
#define GIMP_TARGET_CHANNEL                                                    \
  {                                                                            \
    "application/x-gimp-channel-id", GTK_TARGET_SAME_APP,                      \
        GIMP_DND_TYPE_CHANNEL                                                  \
  }

#define GIMP_TARGET_LAYER_MASK                                                 \
  {                                                                            \
    "application/x-gimp-layer-mask-id", GTK_TARGET_SAME_APP,                   \
        GIMP_DND_TYPE_LAYER_MASK                                               \
  }

#define GIMP_TARGET_VECTORS                                                    \
  {                                                                            \
    "application/x-gimp-vectors-id", GTK_TARGET_SAME_APP,                      \
        GIMP_DND_TYPE_VECTORS                                                  \
  }
...
#define GIMP_TARGET_BUFFER                                                     \
  {                                                                            \
    "application/x-gimp-buffer-name", GTK_TARGET_SAME_APP,                     \
        GIMP_DND_TYPE_BUFFER                                                   \
  }

#define GIMP_TARGET_IMAGEFILE                                                  \
  {                                                                            \
    "application/x-gimp-imagefile-name", GTK_TARGET_SAME_APP,                  \
        GIMP_DND_TYPE_IMAGEFILE                                                \
  }

#define GIMP_TARGET_TEMPLATE                                                   \
  {                                                                            \
    "application/x-gimp-template-name", GTK_TARGET_SAME_APP,                   \
        GIMP_DND_TYPE_TEMPLATE                                                 \
  }

#define GIMP_TARGET_TOOL_ITEM                                                  \
  {                                                                            \
    "application/x-gimp-tool-item-name", GTK_TARGET_SAME_APP,                  \
        GIMP_DND_TYPE_TOOL_ITEM                                                \
  }
...
#define GIMP_TARGET_LAYER_LIST                                                 \
  {                                                                            \
    "application/x-gimp-layer-list", GTK_TARGET_SAME_APP,                      \
        GIMP_DND_TYPE_LAYER_LIST                                               \
  }
...
typedef GList *(*GimpDndDragUriListFunc)(GtkWidget *widget, gpointer data);
typedef void (*GimpDndDropUriListFunc)(GtkWidget *widget, gint x, gint y,
...
typedef void (*GimpDndDragColorFunc)(GtkWidget *widget, GimpRGB *color,
                                     gpointer data);
typedef void (*GimpDndDropColorFunc)(GtkWidget *widget, gint x, gint y,
...
typedef guchar *(*GimpDndDragStreamFunc)(GtkWidget *widget, gsize *stream_len,
                                         gpointer data);
typedef void (*GimpDndDropStreamFunc)(GtkWidget *widget, gint x, gint y,
                                      const guchar *stream, gsize stream_len,
                                      gpointer data);

void gimp_dnd_svg_source_add(GtkWidget *widget,
                             GimpDndDragStreamFunc get_svg_func, gpointer data);
...
typedef GdkPixbuf *(*GimpDndDragPixbufFunc)(GtkWidget *widget, gpointer data);
typedef void (*GimpDndDropPixbufFunc)(GtkWidget *widget, gint x, gint y,
...
typedef GimpImage *(*GimpDndDragComponentFunc)(GtkWidget *widget,
                                               ...
                                               gpointer data);
typedef void (*GimpDndDropComponentFunc)(GtkWidget *widget, gint x, gint y,
                                         GimpImage *image,
                                         GimpChannelType channel,
                                         gpointer data);
...
typedef GimpViewable *(*GimpDndDragViewableFunc)(GtkWidget *widget,
                                                 GimpContext **context,
                                                 gpointer data);
typedef void (*GimpDndDropViewableFunc)(GtkWidget *widget, gint x, gint y,
...
typedef GList *(*GimpDndDragViewableListFunc)(GtkWidget *widget,
                                              GimpContext **context,
                                              gpointer data);
typedef void (*GimpDndDropViewableListFunc)(GtkWidget *widget, gint x, gint y,
                                            GList *viewables, gpointer data);
