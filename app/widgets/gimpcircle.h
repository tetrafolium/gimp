...
#define GIMP_CIRCLE(obj)                                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CIRCLE, GimpCircle))
#define GIMP_CIRCLE_CLASS(klass)                                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_CIRCLE, GimpCircleClass))
#define GIMP_IS_CIRCLE(obj) (G_TYPE_CHECK_INSTANCE_TYPE(obj, GIMP_TYPE_CIRCLE))
#define GIMP_IS_CIRCLE_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CIRCLE))
#define GIMP_CIRCLE_GET_CLASS(obj)                                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_CIRCLE, GimpCircleClass))
...
gdouble _gimp_circle_get_angle_and_distance(GimpCircle *circle, gdouble event_x,
                                            gdouble event_y, gdouble *distance);
