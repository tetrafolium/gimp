...
#define GIMP_SYMMETRY_EDITOR(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SYMMETRY_EDITOR,                \
                              GimpSymmetryEditor))
#define GIMP_SYMMETRY_EDITOR_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SYMMETRY_EDITOR,                 \
                           GimpSymmetryEditorClass))
#define GIMP_IS_SYMMETRY_EDITOR(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_SYMMETRY_EDITOR))
#define GIMP_IS_SYMMETRY_EDITOR_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SYMMETRY_EDITOR))
#define GIMP_SYMMETRY_EDITOR_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SYMMETRY_EDITOR,                 \
                             GimpSymmetryEditorClass))
