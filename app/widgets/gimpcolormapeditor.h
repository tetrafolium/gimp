...
#define GIMP_COLORMAP_EDITOR(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_COLORMAP_EDITOR,                \
                              GimpColormapEditor))
#define GIMP_COLORMAP_EDITOR_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_COLORMAP_EDITOR,                 \
                           GimpColormapEditorClass))
#define GIMP_IS_COLORMAP_EDITOR(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_COLORMAP_EDITOR))
#define GIMP_IS_COLORMAP_EDITOR_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_COLORMAP_EDITOR))
#define GIMP_COLORMAP_EDITOR_GET_CLASS(obj)                                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_COLORMAP_EDITOR,                 \
                             GimpColormapEditorClass))
