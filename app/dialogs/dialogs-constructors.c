...
GtkWidget *dialogs_module_get(GimpDialogFactory *factory, GimpContext *context,
                              GimpUIManager *ui_manager, gint view_size) {
...
GtkWidget *dialogs_tips_get(GimpDialogFactory *factory, GimpContext *context,
                            GimpUIManager *ui_manager, gint view_size) {
  return tips_dialog_create(context->gimp);
}

GtkWidget *dialogs_about_get(GimpDialogFactory *factory, GimpContext *context,
                             GimpUIManager *ui_manager, gint view_size) {
...
GtkWidget *dialogs_error_get(GimpDialogFactory *factory, GimpContext *context,
                             GimpUIManager *ui_manager, gint view_size) {
  return gimp_error_dialog_new(_("GIMP Message"));
}

GtkWidget *dialogs_critical_get(GimpDialogFactory *factory,
                                GimpContext *context, GimpUIManager *ui_manager,
                                gint view_size) {
  return gimp_critical_dialog_new(
      _("GIMP Debug"), context->gimp->config->last_known_release,
...
GtkWidget *dialogs_quit_get(GimpDialogFactory *factory, GimpContext *context,
                            GimpUIManager *ui_manager, gint view_size) {
...
GtkWidget *dialogs_toolbox_new(GimpDialogFactory *factory, GimpContext *context,
                               GimpUIManager *ui_manager, gint view_size) {
  return gimp_toolbox_new(factory, context, ui_manager);
}
...
GtkWidget *dialogs_toolbox_dock_window_new(GimpDialogFactory *factory,
  ...
  dock = gimp_dock_window_new(role, "<Toolbox>", TRUE, factory, context);
  g_free(role);

  return dock;
}

GtkWidget *dialogs_dock_new(GimpDialogFactory *factory, GimpContext *context,
                            GimpUIManager *ui_manager, gint view_size) {
...
GtkWidget *dialogs_dock_window_new(GimpDialogFactory *factory,
  ...
  dock = gimp_dock_window_new(role, "<Dock>", FALSE, factory, context);
  g_free(role);
...
GtkWidget *dialogs_tool_options_new(GimpDialogFactory *factory,
                                    GimpContext *context,
                                    GimpUIManager *ui_manager, gint view_size) {
  return gimp_tool_options_editor_new(
      context->gimp, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_image_list_view_new(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_image_view_new(GIMP_VIEW_TYPE_LIST, context->gimp->images,
                             context, view_size, 1,
                             gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_brush_list_view_new(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_brush_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->brush_factory, context, TRUE,
      view_size, 1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_dynamics_list_view_new(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_dynamics_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->dynamics_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_mypaint_brush_list_view_new(GimpDialogFactory *factory,
                                               ...
                                               GimpUIManager *ui_manager,
                                               gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->mybrush_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<MyPaintBrushes>",
      "/mypaint-brushes-popup", "mypaint-brushes");
}
...
GtkWidget *dialogs_pattern_list_view_new(GimpDialogFactory *factory,
                                         ...
                                         GimpUIManager *ui_manager,
                                         gint view_size) {
  return gimp_pattern_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->pattern_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_gradient_list_view_new(GimpDialogFactory *factory,
                                          ...
                                          gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->gradient_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<Gradients>",
      "/gradients-popup", "gradients");
}
...
GtkWidget *dialogs_palette_list_view_new(GimpDialogFactory *factory,
                                         ...
                                         gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->palette_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<Palettes>",
...
GtkWidget *dialogs_font_list_view_new(GimpDialogFactory *factory,
                                      ...
                                      GimpUIManager *ui_manager,
                                      gint view_size) {
  return gimp_font_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->font_factory, context, view_size, 1,
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_buffer_list_view_new(GimpDialogFactory *factory,
                                        ...
                                        GimpUIManager *ui_manager,
                                        gint view_size) {
  return gimp_buffer_view_new(GIMP_VIEW_TYPE_LIST, context->gimp->named_buffers,
                              context, view_size, 1,
                              gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_tool_preset_list_view_new(GimpDialogFactory *factory,
                                             ...
                                             GimpUIManager *ui_manager,
                                             gint view_size) {
  return gimp_tool_preset_factory_view_new(
      GIMP_VIEW_TYPE_LIST, context->gimp->tool_preset_factory, context,
      view_size, 1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_document_list_view_new(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_document_view_new(GIMP_VIEW_TYPE_LIST, context->gimp->documents,
                                context, view_size, 0,
                                gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_template_list_view_new(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_template_view_new(GIMP_VIEW_TYPE_LIST, context->gimp->templates,
                                context, view_size, 0,
                                gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_image_grid_view_new(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_image_view_new(GIMP_VIEW_TYPE_GRID, context->gimp->images,
                             context, view_size, 1,
                             gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_brush_grid_view_new(GimpDialogFactory *factory,
                                       ...
                                       gint view_size) {
  return gimp_brush_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->brush_factory, context, TRUE,
      view_size, 1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_dynamics_grid_view_new(GimpDialogFactory *factory,
                                          ...
                                          gint view_size) {
  return gimp_dynamics_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->dynamics_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_mypaint_brush_grid_view_new(GimpDialogFactory *factory,
                                               ...
                                               gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->mybrush_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<MyPaintBrushes>",
      "/mypaint-brushes-popup", "mypaint-brushes");
}
...
GtkWidget *dialogs_pattern_grid_view_new(GimpDialogFactory *factory,
                                         ...
                                         gint view_size) {
  return gimp_pattern_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->pattern_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_gradient_grid_view_new(GimpDialogFactory *factory,
                                          ...
                                          gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->gradient_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<Gradients>",
      "/gradients-popup", "gradients");
}
...
GtkWidget *dialogs_palette_grid_view_new(GimpDialogFactory *factory,
                                         ...
                                         gint view_size) {
  return gimp_data_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->palette_factory, context, view_size,
      1, gimp_dialog_factory_get_menu_factory(factory), "<Palettes>",
      "/palettes-popup", "palettes");
}
...
GtkWidget *dialogs_font_grid_view_new(GimpDialogFactory *factory,
                                      ...
                                      gint view_size) {
  return gimp_font_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->font_factory, context, view_size, 1,
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_buffer_grid_view_new(GimpDialogFactory *factory,
                                        ...
                                        GimpUIManager *ui_manager,
                                        gint view_size) {
  return gimp_buffer_view_new(GIMP_VIEW_TYPE_GRID, context->gimp->named_buffers,
                              context, view_size, 1,
                              gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_tool_preset_grid_view_new(GimpDialogFactory *factory,
                                             ...
                                             gint view_size) {
  return gimp_tool_preset_factory_view_new(
      GIMP_VIEW_TYPE_GRID, context->gimp->tool_preset_factory, context,
      view_size, 1, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_document_grid_view_new(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_document_view_new(GIMP_VIEW_TYPE_GRID, context->gimp->documents,
                                context, view_size, 0,
                                gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_template_grid_view_new(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_template_view_new(GIMP_VIEW_TYPE_GRID, context->gimp->templates,
                                context, view_size, 0,
                                gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_layer_list_view_new(GimpDialogFactory *factory,
  ...
  return gimp_item_tree_view_new(GIMP_TYPE_LAYER_TREE_VIEW, view_size, 2, TRUE,
...
GtkWidget *dialogs_channel_list_view_new(GimpDialogFactory *factory,
  ...
  return gimp_item_tree_view_new(GIMP_TYPE_CHANNEL_TREE_VIEW, view_size, 1,
                                 FALSE, gimp_context_get_image(context),
                                 gimp_dialog_factory_get_menu_factory(factory),
                                 "<Channels>", "/channels-popup");
}
...
GtkWidget *dialogs_vectors_list_view_new(GimpDialogFactory *factory,
  ...
  return gimp_item_tree_view_new(GIMP_TYPE_VECTORS_TREE_VIEW, view_size, 1,
                                 FALSE, gimp_context_get_image(context),
                                 gimp_dialog_factory_get_menu_factory(factory),
                                 "<Vectors>", "/vectors-popup");
}
...
GtkWidget *dialogs_colormap_editor_new(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_colormap_editor_new(
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_selection_editor_new(GimpDialogFactory *factory,
                                        ...
                                        GimpUIManager *ui_manager,
                                        gint view_size) {
  return gimp_selection_editor_new(
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_symmetry_editor_new(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_symmetry_editor_new(
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_sample_point_editor_new(GimpDialogFactory *factory,
                                           ...
                                           GimpUIManager *ui_manager,
                                           gint view_size) {
  return gimp_sample_point_editor_new(
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_navigation_editor_new(GimpDialogFactory *factory,
                                         ...
                                         GimpUIManager *ui_manager,
                                         gint view_size) {
  return gimp_navigation_editor_new(
      gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_dynamics_editor_get(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_dynamics_editor_new(
      context, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_gradient_editor_get(GimpDialogFactory *factory,
                                       ...
                                       GimpUIManager *ui_manager,
                                       gint view_size) {
  return gimp_gradient_editor_new(
      context, gimp_dialog_factory_get_menu_factory(factory));
}
...
GtkWidget *dialogs_tool_preset_editor_get(GimpDialogFactory *factory,
                                          ...
                                          GimpUIManager *ui_manager,
                                          gint view_size) {
  return gimp_tool_preset_editor_new(
      context, gimp_dialog_factory_get_menu_factory(factory));
}
