...
gboolean gimp_contexts_load(Gimp *gimp, GError **error) {
  ...
  success = gimp_config_deserialize_file(
      GIMP_CONFIG(gimp_get_user_context(gimp)), file, NULL, &my_error);
...
gboolean gimp_contexts_save(Gimp *gimp, GError **error) {
  ...
  success = gimp_config_serialize_to_file(
      GIMP_CONFIG(gimp_get_user_context(gimp)), file, "GIMP user context",
      "end of user context", NULL, error);
