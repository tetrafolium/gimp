...
#define GIMP_GRADIENT(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GRADIENT, GimpGradient))
#define GIMP_GRADIENT_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GRADIENT, GimpGradientClass))
#define GIMP_IS_GRADIENT(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GRADIENT))
#define GIMP_IS_GRADIENT_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GRADIENT))
#define GIMP_GRADIENT_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_GRADIENT, GimpGradientClass))
...
void gimp_gradient_segment_range_replicate(
    ...
    GimpGradientSegment **final_start_seg, GimpGradientSegment **final_end_seg);
