...
static void gimp_filter_stack_add(GimpContainer *container, GimpObject *object);
...
static void gimp_filter_stack_class_init(GimpFilterStackClass *klass) {
...
static void gimp_filter_stack_init(GimpFilterStack *stack) {}
...
GimpContainer *gimp_filter_stack_new(GType filter_type) {
  ...
  return g_object_new(GIMP_TYPE_FILTER_STACK, "name", g_type_name(filter_type),
                      "children-type", filter_type, "policy",
...
GeglNode *gimp_filter_stack_get_graph(GimpFilterStack *stack) {
  ...
  for (list = GIMP_LIST(stack)->queue->tail; list;
    ...
    gegl_node_connect_to(previous, "output", node, "input");
  ...
  gegl_node_connect_to(previous, "output", output, "input");
...
static void gimp_filter_stack_add_node(GimpFilterStack *stack,
  ...
  gegl_node_connect_to(node_below, "output", node, "input");
  gegl_node_connect_to(node, "output", node_above, "input");
}
...
static void gimp_filter_stack_remove_node(GimpFilterStack *stack,
  ...
  gegl_node_connect_to(node_below, "output", node_above, "input");
}
