...
#define GIMP_CONTEXT(obj)                                                      \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_CONTEXT, GimpContext))
#define GIMP_CONTEXT_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_CAST(klass, GIMP_TYPE_CONTEXT, GimpContextClass))
#define GIMP_IS_CONTEXT(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_CONTEXT))
#define GIMP_IS_CONTEXT_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_CONTEXT))
#define GIMP_CONTEXT_GET_CLASS(obj)                                            \
  (G_TYPE_INSTANCE_GET_CLASS(obj, GIMP_TYPE_CONTEXT, GimpContextClass))
...
struct _GimpContextClass {
  ...
  void (*image_changed)(GimpContext *context, GimpImage *image);
  void (*display_changed)(GimpContext *context, GimpDisplay *display);

  void (*tool_changed)(GimpContext *context, GimpToolInfo *tool_info);
  void (*paint_info_changed)(GimpContext *context, GimpPaintInfo *paint_info);

  void (*foreground_changed)(GimpContext *context, GimpRGB *color);
  void (*background_changed)(GimpContext *context, GimpRGB *color);
  void (*opacity_changed)(GimpContext *context, gdouble opacity);
  void (*paint_mode_changed)(GimpContext *context, GimpLayerMode paint_mode);
  void (*brush_changed)(GimpContext *context, GimpBrush *brush);
  void (*dynamics_changed)(GimpContext *context, GimpDynamics *dynamics);
  void (*mybrush_changed)(GimpContext *context, GimpMybrush *brush);
  void (*pattern_changed)(GimpContext *context, GimpPattern *pattern);
  void (*gradient_changed)(GimpContext *context, GimpGradient *gradient);
  void (*palette_changed)(GimpContext *context, GimpPalette *palette);
  void (*font_changed)(GimpContext *context, GimpFont *font);
  void (*tool_preset_changed)(GimpContext *context,
                              GimpToolPreset *tool_preset);
  void (*buffer_changed)(GimpContext *context, GimpBuffer *buffer);
  void (*imagefile_changed)(GimpContext *context, GimpImagefile *imagefile);
  void (*template_changed)(GimpContext *context, GimpTemplate *template);

  void (*prop_name_changed)(GimpContext *context, GimpContextPropType prop);
};
