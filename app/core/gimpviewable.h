...
#define GIMP_VIEWABLE(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_VIEWABLE, GimpViewable))
#define GIMP_VIEWABLE_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_VIEWABLE, GimpViewableClass))
#define GIMP_IS_VIEWABLE(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_VIEWABLE))
#define GIMP_IS_VIEWABLE_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_VIEWABLE))
#define GIMP_VIEWABLE_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_VIEWABLE, GimpViewableClass))
...
struct _GimpViewableClass {
  ...
  void (*get_preview_size)(GimpViewable *viewable, gint size, gboolean is_popup,
                           gboolean dot_for_dot, gint *width, gint *height);
  gboolean (*get_popup_size)(GimpViewable *viewable, gint width, gint height,
                             gboolean dot_for_dot, gint *popup_width,
                             gint *popup_height);
  GimpTempBuf *(*get_preview)(GimpViewable *viewable, GimpContext *context,
                              gint width, gint height);
  GimpTempBuf *(*get_new_preview)(GimpViewable *viewable, GimpContext *context,
                                  gint width, gint height);
  GdkPixbuf *(*get_pixbuf)(GimpViewable *viewable, GimpContext *context,
                           gint width, gint height);
  GdkPixbuf *(*get_new_pixbuf)(GimpViewable *viewable, GimpContext *context,
                               gint width, gint height);
  gchar *(*get_description)(GimpViewable *viewable, gchar **tooltip);
  ...
  void (*set_expanded)(GimpViewable *viewable, gboolean expand);
...
void gimp_viewable_calc_preview_size(gint aspect_width, gint aspect_height,
                                     ...
                                     gint *return_height, gboolean *scaling_up);
