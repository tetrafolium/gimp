...
#define GIMP_FILTERED_CONTAINER(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FILTERED_CONTAINER,             \
                              GimpFilteredContainer))
#define GIMP_FILTERED_CONTAINER_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FILTERED_CONTAINER,              \
                           GimpFilteredContainerClass))
#define GIMP_IS_FILTERED_CONTAINER(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FILTERED_CONTAINER))
#define GIMP_IS_FILTERED_CONTAINER_CLASS(class)                                \
  (G_TYPE_CHECK_CLASS_TYPE((class), GIMP_TYPE_FILTERED_CONTAINER))
#define GIMP_FILTERED_CONTAINER_GET_CLASS(obj)                                 \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FILTERED_CONTAINER,              \
                             GimpFilteredContainerClass))
