...
static const GimpUnitDef gimp_unit_defs[GIMP_UNIT_END] = {
    /* pseudo unit */
    {FALSE, 0.0, 0, "pixels", "px", "px", NC_("unit-singular", "pixel"),
     NC_("unit-plural", "pixels")},

    /* standard units */
    {FALSE, 1.0, 2, "inches", "''", "in", NC_("unit-singular", "inch"),
    ...
    /* professional units */
    {FALSE, 72.0, 0, "points", "pt", "pt", NC_("unit-singular", "point"),
     NC_("unit-plural", "points")},

    {FALSE, 6.0, 1, "picas", "pc", "pc", NC_("unit-singular", "pica"),
     NC_("unit-plural", "picas")}};

/*  not a unit at all but kept here to have the strings in one place
 */
static const GimpUnitDef gimp_unit_percent = {FALSE,
                                              0.0,
                                              0,
                                              "percent",
                                              "%",
                                              "%",
                                              NC_("singular", "percent"),
                                              NC_("plural", "percent")};

/* private functions */

static GimpUnitDef *_gimp_unit_get_user_unit(Gimp *gimp, GimpUnit unit) {
...
GimpUnit _gimp_unit_new(Gimp *gimp, const gchar *identifier, gdouble factor,
                        gint digits, const gchar *symbol,
                        const gchar *abbreviation, const gchar *singular,
                        const gchar *plural) {
...
gboolean _gimp_unit_get_deletion_flag(Gimp *gimp, GimpUnit unit) {
...
void _gimp_unit_set_deletion_flag(Gimp *gimp, GimpUnit unit,
...
gdouble _gimp_unit_get_factor(Gimp *gimp, GimpUnit unit) {
...
gint _gimp_unit_get_digits(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail(unit < (GIMP_UNIT_END + gimp->n_user_units) ||
                           (unit == GIMP_UNIT_PERCENT),
...
const gchar *_gimp_unit_get_identifier(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail((unit < (GIMP_UNIT_END + gimp->n_user_units)) ||
                           (unit == GIMP_UNIT_PERCENT),
...
const gchar *_gimp_unit_get_symbol(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail((unit < (GIMP_UNIT_END + gimp->n_user_units)) ||
                           (unit == GIMP_UNIT_PERCENT),
...
const gchar *_gimp_unit_get_abbreviation(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail((unit < (GIMP_UNIT_END + gimp->n_user_units)) ||
                           (unit == GIMP_UNIT_PERCENT),
...
const gchar *_gimp_unit_get_singular(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail((unit < (GIMP_UNIT_END + gimp->n_user_units)) ||
                           (unit == GIMP_UNIT_PERCENT),
...
const gchar *_gimp_unit_get_plural(Gimp *gimp, GimpUnit unit) {
  g_return_val_if_fail((unit < (GIMP_UNIT_END + gimp->n_user_units)) ||
                           (unit == GIMP_UNIT_PERCENT),
