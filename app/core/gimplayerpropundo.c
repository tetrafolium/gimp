...
static void gimp_layer_prop_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
...
static void gimp_layer_prop_undo_class_init(GimpLayerPropUndoClass *klass) {
...
static void gimp_layer_prop_undo_init(GimpLayerPropUndo *undo) {}
...
static void gimp_layer_prop_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
  ...
  case GIMP_UNDO_LAYER_MODE: {
    ...
    gimp_layer_set_blend_space(layer, layer_prop_undo->blend_space, FALSE);
