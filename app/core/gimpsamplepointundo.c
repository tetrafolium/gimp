...
static void gimp_sample_point_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
...
static void gimp_sample_point_undo_init(GimpSamplePointUndo *undo) {}
...
static void gimp_sample_point_undo_constructed(GObject *object) {
  ...
  gimp_sample_point_get_position(sample_point, &sample_point_undo->x,
                                 &sample_point_undo->y);
...
static void gimp_sample_point_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
  ...
  if (x == GIMP_SAMPLE_POINT_POSITION_UNDEFINED) {
    gimp_image_add_sample_point(undo->image, sample_point, sample_point_undo->x,
                                sample_point_undo->y);
    ...
    gimp_sample_point_set_position(sample_point, sample_point_undo->x,
                                   sample_point_undo->y);
    gimp_sample_point_set_pick_mode(sample_point, sample_point_undo->pick_mode);
