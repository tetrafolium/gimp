...
static void gimp_aux_item_get_property(GObject *object, guint property_id,
                                       GValue *value, GParamSpec *pspec);
static void gimp_aux_item_set_property(GObject *object, guint property_id,
...
static void gimp_aux_item_class_init(GimpAuxItemClass *klass) {
  GObjectClass *object_class = G_OBJECT_CLASS(klass);

  gimp_aux_item_signals[REMOVED] =
      g_signal_new("removed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpAuxItemClass, removed), NULL, NULL, NULL,
                   G_TYPE_NONE, 0);
  ...
  g_object_class_install_property(
      ...
      g_param_spec_uint("id", NULL, NULL, 0, G_MAXUINT32, 0,
                        G_PARAM_CONSTRUCT_ONLY | GIMP_PARAM_READWRITE));
}

static void gimp_aux_item_init(GimpAuxItem *aux_item) {
