...
#define GIMP_IMAGEFILE(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_IMAGEFILE, GimpImagefile))
#define GIMP_IMAGEFILE_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_IMAGEFILE, GimpImagefileClass))
#define GIMP_IS_IMAGEFILE(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_IMAGEFILE))
#define GIMP_IS_IMAGEFILE_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_IMAGEFILE))
#define GIMP_IMAGEFILE_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_IMAGEFILE, GimpImagefileClass))
