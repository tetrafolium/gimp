...
#define GIMP_GROUP_LAYER_UNDO(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GROUP_LAYER_UNDO,               \
                              GimpGroupLayerUndo))
#define GIMP_GROUP_LAYER_UNDO_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GROUP_LAYER_UNDO,                \
                           GimpGroupLayerUndoClass))
#define GIMP_IS_GROUP_LAYER_UNDO(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GROUP_LAYER_UNDO))
#define GIMP_IS_GROUP_LAYER_UNDO_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GROUP_LAYER_UNDO))
#define GIMP_GROUP_LAYER_UNDO_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_GROUP_LAYER_UNDO,                \
                             GimpGroupLayerUndoClass))
