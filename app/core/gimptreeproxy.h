...
#define GIMP_TREE_PROXY(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TREE_PROXY, GimpTreeProxy))
#define GIMP_TREE_PROXY_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TREE_PROXY, GimpTreeProxyClass))
#define GIMP_IS_TREE_PROXY(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TREE_PROXY))
#define GIMP_IS_TREE_PROXY_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TREE_PROXY))
#define GIMP_TREE_PROXY_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TREE_PROXY, GimpTreeProxyClass))
