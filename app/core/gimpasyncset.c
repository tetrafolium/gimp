...
static void gimp_async_set_set_property(GObject *object, guint property_id,
                                        const GValue *value, GParamSpec *pspec);
static void gimp_async_set_get_property(GObject *object, guint property_id,
...
G_DEFINE_TYPE_WITH_CODE(
    GimpAsyncSet, gimp_async_set, G_TYPE_OBJECT,
...
static void gimp_async_set_class_init(GimpAsyncSetClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_EMPTY,
      g_param_spec_boolean("empty", NULL, NULL, FALSE, GIMP_PARAM_READABLE));
}
...
static void gimp_async_set_init(GimpAsyncSet *async_set) {
...
GimpAsyncSet *gimp_async_set_new(void) {
  return g_object_new(GIMP_TYPE_ASYNC_SET, NULL);
}
...
void gimp_async_set_add(GimpAsyncSet *async_set, GimpAsync *async) {
  ...
  if (g_hash_table_add(async_set->priv->asyncs, async)) {
    ...
    gimp_async_add_callback(
        async, (GimpAsyncCallback)gimp_async_set_async_callback, async_set);
  }
}
