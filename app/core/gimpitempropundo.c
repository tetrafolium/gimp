...
enum { PROP_0, PROP_PARASITE_NAME };

static void gimp_item_prop_undo_constructed(GObject *object);
static void gimp_item_prop_undo_set_property(GObject *object, guint property_id,
                                             const GValue *value,
                                             GParamSpec *pspec);
static void gimp_item_prop_undo_get_property(GObject *object, guint property_id,
                                             GValue *value, GParamSpec *pspec);

static gint64 gimp_item_prop_undo_get_memsize(GimpObject *object,
                                              gint64 *gui_size);

static void gimp_item_prop_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
                                    GimpUndoAccumulator *accum);
static void gimp_item_prop_undo_free(GimpUndo *undo, GimpUndoMode undo_mode);
...
static void gimp_item_prop_undo_class_init(GimpItemPropUndoClass *klass) {
...
static void gimp_item_prop_undo_init(GimpItemPropUndo *undo) {}
...
static void gimp_item_prop_undo_constructed(GObject *object) {
  ...
  case GIMP_UNDO_ITEM_DISPLACE:
    gimp_item_get_offset(item, &item_prop_undo->offset_x,
...
static void gimp_item_prop_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
  ...
  case GIMP_UNDO_ITEM_REORDER: {
    ...
    gimp_item_tree_reorder_item(gimp_item_get_tree(item), item,
                                ...
                                item_prop_undo->position, FALSE, NULL);
  ...
  case GIMP_UNDO_ITEM_RENAME: {
    ...
    gimp_item_tree_rename_item(gimp_item_get_tree(item), item,
                               item_prop_undo->name, FALSE, NULL);
  ...
  case GIMP_UNDO_ITEM_DISPLACE: {
    ...
    gimp_item_translate(item, item_prop_undo->offset_x - offset_x,
                        item_prop_undo->offset_y - offset_y, FALSE);
