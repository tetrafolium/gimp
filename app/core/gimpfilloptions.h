...
#define GIMP_FILL_OPTIONS(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FILL_OPTIONS, GimpFillOptions))
#define GIMP_FILL_OPTIONS_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FILL_OPTIONS,                    \
                           GimpFillOptionsClass))
#define GIMP_IS_FILL_OPTIONS(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FILL_OPTIONS))
#define GIMP_IS_FILL_OPTIONS_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FILL_OPTIONS))
#define GIMP_FILL_OPTIONS_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FILL_OPTIONS,                    \
                             GimpFillOptionsClass))
...
void gimp_fill_options_set_style(GimpFillOptions *options, GimpFillStyle style);
