...
#define GIMP_AUX_ITEM(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_AUX_ITEM, GimpAuxItem))
#define GIMP_AUX_ITEM_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_AUX_ITEM, GimpAuxItemClass))
#define GIMP_IS_AUX_ITEM(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_AUX_ITEM))
#define GIMP_IS_AUX_ITEM_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_AUX_ITEM))
#define GIMP_AUX_ITEM_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_AUX_ITEM, GimpAuxItemClass))
