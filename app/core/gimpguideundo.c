...
static void gimp_guide_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
                                GimpUndoAccumulator *accum);

G_DEFINE_TYPE(GimpGuideUndo, gimp_guide_undo, GIMP_TYPE_AUX_ITEM_UNDO)

#define parent_class gimp_guide_undo_parent_class

static void gimp_guide_undo_class_init(GimpGuideUndoClass *klass) {
...
static void gimp_guide_undo_init(GimpGuideUndo *undo) {}
