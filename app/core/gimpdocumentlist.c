...
static void gimp_document_list_class_init(GimpDocumentListClass *klass) {}

static void gimp_document_list_init(GimpDocumentList *list) {}
...
GimpContainer *gimp_document_list_new(Gimp *gimp) {
  ...
  document_list = g_object_new(GIMP_TYPE_DOCUMENT_LIST, "name", "document-list",
                               "children-type", GIMP_TYPE_IMAGEFILE, "policy",
...
GimpImagefile *gimp_document_list_add_file(GimpDocumentList *document_list,
  ...
  imagefile = (GimpImagefile *)gimp_container_get_child_by_name(container, uri);
