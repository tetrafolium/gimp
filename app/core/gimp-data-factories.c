...
void gimp_data_factories_init(Gimp *gimp) {
  ...
  gimp->brush_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_BRUSH, "brush-path", "brush-path-writable", "brush-paths",
      gimp_brush_new, gimp_brush_get_standard);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->brush_factory),
                              "brush factory");
  gimp_data_loader_factory_add_loader(gimp->brush_factory, "GIMP Brush",
                                      gimp_brush_load,
                                      GIMP_BRUSH_FILE_EXTENSION, TRUE);
  gimp_data_loader_factory_add_loader(gimp->brush_factory, "GIMP Brush Pixmap",
                                      gimp_brush_load,
                                      GIMP_BRUSH_PIXMAP_FILE_EXTENSION, FALSE);
  gimp_data_loader_factory_add_loader(
      gimp->brush_factory, "Photoshop ABR Brush", gimp_brush_load_abr,
      GIMP_BRUSH_PS_FILE_EXTENSION, FALSE);
  gimp_data_loader_factory_add_loader(
      gimp->brush_factory, "Paint Shop Pro JBR Brush", gimp_brush_load_abr,
      GIMP_BRUSH_PSP_FILE_EXTENSION, FALSE);
  gimp_data_loader_factory_add_loader(
      gimp->brush_factory, "GIMP Generated Brush", gimp_brush_generated_load,
      GIMP_BRUSH_GENERATED_FILE_EXTENSION, TRUE);
  gimp_data_loader_factory_add_loader(gimp->brush_factory, "GIMP Brush Pipe",
                                      gimp_brush_pipe_load,
                                      GIMP_BRUSH_PIPE_FILE_EXTENSION, TRUE);

  gimp->dynamics_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_DYNAMICS, "dynamics-path", "dynamics-path-writable",
      "dynamics-paths", gimp_dynamics_new, gimp_dynamics_get_standard);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->dynamics_factory),
                              "dynamics factory");
  gimp_data_loader_factory_add_loader(gimp->dynamics_factory,
                                      "GIMP Paint Dynamics", gimp_dynamics_load,
                                      GIMP_DYNAMICS_FILE_EXTENSION, TRUE);

  gimp->mybrush_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_MYBRUSH, "mypaint-brush-path",
      "mypaint-brush-path-writable", "mypaint-brush-paths", NULL, NULL);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->mybrush_factory),
                              "mypaint brush factory");
  gimp_data_loader_factory_add_loader(gimp->mybrush_factory, "MyPaint Brush",
                                      gimp_mybrush_load,
                                      GIMP_MYBRUSH_FILE_EXTENSION, FALSE);

  gimp->pattern_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_PATTERN, "pattern-path", "pattern-path-writable",
      "pattern-paths", NULL, gimp_pattern_get_standard);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->pattern_factory),
                              "pattern factory");
  gimp_data_loader_factory_add_loader(gimp->pattern_factory, "GIMP Pattern",
                                      gimp_pattern_load,
                                      GIMP_PATTERN_FILE_EXTENSION, TRUE);
  gimp_data_loader_factory_add_fallback(gimp->pattern_factory,
                                        "Pattern from GdkPixbuf",
                                        gimp_pattern_load_pixbuf);

  gimp->gradient_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_GRADIENT, "gradient-path", "gradient-path-writable",
      "gradient-paths", gimp_gradient_new, gimp_gradient_get_standard);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->gradient_factory),
                              "gradient factory");
  gimp_data_loader_factory_add_loader(gimp->gradient_factory, "GIMP Gradient",
                                      gimp_gradient_load,
                                      GIMP_GRADIENT_FILE_EXTENSION, TRUE);
  gimp_data_loader_factory_add_loader(gimp->gradient_factory, "SVG Gradient",
                                      gimp_gradient_load_svg,
                                      GIMP_GRADIENT_SVG_FILE_EXTENSION, FALSE);

  gimp->palette_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_PALETTE, "palette-path", "palette-path-writable",
      "palette-paths", gimp_palette_new, gimp_palette_get_standard);
  gimp_object_set_static_name(GIMP_OBJECT(gimp->palette_factory),
                              "palette factory");
  gimp_data_loader_factory_add_loader(gimp->palette_factory, "GIMP Palette",
                                      gimp_palette_load,
                                      GIMP_PALETTE_FILE_EXTENSION, TRUE);

  gimp->font_factory = gimp_font_factory_new(gimp, "font-path");
  gimp_object_set_static_name(GIMP_OBJECT(gimp->font_factory), "font factory");

  gimp->tool_preset_factory = gimp_data_loader_factory_new(
      gimp, GIMP_TYPE_TOOL_PRESET, "tool-preset-path",
      "tool-preset-path-writable", "tool-preset-paths", gimp_tool_preset_new,
      NULL);
  ...
  gimp_data_loader_factory_add_loader(gimp->tool_preset_factory,
                                      "GIMP Tool Preset", gimp_tool_preset_load,
                                      GIMP_TOOL_PRESET_FILE_EXTENSION, TRUE);
...
gint64 gimp_data_factories_get_memsize(Gimp *gimp, gint64 *gui_size) {
  ...
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->brush_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->dynamics_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->mybrush_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->pattern_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->gradient_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->palette_factory), gui_size);
  memsize += gimp_object_get_memsize(GIMP_OBJECT(gimp->font_factory), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(gimp->tool_preset_factory), gui_size);

  memsize += gimp_object_get_memsize(GIMP_OBJECT(gimp->tag_cache), gui_size);
...
void gimp_data_factories_load(Gimp *gimp, GimpInitStatusFunc status_callback) {
  ...
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->brush_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->dynamics_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->mybrush_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->pattern_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->gradient_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->palette_factory));
  gimp_tag_cache_add_container(
      gimp->tag_cache, gimp_data_factory_get_container(gimp->font_factory));
  gimp_tag_cache_add_container(gimp->tag_cache, gimp_data_factory_get_container(
