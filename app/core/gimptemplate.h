...
#define GIMP_TEMPLATE(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TEMPLATE, GimpTemplate))
#define GIMP_TEMPLATE_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TEMPLATE, GimpTemplateClass))
#define GIMP_IS_TEMPLATE(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TEMPLATE))
#define GIMP_IS_TEMPLATE_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TEMPLATE))
#define GIMP_TEMPLATE_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TEMPLATE, GimpTemplateClass))
