...
#define GIMP_MYBRUSH(obj)                                                      \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_MYBRUSH, GimpMybrush))
#define GIMP_MYBRUSH_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_MYBRUSH, GimpMybrushClass))
#define GIMP_IS_MYBRUSH(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_MYBRUSH))
#define GIMP_IS_MYBRUSH_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_MYBRUSH))
#define GIMP_MYBRUSH_GET_CLASS(obj)                                            \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_MYBRUSH, GimpMybrushClass))
...
GimpData *gimp_mybrush_new(GimpContext *context, const gchar *name);
