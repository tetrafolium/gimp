...
static void gimp_layer_mask_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
                                     GimpUndoAccumulator *accum);
static void gimp_layer_mask_undo_free(GimpUndo *undo, GimpUndoMode undo_mode);
...
static void gimp_layer_mask_undo_class_init(GimpLayerMaskUndoClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_LAYER_MASK,
      g_param_spec_object("layer-mask", NULL, NULL, GIMP_TYPE_LAYER_MASK,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));
}

static void gimp_layer_mask_undo_init(GimpLayerMaskUndo *undo) {}
