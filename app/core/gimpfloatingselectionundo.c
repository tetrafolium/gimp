...
static void gimp_floating_selection_undo_init(GimpFloatingSelectionUndo *undo) {
}
  ...
  case GIMP_UNDO_FS_TO_LAYER:
    if (undo_mode == GIMP_UNDO_MODE_UNDO) {
      ...
      gimp_drawable_attach_floating_sel(
          gimp_layer_get_floating_sel_drawable(floating_layer), floating_layer);
    } else {
      gimp_drawable_detach_floating_sel(
          gimp_layer_get_floating_sel_drawable(floating_layer));
    ...
    gimp_drawable_update(GIMP_DRAWABLE(floating_layer), 0, 0,
