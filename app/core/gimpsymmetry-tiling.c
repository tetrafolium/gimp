...
static void gimp_tiling_set_property(GObject *object, guint property_id,
                                     const GValue *value, GParamSpec *pspec);
static void gimp_tiling_get_property(GObject *object, guint property_id,
...
static void gimp_tiling_update_strokes(GimpSymmetry *tiling,
                                       ...
                                       GimpCoords *origin);
static void
gimp_tiling_image_size_changed_cb(GimpImage *image, gint previous_origin_x,
...
static void gimp_tiling_class_init(GimpTilingClass *klass) {
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_INTERVAL_X, "interval-x",
                          _("Interval X"), _("Interval on the X axis (pixels)"),
                          0.0, G_MAXDOUBLE, 0.0,
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_INTERVAL_Y, "interval-y",
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_SHIFT, "shift", _("Shift"),
                          _("X-shift between lines (pixels)"), 0.0, G_MAXDOUBLE,
                          0.0,
                          GIMP_PARAM_STATIC_STRINGS | GIMP_SYMMETRY_PARAM_GUI);
  ...
  GIMP_CONFIG_PROP_INT(object_class, PROP_MAX_X, "max-x", _("Max strokes X"),
                       _("Maximum number of strokes on the X axis"), 0, 100, 0,
                       GIMP_PARAM_STATIC_STRINGS | GIMP_SYMMETRY_PARAM_GUI);

  GIMP_CONFIG_PROP_INT(object_class, PROP_MAX_Y, "max-y", _("Max strokes Y"),
                       _("Maximum number of strokes on the Y axis"), 0, 100, 0,
                       GIMP_PARAM_STATIC_STRINGS | GIMP_SYMMETRY_PARAM_GUI);
}

static void gimp_tiling_init(GimpTiling *tiling) {}
...
static void gimp_tiling_constructed(GObject *object) {
  ...
  g_signal_connect_object(sym->image, "size-changed-detailed",
                          G_CALLBACK(gimp_tiling_image_size_changed_cb), sym,
                          0);
...
static void gimp_tiling_update_strokes(GimpSymmetry *sym,
                                       GimpDrawable *drawable,
                                       GimpCoords *origin) {
