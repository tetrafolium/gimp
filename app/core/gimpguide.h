...
#define GIMP_GUIDE(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GUIDE, GimpGuide))
#define GIMP_GUIDE_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GUIDE, GimpGuideClass))
#define GIMP_IS_GUIDE(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GUIDE))
#define GIMP_IS_GUIDE_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GUIDE))
#define GIMP_GUIDE_GET_CLASS(obj)                                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_GUIDE, GimpGuideClass))
