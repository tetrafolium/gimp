...
#define GIMP_BRUSH(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_BRUSH, GimpBrush))
#define GIMP_BRUSH_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_BRUSH, GimpBrushClass))
#define GIMP_IS_BRUSH(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_BRUSH))
#define GIMP_IS_BRUSH_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_BRUSH))
#define GIMP_BRUSH_GET_CLASS(obj)                                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_BRUSH, GimpBrushClass))
...
struct _GimpBrushClass {
  ...
  GimpBrush *(*select_brush)(GimpBrush *brush, const GimpCoords *last_coords,
                             const GimpCoords *current_coords);
  gboolean (*want_null_motion)(GimpBrush *brush, const GimpCoords *last_coords,
                               const GimpCoords *current_coords);
  void (*transform_size)(GimpBrush *brush, gdouble scale, gdouble aspect_ratio,
                         gdouble angle, gboolean reflect, gint *width,
                         gint *height);
  GimpTempBuf *(*transform_mask)(GimpBrush *brush, gdouble scale,
                                 gdouble aspect_ratio, gdouble angle,
                                 gboolean reflect, gdouble hardness);
  GimpTempBuf *(*transform_pixmap)(GimpBrush *brush, gdouble scale,
                                   gdouble aspect_ratio, gdouble angle,
                                   gboolean reflect, gdouble hardness);
  GimpBezierDesc *(*transform_boundary)(GimpBrush *brush, gdouble scale,
                                        gdouble aspect_ratio, gdouble angle,
                                        gboolean reflect, gdouble hardness,
