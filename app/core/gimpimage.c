...
static void gimp_image_set_property(GObject *object, guint property_id,
                                    const GValue *value, GParamSpec *pspec);
static void gimp_image_get_property(GObject *object, guint property_id,
...
static gboolean gimp_image_get_size(GimpViewable *viewable, gint *width,
                                    gint *height);
...
static void gimp_image_real_size_changed_detailed(GimpImage *image,
...
static const guint8 *
gimp_image_color_managed_get_icc_profile(GimpColorManaged *managed, gsize *len);
static GimpColorProfile *
gimp_image_color_managed_get_color_profile(GimpColorManaged *managed);
static void gimp_image_color_managed_profile_changed(GimpColorManaged *managed);
...
static gboolean gimp_image_get_pixel_at(GimpPickable *pickable, gint x, gint y,
                                        const Babl *format, gpointer pixel);
static gdouble gimp_image_get_opacity_at(GimpPickable *pickable, gint x,
                                         gint y);
static void gimp_image_get_pixel_average(GimpPickable *pickable,
                                         const GeglRectangle *rect,
                                         const Babl *format, gpointer pixel);
static void gimp_image_pixel_to_srgb(GimpPickable *pickable, const Babl *format,
                                     gpointer pixel, GimpRGB *color);
static void gimp_image_srgb_to_pixel(GimpPickable *pickable,
                                     const GimpRGB *color, const Babl *format,
                                     gpointer pixel);

static void gimp_image_projection_buffer_notify(GimpProjection *projection,
                                                const GParamSpec *pspec,
                                                GimpImage *image);
static void gimp_image_mask_update(GimpDrawable *drawable, gint x, gint y,
                                   gint width, gint height, GimpImage *image);
static void gimp_image_layers_changed(GimpContainer *container,
                                      GimpChannel *channel, GimpImage *image);
static void gimp_image_layer_offset_changed(GimpDrawable *drawable,
                                            const GParamSpec *pspec,
                                            GimpImage *image);
static void gimp_image_layer_bounding_box_changed(GimpDrawable *drawable,
                                                  GimpImage *image);
...
static gint gimp_image_layer_stack_cmp(GList *layers1, GList *layers2);
...
G_DEFINE_TYPE_WITH_CODE(GimpImage, gimp_image, GIMP_TYPE_VIEWABLE,
                        G_ADD_PRIVATE(GimpImage) G_IMPLEMENT_INTERFACE(
...
static void gimp_image_class_init(GimpImageClass *klass) {
  ...
  gimp_image_signals[MODE_CHANGED] =
      g_signal_new("mode-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, mode_changed), NULL, NULL,
                   NULL, G_TYPE_NONE, 0);

  gimp_image_signals[PRECISION_CHANGED] = g_signal_new(
      "precision-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, precision_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[ALPHA_CHANGED] = g_signal_new(
      "alpha-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, alpha_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[FLOATING_SELECTION_CHANGED] =
      g_signal_new("floating-selection-changed", G_TYPE_FROM_CLASS(klass),
                   G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, floating_selection_changed),
                   NULL, NULL, NULL, G_TYPE_NONE, 0);

  gimp_image_signals[SELECTED_LAYERS_CHANGED] = g_signal_new(
      "selected-layers-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, selected_layers_changed), NULL, NULL,
      NULL, G_TYPE_NONE, 0);

  gimp_image_signals[SELECTED_CHANNELS_CHANGED] = g_signal_new(
      "selected-channels-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, selected_channels_changed), NULL, NULL,
      NULL, G_TYPE_NONE, 0);

  gimp_image_signals[SELECTED_VECTORS_CHANGED] = g_signal_new(
      "selected-vectors-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, selected_vectors_changed), NULL, NULL,
      NULL, G_TYPE_NONE, 0);

  gimp_image_signals[LINKED_ITEMS_CHANGED] = g_signal_new(
      "linked-items-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, linked_items_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[COMPONENT_VISIBILITY_CHANGED] = g_signal_new(
      "component-visibility-changed", G_TYPE_FROM_CLASS(klass),
      G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, component_visibility_changed), NULL, NULL,
      NULL, G_TYPE_NONE, 1, GIMP_TYPE_CHANNEL_TYPE);

  gimp_image_signals[COMPONENT_ACTIVE_CHANGED] = g_signal_new(
      "component-active-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, component_active_changed), NULL, NULL,
      NULL, G_TYPE_NONE, 1, GIMP_TYPE_CHANNEL_TYPE);

  gimp_image_signals[MASK_CHANGED] =
      g_signal_new("mask-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, mask_changed), NULL, NULL,
                   NULL, G_TYPE_NONE, 0);

  gimp_image_signals[RESOLUTION_CHANGED] = g_signal_new(
      "resolution-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, resolution_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[SIZE_CHANGED_DETAILED] = g_signal_new(
      "size-changed-detailed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, size_changed_detailed), NULL, NULL,
      gimp_marshal_VOID__INT_INT_INT_INT, G_TYPE_NONE, 4, G_TYPE_INT,
      G_TYPE_INT, G_TYPE_INT, G_TYPE_INT);

  gimp_image_signals[UNIT_CHANGED] =
      g_signal_new("unit-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, unit_changed), NULL, NULL,
                   NULL, G_TYPE_NONE, 0);

  gimp_image_signals[QUICK_MASK_CHANGED] = g_signal_new(
      "quick-mask-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, quick_mask_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[SELECTION_INVALIDATE] = g_signal_new(
      "selection-invalidate", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, selection_invalidate), NULL, NULL, NULL,
      G_TYPE_NONE, 0);

  gimp_image_signals[CLEAN] =
      g_signal_new("clean", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, clean), NULL, NULL, NULL,
                   G_TYPE_NONE, 1, GIMP_TYPE_DIRTY_MASK);

  gimp_image_signals[DIRTY] =
      g_signal_new("dirty", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, dirty), NULL, NULL, NULL,
                   G_TYPE_NONE, 1, GIMP_TYPE_DIRTY_MASK);

  gimp_image_signals[SAVING] =
      g_signal_new("saving", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, saving), NULL, NULL, NULL,
                   G_TYPE_NONE, 0);

  gimp_image_signals[SAVED] =
      g_signal_new("saved", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, saved), NULL, NULL, NULL,
                   G_TYPE_NONE, 1, G_TYPE_FILE);

  gimp_image_signals[EXPORTED] =
      g_signal_new("exported", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, exported), NULL, NULL, NULL,
                   G_TYPE_NONE, 1, G_TYPE_FILE);

  gimp_image_signals[GUIDE_ADDED] =
      g_signal_new("guide-added", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, guide_added), NULL, NULL,
                   NULL, G_TYPE_NONE, 1, GIMP_TYPE_GUIDE);

  gimp_image_signals[GUIDE_REMOVED] = g_signal_new(
      "guide-removed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, guide_removed), NULL, NULL, NULL,
      G_TYPE_NONE, 1, GIMP_TYPE_GUIDE);

  gimp_image_signals[GUIDE_MOVED] =
      g_signal_new("guide-moved", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, guide_moved), NULL, NULL,
                   NULL, G_TYPE_NONE, 1, GIMP_TYPE_GUIDE);

  gimp_image_signals[SAMPLE_POINT_ADDED] = g_signal_new(
      "sample-point-added", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, sample_point_added), NULL, NULL, NULL,
      G_TYPE_NONE, 1, GIMP_TYPE_SAMPLE_POINT);

  gimp_image_signals[SAMPLE_POINT_REMOVED] = g_signal_new(
      "sample-point-removed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, sample_point_removed), NULL, NULL, NULL,
      G_TYPE_NONE, 1, GIMP_TYPE_SAMPLE_POINT);

  gimp_image_signals[SAMPLE_POINT_MOVED] = g_signal_new(
      "sample-point-moved", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, sample_point_moved), NULL, NULL, NULL,
      G_TYPE_NONE, 1, GIMP_TYPE_SAMPLE_POINT);

  gimp_image_signals[PARASITE_ATTACHED] = g_signal_new(
      "parasite-attached", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, parasite_attached), NULL, NULL, NULL,
      G_TYPE_NONE, 1, G_TYPE_STRING);

  gimp_image_signals[PARASITE_DETACHED] = g_signal_new(
      "parasite-detached", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, parasite_detached), NULL, NULL, NULL,
      G_TYPE_NONE, 1, G_TYPE_STRING);

  gimp_image_signals[COLORMAP_CHANGED] = g_signal_new(
      "colormap-changed", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpImageClass, colormap_changed), NULL, NULL, NULL,
      G_TYPE_NONE, 1, G_TYPE_INT);

  gimp_image_signals[UNDO_EVENT] =
      g_signal_new("undo-event", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
                   G_STRUCT_OFFSET(GimpImageClass, undo_event), NULL, NULL,
                   gimp_marshal_VOID__ENUM_OBJECT, G_TYPE_NONE, 2,
                   GIMP_TYPE_UNDO_EVENT, GIMP_TYPE_UNDO);
  ...
  g_object_class_install_property(
      object_class, PROP_GIMP,
      g_param_spec_object("gimp", NULL, NULL, GIMP_TYPE_GIMP,
                          GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));

  g_object_class_install_property(
      object_class, PROP_ID,
      g_param_spec_int("id", NULL, NULL, 0, G_MAXINT, 0, GIMP_PARAM_READABLE));

  g_object_class_install_property(
      object_class, PROP_WIDTH,
      g_param_spec_int("width", NULL, NULL, 1, GIMP_MAX_IMAGE_SIZE, 1,
                       GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_HEIGHT,
      g_param_spec_int("height", NULL, NULL, 1, GIMP_MAX_IMAGE_SIZE, 1,
                       GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_BASE_TYPE,
      g_param_spec_enum("base-type", NULL, NULL, GIMP_TYPE_IMAGE_BASE_TYPE,
                        GIMP_RGB, GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));

  g_object_class_install_property(
      object_class, PROP_PRECISION,
      g_param_spec_enum("precision", NULL, NULL, GIMP_TYPE_PRECISION,
  ...
  g_object_class_install_property(
      object_class, PROP_SYMMETRY,
      g_param_spec_gtype("symmetry", NULL, _("Symmetry"), GIMP_TYPE_SYMMETRY,
                         GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT));
}
...
static void gimp_projectable_iface_init(GimpProjectableInterface *iface) {
  ...
  iface->invalidate_preview =
      (void (*)(GimpProjectable *))gimp_viewable_invalidate_preview;
}

static void gimp_pickable_iface_init(GimpPickableInterface *iface) {
  iface->flush = gimp_image_pickable_flush;
  iface->get_image =
      (GimpImage * (*)(GimpPickable * pickable)) gimp_image_get_image;
  iface->get_format =
      (const Babl *(*)(GimpPickable * pickable)) gimp_image_get_proj_format;
...
private
  ->resolution_unit = GIMP_UNIT_INCH;
private
  ->base_type = GIMP_RGB;
private
...
private
  ->projection = gimp_projection_new(GIMP_PROJECTABLE(image));

private
  ->symmetries = NULL;
private
  ->active_symmetry = NULL;
...
private
  ->layers = gimp_item_tree_new(image, GIMP_TYPE_LAYER_STACK, GIMP_TYPE_LAYER);
private
  ->channels =
      gimp_item_tree_new(image, GIMP_TYPE_DRAWABLE_STACK, GIMP_TYPE_CHANNEL);
private
  ->vectors =
      gimp_item_tree_new(image, GIMP_TYPE_ITEM_STACK, GIMP_TYPE_VECTORS);
private
  ->layer_stack = NULL;

  g_signal_connect(private->projection, "notify::buffer",
                   G_CALLBACK(gimp_image_projection_buffer_notify), image);

  g_signal_connect(private->layers, "notify::selected-items",
                   G_CALLBACK(gimp_image_selected_layers_notify), image);
  g_signal_connect(private->channels, "notify::selected-items",
                   G_CALLBACK(gimp_image_selected_channels_notify), image);
  g_signal_connect(private->vectors, "notify::selected-items",
                   G_CALLBACK(gimp_image_selected_vectors_notify), image);

  g_signal_connect_swapped(private->layers->container, "update",
                           G_CALLBACK(gimp_image_invalidate), image);

private
  ->layer_offset_x_handler = gimp_container_add_handler(
      private->layers->container, "notify::offset-x",
      G_CALLBACK(gimp_image_layer_offset_changed), image);
private
  ->layer_offset_y_handler = gimp_container_add_handler(
      private->layers->container, "notify::offset-y",
      G_CALLBACK(gimp_image_layer_offset_changed), image);
private
  ->layer_bounding_box_handler = gimp_container_add_handler(
      private->layers->container, "bounding-box-changed",
      G_CALLBACK(gimp_image_layer_bounding_box_changed), image);
private
  ->layer_alpha_handler = gimp_container_add_handler(
      private->layers->container, "alpha-changed",
      G_CALLBACK(gimp_image_layer_alpha_changed), image);

  g_signal_connect(private->layers->container, "add",
                   G_CALLBACK(gimp_image_layers_changed), image);
...
private
  ->channel_name_changed_handler = gimp_container_add_handler(
      private->channels->container, "name-changed",
      G_CALLBACK(gimp_image_channel_name_changed), image);
private
  ->channel_color_changed_handler = gimp_container_add_handler(
      private->channels->container, "color-changed",
      G_CALLBACK(gimp_image_channel_color_changed), image);

  g_signal_connect(private->channels->container, "add",
                   G_CALLBACK(gimp_image_channel_add), image);
  g_signal_connect(private->channels->container, "remove",
                   G_CALLBACK(gimp_image_channel_remove), image);
...
private
  ->parasites = gimp_parasite_list_new();
...
private
  ->quick_mask_state = FALSE;
private
  ->quick_mask_inverted = FALSE;
  gimp_rgba_set(&private->quick_mask_color, 1.0, 0.0, 0.0, 0.5);

private
  ->undo_stack = gimp_undo_stack_new(image);
private
  ->redo_stack = gimp_undo_stack_new(image);
private
  ->group_count = 0;
private
...
private
  ->flush_accum.alpha_changed = FALSE;
private
  ->flush_accum.mask_changed = FALSE;
private
  ->flush_accum.floating_selection_changed = FALSE;
private
  ->flush_accum.preview_invalidated = FALSE;
}
...
private
  ->ID = gimp_id_table_insert(image->gimp->image_table, image);

  template = config->default_image;

private
  ->xresolution = gimp_template_get_resolution_x(template);
private
  ->yresolution = gimp_template_get_resolution_y(template);
private
  ->resolution_unit = gimp_template_get_resolution_unit(template);

private
  ->grid = gimp_config_duplicate(GIMP_CONFIG(config->default_grid));

private
  ->quick_mask_color = config->quick_mask_color;
  ...
  selection = gimp_selection_new(image, gimp_image_get_width(image),
  ...
  g_signal_connect_object(config, "notify::layer-previews",
                          G_CALLBACK(gimp_viewable_size_changed), image,
                          G_CONNECT_SWAPPED);
...
static void gimp_image_set_property(GObject *object, guint property_id,
  ...
  case PROP_BASE_TYPE:
  private
    ->base_type = g_value_get_enum(value);
    _gimp_image_free_color_transforms(image);
    break;

  case PROP_PRECISION:
  private
    ->precision = g_value_get_enum(value);
    _gimp_image_free_color_transforms(image);
    break;
  ...
  case PROP_SYMMETRY: {
    ...
    if (private->active_symmetry)
      g_object_set(private->active_symmetry, "active", FALSE, NULL);
  private
    ->active_symmetry = NULL;
    ...
    for (iter = private->symmetries; iter; iter = g_list_next(iter)) {
      ...
      private
      ->active_symmetry = iter->data;
    }

    if (!private->active_symmetry && g_type_is_a(type, GIMP_TYPE_SYMMETRY)) {
    ...
    if (private->active_symmetry)
      g_object_set(private->active_symmetry, "active", TRUE, NULL);
  } break;
...
static void gimp_image_dispose(GObject *object) {
  ...
  g_signal_handlers_disconnect_by_func(private->layers->container,
                                       gimp_image_layers_changed, image);
  ...
  g_signal_handlers_disconnect_by_func(private->channels->container,
                                       gimp_image_channel_add, image);
  g_signal_handlers_disconnect_by_func(private->channels->container,
                                       gimp_image_channel_remove, image);
...
private
  ...
  if (private->layer_stack) {
    g_slist_free_full(private->layer_stack, (GDestroyNotify)g_list_free);
  private
    ->layer_stack = NULL;
  }
  ...
  if (private->sample_points) {
    g_list_free_full(private->sample_points, (GDestroyNotify)g_object_unref);
  private
    ->sample_points = NULL;
  }
...
static gint64 gimp_image_get_memsize(GimpObject *object, gint64 *gui_size) {
  ...
  memsize += gimp_object_get_memsize(GIMP_OBJECT(private->palette), gui_size);

  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(private->projection), gui_size);

  memsize +=
      gimp_g_list_get_memsize(gimp_image_get_guides(image), sizeof(GimpGuide));
  ...
  memsize += gimp_object_get_memsize(GIMP_OBJECT(private->layers), gui_size);
  memsize += gimp_object_get_memsize(GIMP_OBJECT(private->channels), gui_size);
  memsize += gimp_object_get_memsize(GIMP_OBJECT(private->vectors), gui_size);

  memsize += gimp_g_slist_get_memsize(private->layer_stack, 0);

  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(private->selection_mask), gui_size);

  memsize += gimp_object_get_memsize(GIMP_OBJECT(private->parasites), gui_size);

  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(private->undo_stack), gui_size);
  memsize +=
      gimp_object_get_memsize(GIMP_OBJECT(private->redo_stack), gui_size);
...
static gchar *gimp_image_get_description(GimpViewable *viewable,
  ...
  return g_strdup_printf("%s-%d", gimp_image_get_display_name(image),
...
static void gimp_image_real_colormap_changed(GimpImage *image,
  ...
  if (gimp_image_get_base_type(image) == GIMP_INDEXED) {
    ...
    gimp_item_stack_invalidate_previews(
        GIMP_ITEM_STACK(private->layers->container));
  }
}
...
static GeglBuffer *gimp_image_get_buffer(GimpPickable *pickable) {
  ...
  if (!private->pickable_buffer) {
    ...
    if (!private->show_all) {
    private
      ->pickable_buffer = g_object_ref(buffer);
    } else {
    private
      ->pickable_buffer = gegl_buffer_create_sub_buffer(
          buffer, GEGL_RECTANGLE(0, 0, gimp_image_get_width(image),
                                 gimp_image_get_height(image)));
    }
  }
...
static gboolean gimp_image_get_pixel_at(GimpPickable *pickable, gint x, gint y,
  ...
  if (x >= 0 && y >= 0 && x < gimp_image_get_width(image) &&
      y < gimp_image_get_height(image)) {
    return gimp_pickable_get_pixel_at(GIMP_PICKABLE(private->projection), x, y,
                                      format, pixel);
  }
...
static gdouble gimp_image_get_opacity_at(GimpPickable *pickable, gint x,
  ...
  if (x >= 0 && y >= 0 && x < gimp_image_get_width(image) &&
      y < gimp_image_get_height(image)) {
    return gimp_pickable_get_opacity_at(GIMP_PICKABLE(private->projection), x,
                                        y);
  }
...
static void gimp_image_pixel_to_srgb(GimpPickable *pickable, const Babl *format,
                                     gpointer pixel, GimpRGB *color) {
  gimp_image_color_profile_pixel_to_srgb(GIMP_IMAGE(pickable), format, pixel,
                                         color);
}
...
static void gimp_image_srgb_to_pixel(GimpPickable *pickable,
                                     const GimpRGB *color, const Babl *format,
                                     gpointer pixel) {
  gimp_image_color_profile_srgb_to_pixel(GIMP_IMAGE(pickable), color, format,
                                         pixel);
}
...
private
  ...
  layers_node = gimp_filter_stack_get_graph(
      GIMP_FILTER_STACK(private->layers->container));
...
private
  ->visible_mask =
      gegl_node_new_child(private->graph, "operation", "gimp:mask-components",
                          "mask", mask, "alpha", 1.0, NULL);

  gegl_node_connect_to(layers_node, "output", private->visible_mask, "input");

  channels_node = gimp_filter_stack_get_graph(
      GIMP_FILTER_STACK(private->channels->container));

  gegl_node_add_child(private->graph, channels_node);

  gegl_node_connect_to(private->visible_mask, "output", channels_node, "input");

  output = gegl_node_get_output_proxy(private->graph, "output");

  gegl_node_connect_to(channels_node, "output", output, "input");
...
static void gimp_image_layer_alpha_changed(GimpDrawable *drawable,
  ...
  private
  ->flush_accum.alpha_changed = TRUE;
}

static void gimp_image_channel_add(GimpContainer *container,
                                   GimpChannel *channel, GimpImage *image) {
  if (!strcmp(GIMP_IMAGE_QUICK_MASK_NAME, gimp_object_get_name(channel))) {
...
static void gimp_image_selected_layers_notify(GimpItemTree *tree,
  ...
  if (layers) {
    ...
    private
      ->layer_stack = g_slist_delete_link(private->layer_stack, prev_layers);
    }
  private
    ->layer_stack = g_slist_prepend(private->layer_stack, g_list_copy(layers));
  }
...
private
  ...
  private
    ->bounding_box_update_pending = FALSE;
...
static void gimp_image_update_bounding_box(GimpImage *image) {
  ...
  if (private->bounding_box_freeze_count > 0) {
  private
    ->bounding_box_update_pending = TRUE;
  ...
  if (private->show_all) {
    ...
    for (iter = gimp_image_get_layer_iter(image); iter;
      ...
      layer_bounding_box = gimp_drawable_get_bounding_box(GIMP_DRAWABLE(layer));

      layer_bounding_box.x += offset_x;
      layer_bounding_box.y += offset_y;

      gegl_rectangle_bounding_box(&bounding_box, &bounding_box,
                                  &layer_bounding_box);
    }
  }
...
private
  ...
  for (slist = private->layer_stack; slist; slist = slist->next) {
    ...
    if (layers == NULL)
    private
    ->layer_stack = g_slist_delete_link(private->layer_stack, slist);
    else slist->data = layers;
  }
...
GimpImage *gimp_image_new(Gimp *gimp, gint width, gint height,
                          GimpImageBaseType base_type,
                          GimpPrecision precision) {
  g_return_val_if_fail(GIMP_IS_GIMP(gimp), NULL);
  g_return_val_if_fail(gimp_babl_is_valid(base_type, precision), NULL);

  return g_object_new(GIMP_TYPE_IMAGE, "gimp", gimp, "width", width, "height",
                      height, "base-type", base_type, "precision", precision,
                      NULL);
}

gint64 gimp_image_estimate_memsize(GimpImage *image,
                                   GimpComponentType component_type, gint width,
                                   gint height) {
  GList *drawables;
  GList *list;
  gint current_width;
  ...
  drawables = gimp_image_item_list_get_list(
      image, GIMP_ITEM_TYPE_LAYERS | GIMP_ITEM_TYPE_CHANNELS,
      GIMP_ITEM_SET_ALL);
  ...
  for (list = drawables; list; list = g_list_next(list)) {
    ...
    scalable_size += gimp_drawable_estimate_memsize(
        drawable, gimp_drawable_get_component_type(drawable), drawable_width,
        drawable_height);

    scaled_size += gimp_drawable_estimate_memsize(
        drawable, component_type, drawable_width * width / current_width,
        drawable_height * height / current_height);
  }

  g_list_free(drawables);

  scalable_size += gimp_projection_estimate_memsize(
      gimp_image_get_base_type(image), gimp_image_get_component_type(image),
      gimp_image_get_width(image), gimp_image_get_height(image));

  scaled_size += gimp_projection_estimate_memsize(
      gimp_image_get_base_type(image), component_type, width, height);

  GIMP_LOG(IMAGE_SCALE,
           "scalable_size = %" G_GINT64_FORMAT
           "  scaled_size = %" G_GINT64_FORMAT,
...
const Babl *gimp_image_get_format(GimpImage *image, GimpImageBaseType base_type,
                                  GimpPrecision precision, gboolean with_alpha,
                                  const Babl *space) {
...
const Babl *gimp_image_get_layer_format(GimpImage *image, gboolean with_alpha) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);

  return gimp_image_get_format(image, gimp_image_get_base_type(image),
                               gimp_image_get_precision(image), with_alpha,
                               gimp_image_get_layer_space(image));
}
...
const Babl *gimp_image_get_channel_format(GimpImage *image) {
  ...
  if (precision == GIMP_PRECISION_U8_NON_LINEAR)
    return gimp_image_get_format(image, GIMP_GRAY,
                                 gimp_image_get_precision(image), FALSE, NULL);
    ...
    if (layers) {
      ...
      for (list = layers; list; list = g_list_next(list)) {
        ...
        if (!gimp_layer_mode_is_legacy(mode)) {
           ...
           */
        private
          ->new_layer_mode = GIMP_LAYER_MODE_NORMAL;
          break;
        }
      }
      ...
      if (!list)
      private
      ->new_layer_mode = GIMP_LAYER_MODE_NORMAL_LEGACY;
...
void gimp_image_set_file(GimpImage *image, GFile *file) {
  GimpImagePrivate *private;
...
private
  ...
  private
  ->untitled_file = g_file_new_for_uri(_("Untitled"));
 ...
 **/
void gimp_image_set_imported_file(GimpImage *image, GFile *file) {
  GimpImagePrivate *private;
 ...
 **/
void gimp_image_set_exported_file(GimpImage *image, GFile *file) {
  GimpImagePrivate *private;
 ...
 * "save a copy" action.
 **/
void gimp_image_set_save_a_copy_file(GimpImage *image, GFile *file) {
  GimpImagePrivate *private;
...
static gchar *gimp_image_format_display_uri(GimpImage *image,
                                            gboolean basename) {
...
private
  ...
  private
  ->display_name = gimp_image_format_display_uri(image, TRUE);
...
private
  ...
  private
  ->display_path = gimp_image_format_display_uri(image, FALSE);
...
void gimp_image_set_export_proc(GimpImage *image, GimpPlugInProcedure *proc) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
...
gint gimp_image_get_xcf_version(GimpImage *image, gboolean zlib_compression,
                                gint *gimp_version,
...
#define ADD_REASON(_reason)                                                    \
  ...
  for (list = layers; list; list = g_list_next(list)) {
    ...
    case GIMP_LAYER_MODE_COLOR_ERASE_LEGACY:
      gimp_enum_get_value(GIMP_TYPE_LAYER_MODE, gimp_layer_get_mode(layer),
    ...
    if (gimp_viewable_get_children(GIMP_VIEWABLE(layer))) {
      ADD_REASON(
          g_strdup_printf(_("Layer groups were added in %s"), "GIMP 2.8"));
...
void gimp_image_set_xcf_compression(GimpImage *image, gboolean compression) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
...
void gimp_image_set_resolution(GimpImage *image, gdouble xresolution,
                               gdouble yresolution) {
  GimpImagePrivate *private;
...
private
  ...
  if ((ABS(private->xresolution - xresolution) >= 1e-5) ||
    ...
    gimp_image_undo_push_image_resolution(
        image, C_("undo-type", "Change Image Resolution"));
  ...
  private
    ...
    gimp_image_size_changed_detailed(image, 0, 0, gimp_image_get_width(image),
                                     gimp_image_get_height(image));
  }
}

void gimp_image_get_resolution(GimpImage *image, gdouble *xresolution,
                               gdouble *yresolution) {
  GimpImagePrivate *private;
...
private
  ...
  layer =
      GIMP_LAYER(gimp_container_get_first_child(private->layers->container));
...
gboolean gimp_image_is_empty(GimpImage *image) {
  ...
  return gimp_container_is_empty(
      GIMP_IMAGE_GET_PRIVATE(image)->layers->container);
}
...
private
  ...
  private
    ->flush_accum.floating_selection_changed = TRUE;
  }
}
 ...
 */
gboolean gimp_image_mask_intersect(GimpImage *image, GList *items, gint *x,
  ...
  if (selection)
    gimp_item_bounds(GIMP_ITEM(selection), &sel_x, &sel_y, &sel_width,
                     &sel_height);
  ...
  for (iter = items; iter; iter = iter->next) {
     ...
     */
    if (GIMP_ITEM(selection) != item && !gimp_channel_is_empty(selection)) {
      item_intersect = gimp_rectangle_intersect(
          sel_x, sel_y, sel_width, sel_height, tmp_x, tmp_y,
          gimp_item_get_width(item), gimp_item_get_height(item), &tmp_x, &tmp_y,
...
private
  ->selection_mask = g_object_ref_sink(mask);

  g_signal_connect(private->selection_mask, "update",
                   G_CALLBACK(gimp_image_mask_update), image);
}
...
const Babl *gimp_image_get_component_format(GimpImage *image,
  ...
  case GIMP_CHANNEL_RED:
    return gimp_babl_component_format(GIMP_RGB, gimp_image_get_precision(image),
                                      RED);
  ...
  case GIMP_CHANNEL_GRAY:
    return gimp_babl_component_format(GIMP_GRAY,
                                      gimp_image_get_precision(image), GRAY);
...
gint gimp_image_get_component_index(GimpImage *image, GimpChannelType channel) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), -1);
...
void gimp_image_set_component_active(GimpImage *image, GimpChannelType channel,
                                     gboolean active) {
  GimpImagePrivate *private;
  gint index = -1;
...
private
  ...
  private
    ...
    g_signal_emit(image, gimp_image_signals[COMPONENT_ACTIVE_CHANGED], 0,
                  channel);
  }
}
...
void gimp_image_get_active_array(GimpImage *image, gboolean *components) {
  GimpImagePrivate *private;
  gint i;
...
void gimp_image_set_component_visible(GimpImage *image, GimpChannelType channel,
                                      gboolean visible) {
  GimpImagePrivate *private;
  gint index = -1;
...
private
  ...
  private
    ...
    if (private->visible_mask) {
      ...
      gegl_node_set(private->visible_mask, "mask", mask, NULL);
    }

    g_signal_emit(image, gimp_image_signals[COMPONENT_VISIBILITY_CHANGED], 0,
                  channel);
...
void gimp_image_get_visible_array(GimpImage *image, gboolean *components) {
  GimpImagePrivate *private;
  gint i;
...
void gimp_image_invalidate(GimpImage *image, gint x, gint y, gint width,
                           gint height) {
  g_return_if_fail(GIMP_IS_IMAGE(image));

  gimp_projectable_invalidate(GIMP_PROJECTABLE(image), x, y, width, height);
...
void gimp_image_invalidate_all(GimpImage *image) {
  ...
  gimp_image_invalidate(image, bounding_box->x, bounding_box->y,
 ...
 **/
void gimp_image_size_changed_detailed(GimpImage *image, gint previous_origin_x,
                                      gint previous_origin_y,
                                      gint previous_width,
                                      gint previous_height) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
  ...
  g_signal_emit(image, gimp_image_signals[SIZE_CHANGED_DETAILED], 0,
                previous_origin_x, previous_origin_y, previous_width,
                previous_height);
}
...
void gimp_image_undo_event(GimpImage *image, GimpUndoEvent event,
                           GimpUndo *undo) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
  g_return_if_fail(((event == GIMP_UNDO_EVENT_UNDO_FREE ||
                     event == GIMP_UNDO_EVENT_UNDO_FREEZE ||
                     event == GIMP_UNDO_EVENT_UNDO_THAW) &&
                    undo == NULL) ||
                   GIMP_IS_UNDO(undo));
 ...
 */
void gimp_image_saved(GimpImage *image, GFile *file) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
 ...
 * location specified by @file.
 */
void gimp_image_exported(GimpImage *image, GFile *file) {
  g_return_if_fail(GIMP_IS_IMAGE(image));
  g_return_if_fail(G_IS_FILE(file));
...
gchar **gimp_image_parasite_list(GimpImage *image, gint *count) {
  GimpImagePrivate *private;
  gchar **list;
  gchar **cur;
...
private
  ...
  if (strcmp(name, GIMP_ICC_PROFILE_PARASITE_NAME) == 0) {
    ...
    profile = gimp_color_profile_new_from_icc_profile(
        gimp_parasite_data(parasite), gimp_parasite_data_size(parasite), NULL);
  ...
  if (push_undo && gimp_parasite_is_undoable(&copy))
    gimp_image_undo_push_image_parasite(
        image, C_("undo-type", "Attach Parasite to Image"), &copy);
  ...
  g_signal_emit(image, gimp_image_signals[PARASITE_ATTACHED], 0, name);
}
...
private
  ...
  if (push_undo && gimp_parasite_is_undoable(parasite))
    gimp_image_undo_push_image_parasite_remove(
        image, C_("undo-type", "Remove Parasite from Image"), name);
...
void gimp_image_set_selected_layers(GimpImage *image, GList *layers) {
  GimpImagePrivate *private;
  GimpLayer *floating_sel;
  GList *selected_layers;
  GList *layers2;
...
private
  ...
  if (floating_sel &&
      (g_list_length(layers2) != 1 || layers2->data != floating_sel))
    return;
...
void gimp_image_set_selected_channels(GimpImage *image, GList *channels) {
  GimpImagePrivate *private;
  GList *iter;
...
void gimp_image_set_selected_vectors(GimpImage *image, GList *vectors) {
  GimpImagePrivate *private;
  GList *iter;
...
GimpLayer *gimp_image_get_layer_by_tattoo(GimpImage *image, GimpTattoo tattoo) {
  GimpItemStack *stack;
...
gboolean gimp_image_reorder_item(GimpImage *image, GimpItem *item,
                                 GimpItem *new_parent, gint new_index,
...
gboolean gimp_image_raise_item(GimpImage *image, GimpItem *item,
                               GError **error) {
  gint index;
  ...
  return gimp_image_reorder_item(image, item, gimp_item_get_parent(item),
                                 index - 1, TRUE,
                                 GIMP_ITEM_GET_CLASS(item)->raise_desc);
}
...
gboolean gimp_image_raise_item_to_top(GimpImage *image, GimpItem *item) {
  ...
  return gimp_image_reorder_item(image, item, gimp_item_get_parent(item), 0,
                                 TRUE,
                                 GIMP_ITEM_GET_CLASS(item)->raise_to_top_desc);
}

gboolean gimp_image_lower_item(GimpImage *image, GimpItem *item,
                               GError **error) {
  ...
  return gimp_image_reorder_item(image, item, gimp_item_get_parent(item),
                                 index + 1, TRUE,
                                 GIMP_ITEM_GET_CLASS(item)->lower_desc);
}
...
gboolean gimp_image_lower_item_to_bottom(GimpImage *image, GimpItem *item) {
  ...
  return gimp_image_reorder_item(
      image, item, gimp_item_get_parent(item), length - 1, TRUE,
      GIMP_ITEM_GET_CLASS(item)->lower_to_bottom_desc);
}

/*  layers  */

gboolean gimp_image_add_layer(GimpImage *image, GimpLayer *layer,
                              GimpLayer *parent, gint position,
                              gboolean push_undo) {
  GimpImagePrivate *private;
  GList *selected_layers;
...
private
   ...
   */
  if (!gimp_item_tree_get_insert_pos(private->layers, (GimpItem *)layer,
                                     (GimpItem **)&parent, &position))
    return FALSE;
  ...
  if (push_undo)
    gimp_image_undo_push_layer_add(image, C_("undo-type", "Add Layer"), layer,
                                   gimp_image_get_selected_layers(image));

  gimp_item_tree_add_item(private->layers, GIMP_ITEM(layer), GIMP_ITEM(parent),
                          position);
  ...
  if (gimp_layer_is_floating_sel(layer))
    gimp_drawable_attach_floating_sel(
        gimp_layer_get_floating_sel_drawable(layer), layer);
...
void gimp_image_remove_layer(GimpImage *image, GimpLayer *layer,
                             gboolean push_undo, GList *new_selected) {
  GimpImagePrivate *private;
  GList *selected_layers;
  gboolean old_has_alpha;
...
private
  ...
  if (gimp_drawable_get_floating_sel(GIMP_DRAWABLE(layer))) {
    ...
    gimp_image_remove_layer(
        image, gimp_drawable_get_floating_sel(GIMP_DRAWABLE(layer)), TRUE,
        NULL);
  }
  ...
  if (gimp_layer_is_floating_sel(layer)) {
    ...
    gimp_drawable_detach_floating_sel(
        gimp_layer_get_floating_sel_drawable(layer));
  } else {
  ...
  if (push_undo)
    gimp_image_undo_push_layer_remove(
        image, undo_desc, layer, gimp_layer_get_parent(layer),
        gimp_item_get_index(GIMP_ITEM(layer)), selected_layers);
  ...
  new_selected = gimp_item_tree_remove_item(private->layers, GIMP_ITEM(layer),
                                            new_selected);
...
void gimp_image_add_layers(GimpImage *image, GList *layers, GimpLayer *parent,
                           gint position, gint x, gint y, gint width,
                           gint height, const gchar *undo_desc) {
  GimpImagePrivate *private;
  GList *list;
...
private
  ...
  /*  item and parent are type-checked in GimpItemTree
   */
  if (!gimp_item_tree_get_insert_pos(private->layers, (GimpItem *)layers->data,
                                     (GimpItem **)&parent, &position))
    return;
  ...
  for (list = layers; list; list = g_list_next(list)) {
    ...
    layers_width =
        MAX(layers_width, off_x + gimp_item_get_width(item) - layers_x);
    layers_height =
        MAX(layers_height, off_y + gimp_item_get_height(item) - layers_y);
  }
  ...
  for (list = layers; list; list = g_list_next(list)) {
    ...
    gimp_image_add_layer(image, GIMP_LAYER(new_item), parent, position, TRUE);
    position++;
  }
...
gboolean gimp_image_add_channel(GimpImage *image, GimpChannel *channel,
                                GimpChannel *parent, gint position,
                                gboolean push_undo) {
  GimpImagePrivate *private;
  GList *channels;
...
private
  ...
  /*  item and parent are type-checked in GimpItemTree
   */
  if (!gimp_item_tree_get_insert_pos(private->channels, (GimpItem *)channel,
                                     (GimpItem **)&parent, &position))
    return FALSE;
...
void gimp_image_remove_channel(GimpImage *image, GimpChannel *channel,
                               gboolean push_undo, GList *new_selected) {
  GimpImagePrivate *private;
  GList *selected_channels;
  ...
  if (gimp_drawable_get_floating_sel(GIMP_DRAWABLE(channel))) {
    ...
    gimp_image_remove_layer(
        image, gimp_drawable_get_floating_sel(GIMP_DRAWABLE(channel)), TRUE,
        NULL);
  }
...
private
  ...
  if (push_undo)
    gimp_image_undo_push_channel_remove(
        image, C_("undo-type", "Remove Channel"), channel,
        gimp_channel_get_parent(channel),
        gimp_item_get_index(GIMP_ITEM(channel)), selected_channels);

  g_object_ref(channel);

  new_selected = gimp_item_tree_remove_item(private->channels,
                                            GIMP_ITEM(channel), new_selected);
...
gboolean gimp_image_add_vectors(GimpImage *image, GimpVectors *vectors,
...
private
  ...
  /*  item and parent are type-checked in GimpItemTree
   */
  if (!gimp_item_tree_get_insert_pos(private->vectors, (GimpItem *)vectors,
                                     (GimpItem **)&parent, &position))
    return FALSE;
...
void gimp_image_remove_vectors(GimpImage *image, GimpVectors *vectors,
                               gboolean push_undo, GList *new_selected) {
  GimpImagePrivate *private;
...
private
  ...
  if (push_undo)
    gimp_image_undo_push_vectors_remove(
        image, C_("undo-type", "Remove Path"), vectors,
        gimp_vectors_get_parent(vectors),
        gimp_item_get_index(GIMP_ITEM(vectors)), selected_vectors);

  g_object_ref(vectors);

  new_selected = gimp_item_tree_remove_item(private->vectors,
                                            GIMP_ITEM(vectors), new_selected);
...
gboolean gimp_image_coords_in_active_pickable(GimpImage *image,
  ...
  if (sample_merged) {
    if (show_all || (x >= 0 && x < gimp_image_get_width(image) && y >= 0 &&
                     y < gimp_image_get_height(image))) {
      in_pickable = TRUE;
    }
  } else {
    ...
    for (iter = drawables; iter; iter = iter->next) {
      ...
      if (d_x >= 0 && d_x < gimp_item_get_width(item) && d_y >= 0 &&
          d_y < gimp_item_get_height(item)) {
        in_pickable = TRUE;
        break;
      }
    }
  ...
  if (in_pickable && selected_only) {
    ...
    if (!gimp_channel_is_empty(selection) &&
        !gimp_pickable_get_opacity_at(GIMP_PICKABLE(selection), x, y)) {
      in_pickable = FALSE;
    }
  }
