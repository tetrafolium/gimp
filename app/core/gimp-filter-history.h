...
GimpProcedure *gimp_filter_history_nth(Gimp *gimp, gint n);
void gimp_filter_history_add(Gimp *gimp, GimpProcedure *procedure);
void gimp_filter_history_remove(Gimp *gimp, GimpProcedure *procedure);
