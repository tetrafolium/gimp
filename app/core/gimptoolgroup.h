...
#define GIMP_TOOL_GROUP(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_GROUP, GimpToolGroup))
#define GIMP_TOOL_GROUP_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_GROUP, GimpToolGroupClass))
#define GIMP_IS_TOOL_GROUP(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_GROUP))
#define GIMP_IS_TOOL_GROUP_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_GROUP))
#define GIMP_TOOL_GROUP_GET_CLASS(obj)                                         \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_GROUP, GimpToolGroupClass))
