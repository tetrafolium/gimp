...
#define GIMP_TAGGED_CONTAINER(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TAGGED_CONTAINER,               \
                              GimpTaggedContainer))
#define GIMP_TAGGED_CONTAINER_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TAGGED_CONTAINER,                \
                           GimpTaggedContainerClass))
#define GIMP_IS_TAGGED_CONTAINER(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TAGGED_CONTAINER))
#define GIMP_IS_TAGGED_CONTAINER_CLASS(class)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((class), GIMP_TYPE_TAGGED_CONTAINER))
#define GIMP_TAGGED_CONTAINER_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TAGGED_CONTAINER,                \
                             GimpTaggedContainerClass))
...
struct _GimpTaggedContainerClass {
  ...
  void (*tag_count_changed)(GimpTaggedContainer *container, gint count);
};
