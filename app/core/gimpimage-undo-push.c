...
GimpUndo *gimp_image_undo_push_image_type(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_IMAGE_UNDO, GIMP_UNDO_IMAGE_TYPE,
                              undo_desc, GIMP_DIRTY_IMAGE, NULL);
}
...
GimpUndo *gimp_image_undo_push_image_precision(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_IMAGE_UNDO,
                              ...
                              GIMP_DIRTY_IMAGE, NULL);
}

GimpUndo *
gimp_image_undo_push_image_size(GimpImage *image, const gchar *undo_desc,
                                gint previous_origin_x, gint previous_origin_y,
                                gint previous_width, gint previous_height) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);

  return gimp_image_undo_push(
      image, GIMP_TYPE_IMAGE_UNDO, GIMP_UNDO_IMAGE_SIZE, undo_desc,
      GIMP_DIRTY_IMAGE | GIMP_DIRTY_IMAGE_SIZE, "previous-origin-x",
      previous_origin_x, "previous-origin-y", previous_origin_y,
      "previous-width", previous_width, "previous-height", previous_height,
      NULL);
}
...
GimpUndo *gimp_image_undo_push_image_grid(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_IMAGE_UNDO, GIMP_UNDO_IMAGE_GRID,
                              undo_desc, GIMP_DIRTY_IMAGE_META, "grid", grid,
                              NULL);
}
...
GimpUndo *gimp_image_undo_push_image_parasite(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_IMAGE_UNDO,
                              ...
                              GIMP_DIRTY_IMAGE_META, "parasite-name",
                              gimp_parasite_name(parasite), NULL);
}
...
GimpUndo *gimp_image_undo_push_image_parasite_remove(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_IMAGE_UNDO, GIMP_UNDO_PARASITE_REMOVE, undo_desc,
      GIMP_DIRTY_IMAGE_META, "parasite-name", name, NULL);
}
...
GimpUndo *gimp_image_undo_push_guide(GimpImage *image, const gchar *undo_desc,
                                     GimpGuide *guide) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GUIDE(guide), NULL);

  return gimp_image_undo_push(image, GIMP_TYPE_GUIDE_UNDO, GIMP_UNDO_GUIDE,
                              undo_desc, GIMP_DIRTY_IMAGE_META, "aux-item",
                              guide, NULL);
}
...
GimpUndo *gimp_image_undo_push_sample_point(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_SAMPLE_POINT_UNDO, GIMP_UNDO_SAMPLE_POINT, undo_desc,
      GIMP_DIRTY_IMAGE_META, "aux-item", sample_point, NULL);
}
...
GimpUndo *gimp_image_undo_push_drawable(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_DRAWABLE_UNDO,
                              ...
                              GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item",
                              item, "buffer", buffer, "x", x, "y", y, NULL);
}
...
GimpUndo *gimp_image_undo_push_drawable_mod(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_DRAWABLE_MOD_UNDO,
                              ...
                              GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item",
                              drawable, "copy-buffer", copy_buffer, NULL);
}
...
GimpUndo *gimp_image_undo_push_drawable_format(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_DRAWABLE_PROP_UNDO, GIMP_UNDO_DRAWABLE_FORMAT, undo_desc,
      GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", drawable, NULL);
}
...
GimpUndo *gimp_image_undo_push_mask(GimpImage *image, const gchar *undo_desc,
                                    GimpChannel *mask) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_MASK_UNDO, GIMP_UNDO_MASK, undo_desc,
      GIMP_IS_SELECTION(mask) ? GIMP_DIRTY_SELECTION
...
GimpUndo *gimp_image_undo_push_mask_precision(GimpImage *image,
  ...
  return gimp_image_undo_push(
      ...
      GIMP_IS_SELECTION(mask) ? GIMP_DIRTY_SELECTION
                              : GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE,
      "item", mask, "convert-format", TRUE, NULL);
}
...
GimpUndo *gimp_image_undo_push_item_reorder(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_ITEM_PROP_UNDO,
                              ...
                              GIMP_DIRTY_IMAGE_STRUCTURE, "item", item, NULL);
}
...
GimpUndo *gimp_image_undo_push_item_displace(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_ITEM_PROP_UNDO, GIMP_UNDO_ITEM_DISPLACE, undo_desc,
      GIMP_IS_DRAWABLE(item) ? GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE
...
GimpUndo *gimp_image_undo_push_item_parasite(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_ITEM_PROP_UNDO, GIMP_UNDO_PARASITE_ATTACH, undo_desc,
      GIMP_DIRTY_ITEM_META, "item", item, "parasite-name",
      gimp_parasite_name(parasite), NULL);
}
...
GimpUndo *gimp_image_undo_push_item_parasite_remove(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_ITEM_PROP_UNDO, GIMP_UNDO_PARASITE_REMOVE, undo_desc,
      GIMP_DIRTY_ITEM_META, "item", item, "parasite-name", name, NULL);
}
...
GimpUndo *gimp_image_undo_push_layer_add(GimpImage *image,
                                         const gchar *undo_desc,
                                         GimpLayer *layer, GList *prev_layers) {
  GList *iter;
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_LAYER_UNDO, GIMP_UNDO_LAYER_ADD,
                              undo_desc, GIMP_DIRTY_IMAGE_STRUCTURE, "item",
                              layer, "prev-layers", prev_layers, NULL);
}

GimpUndo *
gimp_image_undo_push_layer_remove(GimpImage *image, const gchar *undo_desc,
                                  GimpLayer *layer, GimpLayer *prev_parent,
                                  gint prev_position, GList *prev_layers) {
  GList *iter;

  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_LAYER(layer), NULL);
  g_return_val_if_fail(gimp_item_is_attached(GIMP_ITEM(layer)), NULL);
  g_return_val_if_fail(prev_parent == NULL || GIMP_IS_LAYER(prev_parent), NULL);

  for (iter = prev_layers; iter; iter = iter->next)
    g_return_val_if_fail(GIMP_IS_LAYER(iter->data), NULL);

  return gimp_image_undo_push(
      image, GIMP_TYPE_LAYER_UNDO, GIMP_UNDO_LAYER_REMOVE, undo_desc,
      GIMP_DIRTY_IMAGE_STRUCTURE, "item", layer, "prev-parent", prev_parent,
      "prev-position", prev_position, "prev-layers", prev_layers, NULL);
}
...
GimpUndo *gimp_image_undo_push_layer_mode(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_LAYER_PROP_UNDO,
                              ...
                              GIMP_DIRTY_ITEM_META, "item", layer, NULL);
}
...
GimpUndo *gimp_image_undo_push_group_layer_suspend_resize(
    GimpImage *image, const gchar *undo_desc, GimpGroupLayer *group) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GROUP_LAYER(group), NULL);
  g_return_val_if_fail(gimp_item_is_attached(GIMP_ITEM(group)), NULL);

  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_SUSPEND_RESIZE,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}

GimpUndo *gimp_image_undo_push_group_layer_resume_resize(
    GimpImage *image, const gchar *undo_desc, GimpGroupLayer *group) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GROUP_LAYER(group), NULL);
  g_return_val_if_fail(gimp_item_is_attached(GIMP_ITEM(group)), NULL);
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_RESUME_RESIZE,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}

GimpUndo *gimp_image_undo_push_group_layer_suspend_mask(GimpImage *image,
                                                        const gchar *undo_desc,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_SUSPEND_MASK,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}

GimpUndo *gimp_image_undo_push_group_layer_resume_mask(GimpImage *image,
                                                       const gchar *undo_desc,
                                                       GimpGroupLayer *group) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GROUP_LAYER(group), NULL);
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_RESUME_MASK,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}

GimpUndo *gimp_image_undo_push_group_layer_start_transform(
    GimpImage *image, const gchar *undo_desc, GimpGroupLayer *group) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GROUP_LAYER(group), NULL);
  g_return_val_if_fail(gimp_item_is_attached(GIMP_ITEM(group)), NULL);
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_START_TRANSFORM,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}

GimpUndo *gimp_image_undo_push_group_layer_end_transform(
    GimpImage *image, const gchar *undo_desc, GimpGroupLayer *group) {
  g_return_val_if_fail(GIMP_IS_IMAGE(image), NULL);
  g_return_val_if_fail(GIMP_IS_GROUP_LAYER(group), NULL);
  g_return_val_if_fail(gimp_item_is_attached(GIMP_ITEM(group)), NULL);
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_END_TRANSFORM,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}
...
GimpUndo *gimp_image_undo_push_group_layer_convert(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_GROUP_LAYER_UNDO, GIMP_UNDO_GROUP_LAYER_CONVERT,
      undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", group, NULL);
}
...
GimpUndo *gimp_image_undo_push_text_layer(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_TEXT_UNDO, GIMP_UNDO_TEXT_LAYER,
                              undo_desc, GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE,
                              "item", layer, "param", pspec, NULL);
}
...
GimpUndo *gimp_image_undo_push_text_layer_convert(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_TEXT_UNDO,
                              ...
                              GIMP_DIRTY_ITEM, "item", layer, NULL);
}
...
GimpUndo *gimp_image_undo_push_layer_mask_add(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_LAYER_MASK_UNDO, GIMP_UNDO_LAYER_MASK_ADD, undo_desc,
      GIMP_DIRTY_IMAGE_STRUCTURE, "item", layer, "layer-mask", mask, NULL);
}
...
GimpUndo *gimp_image_undo_push_layer_mask_remove(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_LAYER_MASK_UNDO, GIMP_UNDO_LAYER_MASK_REMOVE, undo_desc,
      GIMP_DIRTY_IMAGE_STRUCTURE, "item", layer, "layer-mask", mask, NULL);
}
...
GimpUndo *gimp_image_undo_push_channel_add(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_CHANNEL_UNDO,
                              ...
                              GIMP_DIRTY_IMAGE_STRUCTURE, "item", channel,
                              "prev-channels", prev_channels, NULL);
}

GimpUndo *gimp_image_undo_push_channel_remove(
    GimpImage *image, const gchar *undo_desc, GimpChannel *channel,
    GimpChannel *prev_parent, gint prev_position, GList *prev_channels) {
  GList *iter;
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_CHANNEL_UNDO, GIMP_UNDO_CHANNEL_REMOVE, undo_desc,
      GIMP_DIRTY_IMAGE_STRUCTURE, "item", channel, "prev-parent", prev_parent,
      "prev-position", prev_position, "prev-channels", prev_channels, NULL);
}
...
GimpUndo *gimp_image_undo_push_channel_color(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_CHANNEL_PROP_UNDO, GIMP_UNDO_CHANNEL_COLOR, undo_desc,
      GIMP_DIRTY_ITEM | GIMP_DIRTY_DRAWABLE, "item", channel, NULL);
}
...
GimpUndo *gimp_image_undo_push_vectors_add(GimpImage *image,
  ...
  return gimp_image_undo_push(image, GIMP_TYPE_VECTORS_UNDO,
                              ...
                              GIMP_DIRTY_IMAGE_STRUCTURE, "item", vectors,
                              "prev-vectors", prev_vectors, NULL);
}

GimpUndo *gimp_image_undo_push_vectors_remove(
    GimpImage *image, const gchar *undo_desc, GimpVectors *vectors,
    GimpVectors *prev_parent, gint prev_position, GList *prev_vectors) {
  GList *iter;
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_VECTORS_UNDO, GIMP_UNDO_VECTORS_REMOVE, undo_desc,
      GIMP_DIRTY_IMAGE_STRUCTURE, "item", vectors, "prev-parent", prev_parent,
      "prev-position", prev_position, "prev-vectors", prev_vectors, NULL);
}
...
GimpUndo *gimp_image_undo_push_vectors_mod(GimpImage *image,
  ...
  return gimp_image_undo_push(
      image, GIMP_TYPE_VECTORS_MOD_UNDO, GIMP_UNDO_VECTORS_MOD, undo_desc,
      GIMP_DIRTY_ITEM | GIMP_DIRTY_VECTORS, "item", vectors, NULL);
}
...
GimpUndo *gimp_image_undo_push_fs_to_layer(GimpImage *image,
  ...
  undo = gimp_image_undo_push(
      image, GIMP_TYPE_FLOATING_SELECTION_UNDO, GIMP_UNDO_FS_TO_LAYER,
      undo_desc, GIMP_DIRTY_IMAGE_STRUCTURE, "item", floating_layer, NULL);
...
static void undo_pop_cantundo(GimpUndo *undo, GimpUndoMode undo_mode,
...
GimpUndo *gimp_image_undo_push_cantundo(GimpImage *image,
  ...
  undo = gimp_image_undo_push(image, GIMP_TYPE_UNDO, GIMP_UNDO_CANT, undo_desc,
                              GIMP_DIRTY_ALL, NULL);

  if (undo)
    g_signal_connect(undo, "pop", G_CALLBACK(undo_pop_cantundo), NULL);
