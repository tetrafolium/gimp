...
static void gimp_drawable_mod_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
                                       GimpUndoAccumulator *accum);
static void gimp_drawable_mod_undo_free(GimpUndo *undo, GimpUndoMode undo_mode);
...
static void gimp_drawable_mod_undo_class_init(GimpDrawableModUndoClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_COPY_BUFFER,
      g_param_spec_boolean("copy-buffer", NULL, NULL, FALSE,
                           GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY));
}

static void gimp_drawable_mod_undo_init(GimpDrawableModUndo *undo) {}
...
static void gimp_drawable_mod_undo_constructed(GObject *object) {
  ...
  gimp_item_get_offset(item, &drawable_mod_undo->offset_x,
...
static void gimp_drawable_mod_undo_pop(GimpUndo *undo, GimpUndoMode undo_mode,
  ...
  gimp_item_get_offset(GIMP_ITEM(drawable), &drawable_mod_undo->offset_x,
                       &drawable_mod_undo->offset_y);

  gimp_drawable_set_buffer_full(drawable, FALSE, NULL, buffer,
                                GEGL_RECTANGLE(offset_x, offset_y, 0, 0), TRUE);
