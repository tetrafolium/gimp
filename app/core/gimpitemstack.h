...
#define GIMP_ITEM_STACK(obj)                                                   \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ITEM_STACK, GimpItemStack))
#define GIMP_ITEM_STACK_CLASS(klass)                                           \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_ITEM_STACK, GimpItemStackClass))
#define GIMP_IS_ITEM_STACK(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_ITEM_STACK))
#define GIMP_IS_ITEM_STACK_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_ITEM_STACK))
