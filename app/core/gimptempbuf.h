...
GimpTempBuf *gimp_temp_buf_new(gint width, gint height,
...
GimpTempBuf *
gimp_temp_buf_copy(const GimpTempBuf *src) G_GNUC_WARN_UNUSED_RESULT;

GimpTempBuf *gimp_temp_buf_ref(const GimpTempBuf *buf);
void gimp_temp_buf_unref(const GimpTempBuf *buf);

GimpTempBuf *gimp_temp_buf_scale(const GimpTempBuf *buf, gint width,
...
gpointer
gimp_temp_buf_lock(const GimpTempBuf *buf, const Babl *format,
