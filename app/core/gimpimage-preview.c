...
void gimp_image_get_preview_size(GimpViewable *viewable, gint size,
  ...
  gimp_viewable_calc_preview_size(gimp_image_get_width(image),
                                  gimp_image_get_height(image), size, size,
                                  dot_for_dot, xres, yres, width, height, NULL);
}

gboolean gimp_image_get_popup_size(GimpViewable *viewable, gint width,
  ...
  if (gimp_image_get_width(image) > width ||
    ...
    gimp_viewable_calc_preview_size(gimp_image_get_width(image),
                                    gimp_image_get_height(image), width * 2,
...
GimpTempBuf *gimp_image_get_new_preview(GimpViewable *viewable,
  ...
  gegl_buffer_get(gimp_pickable_get_buffer(GIMP_PICKABLE(image)),
                  GEGL_RECTANGLE(0, 0, width, height), MIN(scale_x, scale_y),
                  gimp_temp_buf_get_format(buf), gimp_temp_buf_get_data(buf),
...
GdkPixbuf *gimp_image_get_new_pixbuf(GimpViewable *viewable,
  ...
  if (transform) {
    ...
    temp_buf = gimp_temp_buf_new(
        width, height, gimp_pickable_get_format(GIMP_PICKABLE(image)));
