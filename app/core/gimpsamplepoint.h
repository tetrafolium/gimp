...
#define GIMP_SAMPLE_POINT(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SAMPLE_POINT, GimpSamplePoint))
#define GIMP_SAMPLE_POINT_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SAMPLE_POINT,                    \
                           GimpSamplePointClass))
#define GIMP_IS_SAMPLE_POINT(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_SAMPLE_POINT))
#define GIMP_IS_SAMPLE_POINT_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SAMPLE_POINT))
#define GIMP_SAMPLE_POINT_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SAMPLE_POINT,                    \
                             GimpSamplePointClass))
