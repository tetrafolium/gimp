...
static GimpPalette *gimp_palettes_add_palette(Gimp *gimp, const gchar *name,
                                              const gchar *id);
...
void gimp_palettes_init(Gimp *gimp) {
  ...
  palette =
      gimp_palettes_add_palette(gimp, _("Color History"), COLOR_HISTORY_KEY);
...
void gimp_palettes_add_color_history(Gimp *gimp, const GimpRGB *color) {
  GimpPalette *history;
