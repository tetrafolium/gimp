...
#define GIMP_ASYNC(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_ASYNC, GimpAsync))
#define GIMP_ASYNC_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_ASYNC, GimpAsyncClass))
#define GIMP_IS_ASYNC(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_ASYNC))
#define GIMP_IS_ASYNC_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_ASYNC))
#define GIMP_ASYNC_GET_CLASS(obj)                                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_ASYNC, GimpAsyncClass))

typedef void (*GimpAsyncCallback)(GimpAsync *async, gpointer data);
