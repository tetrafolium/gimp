...
#define GIMP_UNDO(obj)                                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_UNDO, GimpUndo))
#define GIMP_UNDO_CLASS(klass)                                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_UNDO, GimpUndoClass))
#define GIMP_IS_UNDO(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_UNDO))
#define GIMP_IS_UNDO_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_UNDO))
#define GIMP_UNDO_GET_CLASS(obj)                                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_UNDO, GimpUndoClass))
...
struct _GimpUndoClass {
  ...
  void (*pop)(GimpUndo *undo, GimpUndoMode undo_mode,
              GimpUndoAccumulator *accum);
  void (*free)(GimpUndo *undo, GimpUndoMode undo_mode);
};
