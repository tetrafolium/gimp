...
#define GIMP_LAYER(obj)                                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_LAYER, GimpLayer))
#define GIMP_LAYER_CLASS(klass)                                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_LAYER, GimpLayerClass))
#define GIMP_IS_LAYER(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_LAYER))
#define GIMP_IS_LAYER_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_LAYER))
#define GIMP_LAYER_GET_CLASS(obj)                                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_LAYER, GimpLayerClass))
...
struct _GimpLayer {
  ...
  GimpLayerColorSpace
      effective_blend_space; /*  layer effective blend space       */
  GimpLayerColorSpace
      effective_composite_space; /*  layer effective composite space   */
  GimpLayerCompositeMode
      effective_composite_mode; /*  layer effective composite mode    */
...
struct _GimpLayerClass {
  ...
  /*  virtual functions  */
  void (*translate)(GimpLayer *layer, gint offset_x, gint offset_y);
  void (*scale)(GimpLayer *layer, gint new_width, gint new_height,
                gint new_offset_x, gint new_offset_y,
                GimpInterpolationType interpolation_type,
                GimpProgress *progress);
  void (*resize)(GimpLayer *layer, GimpContext *context, GimpFillType fill_type,
                 gint new_width, gint new_height, gint offset_x, gint offset_y);
  void (*flip)(GimpLayer *layer, GimpContext *context,
               GimpOrientationType flip_type, gdouble axis,
               gboolean clip_result);
  void (*rotate)(GimpLayer *layer, GimpContext *context,
                 GimpRotationType rotate_type, gdouble center_x,
                 gdouble center_y, gboolean clip_result);
  void (*transform)(GimpLayer *layer, GimpContext *context,
                    const GimpMatrix3 *matrix, GimpTransformDirection direction,
                    GimpInterpolationType interpolation_type,
                    GimpTransformResize clip_result, GimpProgress *progress);
  void (*convert_type)(GimpLayer *layer, GimpImage *dest_image,
                       const Babl *new_format, GimpColorProfile *src_profile,
                       GimpColorProfile *dest_profile,
                       GeglDitherMethod layer_dither_type,
                       GeglDitherMethod mask_dither_type, gboolean push_undo,
                       GimpProgress *progress);
  GeglRectangle (*get_bounding_box)(GimpLayer *layer);
  void (*get_effective_mode)(GimpLayer *layer, GimpLayerMode *mode,
