...
#define GIMP_OBJECT(obj)                                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_OBJECT, GimpObject))
#define GIMP_OBJECT_CLASS(klass)                                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_OBJECT, GimpObjectClass))
#define GIMP_IS_OBJECT(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_OBJECT))
#define GIMP_IS_OBJECT_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_OBJECT))
#define GIMP_OBJECT_GET_CLASS(obj)                                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_OBJECT, GimpObjectClass))
...
struct _GimpObjectClass {
  ...
  /*  virtual functions  */
  gint64 (*get_memsize)(GimpObject *object, gint64 *gui_size);
};
