...
{ GIMP_ALIGN_LEFT,
  ...
  GIMP_ARRANGE_BOTTOM,
  GIMP_ARRANGE_HFILL,
  GIMP_ARRANGE_VFILL } GimpAlignmentType;
...
{ GIMP_COLOR_PROFILE_POLICY_ASK,  /*< desc="Ask what to do"  >*/
  ...
  GIMP_COLOR_PROFILE_POLICY_CONVERT_BUILTIN, /*< desc="Convert to built-in sRGB
                                                or grayscale profile" >*/
  GIMP_COLOR_PROFILE_POLICY_CONVERT_PREFERRED, /*< desc="Convert to preferred
                                                  sRGB or grayscale profile
...
{ GIMP_CONTAINER_POLICY_STRONG,
  GIMP_CONTAINER_POLICY_WEAK } GimpContainerPolicy;
...
typedef enum {
  ...
  GIMP_CONVERT_DITHER_FS_LOWBLEED, /*< desc="Floyd-Steinberg (reduced color
                                      bleeding)" >*/
...
typedef enum                  /*< pdb-skip >*/
{ GIMP_DEBUG_POLICY_WARNING,  /*< desc="Debug warnings, critical errors and
                                 crashes" >*/
...
{ GIMP_DIRTY_NONE = 0,
  ...
  GIMP_DIRTY_ALL = 0xffff } GimpDirtyMask;
...
{ GIMP_GRADIENT_COLOR_FIXED,      /*< desc="Fixed"      >*/
  ...
  GIMP_GRADIENT_COLOR_FOREGROUND_TRANSPARENT, /*< desc="Foreground color
                                                 (transparent)",  abbrev="FG
                                                 (t)" >*/
  GIMP_GRADIENT_COLOR_BACKGROUND, /*< desc="Background color", abbrev="BG" >*/
  GIMP_GRADIENT_COLOR_BACKGROUND_TRANSPARENT /*< desc="Background color
                                                (transparent)", abbrev="BG (t)"
                                                >*/
} GimpGradientColor;
...
{ GIMP_GRAVITY_NONE,
  ...
  GIMP_GRAVITY_SOUTH,
  GIMP_GRAVITY_SOUTH_EAST } GimpGravityType;
...
{ GIMP_GUIDE_STYLE_NONE,
  ...
  GIMP_GUIDE_STYLE_SPLIT_VIEW } GimpGuideStyle;
...
#define GIMP_TYPE_METADATA_ROTATION_POLICY                                     \
  (gimp_metadata_rotation_policy_get_type())

GType gimp_metadata_rotation_policy_get_type(void) G_GNUC_CONST;

typedef enum                           /*< pdb-skip >*/
{ GIMP_METADATA_ROTATION_POLICY_ASK,   /*< desc="Ask what to do"   >*/
  GIMP_METADATA_ROTATION_POLICY_KEEP,  /*< desc="Discard metadata without
                                          rotating"      >*/
  GIMP_METADATA_ROTATION_POLICY_ROTATE /*< desc="Rotate the image then discard
                                          metadata" >*/
...
{ GIMP_PASTE_TYPE_FLOATING,
  ...
  GIMP_PASTE_TYPE_NEW_LAYER_IN_PLACE } GimpPasteType;
...
typedef enum /*< pdb-skip >*/
{ GIMP_UNDO_MODE_UNDO,
  GIMP_UNDO_MODE_REDO } GimpUndoMode;
...
typedef enum /*< pdb-skip >*/
{
  ...
  GIMP_UNDO_GROUP_LAYER_START_TRANSFORM, /*< desc="Start transforming group
                                            layer" >*/
...
{ GIMP_CONTEXT_PROP_FIRST = 2,
  ...
  GIMP_CONTEXT_PROP_LAST = GIMP_CONTEXT_PROP_TEMPLATE } GimpContextPropType;
...
{ GIMP_CONTEXT_PROP_MASK_IMAGE = 1 << 2,
  ...
  GIMP_CONTEXT_PROP_MASK_ALL =
      (GIMP_CONTEXT_PROP_MASK_IMAGE | GIMP_CONTEXT_PROP_MASK_DISPLAY |
       GIMP_CONTEXT_PROP_MASK_TOOL | GIMP_CONTEXT_PROP_MASK_PAINT_INFO |
       GIMP_CONTEXT_PROP_MASK_MYBRUSH | GIMP_CONTEXT_PROP_MASK_PALETTE |
       GIMP_CONTEXT_PROP_MASK_FONT | GIMP_CONTEXT_PROP_MASK_TOOL_PRESET |
       GIMP_CONTEXT_PROP_MASK_BUFFER | GIMP_CONTEXT_PROP_MASK_IMAGEFILE |
       GIMP_CONTEXT_PROP_MASK_TEMPLATE | GIMP_CONTEXT_PROP_MASK_PAINT)
} GimpContextPropMask;

typedef enum /*< pdb-skip, skip >*/
{ GIMP_IMAGE_SCALE_OK,
  GIMP_IMAGE_SCALE_TOO_SMALL,
  GIMP_IMAGE_SCALE_TOO_BIG } GimpImageScaleCheckType;
...
{ GIMP_ITEM_TYPE_LAYERS = 1 << 0,
  ...
  GIMP_ITEM_TYPE_ALL = (GIMP_ITEM_TYPE_LAYERS | GIMP_ITEM_TYPE_CHANNELS |
                        GIMP_ITEM_TYPE_VECTORS) } GimpItemTypeMask;
