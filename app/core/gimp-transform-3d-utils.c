...
gint gimp_transform_3d_permutation_to_rotation_order(
    const gint permutation[3]) {
...
void gimp_transform_3d_vector3_rotate(GimpVector3 *vector,
  ...
  proj = gimp_vector3_mul_val(normal,
                              gimp_vector3_inner_product_val(*vector, normal));
...
void gimp_transform_3d_matrix4_translate(GimpMatrix4 *matrix, gdouble x,
                                         gdouble y, gdouble z) {
  gint i;
...
void gimp_transform_3d_matrix4_rotate(GimpMatrix4 *matrix,
  ...
  v = gimp_transform_3d_vector3_rotate_val((GimpVector3){1.0, 0.0, 0.0}, *axis);
  ...
  v = gimp_transform_3d_vector3_rotate_val((GimpVector3){0.0, 1.0, 0.0}, *axis);
  ...
  v = gimp_transform_3d_vector3_rotate_val((GimpVector3){0.0, 0.0, 1.0}, *axis);
...
void gimp_transform_3d_matrix4_rotate_standard(GimpMatrix4 *matrix, gint axis,
                                               gdouble angle) {
  gdouble v[3] = {};
...
void gimp_transform_3d_matrix4_rotate_euler(GimpMatrix4 *matrix,
                                            gint rotation_order,
                                            gdouble angle_x, gdouble angle_y,
                                            gdouble angle_z, gdouble pivot_x,
                                            gdouble pivot_y, gdouble pivot_z) {
  ...
  for (i = 0; i < 3; i++) {
    gimp_transform_3d_matrix4_rotate_standard(matrix, permutation[i],
...
void gimp_transform_3d_matrix4_rotate_euler_decompose(GimpMatrix4 *matrix,
  ...
  *angles[permutation[2]] = atan2(m.coeff[permutation[1]][permutation[0]],
  ...
  gimp_transform_3d_matrix4_rotate_standard(&m, permutation[2],
  ...
  *angles[permutation[1]] = atan2(m.coeff[permutation[2]][permutation[0]],
  ...
  gimp_transform_3d_matrix4_rotate_standard(&m, permutation[1],
...
void gimp_transform_3d_matrix4_perspective(GimpMatrix4 *matrix,
                                           gdouble camera_x, gdouble camera_y,
                                           gdouble camera_z) {
  gint i;
...
void gimp_transform_3d_matrix(GimpMatrix3 *matrix, gdouble camera_x,
                              gdouble camera_y, gdouble camera_z,
                              gdouble offset_x, gdouble offset_y,
                              gdouble offset_z, gint rotation_order,
                              gdouble angle_x, gdouble angle_y, gdouble angle_z,
                              gdouble pivot_x, gdouble pivot_y,
                              gdouble pivot_z) {
  GimpMatrix4 m;

  gimp_matrix4_identity(&m);
  gimp_transform_3d_matrix4_rotate_euler(&m, rotation_order, angle_x, angle_y,
                                         angle_z, pivot_x, pivot_y, pivot_z);
