...
#define GIMP_LAYER_STACK(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_LAYER_STACK, GimpLayerStack))
#define GIMP_LAYER_STACK_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_LAYER_STACK, GimpLayerStackClass))
#define GIMP_IS_LAYER_STACK(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_LAYER_STACK))
#define GIMP_IS_LAYER_STACK_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_LAYER_STACK))
