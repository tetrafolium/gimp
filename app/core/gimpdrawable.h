...
#define GIMP_DRAWABLE(obj)                                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DRAWABLE, GimpDrawable))
#define GIMP_DRAWABLE_CLASS(klass)                                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DRAWABLE, GimpDrawableClass))
#define GIMP_IS_DRAWABLE(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DRAWABLE))
#define GIMP_IS_DRAWABLE_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DRAWABLE))
#define GIMP_DRAWABLE_GET_CLASS(obj)                                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DRAWABLE, GimpDrawableClass))
...
struct _GimpDrawableClass {
  ...
  /*  signals  */
  void (*update)(GimpDrawable *drawable, gint x, gint y, gint width,
                 gint height);
  ...
  void (*get_active_components)(GimpDrawable *drawable, gboolean *active);
  GimpComponentMask (*get_active_mask)(GimpDrawable *drawable);
  gboolean (*supports_alpha)(GimpDrawable *drawable);
  void (*convert_type)(GimpDrawable *drawable, GimpImage *dest_image,
                       const Babl *new_format, GimpColorProfile *src_profile,
                       GimpColorProfile *dest_profile,
                       GeglDitherMethod layer_dither_type,
                       GeglDitherMethod mask_dither_type, gboolean push_undo,
                       GimpProgress *progress);
  void (*apply_buffer)(GimpDrawable *drawable, GeglBuffer *buffer,
                       const GeglRectangle *buffer_region, gboolean push_undo,
                       const gchar *undo_desc, gdouble opacity,
                       GimpLayerMode mode, GimpLayerColorSpace blend_space,
                       GimpLayerColorSpace composite_space,
                       GimpLayerCompositeMode composite_mode,
                       GeglBuffer *base_buffer, gint base_x, gint base_y);
  GeglBuffer *(*get_buffer)(GimpDrawable *drawable);
  void (*set_buffer)(GimpDrawable *drawable, gboolean push_undo,
                     const gchar *undo_desc, GeglBuffer *buffer,
                     const GeglRectangle *bounds);
  GeglRectangle (*get_bounding_box)(GimpDrawable *drawable);
  void (*push_undo)(GimpDrawable *drawable, const gchar *undo_desc,
                    GeglBuffer *buffer, gint x, gint y, gint width,
                    gint height);
  void (*swap_pixels)(GimpDrawable *drawable, GeglBuffer *buffer, gint x,
                      gint y);
