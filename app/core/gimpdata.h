...
#define GIMP_DATA(obj)                                                         \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_DATA, GimpData))
#define GIMP_DATA_CLASS(klass)                                                 \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_DATA, GimpDataClass))
#define GIMP_IS_DATA(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_DATA))
#define GIMP_IS_DATA_CLASS(klass)                                              \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_DATA))
#define GIMP_DATA_GET_CLASS(obj)                                               \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_DATA, GimpDataClass))
...
struct _GimpDataClass {
  ...
  void (*copy)(GimpData *data, GimpData *src_data);
  GimpData *(*duplicate)(GimpData *data);
  gint (*compare)(GimpData *data1, GimpData *data2);
};
