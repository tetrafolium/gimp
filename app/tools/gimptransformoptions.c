...
enum { PROP_0, PROP_TYPE, PROP_DIRECTION, PROP_INTERPOLATION, PROP_CLIP };
...
G_DEFINE_TYPE_WITH_CODE(
    GimpTransformOptions, gimp_transform_options, GIMP_TYPE_TOOL_OPTIONS,
...
gimp_transform_options_class_init(GimpTransformOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_TYPE, "type", NULL, NULL,
                        GIMP_TYPE_TRANSFORM_TYPE, GIMP_TRANSFORM_TYPE_LAYER,
                        GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_ENUM(object_class, PROP_DIRECTION, "direction",
                        _("Direction"), _("Direction of transformation"),
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_INTERPOLATION, "interpolation",
                        ...
                        GIMP_TYPE_INTERPOLATION_TYPE, GIMP_INTERPOLATION_LINEAR,
                        GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_ENUM(object_class, PROP_CLIP, "clip", _("Clipping"),
...
static void gimp_transform_options_reset(GimpConfig *config) {
  ...
  pspec =
      g_object_class_find_property(G_OBJECT_GET_CLASS(config), "interpolation");
...
GtkWidget *gimp_transform_options_gui(GimpToolOptions *tool_options,
  ...
  if (direction) {
    frame = gimp_prop_enum_radio_frame_new(config, "direction", NULL, 0, 0);
