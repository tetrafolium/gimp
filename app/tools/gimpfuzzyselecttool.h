...
#define GIMP_FUZZY_SELECT_TOOL(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FUZZY_SELECT_TOOL,              \
                              GimpFuzzySelectTool))
#define GIMP_FUZZY_SELECT_TOOL_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FUZZY_SELECT_TOOL,               \
                           GimpFuzzySelectToolClass))
#define GIMP_IS_FUZZY_SELECT_TOOL(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FUZZY_SELECT_TOOL))
#define GIMP_IS_FUZZY_SELECT_TOOL_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FUZZY_SELECT_TOOL))
#define GIMP_FUZZY_SELECT_TOOL_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FUZZY_SELECT_TOOL,               \
                             GimpFuzzySelectToolClass))
