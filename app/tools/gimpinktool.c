...
void gimp_ink_tool_register(GimpToolRegisterCallback callback, gpointer data) {
  (*callback)(
      GIMP_TYPE_INK_TOOL, GIMP_TYPE_INK_OPTIONS, gimp_ink_options_gui,
      ...
      "gimp-ink-tool", _("Ink"), _("Ink Tool: Calligraphy-style painting"),
      N_("In_k"), "K", NULL, GIMP_HELP_TOOL_INK, GIMP_ICON_TOOL_INK, data);
}
...
static void gimp_ink_tool_init(GimpInkTool *ink_tool) {
...
static GimpCanvasItem *gimp_ink_tool_get_outline(GimpPaintTool *paint_tool,
  ...
  gimp_paint_tool_set_draw_circle(paint_tool, TRUE, options->size);
