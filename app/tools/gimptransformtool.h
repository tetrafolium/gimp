...
#define GIMP_TRANSFORM_TOOL(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TRANSFORM_TOOL,                 \
                              GimpTransformTool))
#define GIMP_TRANSFORM_TOOL_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TRANSFORM_TOOL,                  \
                           GimpTransformToolClass))
#define GIMP_IS_TRANSFORM_TOOL(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TRANSFORM_TOOL))
#define GIMP_IS_TRANSFORM_TOOL_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TRANSFORM_TOOL))
#define GIMP_TRANSFORM_TOOL_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TRANSFORM_TOOL,                  \
                             GimpTransformToolClass))

#define GIMP_TRANSFORM_TOOL_GET_OPTIONS(t)                                     \
  (GIMP_TRANSFORM_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
...
struct _GimpTransformToolClass {
  ...
  GeglBuffer *(*transform)(GimpTransformTool *tr_tool, GList *objects,
