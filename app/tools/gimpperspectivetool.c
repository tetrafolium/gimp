...
void gimp_perspective_tool_register(GimpToolRegisterCallback callback,
                                    gpointer data) {
  (*callback)(GIMP_TYPE_PERSPECTIVE_TOOL, GIMP_TYPE_TRANSFORM_GRID_OPTIONS,
              gimp_transform_grid_options_gui,
              GIMP_CONTEXT_PROP_MASK_BACKGROUND, "gimp-perspective-tool",
              _("Perspective"),
              _("Perspective Tool: "
                "Change perspective of the layer, selection or path"),
              N_("_Perspective"), "<shift>P", NULL, GIMP_HELP_TOOL_PERSPECTIVE,
              GIMP_ICON_TOOL_PERSPECTIVE, data);
}
...
gimp_perspective_tool_get_widget(GimpTransformGridTool *tg_tool) {
  ...
  g_object_set(widget, "inside-function", GIMP_TRANSFORM_FUNCTION_PERSPECTIVE,
               "outside-function", GIMP_TRANSFORM_FUNCTION_PERSPECTIVE,
               "use-perspective-handles", TRUE, "use-center-handle", TRUE,
               NULL);
