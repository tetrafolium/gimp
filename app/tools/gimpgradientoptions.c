...
static void gradient_options_repeat_gradient_type_notify(
    GimpGradientOptions *options, GParamSpec *pspec, GtkWidget *repeat_combo);
static void gradient_options_metric_gradient_type_notify(
    GimpGradientOptions *options, GParamSpec *pspec, GtkWidget *repeat_combo);

G_DEFINE_TYPE(GimpGradientOptions, gimp_gradient_options,
              GIMP_TYPE_PAINT_OPTIONS)

static void gimp_gradient_options_class_init(GimpGradientOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_OFFSET, "offset", _("Offset"),
                          NULL, 0.0, 100.0, 0.0, GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_GRADIENT_TYPE, "gradient-type",
                        _("Shape"), NULL, GIMP_TYPE_GRADIENT_TYPE,
                        GIMP_GRADIENT_LINEAR, GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_ENUM(
      object_class, PROP_DISTANCE_METRIC, "distance-metric", _("Metric"),
      _("Metric to use for the distance calculation"),
      GEGL_TYPE_DISTANCE_METRIC, GEGL_DISTANCE_METRIC_EUCLIDEAN,
      GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SUPERSAMPLE, "supersample",
                           _("Adaptive Supersampling"), NULL, FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_INT(object_class, PROP_SUPERSAMPLE_DEPTH,
                       "supersample-depth", _("Max depth"), NULL, 1, 9, 3,
                       GIMP_PARAM_STATIC_STRINGS);
  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_SUPERSAMPLE_THRESHOLD,
                          "supersample-threshold", _("Threshold"), NULL, 0.0,
                          4.0, 0.2, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_DITHER, "dither", _("Dithering"),
                           NULL, TRUE, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_INSTANT, "instant",
                           _("Instant mode"), _("Commit gradient instantly"),
                           FALSE, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_MODIFY_ACTIVE, "modify-active",
                           _("Modify active gradient"),
                           _("Modify the active gradient in-place"), FALSE,
                           GIMP_PARAM_STATIC_STRINGS);
}

static void gimp_gradient_options_init(GimpGradientOptions *options) {}
...
GtkWidget *gimp_gradient_options_gui(GimpToolOptions *tool_options) {
  ...
  /*  the gradient  */
  button = gimp_prop_gradient_box_new(
      NULL, GIMP_CONTEXT(tool_options), _("Gradient"), 2, "gradient-view-type",
  ...
  combo =
      gimp_prop_enum_combo_box_new(config, "gradient-blend-color-space", 0, 0);
  ...
  /*  the offset scale  */
  scale = gimp_prop_spin_scale_new(config, "offset", NULL, 1.0, 10.0, 1);
  ...
  frame =
      gimp_prop_expanding_frame_new(config, "supersample", NULL, vbox2, NULL);
  gtk_box_pack_start(GTK_BOX(vbox), frame, FALSE, FALSE, 0);

  /*  max depth scale  */
  scale =
      gimp_prop_spin_scale_new(config, "supersample-depth", NULL, 1.0, 1.0, 0);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);

  /*  threshold scale  */
  scale = gimp_prop_spin_scale_new(config, "supersample-threshold", NULL, 0.01,
                                   0.1, 2);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);
  ...
  vbox2 = gtk_box_new(GTK_ORIENTATION_VERTICAL, 2);
  frame =
      gimp_prop_expanding_frame_new(config, "modify-active", NULL, vbox2, NULL);
  gtk_box_pack_start(GTK_BOX(vbox), frame, FALSE, FALSE, 0);
...
static void gradient_options_repeat_gradient_type_notify(
    GimpGradientOptions *options, GParamSpec *pspec, GtkWidget *repeat_combo) {
  gtk_widget_set_sensitive(repeat_combo, options->gradient_type <
