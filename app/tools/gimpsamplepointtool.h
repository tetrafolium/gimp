...
#define GIMP_SAMPLE_POINT_TOOL(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SAMPLE_POINT_TOOL,              \
                              GimpSamplePointTool))
#define GIMP_SAMPLE_POINT_TOOL_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SAMPLE_POINT_TOOL,               \
                           GimpSamplePointToolClass))
#define GIMP_IS_SAMPLE_POINT_TOOL(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_SAMPLE_POINT_TOOL))
#define GIMP_IS_SAMPLE_POINT_TOOL_CLASS(klass)                                 \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SAMPLE_POINT_TOOL))
#define GIMP_SAMPLE_POINT_TOOL_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SAMPLE_POINT_TOOL,               \
                             GimpSamplePointToolClass))
