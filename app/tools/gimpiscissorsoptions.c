...
gimp_iscissors_options_class_init(GimpIscissorsOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_INTERACTIVE, "interactive",
...
static void gimp_iscissors_options_init(GimpIscissorsOptions *options) {}
