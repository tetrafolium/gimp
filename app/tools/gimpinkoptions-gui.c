...
GtkWidget *gimp_ink_options_gui(GimpToolOptions *tool_options) {
  ...
  /*  size slider  */
  scale = gimp_prop_spin_scale_new(config, "size", NULL, 1.0, 2.0, 1);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);

  /* angle adjust slider */
  scale = gimp_prop_spin_scale_new(config, "tilt-angle", NULL, 1.0, 10.0, 1);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);
  ...
  /* size sens slider */
  scale =
      gimp_prop_spin_scale_new(config, "size-sensitivity", NULL, 0.01, 0.1, 2);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);

  /* tilt sens slider */
  scale =
      gimp_prop_spin_scale_new(config, "tilt-sensitivity", NULL, 0.01, 0.1, 2);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);

  /* velocity sens slider */
  scale =
      gimp_prop_spin_scale_new(config, "vel-sensitivity", NULL, 0.01, 0.1, 2);
  gtk_box_pack_start(GTK_BOX(vbox2), scale, FALSE, FALSE, 0);
  ...
  blob_box =
      gimp_prop_enum_icon_box_new(config, "blob-type", "gimp-shape", 0, 0);
  ...
  editor =
      gimp_blob_editor_new(ink_options->blob_type, ink_options->blob_aspect,
