...
#define GIMP_GRADIENT_TOOL(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GRADIENT_TOOL, GimpGradientTool))
#define GIMP_GRADIENT_TOOL_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GRADIENT_TOOL,                   \
                           GimpGradientToolClass))
#define GIMP_IS_GRADIENT_TOOL(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GRADIENT_TOOL))
#define GIMP_IS_GRADIENT_TOOL_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GRADIENT_TOOL))
#define GIMP_GRADIENT_TOOL_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_GRADIENT_TOOL,                   \
                             GimpGradientToolClass))

#define GIMP_GRADIENT_TOOL_GET_OPTIONS(t)                                      \
  (GIMP_GRADIENT_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
