...
void gimp_tool_control_push_preserve(GimpToolControl *control,
  ...
  control->preserve_stack = g_slist_prepend(control->preserve_stack,
...
void gimp_tool_control_pop_preserve(GimpToolControl *control) {
  ...
  control->preserve_stack =
      g_slist_delete_link(control->preserve_stack, control->preserve_stack);
}
...
void gimp_tool_control_get_snap_offsets(GimpToolControl *control,
  ...
  if (offset_x)
    *offset_x = control->snap_offset_x;
  if (offset_y)
    *offset_y = control->snap_offset_y;
  if (width)
    *width = control->snap_width;
  if (height)
    *height = control->snap_height;
}
