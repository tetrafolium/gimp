...
#define GIMP_TYPE_TRANSFORM_3D_LENS_MODE                                       \
  (gimp_transform_3d_lens_mode_get_type())
...
{ GIMP_TRANSFORM_3D_LENS_MODE_FOCAL_LENGTH, /*< desc="Focal length" >*/
  GIMP_TRANSFORM_3D_LENS_MODE_FOV_IMAGE,    /*< desc="Field of view (relative to
                                               image)", abbrev="FOV (image)" >*/
  GIMP_TRANSFORM_3D_LENS_MODE_FOV_ITEM,     /*< desc="Field of view (relative to
                                               item)", abbrev="FOV (item)" >*/
...
{ SELECTION_SELECT,
  ...
  SELECTION_MOVE,
  SELECTION_MOVE_COPY,
  SELECTION_ANCHOR } SelectFunction;
...
{ GIMP_TRANSLATE_MODE_VECTORS,
  ...
  GIMP_TRANSLATE_MODE_FLOATING_SEL } GimpTranslateMode;

/*  Motion event report modes  */
typedef enum /*< skip >*/
{ GIMP_MOTION_MODE_EXACT,
  GIMP_MOTION_MODE_COMPRESS } GimpMotionMode;
