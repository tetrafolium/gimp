...
#define GIMP_MEASURE_TOOL(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_MEASURE_TOOL, GimpMeasureTool))
#define GIMP_MEASURE_TOOL_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_MEASURE_TOOL,                    \
                           GimpMeasureToolClass))
#define GIMP_IS_MEASURE_TOOL(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_MEASURE_TOOL))
#define GIMP_IS_MEASURE_TOOL_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_MEASURE_TOOL))
#define GIMP_MEASURE_TOOL_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_MEASURE_TOOL,                    \
                             GimpMeasureToolClass))

#define GIMP_MEASURE_TOOL_GET_OPTIONS(t)                                       \
  (GIMP_MEASURE_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
