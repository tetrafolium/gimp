...
#define GIMP_TOOL_CONTROL(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TOOL_CONTROL, GimpToolControl))
#define GIMP_TOOL_CONTROL_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TOOL_CONTROL,                    \
                           GimpToolControlClass))
#define GIMP_IS_TOOL_CONTROL(obj)                                              \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TOOL_CONTROL))
#define GIMP_IS_TOOL_CONTROL_CLASS(klass)                                      \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TOOL_CONTROL))
#define GIMP_TOOL_CONTROL_GET_CLASS(obj)                                       \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TOOL_CONTROL,                    \
                             GimpToolControlClass))
...
void gimp_tool_control_set_snap_to(GimpToolControl *control, gboolean snap_to);
...
void gimp_tool_control_set_active_modifiers(
    GimpToolControl *control, GimpToolActiveModifiers active_modifiers);
GimpToolActiveModifiers
gimp_tool_control_get_active_modifiers(GimpToolControl *control);

void gimp_tool_control_set_snap_offsets(GimpToolControl *control, gint offset_x,
...
void gimp_tool_control_set_toggled(GimpToolControl *control, gboolean toggled);
