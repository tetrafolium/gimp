...
static void gimp_ellipse_select_tool_select(GimpRectangleSelectTool *rect_tool,
                                            GimpChannelOps operation, gint x,
...
void gimp_ellipse_select_tool_register(GimpToolRegisterCallback callback,
                                       gpointer data) {
  (*callback)(GIMP_TYPE_ELLIPSE_SELECT_TOOL, GIMP_TYPE_RECTANGLE_SELECT_OPTIONS,
              gimp_rectangle_select_options_gui, 0, "gimp-ellipse-select-tool",
              _("Ellipse Select"),
              _("Ellipse Select Tool: Select an elliptical region"),
              N_("_Ellipse Select"), "E", NULL, GIMP_HELP_TOOL_ELLIPSE_SELECT,
              GIMP_ICON_TOOL_ELLIPSE_SELECT, data);
}
...
static void gimp_ellipse_select_tool_select(GimpRectangleSelectTool *rect_tool,
  ...
  gimp_channel_select_ellipse(
      gimp_image_get_mask(image), x, y, w, h, operation, options->antialias,
      options->feather, options->feather_radius, options->feather_radius, TRUE);
}
