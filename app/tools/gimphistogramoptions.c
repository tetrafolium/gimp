...
gimp_histogram_options_class_init(GimpHistogramOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_SCALE, "histogram-scale",
                        _("Histogram Scale"), NULL, GIMP_TYPE_HISTOGRAM_SCALE,
                        GIMP_HISTOGRAM_SCALE_LINEAR, GIMP_PARAM_STATIC_STRINGS);
}

static void gimp_histogram_options_init(GimpHistogramOptions *options) {}
