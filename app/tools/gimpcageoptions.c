...
enum { PROP_0, PROP_CAGE_MODE, PROP_FILL_PLAIN_COLOR };

static void gimp_cage_options_set_property(GObject *object, guint property_id,
                                           const GValue *value,
                                           GParamSpec *pspec);
static void gimp_cage_options_get_property(GObject *object, guint property_id,
                                           GValue *value, GParamSpec *pspec);

G_DEFINE_TYPE(GimpCageOptions, gimp_cage_options, GIMP_TYPE_TOOL_OPTIONS)

#define parent_class gimp_cage_options_parent_class

static void gimp_cage_options_class_init(GimpCageOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_CAGE_MODE, "cage-mode", NULL, NULL,
                        GIMP_TYPE_CAGE_MODE, GIMP_CAGE_MODE_CAGE_CHANGE,
...
static void gimp_cage_options_init(GimpCageOptions *options) {}
