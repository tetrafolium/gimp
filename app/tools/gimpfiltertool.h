...
#define GIMP_FILTER_TOOL(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FILTER_TOOL, GimpFilterTool))
#define GIMP_FILTER_TOOL_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FILTER_TOOL, GimpFilterToolClass))
#define GIMP_IS_FILTER_TOOL(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FILTER_TOOL))
#define GIMP_IS_FILTER_TOOL_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FILTER_TOOL))
#define GIMP_FILTER_TOOL_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FILTER_TOOL, GimpFilterToolClass))

#define GIMP_FILTER_TOOL_GET_OPTIONS(t)                                        \
  (GIMP_FILTER_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
...
struct _GimpFilterToolClass {
  ...
  /* virtual functions */
  gchar *(*get_operation)(GimpFilterTool *filter_tool, gchar **description);
  void (*dialog)(GimpFilterTool *filter_tool);
  void (*reset)(GimpFilterTool *filter_tool);
  void (*set_config)(GimpFilterTool *filter_tool, GimpConfig *config);
  void (*config_notify)(GimpFilterTool *filter_tool, GimpConfig *config,
                        const GParamSpec *pspec);

  gboolean (*settings_import)(GimpFilterTool *filter_tool, GInputStream *input,
                              GError **error);
  ...
  void (*color_picked)(GimpFilterTool *filter_tool, gpointer identifier,
                       gdouble x, gdouble y, const Babl *sample_format,
                       const GimpRGB *color);
};
