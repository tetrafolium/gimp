...
#define GIMP_RECTANGLE_SELECT_TOOL(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_RECTANGLE_SELECT_TOOL,          \
                              GimpRectangleSelectTool))
#define GIMP_RECTANGLE_SELECT_TOOL_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_RECTANGLE_SELECT_TOOL,           \
                           GimpRectangleSelectToolClass))
#define GIMP_IS_RECTANGLE_SELECT_TOOL(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_RECTANGLE_SELECT_TOOL))
#define GIMP_IS_RECTANGLE_SELECT_TOOL_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_RECTANGLE_SELECT_TOOL))
#define GIMP_RECTANGLE_SELECT_TOOL_GET_CLASS(obj)                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_RECTANGLE_SELECT_TOOL,           \
                             GimpRectangleSelectToolClass))

#define GIMP_RECTANGLE_SELECT_TOOL_GET_OPTIONS(t)                              \
  (GIMP_RECTANGLE_SELECT_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
...
struct _GimpRectangleSelectToolClass {
  ...
  void (*select)(GimpRectangleSelectTool *rect_select, GimpChannelOps operation,
