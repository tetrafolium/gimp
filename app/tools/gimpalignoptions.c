...
enum { ALIGN_BUTTON_CLICKED, LAST_SIGNAL };

enum { PROP_0, PROP_ALIGN_REFERENCE, PROP_OFFSET_X, PROP_OFFSET_Y };

static void gimp_align_options_set_property(GObject *object, guint property_id,
                                            const GValue *value,
                                            GParamSpec *pspec);
static void gimp_align_options_get_property(GObject *object, guint property_id,
...
static void gimp_align_options_class_init(GimpAlignOptionsClass *klass) {
  ...
  align_options_signals[ALIGN_BUTTON_CLICKED] = g_signal_new(
      "align-button-clicked", G_TYPE_FROM_CLASS(klass), G_SIGNAL_RUN_FIRST,
      G_STRUCT_OFFSET(GimpAlignOptionsClass, align_button_clicked), NULL, NULL,
      NULL, G_TYPE_NONE, 1, GIMP_TYPE_ALIGNMENT_TYPE);

  GIMP_CONFIG_PROP_ENUM(object_class, PROP_ALIGN_REFERENCE, "align-reference",
                        _("Relative to"),
                        _("Reference image object a layer will be aligned on"),
                        GIMP_TYPE_ALIGN_REFERENCE_TYPE,
                        GIMP_ALIGN_REFERENCE_FIRST, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_OFFSET_X, "offset-x", _("Offset"),
                          _("Horizontal offset for distribution"),
                          -GIMP_MAX_IMAGE_SIZE, GIMP_MAX_IMAGE_SIZE, 0,
                          GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_DOUBLE(object_class, PROP_OFFSET_Y, "offset-y", _("Offset"),
                          _("Vertical offset for distribution"),
                          -GIMP_MAX_IMAGE_SIZE, GIMP_MAX_IMAGE_SIZE, 0,
                          GIMP_PARAM_STATIC_STRINGS);
}

static void gimp_align_options_init(GimpAlignOptions *options) {}
...
static void gimp_align_options_button_clicked(GtkButton *button,
                                              GimpAlignOptions *options) {
  GimpAlignmentType action;

  action = GPOINTER_TO_INT(g_object_get_data(G_OBJECT(button), "align-action"));

  g_signal_emit(options, align_options_signals[ALIGN_BUTTON_CLICKED], 0,
                action);
}

static GtkWidget *gimp_align_options_button_new(GimpAlignOptions *options,
                                                GimpAlignmentType action,
                                                GtkWidget *parent,
                                                const gchar *tooltip) {
  GtkWidget *button;
  ...
  g_object_set_data(G_OBJECT(button), "align-action", GINT_TO_POINTER(action));
  g_signal_connect(button, "clicked",
                   G_CALLBACK(gimp_align_options_button_clicked), options);
...
GtkWidget *gimp_align_options_gui(GimpToolOptions *tool_options) {
  ...
  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_LEFT, hbox, _("Align left edge of target"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_HCENTER, hbox, _("Align center of target"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_RIGHT, hbox, _("Align right edge of target"));
  ...
  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_TOP, hbox, _("Align top edge of target"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_VCENTER, hbox, _("Align middle of target"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ALIGN_BOTTOM, hbox, _("Align bottom of target"));
  ...
  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_LEFT, hbox, _("Distribute left edges of targets"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_HCENTER, hbox,
  ...
  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_HFILL, hbox,
  ...
  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_TOP, hbox, _("Distribute top edges of targets"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_VCENTER, hbox,
      _("Distribute vertical centers of targets"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_BOTTOM, hbox, _("Distribute bottoms of targets"));

  options->button[n++] = gimp_align_options_button_new(
      options, GIMP_ARRANGE_VFILL, hbox,
  ...
  spinbutton = gimp_prop_spin_button_new(config, "offset-x", 1, 20, 0);
  ...
  spinbutton = gimp_prop_spin_button_new(config, "offset-y", 1, 20, 0);
  gtk_box_pack_start(GTK_BOX(hbox), spinbutton, FALSE, FALSE, 0);
