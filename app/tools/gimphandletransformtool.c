...
void gimp_handle_transform_tool_register(GimpToolRegisterCallback callback,
                                         gpointer data) {
  (*callback)(
      GIMP_TYPE_HANDLE_TRANSFORM_TOOL, GIMP_TYPE_HANDLE_TRANSFORM_OPTIONS,
      gimp_handle_transform_options_gui, GIMP_CONTEXT_PROP_MASK_BACKGROUND,
      "gimp-handle-transform-tool", _("Handle Transform"),
      _("Handle Transform Tool: "
        "Deform the layer, selection or path with handles"),
      N_("_Handle Transform"), "<shift>L", NULL,
      GIMP_HELP_TOOL_HANDLE_TRANSFORM, GIMP_ICON_TOOL_HANDLE_TRANSFORM, data);
}
...
gimp_handle_transform_tool_class_init(GimpHandleTransformToolClass *klass) {
  ...
  GimpGenericTransformToolClass *generic_class =
      GIMP_GENERIC_TRANSFORM_TOOL_CLASS(klass);
...
static void gimp_handle_transform_tool_init(GimpHandleTransformTool *ht_tool) {
...
gimp_handle_transform_tool_matrix_to_info(GimpTransformGridTool *tg_tool,
  ...
  gimp_matrix3_transform_point(
      transform, tg_tool->trans_info[OX0], tg_tool->trans_info[OY0],
      &tg_tool->trans_info[X0], &tg_tool->trans_info[Y0]);
  gimp_matrix3_transform_point(
      transform, tg_tool->trans_info[OX1], tg_tool->trans_info[OY1],
      &tg_tool->trans_info[X1], &tg_tool->trans_info[Y1]);
  gimp_matrix3_transform_point(
      transform, tg_tool->trans_info[OX2], tg_tool->trans_info[OY2],
      &tg_tool->trans_info[X2], &tg_tool->trans_info[Y2]);
  gimp_matrix3_transform_point(
      transform, tg_tool->trans_info[OX3], tg_tool->trans_info[OY3],
      &tg_tool->trans_info[X3], &tg_tool->trans_info[Y3]);
}
...
gimp_handle_transform_tool_get_widget(GimpTransformGridTool *tg_tool) {
  ...
  widget = gimp_tool_handle_grid_new(shell, tr_tool->x1, tr_tool->y1,
                                     tr_tool->x2, tr_tool->y2);

  g_object_set(
      widget, "n-handles", (gint)tg_tool->trans_info[N_HANDLES], "orig-x1",
      tg_tool->trans_info[OX0], "orig-y1", tg_tool->trans_info[OY0], "orig-x2",
      tg_tool->trans_info[OX1], "orig-y2", tg_tool->trans_info[OY1], "orig-x3",
      tg_tool->trans_info[OX2], "orig-y3", tg_tool->trans_info[OY2], "orig-x4",
      tg_tool->trans_info[OX3], "orig-y4", tg_tool->trans_info[OY3], "trans-x1",
      tg_tool->trans_info[X0], "trans-y1", tg_tool->trans_info[Y0], "trans-x2",
      tg_tool->trans_info[X1], "trans-y2", tg_tool->trans_info[Y1], "trans-x3",
      tg_tool->trans_info[X2], "trans-y3", tg_tool->trans_info[Y2], "trans-x4",
      tg_tool->trans_info[X3], "trans-y4", tg_tool->trans_info[Y3], NULL);

  g_object_bind_property(G_OBJECT(options), "handle-mode", G_OBJECT(widget),
                         "handle-mode",
...
gimp_handle_transform_tool_update_widget(GimpTransformGridTool *tg_tool) {
  ...
  g_object_set(
      tg_tool->widget, "show-guides", transform_valid, "n-handles",
      (gint)tg_tool->trans_info[N_HANDLES], "orig-x1", tg_tool->trans_info[OX0],
      "orig-y1", tg_tool->trans_info[OY0], "orig-x2", tg_tool->trans_info[OX1],
      "orig-y2", tg_tool->trans_info[OY1], "orig-x3", tg_tool->trans_info[OX2],
      "orig-y3", tg_tool->trans_info[OY2], "orig-x4", tg_tool->trans_info[OX3],
      "orig-y4", tg_tool->trans_info[OY3], "trans-x1", tg_tool->trans_info[X0],
      "trans-y1", tg_tool->trans_info[Y0], "trans-x2", tg_tool->trans_info[X1],
      "trans-y2", tg_tool->trans_info[Y1], "trans-x3", tg_tool->trans_info[X2],
      "trans-y3", tg_tool->trans_info[Y2], "trans-x4", tg_tool->trans_info[X3],
      "trans-y4", tg_tool->trans_info[Y3], NULL);
}
...
gimp_handle_transform_tool_widget_changed(GimpTransformGridTool *tg_tool) {
  ...
  g_object_get(tg_tool->widget, "n-handles", &n_handles, "orig-x1",
               &tg_tool->trans_info[OX0], "orig-y1", &tg_tool->trans_info[OY0],
               "orig-x2", &tg_tool->trans_info[OX1], "orig-y2",
               &tg_tool->trans_info[OY1], "orig-x3", &tg_tool->trans_info[OX2],
               "orig-y3", &tg_tool->trans_info[OY2], "orig-x4",
               &tg_tool->trans_info[OX3], "orig-y4", &tg_tool->trans_info[OY3],
               "trans-x1", &tg_tool->trans_info[X0], "trans-y1",
               &tg_tool->trans_info[Y0], "trans-x2", &tg_tool->trans_info[X1],
               "trans-y2", &tg_tool->trans_info[Y1], "trans-x3",
               &tg_tool->trans_info[X2], "trans-y3", &tg_tool->trans_info[Y2],
               "trans-x4", &tg_tool->trans_info[X3], "trans-y4",
               &tg_tool->trans_info[Y3], NULL);
...
gimp_handle_transform_tool_info_to_points(GimpGenericTransformTool *generic) {
  ...
  generic->input_points[0] =
      (GimpVector2){tg_tool->trans_info[OX0], tg_tool->trans_info[OY0]};
  generic->input_points[1] =
      (GimpVector2){tg_tool->trans_info[OX1], tg_tool->trans_info[OY1]};
  generic->input_points[2] =
      (GimpVector2){tg_tool->trans_info[OX2], tg_tool->trans_info[OY2]};
  generic->input_points[3] =
      (GimpVector2){tg_tool->trans_info[OX3], tg_tool->trans_info[OY3]};

  generic->output_points[0] =
      (GimpVector2){tg_tool->trans_info[X0], tg_tool->trans_info[Y0]};
  generic->output_points[1] =
      (GimpVector2){tg_tool->trans_info[X1], tg_tool->trans_info[Y1]};
  generic->output_points[2] =
      (GimpVector2){tg_tool->trans_info[X2], tg_tool->trans_info[Y2]};
  generic->output_points[3] =
      (GimpVector2){tg_tool->trans_info[X3], tg_tool->trans_info[Y3]};
}
