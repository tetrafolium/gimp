...
#define GIMP_AIRBRUSH_TOOL(obj)                                                \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_AIRBRUSH_TOOL, GimpAirbrushTool))
#define GIMP_AIRBRUSH_TOOL_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_AIRBRUSH_TOOL,                   \
                           GimpAirbrushToolClass))
#define GIMP_IS_AIRBRUSH_TOOL(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_AIRBRUSH_TOOL))
#define GIMP_IS_AIRBRUSH_TOOL_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_AIRBRUSH_TOOL))
#define GIMP_AIRBRUSH_TOOL_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_AIRBRUSH_TOOL,                   \
                             GimpAirbrushToolClass))
