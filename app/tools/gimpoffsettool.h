...
#define GIMP_OFFSET_TOOL(obj)                                                  \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_OFFSET_TOOL, GimpOffsetTool))
#define GIMP_OFFSET_TOOL_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_OFFSET_TOOL, GimpOffsetToolClass))
#define GIMP_IS_OFFSET_TOOL(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_OFFSET_TOOL))
#define GIMP_IS_OFFSET_TOOL_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_OFFSET_TOOL))
#define GIMP_OFFSET_TOOL_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_OFFSET_TOOL, GimpOffsetToolClass))
