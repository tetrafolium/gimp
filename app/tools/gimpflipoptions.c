...
enum { PROP_0, PROP_FLIP_TYPE };

static void gimp_flip_options_set_property(GObject *object, guint property_id,
                                           const GValue *value,
                                           GParamSpec *pspec);
static void gimp_flip_options_get_property(GObject *object, guint property_id,
                                           GValue *value, GParamSpec *pspec);

G_DEFINE_TYPE(GimpFlipOptions, gimp_flip_options, GIMP_TYPE_TRANSFORM_OPTIONS)
...
static void gimp_flip_options_class_init(GimpFlipOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_ENUM(object_class, PROP_FLIP_TYPE, "flip-type",
                        _("Flip Type"), _("Direction of flipping"),
                        GIMP_TYPE_ORIENTATION_TYPE, GIMP_ORIENTATION_HORIZONTAL,
...
GtkWidget *gimp_flip_options_gui(GimpToolOptions *tool_options) {
  ...
  frame = gimp_prop_enum_radio_frame_new(config, "flip-type", str,
