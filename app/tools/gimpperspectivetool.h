...
#define GIMP_PERSPECTIVE_TOOL(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PERSPECTIVE_TOOL,               \
                              GimpPerspectiveTool))
#define GIMP_PERSPECTIVE_TOOL_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PERSPECTIVE_TOOL,                \
                           GimpPerspectiveToolClass))
#define GIMP_IS_PERSPECTIVE_TOOL(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PERSPECTIVE_TOOL))
#define GIMP_IS_PERSPECTIVE_TOOL_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PERSPECTIVE_TOOL))
#define GIMP_PERSPECTIVE_TOOL_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PERSPECTIVE_TOOL,                \
                             GimpPerspectiveToolClass))
