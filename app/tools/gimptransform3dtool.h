...
#define GIMP_TRANSFORM_3D_TOOL(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TRANSFORM_3D_TOOL,              \
                              GimpTransform3DTool))
#define GIMP_TRANSFORM_3D_TOOL_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TRANSFORM_3D_TOOL,               \
                           GimpTransform3DToolClass))
#define GIMP_IS_TRANSFORM_3D_TOOL(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TRANSFORM_3D_TOOL))
#define GIMP_TRANSFORM_3D_TOOL_GET_CLASS(obj)                                  \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TRANSFORM_3D_TOOL,               \
                             GimpTransform3DToolClass))

#define GIMP_TRANSFORM_3D_TOOL_GET_OPTIONS(t)                                  \
  (GIMP_TRANSFORM_3D_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
