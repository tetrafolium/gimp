...
GtkWidget *gimp_clone_options_gui(GimpToolOptions *tool_options) {
  ...
  g_object_bind_property_full(config, "clone-type", button, "visible",
                              G_BINDING_SYNC_CREATE,
                              gimp_clone_options_sync_source, NULL,
  ...
  g_object_bind_property_full(config, "clone-type", hbox, "visible",
                              G_BINDING_SYNC_CREATE,
                              gimp_clone_options_sync_source, NULL,
