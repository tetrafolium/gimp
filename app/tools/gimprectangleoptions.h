...
#define GIMP_IS_RECTANGLE_OPTIONS(obj)                                         \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_RECTANGLE_OPTIONS))
#define GIMP_RECTANGLE_OPTIONS(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_RECTANGLE_OPTIONS,              \
                              GimpRectangleOptions))
#define GIMP_RECTANGLE_OPTIONS_GET_INTERFACE(obj)                              \
  (G_TYPE_INSTANCE_GET_INTERFACE((obj), GIMP_TYPE_RECTANGLE_OPTIONS,           \
...
gboolean gimp_rectangle_options_fixed_rule_active(
    GimpRectangleOptions *rectangle_options, GimpRectangleFixedRule fixed_rule);
