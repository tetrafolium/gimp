...
#define GIMP_REGION_SELECT_OPTIONS(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_REGION_SELECT_OPTIONS,          \
                              GimpRegionSelectOptions))
#define GIMP_REGION_SELECT_OPTIONS_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_REGION_SELECT_OPTIONS,           \
                           GimpRegionSelectOptionsClass))
#define GIMP_IS_REGION_SELECT_OPTIONS(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_REGION_SELECT_OPTIONS))
#define GIMP_IS_REGION_SELECT_OPTIONS_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_REGION_SELECT_OPTIONS))
#define GIMP_REGION_SELECT_OPTIONS_GET_CLASS(obj)                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_REGION_SELECT_OPTIONS,           \
                             GimpRegionSelectOptionsClass))
