...
G_DEFINE_TYPE_WITH_CODE(
    GimpRegionSelectOptions, gimp_region_select_options,
...
gimp_region_select_options_class_init(GimpRegionSelectOptionsClass *klass) {
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SELECT_TRANSPARENT,
                           "select-transparent", _("Select transparent areas"),
  ...
  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_SAMPLE_MERGED, "sample-merged",
                           _("Sample merged"),
                           _("Base selection on all visible layers"), FALSE,
  ...
  GIMP_CONFIG_PROP_ENUM(
      object_class, PROP_SELECT_CRITERION, "select-criterion", _("Select by"),
      _("Selection criterion"), GIMP_TYPE_SELECT_CRITERION,
      GIMP_SELECT_CRITERION_COMPOSITE, GIMP_PARAM_STATIC_STRINGS);

  GIMP_CONFIG_PROP_BOOLEAN(object_class, PROP_DRAW_MASK, "draw-mask",
                           _("Draw mask"), _("Draw the selected region's mask"),
                           FALSE, GIMP_PARAM_STATIC_STRINGS);
}

static void gimp_region_select_options_config_iface_init(
...
static void gimp_region_select_options_init(GimpRegionSelectOptions *options) {}
