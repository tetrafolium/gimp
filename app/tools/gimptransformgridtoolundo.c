...
enum { PROP_0, PROP_TRANSFORM_TOOL };
...
G_DEFINE_TYPE(GimpTransformGridToolUndo, gimp_transform_grid_tool_undo,
              GIMP_TYPE_UNDO)

#define parent_class gimp_transform_grid_tool_undo_parent_class

static void gimp_transform_grid_tool_undo_class_init(
    GimpTransformGridToolUndoClass *klass) {
  ...
  g_object_class_install_property(
      object_class, PROP_TRANSFORM_TOOL,
      g_param_spec_object("transform-tool", NULL, NULL,
...
static void gimp_transform_grid_tool_undo_constructed(GObject *object) {
  GimpTransformGridToolUndo *tg_tool_undo =
      GIMP_TRANSFORM_GRID_TOOL_UNDO(object);
