...
#define GIMP_TYPE_N_POINT_DEFORMATION_TOOL                                     \
  (gimp_n_point_deformation_tool_get_type())
#define GIMP_N_POINT_DEFORMATION_TOOL(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_N_POINT_DEFORMATION_TOOL,       \
                              GimpNPointDeformationTool))
#define GIMP_N_POINT_DEFORMATION_TOOL_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_N_POINT_DEFORMATION_TOOL,        \
                           GimpNPointDeformationToolClass))
#define GIMP_IS_N_POINT_DEFORMATION_TOOL(obj)                                  \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_N_POINT_DEFORMATION_TOOL))
#define GIMP_IS_N_POINT_DEFORMATION_TOOL_CLASS(klass)                          \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_N_POINT_DEFORMATION_TOOL))
#define GIMP_N_POINT_DEFORMATION_TOOL_GET_CLASS(obj)                           \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_N_POINT_DEFORMATION_TOOL,        \
                             GimpNPointDeformationToolClass))

#define GIMP_N_POINT_DEFORMATION_TOOL_GET_OPTIONS(t)                           \
  (GIMP_N_POINT_DEFORMATION_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
