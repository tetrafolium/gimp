...
#define GIMP_TRANSFORM_GRID_TOOL(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_TRANSFORM_GRID_TOOL,            \
                              GimpTransformGridTool))
#define GIMP_TRANSFORM_GRID_TOOL_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_TRANSFORM_GRID_TOOL,             \
                           GimpTransformGridToolClass))
#define GIMP_IS_TRANSFORM_GRID_TOOL(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_TRANSFORM_GRID_TOOL))
#define GIMP_IS_TRANSFORM_GRID_TOOL_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_TRANSFORM_GRID_TOOL))
#define GIMP_TRANSFORM_GRID_TOOL_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_TRANSFORM_GRID_TOOL,             \
                             GimpTransformGridToolClass))

#define GIMP_TRANSFORM_GRID_TOOL_GET_OPTIONS(t)                                \
  (GIMP_TRANSFORM_GRID_OPTIONS(gimp_tool_get_options(GIMP_TOOL(t))))
...
struct _GimpTransformGridToolClass {
  ...
  void (*apply_info)(GimpTransformGridTool *tg_tool, const TransInfo info);
  ...
  GeglBuffer *(*transform)(GimpTransformGridTool *tg_tool, GList *objects,
