...
#define GIMP_THRESHOLD_TOOL(obj)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_THRESHOLD_TOOL,                 \
                              GimpThresholdTool))
#define GIMP_THRESHOLD_TOOL_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_THRESHOLD_TOOL,                  \
                           GimpThresholdToolClass))
#define GIMP_IS_THRESHOLD_TOOL(obj)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_THRESHOLD_TOOL))
#define GIMP_IS_THRESHOLD_TOOL_CLASS(klass)                                    \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_THRESHOLD_TOOL))
#define GIMP_THRESHOLD_TOOL_GET_CLASS(obj)                                     \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_THRESHOLD_TOOL,                  \
                             GimpThresholdToolClass))
