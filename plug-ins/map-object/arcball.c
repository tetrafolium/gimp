...
void ArcBall_Mouse(HVect v_Now) { vNow = v_Now; }
...
void ArcBall_Value(HMatrix m_Now) { ArcBall_CopyMat(mNow, m_Now); }
...
static double V3_Norm(HVect v) { return (v.x * v.x + v.y * v.y + v.z * v.z); }
