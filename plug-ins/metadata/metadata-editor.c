...
#define METADATA                                                               \
  (obj)(G_TYPE_CHECK_INSTANCE_CAST((obj), METADATA_TYPE, Metadata))
...
static gboolean metadata_editor_dialog(GimpImage *image, GimpMetadata *metadata,
                                       GError **error);

static void metadata_dialog_editor_set_metadata(GExiv2Metadata *metadata,
                                                GtkBuilder *builder);

void metadata_editor_write_callback(GtkWidget *dialog, GtkBuilder *builder,
                                    GimpImage *image);

static void impex_combo_callback(GtkComboBoxText *combo, gpointer data);

static void gpsaltsys_combo_callback(GtkComboBoxText *combo, gpointer data);

static void remove_substring(const gchar *string, const gchar *substring);
...
void on_date_button_clicked(GtkButton *widget, GtkWidget *entry_widget,
                            gchar *tag);

void on_create_date_button_clicked(GtkButton *widget, gpointer data);

void on_patient_dob_date_button_clicked(GtkButton *widget, gpointer data);

void on_study_date_button_clicked(GtkButton *widget, gpointer data);

void on_series_date_button_clicked(GtkButton *widget, gpointer data);

static void property_release_id_remove_callback(GtkWidget *widget,
                                                gpointer data);
static void property_release_id_add_callback(GtkWidget *widget, gpointer data);
static void model_release_id_remove_callback(GtkWidget *widget, gpointer data);
static void model_release_id_add_callback(GtkWidget *widget, gpointer data);
static void shown_location_remove_callback(GtkWidget *widget, gpointer data);
static void shown_location_add_callback(GtkWidget *widget, gpointer data);
static void feat_org_name_add_callback(GtkWidget *widget, gpointer data);
static void feat_org_name_remove_callback(GtkWidget *widget, gpointer data);
static void feat_org_code_add_callback(GtkWidget *widget, gpointer data);
static void feat_org_code_remove_callback(GtkWidget *widget, gpointer data);
static void artwork_object_add_callback(GtkWidget *widget, gpointer data);
static void artwork_object_remove_callback(GtkWidget *widget, gpointer data);
static void reg_entry_add_callback(GtkWidget *widget, gpointer data);
static void reg_entry_remove_callback(GtkWidget *widget, gpointer data);
static void image_creator_add_callback(GtkWidget *widget, gpointer data);
static void image_creator_remove_callback(GtkWidget *widget, gpointer data);

static void copyright_own_add_callback(GtkWidget *widget, gpointer data);
static void copyright_own_remove_callback(GtkWidget *widget, gpointer data);
static void licensor_add_callback(GtkWidget *widget, gpointer data);
static void licensor_remove_callback(GtkWidget *widget, gpointer data);

static void list_row_remove_callback(GtkWidget *widget, gpointer data,
                                     gchar *tag);

static void list_row_add_callback(GtkWidget *widget, gpointer data, gchar *tag);

static gint count_tags(GExiv2Metadata *metadata, const gchar *header,
                       const gchar **tags, int items);

static void get_tags(GExiv2Metadata *metadata, const gchar *header,
                     const gchar **tags, const int items, const int count);

gboolean hasModelReleaseTagData(GtkBuilder *builder);

gboolean hasPropertyReleaseTagData(GtkBuilder *builder);

static void organisation_image_code_cell_edited_callback(
    GtkCellRendererText *cell, const gchar *path_string, const gchar *new_text,
    gpointer data);

static void organisation_image_name_cell_edited_callback(
    GtkCellRendererText *cell, const gchar *path_string, const gchar *new_text,
    gpointer data);

static void prop_rel_id_cell_edited_callback(GtkCellRendererText *cell,
                                             const gchar *path_string,
                                             const gchar *new_text,
                                             gpointer data);

static void loc_sho_sub_loc_cell_edited_callback(GtkCellRendererText *cell,
                                                 const gchar *path_string,
                                                 const gchar *new_text,
                                                 gpointer data);

static void loc_sho_city_cell_edited_callback(GtkCellRendererText *cell,
                                              const gchar *path_string,
                                              const gchar *new_text,
                                              gpointer data);

static void loc_sho_state_prov_cell_edited_callback(GtkCellRendererText *cell,
                                                    const gchar *path_string,
                                                    const gchar *new_text,
                                                    gpointer data);

static void loc_sho_cntry_cell_edited_callback(GtkCellRendererText *cell,
                                               const gchar *path_string,
                                               const gchar *new_text,
                                               gpointer data);

static void loc_sho_cntry_iso_cell_edited_callback(GtkCellRendererText *cell,
                                                   const gchar *path_string,
                                                   const gchar *new_text,
                                                   gpointer data);

static void reg_org_id_cell_edited_callback(GtkCellRendererText *cell,
                                            const gchar *path_string,
                                            const gchar *new_text,
                                            gpointer data);

static void reg_item_id_cell_edited_callback(GtkCellRendererText *cell,
                                             const gchar *path_string,
                                             const gchar *new_text,
                                             gpointer data);

static void aoo_title_cell_edited_callback(GtkCellRendererText *cell,
                                           const gchar *path_string,
                                           const gchar *new_text,
                                           gpointer data);

static void aoo_copyright_notice_cell_edited_callback(GtkCellRendererText *cell,
                                                      const gchar *path_string,
                                                      const gchar *new_text,
                                                      gpointer data);

static void aoo_source_inv_cell_edited_callback(GtkCellRendererText *cell,
                                                const gchar *path_string,
                                                const gchar *new_text,
                                                gpointer data);

static void aoo_source_cell_edited_callback(GtkCellRendererText *cell,
                                            const gchar *path_string,
                                            const gchar *new_text,
                                            gpointer data);

static void aoo_creator_cell_edited_callback(GtkCellRendererText *cell,
                                             const gchar *path_string,
                                             const gchar *new_text,
                                             gpointer data);

static void aoo_date_creat_cell_edited_callback(GtkCellRendererText *cell,
                                                const gchar *path_string,
                                                const gchar *new_text,
                                                gpointer data);

static void cr_owner_name_cell_edited_callback(GtkCellRendererText *cell,
                                               const gchar *path_string,
                                               const gchar *new_text,
                                               gpointer data);

static void cr_owner_id_cell_edited_callback(GtkCellRendererText *cell,
                                             const gchar *path_string,
                                             const gchar *new_text,
                                             gpointer data);

static void licensor_name_cell_edited_callback(GtkCellRendererText *cell,
                                               const gchar *path_string,
                                               const gchar *new_text,
                                               gpointer data);

static void licensor_id_cell_edited_callback(GtkCellRendererText *cell,
                                             const gchar *path_string,
                                             const gchar *new_text,
                                             gpointer data);

static void licensor_phone1_cell_edited_callback(GtkCellRendererText *cell,
                                                 const gchar *path_string,
                                                 const gchar *new_text,
                                                 gpointer data);
...
static void licensor_phone2_cell_edited_callback(GtkCellRendererText *cell,
                                                 const gchar *path_string,
                                                 const gchar *new_text,
                                                 gpointer data);
...
static void licensor_email_cell_edited_callback(GtkCellRendererText *cell,
                                                const gchar *path_string,
                                                const gchar *new_text,
                                                gpointer data);

static void licensor_web_cell_edited_callback(GtkCellRendererText *cell,
                                              const gchar *path_string,
                                              const gchar *new_text,
                                              gpointer data);

void cell_edited_callback(GtkCellRendererText *cell, const gchar *path_string,
                          const gchar *new_text, gpointer data, int index);

void cell_edited_callback_combo(GtkCellRendererCombo *cell,
...
static void metadata_class_init(MetadataClass *klass) {
...
static void metadata_init(Metadata *metadata) {}
...
static GimpProcedure *metadata_create_procedure(GimpPlugIn *plug_in,
  ...
  if (!strcmp(name, PLUG_IN_PROC)) {
    ...
    gimp_procedure_set_documentation(procedure,
                                     ...
                                     "file format.",
                                     name);
    gimp_procedure_set_attribution(procedure, "Ben Touchette", "Ben Touchette",
                                   "2017");
...
static GtkWidget *builder_get_widget(GtkBuilder *builder, const gchar *name) {
...
static gboolean metadata_editor_dialog(GimpImage *image,
  ...
  meta_args.filename =
      g_strconcat(g_get_home_dir(), "/", DEFAULT_TEMPLATE_FILE, NULL);

  ui_file = g_build_filename(gimp_data_directory(), "ui", "plug-ins",
                             "plug-in-metadata-editor.ui", NULL);

  if (!gtk_builder_add_from_file(builder, ui_file, &local_error)) {
    if (!local_error)
      local_error = g_error_new_literal(
          G_FILE_ERROR, 0, _("Error loading metadata-editor dialog."));
  ...
  dialog = gimp_dialog_new(title, "gimp-metadata-editor-dialog", NULL, 0,
                           gimp_standard_help_func, PLUG_IN_PROC, _("_Cancel"),
                           GTK_RESPONSE_CANCEL, _("_Write Metadata"),
  ...
  gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(impex_combo), _("Select:"));
  ...
  g_signal_connect(G_OBJECT(impex_combo), "changed",
                   G_CALLBACK(impex_combo_callback), &meta_args);
...
static void get_tags(GExiv2Metadata *metadata, const gchar *header,
                     const gchar **tags, const gint items, const gint count) {
  gchar tag[256];
  int ooo;
  int iii;
...
void on_patient_dob_date_button_clicked(GtkButton *widget, gpointer data) {
  on_date_button_clicked(widget, (GtkWidget *)data, "Xmp.DICOM.PatientDOB");
}

void on_study_date_button_clicked(GtkButton *widget, gpointer data) {
  on_date_button_clicked(widget, (GtkWidget *)data, "Xmp.DICOM.StudyDateTime");
}

void on_series_date_button_clicked(GtkButton *widget, gpointer data) {
  on_date_button_clicked(widget, (GtkWidget *)data, "Xmp.DICOM.SeriesDateTime");
}
...
void on_date_button_clicked(GtkButton *widget, GtkWidget *entry_widget,
  ...
  if (!gtk_builder_add_from_file(builder, ui_file, &error)) {
    g_log("", G_LOG_LEVEL_MESSAGE, _("Error loading calendar. %s"),
          error ? error->message : "");
    g_clear_error(&error);
  ...
  calendar_dialog = gtk_dialog_new_with_buttons(
      _("Calendar Date:"), NULL,
      GTK_DIALOG_MODAL | GTK_DIALOG_DESTROY_WITH_PARENT, _("_Cancel"),
      GTK_RESPONSE_CANCEL, _("Set Date"), GTK_RESPONSE_OK, NULL);

  gtk_dialog_set_default_response(GTK_DIALOG(calendar_dialog), GTK_RESPONSE_OK);
  gimp_dialog_set_alternative_button_order(
      GTK_DIALOG(calendar_dialog), GTK_RESPONSE_OK, GTK_RESPONSE_CANCEL, -1);
...
gboolean hasModelReleaseTagData(GtkBuilder *builder) { return FALSE; }

gboolean hasPropertyReleaseTagData(GtkBuilder *builder) { return FALSE; }
...
void cell_edited_callback(GtkCellRendererText *cell, const gchar *path_string,
  ...
  gtk_list_store_set(GTK_LIST_STORE(model), &iter, index, new_text, -1);
}

void cell_edited_callback_combo(GtkCellRendererCombo *cell,
                                const gchar *path_string, const gchar *new_text,
                                gpointer data, int column) {
  GtkWidget *widget;
  ...
  if (gtk_tree_selection_get_selected(GTK_TREE_SELECTION(selection), NULL,
                                      &iter)) {
...
static void licensor_phone_type1_cell_edited_callback(
    GtkCellRendererCombo *cell, const gchar *path_string, const gchar *new_text,
    gpointer data) {
...
static void licensor_phone_type2_cell_edited_callback(
    GtkCellRendererCombo *cell, const gchar *path_string, const gchar *new_text,
    gpointer data) {
...
static void img_cr8_name_cell_edited_callback(GtkCellRendererText *cell,
                                              const gchar *path_string,
                                              const gchar *new_text,
                                              gpointer data) {
  cell_edited_callback(cell, path_string, new_text, data, 0);
...
static void img_cr8_id_cell_edited_callback(GtkCellRendererText *cell,
                                            const gchar *path_string,
                                            const gchar *new_text,
                                            gpointer data) {
  cell_edited_callback(cell, path_string, new_text, data, 1);
...
static void loc_sho_wrld_reg_cell_edited_callback(GtkCellRendererText *cell,
                                                  const gchar *path_string,
                                                  const gchar *new_text,
                                                  gpointer data) {
  cell_edited_callback(cell, path_string, new_text, data, 5);
...
static void mod_rel_id_cell_edited_callback(GtkCellRendererText *cell,
                                            const gchar *path_string,
                                            const gchar *new_text,
                                            gpointer data) {
  GtkTreeModel *model;
...
static void list_row_add_callback(GtkWidget *widget, gpointer data,
                                  gchar *tag) {
  GtkBuilder *builder = data;
  GtkWidget *list_widget;
  GtkListStore *liststore;
  ...
  liststore =
      GTK_LIST_STORE(gtk_tree_view_get_model(GTK_TREE_VIEW(list_widget)));
...
static void metadata_dialog_editor_set_metadata(GExiv2Metadata *metadata,
  ...
  for (i = 1; i < 6; i++) {
    ...
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(combo_widget), display);
    g_free(display);
  }
  ...
  combo_widget =
      builder_get_widget(builder, "Xmp.plus.MinorModelAgeDisclosure");
  for (i = 0; i < 13; i++) {
    gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(combo_widget),
  ...
  g_signal_connect(G_OBJECT(combo_widget), "changed",
                   G_CALLBACK(gpsaltsys_combo_callback), builder);

  /* Set up text view heights */
  for (i = 0; i < numele; i++) {
    if (!strcmp("multi", default_metadata_tags[i].mode)) {
      text_widget = builder_get_widget(builder, default_metadata_tags[i].tag);
  ...
  for (i = 0; i < creatorContactInfoHeader.size; i++) {
    if (!strcmp("multi", creatorContactInfoTags[i].mode)) {
      text_widget = builder_get_widget(builder, creatorContactInfoTags[i].id);
      gtk_widget_get_size_request(text_widget, &width, &height);
      gtk_widget_set_size_request(text_widget, width, height + 60);
    }
  }
  ...
  for (i = 0; i < imageSupplierInfoHeader.size; i++) {
    ...
    widget = builder_get_widget(builder, imageSupplierInfoTags[i].id);

    value = gexiv2_metadata_get_tag_interpreted_string(
        metadata, imageSupplierInfoTags[i].tag);
  ...
  for (i = 0; i < locationCreationInfoHeader.size; i++) {
    ...
    widget = builder_get_widget(builder, locationCreationInfoTags[i].id);

    value = gexiv2_metadata_get_tag_interpreted_string(
        metadata, locationCreationInfoTags[i].tag);
  ...
  for (i = 0; i < creatorContactInfoHeader.size; i++) {
    ...
    value = gexiv2_metadata_get_tag_interpreted_string(
        metadata, creatorContactInfoTags[i].tag);
  ...
  for (i = 0; i < numele; i++) {
    ...
    value = gexiv2_metadata_get_tag_interpreted_string(
        metadata, default_metadata_tags[i].tag);
    ...
    if (index > -1) {
       ...
       */
      values = gexiv2_metadata_get_tag_multiple(
          metadata, equivalent_metadata_tags[index].tag);
    ...
    if (value) {
      if (!strcmp("single", default_metadata_tags[i].mode)) {
        ...
        if (!strcmp("Xmp.plus.CopyrightOwner", default_metadata_tags[i].tag)) {
          ...
          /* COPYRIGHT OWNER - ID */
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_CR_OWNER_ID);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_CR_OWNER_NAME, NULL,
                                 COL_CR_OWNER_ID, NULL, -1);
            }
          } else {
            gint item;
          ...
          /* IMAGE CREATOR - NAME */
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_IMG_CR8_NAME);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          /* IMAGE CREATOR - ID */
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_IMG_CR8_ID);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_IMG_CR8_NAME,
                                 &arr1[item], COL_IMG_CR8_ID, &arr2[item], -1);
            }
          } else {
            gint item;
            ...
            for (item = 0; item < 2; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_IMG_CR8_NAME, NULL,
                                 COL_IMG_CR8_ID, NULL, -1);
            }
          }
          ...
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_AOO_TITLE);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_AOO_CREATOR);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r != NULL; r = r->next) {
            renderer = r->data;
          ...
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_AOO_SOURCE);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_AOO_CR_NOT);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_AOO_TITLE, &arr1[item],
                                 COL_AOO_DATE_CREAT, &arr2[item],
                                 COL_AOO_CREATOR, &arr3[item], COL_AOO_SOURCE,
                                 &arr4[item], COL_AOO_SRC_INV_ID, &arr5[item],
                                 COL_AOO_CR_NOT, &arr6[item], -1);
            }
          } else {
            gint item;
            ...
            for (item = 0; item < 2; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_AOO_TITLE, NULL,
                                 COL_AOO_DATE_CREAT, NULL, COL_AOO_CREATOR,
                                 NULL, COL_AOO_SOURCE, NULL, COL_AOO_SRC_INV_ID,
                                 NULL, COL_AOO_CR_NOT, NULL, -1);
            }
          }
          ...
          store_index = 0;
          if (value) {
            for (i_ctr = 0, str = strtok(value, ",;"); str;
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_ORG_IMG_NAME, &arr[item],
                                 -1);
            }
          } else {
            gint item;
            ...
            for (item = 0; item < 2; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_ORG_IMG_NAME, NULL, -1);
            }
          }
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_ORG_IMG_CODE, &arr[item],
                                 -1);
            }
          } else {
            gint item;
            ...
            for (item = 0; item < 2; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_ORG_IMG_CODE, NULL, -1);
            }
          }
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_PROP_REL_ID, &arr[item],
                                 -1);
            }

            if (store_index == 1) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_PROP_REL_ID, NULL, -1);
            }
          } else {
            gint item;
          ...
          if (store_index > 0) {
            ...
            for (item = 0; item < store_index; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_MOD_REL_ID, &arr[item],
                                 -1);
            }

            if (store_index == 1) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_MOD_REL_ID, NULL, -1);
            }
          } else {
            gint item;
        ...
        if (!strcmp("Exif.GPSInfo.GPSLatitudeRef",
          ...
          for (loop = 0; loop < 4; loop++) {
            ...
            if (!strcmp(gettext(modelreleasestatus[loop].display), value)) {
              gtk_combo_box_set_active(GTK_COMBO_BOX(widget), loop);
              break;
            }
          }
          ...
          for (loop = 0; loop < 5; loop++) {
            ...
            if (!strcmp(gettext(digitalsourcetype[loop].display), value)) {
              gtk_combo_box_set_active(GTK_COMBO_BOX(widget), loop);
              break;
            }
          }
          ...
          for (loop = 0; loop < 4; loop++) {
            ...
            if (!strcmp(gettext(propertyreleasestatus[loop].display), value)) {
              gtk_combo_box_set_active(GTK_COMBO_BOX(widget), loop);
              break;
            }
          }
      ...
      if (!strcmp("list", default_metadata_tags[i].mode)) {
        if (!strcmp("Xmp.plus.Licensor", default_metadata_tags[i].tag)) {
          ...
          counter = count_tags(metadata, LICENSOR_HEADER, licensor, n_licensor);

          get_tags(metadata, LICENSOR_HEADER, licensor, n_licensor, counter);
          ...
          for (j = 1; j < 6; j++) {
            gtk_list_store_append(phonestore, &phoneiter);
            gtk_list_store_set(phonestore, &phoneiter, 0,
                               gettext(phone_types[j].display), -1);
          }
          ...
          /* LICENSOR - ID */
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_LICENSOR_ID);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          for (r = rlist; r; r = r->next) {
            ...
            g_object_set(renderer, "editable", TRUE, "text-column", 0,
                         "has-entry", FALSE, "model", phonemodel, NULL);
          ...
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_LICENSOR_WEB);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          if (counter > 0) {
            ...
            for (item = 0; item < counter; item++) {
              ...
              for (types = 0; types < 6; types++) {
                if (tagdata[item][3] &&
                    !strcmp(tagdata[item][3], phone_types[types].data)) {
                  strcpy(type1, gettext(phone_types[types].display));
                }

                if (tagdata[item][5] &&
                    !strcmp(tagdata[item][5], phone_types[types].data)) {
                  strcpy(type2, gettext(phone_types[types].display));
                }
              }

              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(
                  liststore, &iter, COL_LICENSOR_NAME, tagdata[item][0],
                  COL_LICENSOR_ID, tagdata[item][1], COL_LICENSOR_PHONE1,
                  tagdata[item][2], COL_LICENSOR_PHONE_TYPE1, (gchar *)&type1,
                  COL_LICENSOR_PHONE2, tagdata[item][4],
                  COL_LICENSOR_PHONE_TYPE2, (gchar *)&type2, COL_LICENSOR_EMAIL,
                  tagdata[item][6], COL_LICENSOR_WEB, tagdata[item][7], -1);
            }
          } else {
            gint item;
            ...
            for (item = 0; item < 2; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(
                  liststore, &iter, COL_LICENSOR_NAME, NULL, COL_LICENSOR_ID,
                  NULL, COL_LICENSOR_PHONE1, NULL, COL_LICENSOR_PHONE_TYPE1,
                  gettext(phone_types[0].display), COL_LICENSOR_PHONE2, NULL,
                  COL_LICENSOR_PHONE_TYPE1, gettext(phone_types[0].display),
                  COL_LICENSOR_EMAIL, NULL, COL_LICENSOR_WEB, NULL, -1);
            }
          }
          ...
          counter = count_tags(metadata, COPYRIGHTOWNER_HEADER, copyrightowner,
                               n_copyrightowner);

          get_tags(metadata, COPYRIGHTOWNER_HEADER, copyrightowner,
          ...
          if (counter > 0) {
            ...
            for (item = 0; item < counter; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_CR_OWNER_NAME,
                                 tagdata[item][0], COL_CR_OWNER_ID,
                                 tagdata[item][1], -1);
            }
          } else {
            gint item;
          ...
          counter = count_tags(metadata, IMAGECREATOR_HEADER, imagecreator,
                               n_imagecreator);

          get_tags(metadata, IMAGECREATOR_HEADER, imagecreator, n_imagecreator,
                   counter);
          ...
          counter = count_tags(metadata, ARTWORKOROBJECT_HEADER,
                               artworkorobject, n_artworkorobject);

          get_tags(metadata, ARTWORKOROBJECT_HEADER, artworkorobject,
          ...
          if (counter > 0) {
            ...
            for (item = 0; item < counter; item++) {
              ...
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(
                  liststore, &iter, COL_AOO_TITLE, tagdata[item][4],
                  COL_AOO_DATE_CREAT, tagdata[item][0], COL_AOO_CREATOR,
                  tagdata[item][5], COL_AOO_SOURCE, tagdata[item][1],
                  COL_AOO_SRC_INV_ID, tagdata[item][2], COL_AOO_CR_NOT,
                  tagdata[item][3], -1);
            }
          } else {
            gint item;
          ...
          counter =
              count_tags(metadata, REGISTRYID_HEADER, registryid, n_registryid);

          get_tags(metadata, REGISTRYID_HEADER, registryid, n_registryid,
                   counter);
          ...
          counter = count_tags(metadata, LOCATIONSHOWN_HEADER, locationshown,
                               n_locationshown);

          get_tags(metadata, LOCATIONSHOWN_HEADER, locationshown,
          ...
          /* LOCATION SHOWN - CITY */
          column =
              gtk_tree_view_get_column(GTK_TREE_VIEW(widget), COL_LOC_SHO_CITY);
          rlist = gtk_cell_layout_get_cells(GTK_CELL_LAYOUT(column));
          for (r = rlist; r; r = r->next) {
            renderer = r->data;
          ...
          if (counter > 0) {
            ...
            for (item = 0; item < counter; item++) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(
                  liststore, &iter, COL_LOC_SHO_SUB_LOC, tagdata[item][0],
                  COL_LOC_SHO_CITY, tagdata[item][1], COL_LOC_SHO_STATE_PROV,
                  tagdata[item][2], COL_LOC_SHO_CNTRY, tagdata[item][3],
                  COL_LOC_SHO_CNTRY_ISO, tagdata[item][4],
                  COL_LOC_SHO_CNTRY_WRLD_REG, tagdata[item][5], -1);
            }

            if (counter == 1) {
              gtk_list_store_append(liststore, &iter);
              gtk_list_store_set(liststore, &iter, COL_LOC_SHO_SUB_LOC, NULL,
                                 COL_LOC_SHO_CITY, NULL, COL_LOC_SHO_STATE_PROV,
                                 NULL, COL_LOC_SHO_CNTRY, NULL,
                                 COL_LOC_SHO_CNTRY_ISO, NULL,
                                 COL_LOC_SHO_CNTRY_WRLD_REG, NULL, -1);
            }
          } else {
            gint item;
...
static void set_tag_failed(const gchar *tag) {
  g_log("", G_LOG_LEVEL_MESSAGE, _("Failed to set metadata tag %s"), tag);
}

static void set_tag_string(GimpMetadata *metadata, const gchar *name,
                           const gchar *value) {
  ...
  if (!gexiv2_metadata_set_tag_string(GEXIV2_METADATA(metadata), name, value)) {
    set_tag_failed(name);
  }
}
...
static void set_gps_longitude_latitude(GimpMetadata *metadata, const gchar *tag,
  ...
  g_log(ME_LOG_DOMAIN, G_LOG_LEVEL_DEBUG,
        "set_gps_longitude_latitude - Tag %s, Input value: %s", tag, value);
  ...
  if (s && s[0] != '\0') {
    ...
    g_log(ME_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "String split into: %s - %s - %s",
          str1, str2, str3);
  }
  ...
  if (str1 && str2 && str3) {
    ...
    seconds =
        ((val - (gdouble)degrees - (gdouble)(minutes / 60.f)) * 60.f * 60.f);
  } else
    remove_val = TRUE;

  if (!remove_val) {
    g_log(ME_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "Converted values: %d - %d - %f",
          degrees, minutes, seconds);
    g_snprintf(lng_lat, sizeof(lng_lat), "%d/1 %d/1 %d/1000", abs(degrees),
               abs(minutes), abs((gint)(seconds * 1000.f)));
    g_log(ME_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "Tag: %s, output string: %s", tag,
          lng_lat);

    if (!gexiv2_metadata_set_tag_string(GEXIV2_METADATA(metadata), tag,
                                        lng_lat)) {
      set_tag_failed(tag);
    }
  } else {
...
void metadata_editor_write_callback(GtkWidget *dialog, GtkBuilder *builder,
  ...
  list_widget =
      builder_get_widget(builder, "Xmp.iptcExt.OrganisationInImageName");
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      gtk_tree_model_get(treemodel, &iter, COL_ORG_IMG_NAME, &rc_data, -1);
      if (rc_data && *rc_data) {
  ...
  set_tag_string(g_metadata, "Xmp.iptcExt.OrganisationInImageName",
                 output_data);

  /* DO ORG IMG CODE (LISTSTORE) */

  list_widget =
      builder_get_widget(builder, "Xmp.iptcExt.OrganisationInImageCode");
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      gtk_tree_model_get(treemodel, &iter, COL_ORG_IMG_CODE, &rc_data, -1);
      if (rc_data && *rc_data) {
        strcat(output_data, rc_data);
        if (row + 1 < number_of_rows)
          strcat(output_data, ", ");
  ...
  set_tag_string(g_metadata, "Xmp.iptcExt.OrganisationInImageCode",
                 output_data);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      gtk_tree_model_get(treemodel, &iter, COL_MOD_REL_ID, &rc_data, -1);
      if (rc_data && *rc_data) {
        strcat(output_data, rc_data);
        if (row + 1 < number_of_rows)
          strcat(output_data, ", ");
  ...
  set_tag_string(g_metadata, "Xmp.plus.ModelReleaseID", output_data);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      gtk_tree_model_get(treemodel, &iter, COL_PROP_REL_ID, &rc_data, -1);
      if (rc_data && *rc_data) {
        strcat(output_data, rc_data);
        if (row + 1 < number_of_rows)
          strcat(output_data, ", ");
  ...
  set_tag_string(g_metadata, "Xmp.plus.PropertyReleaseID", output_data);
  ...
  gexiv2_metadata_clear_tag(GEXIV2_METADATA(g_metadata), LOCATIONSHOWN_HEADER);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_locationshown; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", LOCATIONSHOWN_HEADER, row,
                 locationshown[item]);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_SUB_LOC, &tag_data, -1);

      g_snprintf(tag, sizeof(tag), "%s[%d]%s", LOCATIONSHOWN_HEADER, counter,
                 locationshown[0]);

      set_tag_string(g_metadata, tag, tag_data);
      g_free(tag_data);

      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_CITY, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_STATE_PROV, &tag_data,
                         -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_CNTRY, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_CNTRY_ISO, &tag_data,
                         -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LOC_SHO_CNTRY_WRLD_REG,
                         &tag_data, -1);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_artworkorobject; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", ARTWORKOROBJECT_HEADER, row,
                 artworkorobject[item]);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      ...
      gtk_tree_model_get(treemodel, &iter, COL_AOO_TITLE, &tag_data, -1);

      g_snprintf(tag, sizeof(tag), "%s[%d]%s", ARTWORKOROBJECT_HEADER, counter,
                 artworkorobject[0]);

      set_tag_string(g_metadata, tag, tag_data);
      g_free(tag_data);

      gtk_tree_model_get(treemodel, &iter, COL_AOO_DATE_CREAT, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_AOO_CREATOR, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_AOO_SOURCE, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_AOO_SRC_INV_ID, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_AOO_CR_NOT, &tag_data, -1);
  ...
  gexiv2_metadata_clear_tag(GEXIV2_METADATA(g_metadata), REGISTRYID_HEADER);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_registryid; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", REGISTRYID_HEADER, row,
                 registryid[item]);
  ...
  gexiv2_metadata_clear_tag(GEXIV2_METADATA(g_metadata), IMAGECREATOR_HEADER);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_imagecreator; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", IMAGECREATOR_HEADER, row,
                 imagecreator[item]);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      ...
      gtk_tree_model_get(treemodel, &iter, COL_IMG_CR8_NAME, &tag_data, -1);

      g_snprintf(tag, sizeof(tag), "%s[%d]%s", IMAGECREATOR_HEADER, counter,
                 imagecreator[0]);

      set_tag_string(g_metadata, tag, tag_data);
      g_free(tag_data);

      gtk_tree_model_get(treemodel, &iter, COL_IMG_CR8_ID, &tag_data, -1);
  ...
  gexiv2_metadata_clear_tag(GEXIV2_METADATA(g_metadata), COPYRIGHTOWNER_HEADER);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_copyrightowner; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", COPYRIGHTOWNER_HEADER, row,
                 copyrightowner[item]);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      ...
      gtk_tree_model_get(treemodel, &iter, COL_CR_OWNER_NAME, &tag_data, -1);

      g_snprintf(tag, sizeof(tag), "%s[%d]%s", COPYRIGHTOWNER_HEADER, counter,
                 copyrightowner[0]);

      set_tag_string(g_metadata, tag, tag_data);
      g_free(tag_data);

      gtk_tree_model_get(treemodel, &iter, COL_CR_OWNER_ID, &tag_data, -1);
  ...
  gexiv2_metadata_clear_tag(GEXIV2_METADATA(g_metadata), LICENSOR_HEADER);
  ...
  for (row = 0; row < 256; row++) {
    ...
    for (item = 0; item < n_licensor; item++) {
      g_snprintf(tag, sizeof(tag), "%s[%d]%s", LICENSOR_HEADER, row,
                 licensor[item]);
  ...
  for (row = 0; row < number_of_rows; row++) {
    if (gtk_tree_model_iter_nth_child(treemodel, &iter, NULL, row)) {
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_NAME, &tag_data, -1);

      g_snprintf(tag, sizeof(tag), "%s[%d]%s", LICENSOR_HEADER, counter,
                 licensor[0]);

      set_tag_string(g_metadata, tag, tag_data);
      g_free(tag_data);

      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_ID, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_PHONE1, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_PHONE_TYPE1, &tag_data,
                         -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_PHONE2, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_PHONE_TYPE2, &tag_data,
                         -1);
      ...
      if (tag_data != NULL) {
        for (types = 0; types < 6; types++) {
          ...
          if (!strcmp(tag_data, gettext(phone_types[types].display))) {
            g_log(ME_LOG_DOMAIN, G_LOG_LEVEL_DEBUG, "%d %s", types,
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_EMAIL, &tag_data, -1);
      ...
      gtk_tree_model_get(treemodel, &iter, COL_LICENSOR_WEB, &tag_data, -1);
  ...
  if (hasCreatorTagData(builder)) {
    ...
    for (i = 0; i < creatorContactInfoHeader.size; i++) {
      GObject *object =
          gtk_builder_get_object(builder, creatorContactInfoTags[i].id);
  ...
  for (i = 0; i < max_elements; i++) {
    GObject *object =
        gtk_builder_get_object(builder, default_metadata_tags[i].tag);
    ...
    if (!strcmp("single", default_metadata_tags[i].mode)) {
      ...
      if (!strcmp("Exif.GPSInfo.GPSLongitude", default_metadata_tags[i].tag) ||
          !strcmp("Exif.GPSInfo.GPSLatitude", default_metadata_tags[i].tag)) {
        set_gps_longitude_latitude(g_metadata, default_metadata_tags[i].tag,
                                   value_entry);
      } else if (!strcmp("Exif.GPSInfo.GPSAltitude",
                         default_metadata_tags[i].tag)) {
        GtkWidget *combo_widget;
        ...
        if (index > -1) {
          ...
          if (!gexiv2_metadata_set_tag_string(
                  GEXIV2_METADATA(g_metadata),
                  equivalent_metadata_tags[index].tag, text_value)) {
    ...
    /* MULTI TAGS */
      ...
      if (index > -1) {
        ...
        if (!gexiv2_metadata_set_tag_multiple(
                GEXIV2_METADATA(g_metadata),
                equivalent_metadata_tags[index].tag, (const gchar **)multi)) {
          set_tag_failed(equivalent_metadata_tags[index].tag);
        }
    ...
    /* COMBO TAGS */
      ...
      if (!strcmp("Xmp.photoshop.Urgency", default_metadata_tags[i].tag)) {
        ...
        if (value == 0) {
          ...
          gexiv2_metadata_set_tag_string(GEXIV2_METADATA(g_metadata),
                                         "Iptc.Application2.Urgency", save);
          g_free(save);
        }
      } else if (!strcmp("Xmp.xmpRights.Marked",
                         default_metadata_tags[i].tag)) {
...
static void import_dialog_metadata(metadata_editor *args) {
  ...
  file_dialog = gtk_file_chooser_dialog_new(
      _("Import Metadata File"), NULL, GTK_FILE_CHOOSER_ACTION_OPEN,
      _("_Cancel"), GTK_RESPONSE_CANCEL, _("_Import"), GTK_RESPONSE_ACCEPT,
      NULL);

  gtk_file_chooser_set_filename(GTK_FILE_CHOOSER(file_dialog), args->filename);
...
static void export_dialog_metadata(metadata_editor *args) {
  ...
  file_dialog = gtk_file_chooser_dialog_new(
      _("Export Metadata File"), NULL, GTK_FILE_CHOOSER_ACTION_SAVE,
      _("_Cancel"), GTK_RESPONSE_CANCEL, _("_Export"), GTK_RESPONSE_ACCEPT,
      NULL);
