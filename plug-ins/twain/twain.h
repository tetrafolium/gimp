...
#define TWCC_FILEWRITEERROR                                                    \
  22 /* Error writing the file (meant for things like disk full conditions) */
...
typedef TW_UINT16 (*DSMENTRYPROC)(pTW_IDENTITY, pTW_IDENTITY, TW_UINT32,
...
__declspec(dllexport) TW_UINT16 FAR PASCAL
    DS_Entry(pTW_IDENTITY pOrigin, TW_UINT32 DG, TW_UINT16 DAT, TW_UINT16 MSG,
             TW_MEMREF pData);
#else  /* _WIN32 */
...
typedef TW_UINT16 (*DSENTRYPROC)(pTW_IDENTITY, TW_UINT32, TW_UINT16, TW_UINT16,
                                 TW_MEMREF);
#endif /* _MSWIN_ */
...
/*  16-bit twain.  This allows 16/32-bit thunking. */
                     ...
                     */
#pragma option -a.  /*(Mentor October 30, 1996) switch back to original        \
                       alignment */
