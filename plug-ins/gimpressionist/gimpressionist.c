...
GtkWidget *create_one_column_list(
  ...
  column = gtk_tree_view_column_new_with_attributes("Preset", renderer, "text",
                                                    0, NULL);
...
static GtkWidget *create_dialog(void) {
  ...
  dialog = gimp_dialog_new(_("GIMPressionist"), PLUG_IN_ROLE, NULL, 0,
...
gint create_gimpressionist(void) {
  pcvals.run = FALSE;
