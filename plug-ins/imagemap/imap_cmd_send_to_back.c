...
static CommandClass_t send_to_back_command_class = {
    ...
    send_to_back_command_execute, NULL, /* send_to_back_command_undo */
...
static void remove_one_object(Object_t *obj, gpointer data) {
...
static void add_one_object(Object_t *obj, gpointer data) {
  SendToBackCommand_t *command = (SendToBackCommand_t *)data;
  command_add_subcommand(&command->parent,
