...
static void set_sensitive(const gchar *path, gboolean sensitive) {
  GtkAction *action = gtk_ui_manager_get_action(ui_manager, path);
  g_object_set(action, "sensitive", sensitive, NULL);
}

static void menu_mru(GtkWidget *widget, gpointer data) {
  MRU_t *mru = get_mru();
...
void menu_set_zoom(gint factor) { menu_set_zoom_sensitivity(factor); }
...
static void command_list_changed(Command_t *command, gpointer data) {
  GtkAction *action;
  gchar *label;
  ...
  g_object_set(action, "label", label, "sensitive", command != NULL, NULL);
  g_free(label);
...
static void paste_buffer_added(Object_t *obj, gpointer data) {
  set_sensitive("/MainMenu/EditMenu/Paste", TRUE);
}

static void paste_buffer_removed(Object_t *obj, gpointer data) {
...
static const GtkActionEntry entries[] = {
    ...
    {"Open", GIMP_ICON_DOCUMENT_OPEN, N_("_Open..."), NULL, N_("Open"),
     do_file_open_dialog},
    {"Save", GIMP_ICON_DOCUMENT_SAVE, N_("_Save..."), NULL, N_("Save"), save},
    {"SaveAs", GIMP_ICON_DOCUMENT_SAVE_AS, N_("Save _As..."),
     "<shift><control>S", NULL, do_file_save_as_dialog},
    {"Close", GIMP_ICON_CLOSE, N_("_Close"), "<primary>w", NULL, do_close},
    {"Quit", GIMP_ICON_APPLICATION_EXIT, N_("_Quit"), "<primary>q", NULL,
     do_quit},

    {"EditMenu", NULL, N_("_Edit")},
    {"Undo", GIMP_ICON_EDIT_UNDO, N_("_Undo"), NULL, N_("Undo"), do_undo},
    {"Redo", GIMP_ICON_EDIT_REDO, N_("_Redo"), NULL, N_("Redo"), do_redo},
    {"Cut", GIMP_ICON_EDIT_CUT, N_("Cu_t"), "<primary>x", N_("Cut"), do_cut},
    {"Copy", GIMP_ICON_EDIT_COPY, N_("_Copy"), "<primary>c", N_("Copy"),
     do_copy},
    {"Paste", GIMP_ICON_EDIT_PASTE, N_("_Paste"), "<primary>v", N_("Paste"),
     do_paste},
    {"Clear", GIMP_ICON_EDIT_DELETE, N_("_Delete"), NULL, N_("Delete"),
     do_clear},
    {"SelectAll", NULL, N_("Select _All"), "<primary>A", NULL, do_select_all},
    {"DeselectAll", NULL, N_("D_eselect All"), "<shift><primary>A", NULL,
     do_deselect_all},
    {"EditAreaInfo", GIMP_ICON_EDIT, N_("Edit Area _Info..."), NULL,
     N_("Edit selected area info"), do_edit_selected_shape},
    {"Preferences", GIMP_ICON_PREFERENCES_SYSTEM, N_("_Preferences"), NULL,
     N_("Preferences"), do_preferences_dialog},
    ...
    {"ZoomIn", GIMP_ICON_ZOOM_IN, N_("Zoom _In"), "plus", N_("Zoom in"),
     do_zoom_in},
    {"ZoomOut", GIMP_ICON_ZOOM_OUT, N_("Zoom _Out"), "minus", N_("Zoom out"),
     do_zoom_out},
...
static const GtkToggleActionEntry toggle_entries[] = {
    ...
    {"Grid", GIMP_ICON_GRID, N_("_Grid"), NULL, N_("Grid"), toggle_grid,
     FALSE}};
...
static const GtkRadioActionEntry mapping_entries[] = {
    {"Arrow", GIMP_ICON_CURSOR, N_("Arrow"), NULL, N_("Select existing area"),
     0},
    {"Rectangle", IMAP_RECTANGLE, N_("Rectangle"), NULL,
     N_("Define Rectangle area"), 1},
    {"Circle", IMAP_CIRCLE, N_("Circle"), NULL, N_("Define Circle/Oval area"),
     2},
    {"Polygon", IMAP_POLYGON, N_("Polygon"), NULL, N_("Define Polygon area"),
     3},
};
...
static const gchar ui_description[] = "<ui>"
...
void menu_build_mru_items(MRU_t *mru) {
  ...
  for (p = mru->list; p; p = p->next, i++) {
    GtkWidget *item = insert_item_with_label(
        _menu.open_recent, position++, (gchar *)p->data, menu_mru, p->data);
    if (i < 9) {
...
void menu_check_grid(gboolean check) {
  GtkAction *action =
      gtk_ui_manager_get_action(ui_manager, "/MainMenu/ToolsMenu/Grid");
