...
static CommandClass_t move_sash_command_class = {
    move_sash_command_destruct, move_sash_command_execute, NULL /*undo*/,
...
Command_t *move_sash_command_new(GtkWidget *widget, Object_t *obj, gint x,
                                 gint y, MoveSashFunc_t sash_func) {
  ...
  parent =
      command_init(&command->parent, _("Move Sash"), &move_sash_command_class);
