...
static CommandClass_t object_up_command_class = {
    object_up_command_destruct, object_up_command_execute,
    object_up_command_undo, NULL /* object_up_command_redo */
};
...
Command_t *object_up_command_new(ObjectList_t *list, Object_t *obj) {
  ...
  return command_init(&command->parent, _("Move Up"), &object_up_command_class);
}
