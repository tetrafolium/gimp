...
#define GIMP_THUMBNAIL(obj)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_THUMBNAIL, GimpThumbnail))
#define GIMP_THUMBNAIL_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_THUMBNAIL, GimpThumbnailClass))
#define GIMP_IS_THUMBNAIL(obj)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_THUMBNAIL))
#define GIMP_IS_THUMBNAIL_CLASS(klass)                                         \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_THUMBNAIL))
#define GIMP_THUMBNAIL_GET_CLASS(obj)                                          \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_THUMBNAIL, GimpThumbnailClass))
...
void gimp_thumbnail_delete_others(GimpThumbnail *thumbnail, GimpThumbSize size);
