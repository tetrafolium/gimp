 ...
 *          @drawable is invalid.
 **/
guchar *gimp_drawable_get_thumbnail_data(GimpDrawable *drawable, gint *width,
  ...
  _gimp_drawable_thumbnail(drawable, *width, *height, &ret_width, &ret_height,
                           bpp, &data_size, &image_data);
 ...
 * Since: 2.2
 **/
GdkPixbuf *gimp_drawable_get_thumbnail(GimpDrawable *drawable, gint width,
                                       gint height,
  ...
  data = gimp_drawable_get_thumbnail_data(drawable, &thumb_width, &thumb_height,
                                          &thumb_bpp);

  if (data)
    return _gimp_pixbuf_from_data(data, thumb_width, thumb_height, thumb_bpp,
                                  alpha);
 ...
 *          @drawable is invalid.
 **/
guchar *gimp_drawable_get_sub_thumbnail_data(GimpDrawable *drawable, gint src_x,
  ...
  _gimp_drawable_sub_thumbnail(drawable, src_x, src_y, src_width, src_height,
                               *dest_width, *dest_height, &ret_width,
                               &ret_height, bpp, &data_size, &image_data);
 ...
 * Since: 2.2
 **/
GdkPixbuf *gimp_drawable_get_sub_thumbnail(GimpDrawable *drawable, gint src_x,
                                           gint src_y, gint src_width,
                                           gint src_height, gint dest_width,
                                           gint dest_height,
                                           GimpPixbufTransparency alpha) {
  ...
  data = gimp_drawable_get_sub_thumbnail_data(drawable, src_x, src_y, src_width,
                                              src_height, &thumb_width,
                                              &thumb_height, &thumb_bpp);
...
const Babl *gimp_drawable_get_format(GimpDrawable *drawable) {
  ...
  if (format_str) {
    ...
    if (gimp_drawable_is_indexed(drawable)) {
      ...
      babl_new_palette_with_space(format_str, space, &palette, &palette_alpha);
