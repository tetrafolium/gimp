...
#define GIMP_TYPE_GRADIENT_SELECT_BUTTON                                       \
  (gimp_gradient_select_button_get_type())
#define GIMP_GRADIENT_SELECT_BUTTON(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_GRADIENT_SELECT_BUTTON,         \
                              GimpGradientSelectButton))
#define GIMP_GRADIENT_SELECT_BUTTON_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_GRADIENT_SELECT_BUTTON,          \
                           GimpGradientSelectButtonClass))
#define GIMP_IS_GRADIENT_SELECT_BUTTON(obj)                                    \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_GRADIENT_SELECT_BUTTON))
#define GIMP_IS_GRADIENT_SELECT_BUTTON_CLASS(klass)                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_GRADIENT_SELECT_BUTTON))
#define GIMP_GRADIENT_SELECT_BUTTON_GET_CLASS(obj)                             \
...
struct _GimpGradientSelectButtonClass {
  ...
  void (*gradient_set)(GimpGradientSelectButton *button,
                       ...
                       const gdouble *gradient_data, gboolean dialog_closing);
