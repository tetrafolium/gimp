 ...
 * @spacing: The initial spacing of the brush (if < 0 then use brush default
 *spacing).
...
gboolean gimp_brushes_popup(const gchar *brush_callback,
                            ...
                            const gchar *initial_brush, gdouble opacity,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, brush_callback, G_TYPE_STRING, popup_title,
      G_TYPE_STRING, initial_brush, G_TYPE_DOUBLE, opacity, G_TYPE_INT, spacing,
      GIMP_TYPE_LAYER_MODE, paint_mode, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-brushes-popup", args);
...
gboolean gimp_brushes_close_popup(const gchar *brush_callback) {
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, brush_callback,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-brushes-close-popup", args);
  gimp_value_array_unref(args);
...
gboolean gimp_brushes_set_popup(const gchar *brush_callback,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, brush_callback, G_TYPE_STRING, brush_name,
      G_TYPE_DOUBLE, opacity, G_TYPE_INT, spacing, GIMP_TYPE_LAYER_MODE,
      paint_mode, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-brushes-set-popup", args);
  gimp_value_array_unref(args);
