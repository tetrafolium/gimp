...
#define GIMP_PALETTE_SELECT_BUTTON(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PALETTE_SELECT_BUTTON,          \
                              GimpPaletteSelectButton))
#define GIMP_PALETTE_SELECT_BUTTON_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PALETTE_SELECT_BUTTON,           \
                           GimpPaletteSelectButtonClass))
#define GIMP_IS_PALETTE_SELECT_BUTTON(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PALETTE_SELECT_BUTTON))
#define GIMP_IS_PALETTE_SELECT_BUTTON_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PALETTE_SELECT_BUTTON))
#define GIMP_PALETTE_SELECT_BUTTON_GET_CLASS(obj)                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PALETTE_SELECT_BUTTON,           \
                             GimpPaletteSelectButtonClass))
...
struct _GimpPaletteSelectButtonClass {
  ...
  void (*palette_set)(GimpPaletteSelectButton *button,
                      const gchar *palette_name, gboolean dialog_closing);
