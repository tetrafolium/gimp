 ...
 * Since: 2.10
 **/
GimpItem *gimp_item_transform_translate(GimpItem *item, gdouble off_x,
                                        gdouble off_y) {
  GimpValueArray *args;
  ...
  args =
      gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item, G_TYPE_DOUBLE,
                                      off_x, G_TYPE_DOUBLE, off_y, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-translate", args);
...
GimpItem *gimp_item_transform_flip_simple(GimpItem *item,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, GIMP_TYPE_ORIENTATION_TYPE, flip_type,
      G_TYPE_BOOLEAN, auto_center, G_TYPE_DOUBLE, axis, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-flip-simple", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_flip(GimpItem *item, gdouble x0, gdouble y0,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_DOUBLE, x0, G_TYPE_DOUBLE, y0,
      G_TYPE_DOUBLE, x1, G_TYPE_DOUBLE, y1, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-transform-flip", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_perspective(GimpItem *item, gdouble x0,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_DOUBLE, x0, G_TYPE_DOUBLE, y0,
      G_TYPE_DOUBLE, x1, G_TYPE_DOUBLE, y1, G_TYPE_DOUBLE, x2, G_TYPE_DOUBLE,
      y2, G_TYPE_DOUBLE, x3, G_TYPE_DOUBLE, y3, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-perspective", args);
  gimp_value_array_unref(args);
...
GimpItem *gimp_item_transform_rotate_simple(GimpItem *item,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, GIMP_TYPE_ROTATION_TYPE, rotate_type,
      G_TYPE_BOOLEAN, auto_center, G_TYPE_DOUBLE, center_x, G_TYPE_DOUBLE,
      center_y, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-rotate-simple", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_rotate(GimpItem *item, gdouble angle,
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item,
                                         G_TYPE_DOUBLE, angle, G_TYPE_BOOLEAN,
                                         auto_center, G_TYPE_DOUBLE, center_x,
                                         G_TYPE_DOUBLE, center_y, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-rotate", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_scale(GimpItem *item, gdouble x0, gdouble y0,
                                    gdouble x1, gdouble y1) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  GimpItem *ret_item = NULL;
  ...
  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-transform-scale", args);
  gimp_value_array_unref(args);
...
GimpItem *gimp_item_transform_shear(GimpItem *item,
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item,
                                         ...
                                         G_TYPE_DOUBLE, magnitude, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-transform-shear", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_2d(GimpItem *item, gdouble source_x,
                                 gdouble source_y, gdouble scale_x,
                                 gdouble scale_y, gdouble angle, gdouble dest_x,
                                 gdouble dest_y) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  GimpItem *ret_item = NULL;
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_DOUBLE, source_x, G_TYPE_DOUBLE,
      source_y, G_TYPE_DOUBLE, scale_x, G_TYPE_DOUBLE, scale_y, G_TYPE_DOUBLE,
      angle, G_TYPE_DOUBLE, dest_x, G_TYPE_DOUBLE, dest_y, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-transform-2d", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpItem *gimp_item_transform_matrix(GimpItem *item, gdouble coeff_0_0,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_DOUBLE, coeff_0_0, G_TYPE_DOUBLE,
      coeff_0_1, G_TYPE_DOUBLE, coeff_0_2, G_TYPE_DOUBLE, coeff_1_0,
      G_TYPE_DOUBLE, coeff_1_1, G_TYPE_DOUBLE, coeff_1_2, G_TYPE_DOUBLE,
      coeff_2_0, G_TYPE_DOUBLE, coeff_2_1, G_TYPE_DOUBLE, coeff_2_2,
      G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-transform-matrix", args);
  gimp_value_array_unref(args);
