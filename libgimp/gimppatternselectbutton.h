...
#define GIMP_PATTERN_SELECT_BUTTON(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PATTERN_SELECT_BUTTON,          \
                              GimpPatternSelectButton))
#define GIMP_PATTERN_SELECT_BUTTON_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PATTERN_SELECT_BUTTON,           \
                           GimpPatternSelectButtonClass))
#define GIMP_IS_PATTERN_SELECT_BUTTON(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PATTERN_SELECT_BUTTON))
#define GIMP_IS_PATTERN_SELECT_BUTTON_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PATTERN_SELECT_BUTTON))
#define GIMP_PATTERN_SELECT_BUTTON_GET_CLASS(obj)                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PATTERN_SELECT_BUTTON,           \
                             GimpPatternSelectButtonClass))
...
struct _GimpPatternSelectButtonClass {
  ...
  void (*pattern_set)(GimpPatternSelectButton *button,
                      const gchar *pattern_name, gint width, gint height,
                      gint bpp, const guchar *mask_data,
