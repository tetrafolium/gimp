 ...
 **/
gboolean gimp_fonts_popup(const gchar *font_callback, const gchar *popup_title,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, font_callback, G_TYPE_STRING, popup_title,
      G_TYPE_STRING, initial_font, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-fonts-popup", args);
...
gboolean gimp_fonts_close_popup(const gchar *font_callback) {
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, font_callback,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-fonts-close-popup", args);
  gimp_value_array_unref(args);
...
gboolean gimp_fonts_set_popup(const gchar *font_callback,
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, font_callback,
                                         G_TYPE_STRING, font_name, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-fonts-set-popup", args);
  gimp_value_array_unref(args);
