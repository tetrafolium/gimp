...
#define GIMP_PROC_ARG_BOOLEAN(procedure, name, nick, blurb, default, flags)    \
  gimp_procedure_add_argument(                                                 \
      procedure, g_param_spec_boolean(name, nick, blurb, default, flags))

#define GIMP_PROC_AUX_ARG_BOOLEAN(procedure, name, nick, blurb, default,       \
                                  flags)                                       \
...
#define GIMP_PROC_ARG_INT(procedure, name, nick, blurb, min, max, default,     \
                          flags)                                               \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      g_param_spec_int(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_AUX_ARG_INT(procedure, name, nick, blurb, min, max, default, \
                              flags)                                           \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      g_param_spec_int(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_VAL_INT(procedure, name, nick, blurb, min, max, default,     \
                          flags)                                               \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      g_param_spec_int(name, nick, blurb, min, max, default, flags))
...
#define GIMP_PROC_ARG_UINT(procedure, name, nick, blurb, min, max, default,    \
                           flags)                                              \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      g_param_spec_uint(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_AUX_ARG_UINT(procedure, name, nick, blurb, min, max,         \
                               default, flags)                                 \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      g_param_spec_uint(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_VAL_UINT(procedure, name, nick, blurb, min, max, default,    \
                           flags)                                              \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      g_param_spec_uint(name, nick, blurb, min, max, default, flags))
...
#define GIMP_PROC_ARG_UCHAR(procedure, name, nick, blurb, min, max, default,   \
                            flags)                                             \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      g_param_spec_uchar(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_AUX_ARG_UCHAR(procedure, name, nick, blurb, min, max,        \
                                default, flags)                                \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      g_param_spec_uchar(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_VAL_UCHAR(procedure, name, nick, blurb, min, max, default,   \
                            flags)                                             \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      g_param_spec_uchar(name, nick, blurb, min, max, default, flags))
...
#define GIMP_PROC_ARG_UNIT(procedure, name, nick, blurb, pixels, percent,      \
                           default, flags)                                     \
  gimp_procedure_add_argument(procedure,                                       \
                              gimp_param_spec_unit(name, nick, blurb, pixels,  \
                                                   percent, default, flags))

#define GIMP_PROC_AUX_ARG_UNIT(procedure, name, nick, blurb, pixels, percent,  \
                               default, flags)                                 \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_unit(name, nick, blurb, pixels, percent,      \
                                      default, flags))

#define GIMP_PROC_VAL_UNIT(procedure, name, nick, blurb, pixels, percent,      \
                           default, flags)                                     \
  gimp_procedure_add_return_value(                                             \
      procedure, gimp_param_spec_unit(name, nick, blurb, pixels, percent,      \
                                      default, flags))
...
#define GIMP_PROC_ARG_DOUBLE(procedure, name, nick, blurb, min, max, default,  \
                             flags)                                            \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      g_param_spec_double(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_AUX_ARG_DOUBLE(procedure, name, nick, blurb, min, max,       \
                                 default, flags)                               \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      g_param_spec_double(name, nick, blurb, min, max, default, flags))

#define GIMP_PROC_VAL_DOUBLE(procedure, name, nick, blurb, min, max, default,  \
                             flags)                                            \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      g_param_spec_double(name, nick, blurb, min, max, default, flags))
...
#define GIMP_PROC_ARG_ENUM(procedure, name, nick, blurb, enum_type, default,   \
                           flags)                                              \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      g_param_spec_enum(name, nick, blurb, enum_type, default, flags))

#define GIMP_PROC_AUX_ARG_ENUM(procedure, name, nick, blurb, enum_type,        \
                               default, flags)                                 \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      g_param_spec_enum(name, nick, blurb, enum_type, default, flags))

#define GIMP_PROC_VAL_ENUM(procedure, name, nick, blurb, enum_type, default,   \
                           flags)                                              \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      g_param_spec_enum(name, nick, blurb, enum_type, default, flags))
...
#define GIMP_PROC_ARG_STRING(procedure, name, nick, blurb, default, flags)     \
  gimp_procedure_add_argument(                                                 \
      procedure, g_param_spec_string(name, nick, blurb, default, flags))
...
#define GIMP_PROC_ARG_RGB(procedure, name, nick, blurb, has_alpha, default,    \
                          flags)                                               \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      gimp_param_spec_rgb(name, nick, blurb, has_alpha, default, flags))

#define GIMP_PROC_AUX_ARG_RGB(procedure, name, nick, blurb, has_alpha,         \
                              default, flags)                                  \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      gimp_param_spec_rgb(name, nick, blurb, has_alpha, default, flags))

#define GIMP_PROC_VAL_RGB(procedure, name, nick, blurb, has_alpha, default,    \
                          flags)                                               \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      gimp_param_spec_rgb(name, nick, blurb, has_alpha, default, flags))
...
#define GIMP_PROC_ARG_PARASITE(procedure, name, nick, blurb, flags)            \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_parasite(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_PARAM(procedure, name, nick, blurb, param_type, flags)   \
  gimp_procedure_add_argument(                                                 \
      procedure, g_param_spec_param(name, nick, blurb, param_type, flags))

#define GIMP_PROC_AUX_ARG_PARAM(procedure, name, nick, blurb, param_type,      \
                                flags)                                         \
  gimp_procedure_add_aux_argument(                                             \
      procedure, g_param_spec_param(name, nick, blurb, param_type, flags))
...
#define GIMP_PROC_ARG_UINT8_ARRAY(procedure, name, nick, blurb, flags)         \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_uint8_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_INT16_ARRAY(procedure, name, nick, blurb, flags)         \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_int16_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_INT32_ARRAY(procedure, name, nick, blurb, flags)         \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_int32_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_FLOAT_ARRAY(procedure, name, nick, blurb, flags)         \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_float_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_STRING_ARRAY(procedure, name, nick, blurb, flags)        \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_string_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_RGB_ARRAY(procedure, name, nick, blurb, flags)           \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_rgb_array(name, nick, blurb, flags))
...
#define GIMP_PROC_ARG_OBJECT_ARRAY(procedure, name, nick, blurb, object_type,  \
                                   flags)                                      \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      gimp_param_spec_object_array(name, nick, blurb, object_type, flags))

#define GIMP_PROC_AUX_ARG_OBJECT_ARRAY(procedure, name, nick, blurb,           \
                                       object_type, flags)                     \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      gimp_param_spec_object_array(name, nick, blurb, object_type, flags))

#define GIMP_PROC_VAL_OBJECT_ARRAY(procedure, name, nick, blurb, object_type,  \
                                   flags)                                      \
  gimp_procedure_add_return_value(                                             \
      procedure,                                                               \
      gimp_param_spec_object_array(name, nick, blurb, object_type, flags))
...
#define GIMP_VALUES_SET_OBJECT_ARRAY(args, n, object_type, value, length)      \
  gimp_value_set_object_array(gimp_value_array_index(args, n), object_type,    \
                              (gpointer)value, length)

#define GIMP_VALUES_TAKE_OBJECT_ARRAY(args, n, object_type, value, length)     \
  gimp_value_take_object_array(gimp_value_array_index(args, n), object_type,   \
                               (gpointer)value, length)
...
#define GIMP_PROC_ARG_DISPLAY(procedure, name, nick, blurb, none_ok, flags)    \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_display(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_DISPLAY(procedure, name, nick, blurb, none_ok,       \
                                  flags)                                       \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_display(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_IMAGE(procedure, name, nick, blurb, none_ok, flags)      \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_image(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_ITEM(procedure, name, nick, blurb, none_ok, flags)       \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_item(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_DRAWABLE(procedure, name, nick, blurb, none_ok, flags)   \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_drawable(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_DRAWABLE(procedure, name, nick, blurb, none_ok,      \
                                   flags)                                      \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_drawable(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_LAYER(procedure, name, nick, blurb, none_ok, flags)      \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_layer(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_CHANNEL(procedure, name, nick, blurb, none_ok, flags)    \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_channel(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_CHANNEL(procedure, name, nick, blurb, none_ok,       \
                                  flags)                                       \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_channel(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_VAL_CHANNEL(procedure, name, nick, blurb, none_ok, flags)    \
  gimp_procedure_add_return_value(                                             \
      procedure, gimp_param_spec_channe(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_LAYER_MASK(procedure, name, nick, blurb, none_ok, flags) \
  gimp_procedure_add_argument(                                                 \
      procedure,                                                               \
      gimp_param_spec_layer_mask(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_LAYER_MASK(procedure, name, nick, blurb, none_ok,    \
                                     flags)                                    \
  gimp_procedure_add_aux_argument(                                             \
      procedure,                                                               \
      gimp_param_spec_layer_mask(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_SELECTION(procedure, name, nick, blurb, none_ok, flags)  \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_selection(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_SELECTION(procedure, name, nick, blurb, none_ok,     \
                                    flags)                                     \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_selection(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_VECTORS(procedure, name, nick, blurb, none_ok, flags)    \
  gimp_procedure_add_argument(                                                 \
      procedure, gimp_param_spec_vectors(name, nick, blurb, none_ok, flags))

#define GIMP_PROC_AUX_ARG_VECTORS(procedure, name, nick, blurb, none_ok,       \
                                  flags)                                       \
  gimp_procedure_add_aux_argument(                                             \
      procedure, gimp_param_spec_vectors(name, nick, blurb, none_ok, flags))
...
#define GIMP_PROC_ARG_FILE(procedure, name, nick, blurb, flags)                \
  gimp_procedure_add_argument(                                                 \
      procedure, g_param_spec_object(name, nick, blurb, G_TYPE_FILE, flags))
