 ...
 * @title: gimpprogress
 * @short_description: Functions for embedding the progress bar into a plug-in's
 *GUI.
 *
 ...
 * @gdisplay: (nullable): GimpDisplay to update progressbar in, or %NULL for a
 *separate window.
 *
 ...
 **/
gboolean _gimp_progress_init(const gchar *message, GimpDisplay *gdisplay) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, message, GIMP_TYPE_DISPLAY, gdisplay, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-progress-init", args);
 ...
 * @percentage: Percentage of progress completed which must be between 0.0
 *and 1.0.
 *
...
gboolean _gimp_progress_update(gdouble percentage) {
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_DOUBLE, percentage,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-progress-update", args);
  gimp_value_array_unref(args);
...
gboolean gimp_progress_pulse(void) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-progress-pulse", args);
  gimp_value_array_unref(args);
...
gboolean gimp_progress_end(void) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-progress-end", args);
  gimp_value_array_unref(args);
...
gint gimp_progress_get_window_handle(void) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-progress-get-window-handle", args);
  gimp_value_array_unref(args);
...
gboolean _gimp_progress_install(const gchar *progress_callback) {
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, progress_callback,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-progress-install", args);
  gimp_value_array_unref(args);
