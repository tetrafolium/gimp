 ...
 **/
gchar *_gimp_pdb_temp_name(void) {
  GimpValueArray *args;
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-pdb-temp-name", args);
 ...
 **/
gboolean _gimp_pdb_dump(GFile *file) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(NULL, G_TYPE_FILE, file, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-pdb-dump", args);
  gimp_value_array_unref(args);
 ...
 * @proc_type: The regex for procedure type: { 'Internal GIMP procedure', 'GIMP
 *Plug-in', 'GIMP Extension', 'Temporary Procedure' }.
 * @num_matches: (out): The number of matching procedures.
 * @procedure_names: (out) (array length=num_matches) (element-type gchar*)
 *(transfer full): The list of procedure names.
 *
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_query(const gchar *name, const gchar *blurb,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, name, G_TYPE_STRING, blurb, G_TYPE_STRING, help,
      G_TYPE_STRING, authors, G_TYPE_STRING, copyright, G_TYPE_STRING, date,
      G_TYPE_STRING, proc_type, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-pdb-query", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.6
 **/
gboolean _gimp_pdb_proc_exists(const gchar *procedure_name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean exists = FALSE;

  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-pdb-proc-exists", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_get_proc_info(const gchar *procedure_name,
 ...
 * Since: 3.0
 **/
GParamSpec *_gimp_pdb_get_proc_argument(const gchar *procedure_name,
                                        gint arg_num) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         G_TYPE_INT, arg_num, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-argument", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
GParamSpec *_gimp_pdb_get_proc_return_value(const gchar *procedure_name,
                                            gint val_num) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  GParamSpec *param_spec = NULL;
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         G_TYPE_INT, val_num, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-return-value", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_set_proc_image_types(const gchar *procedure_name,
  ...
  args =
      gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                      G_TYPE_STRING, image_types, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-proc-image-types", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gchar *_gimp_pdb_get_proc_image_types(const gchar *procedure_name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-image-types", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_set_proc_menu_label(const gchar *procedure_name,
  ...
  args =
      gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                      G_TYPE_STRING, menu_label, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-proc-menu-label", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gchar *_gimp_pdb_get_proc_menu_label(const gchar *procedure_name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-menu-label", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_add_proc_menu_path(const gchar *procedure_name,
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         G_TYPE_STRING, menu_path, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-add-proc-menu-path", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gchar **_gimp_pdb_get_proc_menu_paths(const gchar *procedure_name,
                                      gint *num_menu_paths) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-menu-paths", args);
  gimp_value_array_unref(args);
 ...
 * @icon_data: (array length=icon_data_length) (element-type guint8): The
 *procedure's icon. The format depends on the 'icon_type' parameter.
 *
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_set_proc_icon(const gchar *procedure_name,
                                 GimpIconType icon_type, gint icon_data_length,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, procedure_name, GIMP_TYPE_ICON_TYPE, icon_type,
      G_TYPE_INT, icon_data_length, GIMP_TYPE_UINT8_ARRAY, NULL, G_TYPE_NONE);
  gimp_value_set_uint8_array(gimp_value_array_index(args, 3), icon_data,
                             icon_data_length);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-pdb-set-proc-icon", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_set_proc_documentation(const gchar *procedure_name,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, procedure_name, G_TYPE_STRING, blurb, G_TYPE_STRING,
      help, G_TYPE_STRING, help_id, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-proc-documentation", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_get_proc_documentation(const gchar *procedure_name,
                                          gchar **blurb, gchar **help,
                                          gchar **help_id) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-documentation", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_set_proc_attribution(const gchar *procedure_name,
                                        const gchar *authors,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, procedure_name, G_TYPE_STRING, authors,
      G_TYPE_STRING, copyright, G_TYPE_STRING, date, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-proc-attribution", args);
  gimp_value_array_unref(args);
 ...
 * Since: 3.0
 **/
gboolean _gimp_pdb_get_proc_attribution(const gchar *procedure_name,
                                        gchar **authors, gchar **copyright,
                                        gchar **date) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-get-proc-attribution", args);
  gimp_value_array_unref(args);
 ...
 * @extensions: comma separated list of extensions this handler can load (i.e.
 *\"jpg,jpeg\").
 * @prefixes: comma separated list of prefixes this handler can load (i.e.
 *\"http:,ftp:\").
 * @magics: comma separated list of magic file information this handler can load
 *(i.e. \"0,string,GIF\").
 *
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_set_file_proc_load_handler(const gchar *procedure_name,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, procedure_name, G_TYPE_STRING, extensions,
      G_TYPE_STRING, prefixes, G_TYPE_STRING, magics, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-load-handler", args);
  gimp_value_array_unref(args);
 ...
 * @extensions: comma separated list of extensions this handler can save (i.e.
 *\"jpg,jpeg\").
 * @prefixes: comma separated list of prefixes this handler can save (i.e.
 *\"http:,ftp:\").
 *
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_set_file_proc_save_handler(const gchar *procedure_name,
                                              const gchar *extensions,
                                              const gchar *prefixes) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         ...
                                         G_TYPE_STRING, prefixes, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-save-handler", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10.6
 **/
gboolean _gimp_pdb_set_file_proc_priority(const gchar *procedure_name,
                                          gint priority) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                         G_TYPE_INT, priority, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-priority", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.2
 **/
gboolean _gimp_pdb_set_file_proc_mime_types(const gchar *procedure_name,
  ...
  args =
      gimp_value_array_new_from_types(NULL, G_TYPE_STRING, procedure_name,
                                      G_TYPE_STRING, mime_types, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-mime-types", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10
 **/
gboolean _gimp_pdb_set_file_proc_handles_remote(const gchar *procedure_name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-handles-remote", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10
 **/
gboolean _gimp_pdb_set_file_proc_handles_raw(const gchar *procedure_name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-handles-raw", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.2
 **/
gboolean _gimp_pdb_set_file_proc_thumbnail_loader(const gchar *load_proc,
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, load_proc, G_TYPE_STRING, thumb_proc, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-pdb-set-file-proc-thumbnail-loader", args);
  gimp_value_array_unref(args);
 ...
 * @data: (out) (array length=bytes) (element-type guint8) (transfer full): A
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_get_data(const gchar *identifier, gint *bytes,
                            guint8 **data) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(NULL, G_TYPE_STRING, identifier,
                                         G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-pdb-get-data", args);
  gimp_value_array_unref(args);
 ...
 **/
gint _gimp_pdb_get_data_size(const gchar *identifier) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gint bytes = 0;
 ...
 * @data: (array length=bytes) (element-type guint8): A byte array containing
 *data.
 *
 ...
 * Returns: TRUE on success.
 **/
gboolean _gimp_pdb_set_data(const gchar *identifier, gint bytes,
                            const guint8 *data) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  args = gimp_value_array_new_from_types(
      NULL, G_TYPE_STRING, identifier, G_TYPE_INT, bytes, GIMP_TYPE_UINT8_ARRAY,
      NULL, G_TYPE_NONE);
  gimp_value_set_uint8_array(gimp_value_array_index(args, 2), data, bytes);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-pdb-set-data", args);
  gimp_value_array_unref(args);
