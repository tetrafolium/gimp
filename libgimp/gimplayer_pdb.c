 ...
 **/
GimpLayer *_gimp_layer_new(GimpImage *image, gint width, gint height,
                           GimpImageType type, const gchar *name,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_IMAGE, image, G_TYPE_INT, width, G_TYPE_INT, height,
      GIMP_TYPE_IMAGE_TYPE, type, G_TYPE_STRING, name, G_TYPE_DOUBLE, opacity,
      GIMP_TYPE_LAYER_MODE, mode, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-new", args);
 ...
 * Since: 2.6
 **/
GimpLayer *gimp_layer_new_from_visible(GimpImage *image, GimpImage *dest_image,
                                       const gchar *name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  GimpLayer *layer = NULL;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-new-from-visible", args);
  gimp_value_array_unref(args);
...
GimpLayer *gimp_layer_new_from_drawable(GimpDrawable *drawable,
  ...
  args =
      gimp_value_array_new_from_types(NULL, GIMP_TYPE_DRAWABLE, drawable,
                                      GIMP_TYPE_IMAGE, dest_image, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-new-from-drawable", args);
  gimp_value_array_unref(args);
 ...
 * Returns: (transfer none): The newly copied layer.
 **/
GimpLayer *_gimp_layer_copy(GimpLayer *layer, gboolean add_alpha) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  GimpLayer *layer_copy = NULL;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_BOOLEAN, add_alpha, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-copy", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_flatten(GimpLayer *layer) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-flatten", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_scale(GimpLayer *layer, gint new_width, gint new_height,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_INT, new_width, G_TYPE_INT,
      new_height, G_TYPE_BOOLEAN, local_origin, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-scale", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_resize(GimpLayer *layer, gint new_width, gint new_height,
                           gint offx, gint offy) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_INT, new_width, G_TYPE_INT,
      new_height, G_TYPE_INT, offx, G_TYPE_INT, offy, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-resize", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_resize_to_image_size(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-resize-to-image-size", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_offsets(GimpLayer *layer, gint offx, gint offy) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args =
      gimp_value_array_new_from_types(NULL, GIMP_TYPE_LAYER, layer, G_TYPE_INT,
                                      offx, G_TYPE_INT, offy, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-set-offsets", args);
  gimp_value_array_unref(args);
...
GimpLayerMask *gimp_layer_get_mask(GimpLayer *layer) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-get-mask", args);
  gimp_value_array_unref(args);
...
GimpLayer *gimp_layer_from_mask(GimpLayerMask *mask) {
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_LAYER_MASK, mask,
                                         G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-from-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_add_mask(GimpLayer *layer, GimpLayerMask *mask) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, GIMP_TYPE_LAYER_MASK, mask, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-add-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_remove_mask(GimpLayer *layer, GimpMaskApplyMode mode) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
...
gboolean gimp_layer_is_floating_sel(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-is-floating-sel", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_get_lock_alpha(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-get-lock-alpha", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_lock_alpha(GimpLayer *layer, gboolean lock_alpha) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_BOOLEAN, lock_alpha, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-set-lock-alpha", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_get_apply_mask(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-get-apply-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_apply_mask(GimpLayer *layer, gboolean apply_mask) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_BOOLEAN, apply_mask, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-set-apply-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_show_mask(GimpLayer *layer, gboolean show_mask) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_BOOLEAN, show_mask, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-set-show-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_edit_mask(GimpLayer *layer, gboolean edit_mask) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, G_TYPE_BOOLEAN, edit_mask, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-layer-set-edit-mask", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_opacity(GimpLayer *layer, gdouble opacity) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
...
GimpLayerMode gimp_layer_get_mode(GimpLayer *layer) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-get-mode", args);
  gimp_value_array_unref(args);
 ...
 * Returns: TRUE on success.
 **/
gboolean gimp_layer_set_mode(GimpLayer *layer, GimpLayerMode mode) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_LAYER, layer, GIMP_TYPE_LAYER_MODE, mode, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-layer-set-mode", args);
  gimp_value_array_unref(args);
...
GimpLayerColorSpace gimp_layer_get_blend_space(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-get-blend-space", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_set_blend_space(GimpLayer *layer,
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_LAYER, layer,
                                         ...
                                         blend_space, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-set-blend-space", args);
  gimp_value_array_unref(args);
...
GimpLayerColorSpace gimp_layer_get_composite_space(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-get-composite-space", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_set_composite_space(GimpLayer *layer,
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_LAYER, layer,
                                         GIMP_TYPE_LAYER_COLOR_SPACE,
                                         composite_space, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-set-composite-space", args);
  gimp_value_array_unref(args);
...
GimpLayerCompositeMode gimp_layer_get_composite_mode(GimpLayer *layer) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-get-composite-mode", args);
  gimp_value_array_unref(args);
...
gboolean gimp_layer_set_composite_mode(GimpLayer *layer,
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_LAYER, layer,
                                         ...
                                         composite_mode, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-layer-set-composite-mode", args);
  gimp_value_array_unref(args);
