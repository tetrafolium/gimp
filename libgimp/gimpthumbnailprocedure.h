...
#define GIMP_THUMBNAIL_PROCEDURE(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_THUMBNAIL_PROCEDURE,            \
                              GimpThumbnailProcedure))
#define GIMP_THUMBNAIL_PROCEDURE_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_THUMBNAIL_PROCEDURE,             \
                           GimpThumbnailProcedureClass))
#define GIMP_IS_THUMBNAIL_PROCEDURE(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_THUMBNAIL_PROCEDURE))
#define GIMP_IS_THUMBNAIL_PROCEDURE_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_THUMBNAIL_PROCEDURE))
#define GIMP_THUMBNAIL_PROCEDURE_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_THUMBNAIL_PROCEDURE,             \
                             GimpThumbnailProcedureClass))
