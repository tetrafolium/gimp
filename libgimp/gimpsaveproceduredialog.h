...
#define GIMP_SAVE_PROCEDURE_DIALOG(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_SAVE_PROCEDURE_DIALOG,          \
                              GimpSaveProcedureDialog))
#define GIMP_SAVE_PROCEDURE_DIALOG_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_SAVE_PROCEDURE_DIALOG,           \
                           GimpSaveProcedureDialogClass))
#define GIMP_IS_SAVE_PROCEDURE_DIALOG(obj)                                     \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_SAVE_PROCEDURE_DIALOG))
#define GIMP_IS_SAVE_PROCEDURE_DIALOG_CLASS(klass)                             \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_SAVE_PROCEDURE_DIALOG))
#define GIMP_SAVE_PROCEDURE_DIALOG_GET_CLASS(obj)                              \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_SAVE_PROCEDURE_DIALOG,           \
                             GimpSaveProcedureDialogClass))
