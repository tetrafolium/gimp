...
static gboolean gimp_param_image_validate(GParamSpec *pspec, GValue *value);
...
GType gimp_param_image_get_type(void) {
  ...
  if (!type) {
    ...
    type =
        g_type_register_static(G_TYPE_PARAM_OBJECT, "GimpParamImage", &info, 0);
  }
...
static gboolean gimp_param_image_validate(GParamSpec *pspec, GValue *value) {
  ...
  if (image && (!GIMP_IS_IMAGE(image) || !gimp_image_is_valid(image))) {
...
GParamSpec *gimp_param_spec_image(const gchar *name, const gchar *nick,
  ...
  ispec =
      g_param_spec_internal(GIMP_TYPE_PARAM_IMAGE, name, nick, blurb, flags);
...
static gboolean gimp_param_item_validate(GParamSpec *pspec, GValue *value);
...
GType gimp_param_item_get_type(void) {
  ...
  if (!type) {
    ...
    type =
        g_type_register_static(G_TYPE_PARAM_OBJECT, "GimpParamItem", &info, 0);
  }
...
GParamSpec *gimp_param_spec_item(const gchar *name, const gchar *nick,
  ...
  ispec = g_param_spec_internal(GIMP_TYPE_PARAM_ITEM, name, nick, blurb, flags);
...
GType gimp_param_drawable_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ITEM, "GimpParamDrawable",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_drawable(const gchar *name, const gchar *nick,
  ...
  ispec =
      g_param_spec_internal(GIMP_TYPE_PARAM_DRAWABLE, name, nick, blurb, flags);
...
GType gimp_param_layer_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_DRAWABLE, "GimpParamLayer",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_layer(const gchar *name, const gchar *nick,
  ...
  ispec =
      g_param_spec_internal(GIMP_TYPE_PARAM_LAYER, name, nick, blurb, flags);
...
GType gimp_param_channel_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_DRAWABLE, "GimpParamChannel",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_channel(const gchar *name, const gchar *nick,
  ...
  ispec =
      g_param_spec_internal(GIMP_TYPE_PARAM_CHANNEL, name, nick, blurb, flags);
...
GType gimp_param_layer_mask_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_CHANNEL, "GimpParamLayerMask",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_layer_mask(const gchar *name, const gchar *nick,
  ...
  ispec = g_param_spec_internal(GIMP_TYPE_PARAM_LAYER_MASK, name, nick, blurb,
                                flags);
...
GType gimp_param_selection_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_CHANNEL, "GimpParamSelection",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_selection(const gchar *name, const gchar *nick,
  ...
  ispec = g_param_spec_internal(GIMP_TYPE_PARAM_SELECTION, name, nick, blurb,
                                flags);
...
GType gimp_param_vectors_get_type(void) {
  static GType type = 0;
  ...
  if (!type) {
    ...
    type = g_type_register_static(GIMP_TYPE_PARAM_ITEM, "GimpParamVectors",
                                  &info, 0);
  }
...
GParamSpec *gimp_param_spec_vectors(const gchar *name, const gchar *nick,
  ...
  ispec =
      g_param_spec_internal(GIMP_TYPE_PARAM_VECTORS, name, nick, blurb, flags);
...
static gboolean gimp_param_display_validate(GParamSpec *pspec, GValue *value);
...
GType gimp_param_display_get_type(void) {
  ...
  if (!type) {
    ...
    type = g_type_register_static(G_TYPE_PARAM_OBJECT, "GimpParamDisplay",
                                  &info, 0);
  }
...
static gboolean gimp_param_display_validate(GParamSpec *pspec, GValue *value) {
  ...
  if (display &&
      (!GIMP_IS_DISPLAY(display) || !gimp_display_is_valid(display))) {
...
GParamSpec *gimp_param_spec_display(const gchar *name, const gchar *nick,
  ...
  dspec =
      g_param_spec_internal(GIMP_TYPE_PARAM_DISPLAY, name, nick, blurb, flags);
