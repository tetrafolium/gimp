...
static GimpValueArray *gimp_load_procedure_run(GimpProcedure *procedure,
                                               const GimpValueArray *args);
static GimpProcedureConfig *
gimp_load_procedure_create_config(GimpProcedure *procedure, GParamSpec **args,
                                  gint n_args);
...
static void gimp_load_procedure_class_init(GimpLoadProcedureClass *klass) {
...
static void gimp_load_procedure_init(GimpLoadProcedure *procedure) {
...
static void gimp_load_procedure_constructed(GObject *object) {
  ...
  GIMP_PROC_ARG_FILE(procedure, "file", "File", "The file to load",
                     GIMP_PARAM_READWRITE);

  GIMP_PROC_VAL_IMAGE(procedure, "image", "Image", "Output image", TRUE,
                      GIMP_PARAM_READWRITE);
}
...
static GimpValueArray *gimp_load_procedure_run(GimpProcedure *procedure,
  ...
  return_values = load_proc->priv->run_func(
      procedure, run_mode, file, remaining, load_proc->priv->run_data);
...
GimpProcedure *gimp_load_procedure_new(GimpPlugIn *plug_in, const gchar *name,
  ...
  procedure = g_object_new(GIMP_TYPE_LOAD_PROCEDURE, "plug-in", plug_in, "name",
 ...
 * Since: 3.0
 **/
gint gimp_load_procedure_get_handles_raw(GimpLoadProcedure *procedure) {
