...
#define GIMP_BRUSH_SELECT_BUTTON(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_BRUSH_SELECT_BUTTON,            \
                              GimpBrushSelectButton))
#define GIMP_BRUSH_SELECT_BUTTON_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_BRUSH_SELECT_BUTTON,             \
                           GimpBrushSelectButtonClass))
#define GIMP_IS_BRUSH_SELECT_BUTTON(obj)                                       \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_BRUSH_SELECT_BUTTON))
#define GIMP_IS_BRUSH_SELECT_BUTTON_CLASS(klass)                               \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_BRUSH_SELECT_BUTTON))
#define GIMP_BRUSH_SELECT_BUTTON_GET_CLASS(obj)                                \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_BRUSH_SELECT_BUTTON,             \
                             GimpBrushSelectButtonClass))
...
struct _GimpBrushSelectButtonClass {
  ...
  void (*brush_set)(GimpBrushSelectButton *button, const gchar *brush_name,
                    gdouble opacity, gint spacing, GimpLayerMode paint_mode,
                    gint width, gint height, const guchar *mask_data,
