...
#define GIMP_FONT_SELECT_BUTTON(obj)                                           \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_FONT_SELECT_BUTTON,             \
                              GimpFontSelectButton))
#define GIMP_FONT_SELECT_BUTTON_CLASS(klass)                                   \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_FONT_SELECT_BUTTON,              \
                           GimpFontSelectButtonClass))
#define GIMP_IS_FONT_SELECT_BUTTON(obj)                                        \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_FONT_SELECT_BUTTON))
#define GIMP_IS_FONT_SELECT_BUTTON_CLASS(klass)                                \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_FONT_SELECT_BUTTON))
#define GIMP_FONT_SELECT_BUTTON_GET_CLASS(obj)                                 \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_FONT_SELECT_BUTTON,              \
                             GimpFontSelectButtonClass))
...
struct _GimpFontSelectButtonClass {
  ...
  void (*font_set)(GimpFontSelectButton *button, const gchar *font_name,
