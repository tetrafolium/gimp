 ...
 * Since: 2.10
 **/
guint8 *_gimp_image_get_color_profile(GimpImage *image, gint *num_bytes) {
  GimpValueArray *args;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-get-color-profile", args);
 ...
 * Since: 2.10
 **/
guint8 *_gimp_image_get_effective_color_profile(GimpImage *image,
                                                gint *num_bytes) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  guint8 *profile_data = NULL;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-get-effective-color-profile", args);
  gimp_value_array_unref(args);
 ...
 * @color_profile: (array length=num_bytes) (element-type guint8): The new
 *serialized color profile.
 *
 ...
 * Since: 2.10
 **/
gboolean _gimp_image_set_color_profile(GimpImage *image, gint num_bytes,
  ...
  gimp_value_set_uint8_array(gimp_value_array_index(args, 2), color_profile,
                             num_bytes);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-set-color-profile", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10
 **/
gboolean gimp_image_set_color_profile_from_file(GimpImage *image, GFile *file) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-set-color-profile-from-file", args);
  gimp_value_array_unref(args);
 ...
 * @image: The image.
 * @num_bytes: Number of bytes in the color_profile array.
 * @color_profile: (array length=num_bytes) (element-type guint8): The
 *serialized color profile.
 ...
 * Since: 2.10
 **/
gboolean _gimp_image_convert_color_profile(GimpImage *image, gint num_bytes,
                                           const guint8 *color_profile,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_IMAGE, image, G_TYPE_INT, num_bytes,
      GIMP_TYPE_UINT8_ARRAY, NULL, GIMP_TYPE_COLOR_RENDERING_INTENT, intent,
      G_TYPE_BOOLEAN, bpc, G_TYPE_NONE);
  gimp_value_set_uint8_array(gimp_value_array_index(args, 2), color_profile,
                             num_bytes);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-convert-color-profile", args);
  gimp_value_array_unref(args);
 ...
 **/
gboolean
gimp_image_convert_color_profile_from_file(GimpImage *image, GFile *file,
                                           GimpColorRenderingIntent intent,
                                           gboolean bpc) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  args =
      gimp_value_array_new_from_types(NULL, GIMP_TYPE_IMAGE, image, G_TYPE_FILE,
                                      file, GIMP_TYPE_COLOR_RENDERING_INTENT,
                                      intent, G_TYPE_BOOLEAN, bpc, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-image-convert-color-profile-from-file", args);
  gimp_value_array_unref(args);
