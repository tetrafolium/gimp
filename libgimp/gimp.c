...
gint gimp_main(GType plug_in_type, gint argc, gchar *argv[]) {
  ...
  /* Use Dr. Mingw (dumps backtrace on crash) if it is available. */
  {
     ...
     * system.
     */
    dir = g_build_filename(g_get_user_data_dir(), GIMPDIR, GIMP_USER_VERSION,
                           "CrashLog", NULL);
    ...
    if (!_prevExceptionFilter)
      _prevExceptionFilter =
          SetUnhandledExceptionFilter(gimp_plugin_sigfatal_handler);
...
#ifndef _WIN64
  {
    ...
    p_SetProcessDEPPolicy =
        GetProcAddress(GetModuleHandle("kernel32.dll"), "SetProcessDEPPolicy");
  ...
  PLUG_IN = g_object_new(plug_in_type, "read-channel", read_channel,
                         "write-channel", write_channel, NULL);
 ...
 * Since: 3.0
 **/
GimpPlugIn *gimp_get_plug_in(void) { return PLUG_IN; }
 ...
 **/
guint gimp_tile_width(void) { return _tile_width; }
 ...
 **/
guint gimp_tile_height(void) { return _tile_height; }
 ...
 * Since: 2.2
 **/
gboolean gimp_show_help_button(void) { return _show_help_button; }
 ...
 * Since: 2.10.4
 **/
gboolean gimp_export_color_profile(void) { return _export_color_profile; }
 ...
 * Since: 3.0
 **/
gboolean gimp_export_comment(void) { return _export_comment; }
 ...
 * Since: 2.10
 **/
gboolean gimp_export_exif(void) { return _export_exif; }
 ...
 * Since: 2.10
 **/
gboolean gimp_export_xmp(void) { return _export_xmp; }
 ...
 * Since: 2.10
 **/
gboolean gimp_export_iptc(void) { return _export_iptc; }
 ...
 * Since: 3.0
 **/
gint32 gimp_get_num_processors(void) { return _num_processors; }
 ...
 * Since: 2.2
 **/
GimpCheckSize gimp_check_size(void) { return _check_size; }
 ...
 * Since: 2.2
 **/
GimpCheckType gimp_check_type(void) { return _check_type; }
 ...
 **/
GimpDisplay *gimp_default_display(void) {
 ...
 **/
const gchar *gimp_wm_class(void) { return _wm_class; }
 ...
 **/
const gchar *gimp_display_name(void) { return _display_name; }
 ...
 **/
gint gimp_monitor_number(void) { return _monitor_number; }
 ...
 * Since: 2.6
 **/
guint32 gimp_user_time(void) { return _timestamp; }
 ...
 * Since: 2.10.4
 **/
const gchar *gimp_icon_theme_dir(void) { return _icon_theme_dir; }
 ...
 **/
const gchar *gimp_get_progname(void) { return progname; }
...
gimp_plugin_sigfatal_handler(PEXCEPTION_POINTERS pExceptionInfo) {
  ...
  if (_prevExceptionFilter &&
      _prevExceptionFilter != gimp_plugin_sigfatal_handler)
...
void _gimp_config(GPConfig *config) {
  ...
  g_object_set(gegl_config(), "tile-cache-size", config->tile_cache_size,
               "swap", path, "swap-compression", config->swap_compression,
               "threads", (gint)config->num_processors, "use-opencl",
               config->use_opencl, "application-license", "GPL3", NULL);
