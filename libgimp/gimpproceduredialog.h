...
#define GIMP_PROCEDURE_DIALOG(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), GIMP_TYPE_PROCEDURE_DIALOG,               \
                              GimpProcedureDialog))
#define GIMP_PROCEDURE_DIALOG_CLASS(klass)                                     \
  (G_TYPE_CHECK_CLASS_CAST((klass), GIMP_TYPE_PROCEDURE_DIALOG,                \
                           GimpProcedureDialogClass))
#define GIMP_IS_PROCEDURE_DIALOG(obj)                                          \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), GIMP_TYPE_PROCEDURE_DIALOG))
#define GIMP_IS_PROCEDURE_DIALOG_CLASS(klass)                                  \
  (G_TYPE_CHECK_CLASS_TYPE((klass), GIMP_TYPE_PROCEDURE_DIALOG))
#define GIMP_PROCEDURE_DIALOG_GET_CLASS(obj)                                   \
  (G_TYPE_INSTANCE_GET_CLASS((obj), GIMP_TYPE_PROCEDURE_DIALOG,                \
                             GimpProcedureDialogClass))
...
struct _GimpProcedureDialogClass {
  ...
  void (*fill_list)(GimpProcedureDialog *dialog, GimpProcedure *procedure,
                    GimpProcedureConfig *config, GList *properties);
