...
gboolean gimp_item_id_is_valid(gint item_id) {
  ...
  args =
      gimp_value_array_new_from_types(NULL, G_TYPE_INT, item_id, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-id-is-valid", args);
...
gboolean gimp_item_id_is_text_layer(gint item_id) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-id-is-text-layer", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_id_is_layer_mask(gint item_id) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-id-is-layer-mask", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_id_is_selection(gint item_id) {
  ...
  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-id-is-selection", args);
  gimp_value_array_unref(args);
...
GimpImage *gimp_item_get_image(GimpItem *item) {
  ...
  args =
      gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item, G_TYPE_NONE);

  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-item-get-image", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_delete(GimpItem *item) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-item-delete", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_is_group(GimpItem *item) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-item-is-group", args);
  gimp_value_array_unref(args);
 ...
 *
 * Returns: (array length=num_children) (element-type GimpItem) (transfer
 *container): The item's list of children. The returned value must be freed with
 *g_free().
 *
 * Since: 2.8
 **/
GimpItem **gimp_item_get_children(GimpItem *item, gint *num_children) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
    ...
    *num_children = GIMP_VALUES_GET_INT(return_vals, 1);
    {
      ...
      if (a)
        children = g_memdup(a->data, a->length * sizeof(gpointer));
    };
  }
...
gboolean gimp_item_set_expanded(GimpItem *item, gboolean expanded) {
  ...
  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item,
                                         G_TYPE_BOOLEAN, expanded, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-set-expanded", args);
  gimp_value_array_unref(args);
...
gchar *gimp_item_get_name(GimpItem *item) {
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-item-get-name", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
gboolean gimp_item_set_name(GimpItem *item, const gchar *name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals =
      gimp_pdb_run_procedure_array(gimp_get_pdb(), "gimp-item-set-name", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
gboolean gimp_item_set_visible(GimpItem *item, gboolean visible) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
 ...
 * Since: 2.8
 **/
gboolean gimp_item_set_linked(GimpItem *item, gboolean linked) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(NULL, GIMP_TYPE_ITEM, item,
                                         G_TYPE_BOOLEAN, linked, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-set-linked", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_get_lock_content(GimpItem *item) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-get-lock-content", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
gboolean gimp_item_set_lock_content(GimpItem *item, gboolean lock_content) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_BOOLEAN, lock_content, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-set-lock-content", args);
  gimp_value_array_unref(args);
...
gboolean gimp_item_get_lock_position(GimpItem *item) {
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-get-lock-position", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10
 **/
gboolean gimp_item_set_lock_position(GimpItem *item, gboolean lock_position) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, G_TYPE_BOOLEAN, lock_position, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-set-lock-position", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.10
 **/
gboolean gimp_item_set_color_tag(GimpItem *item, GimpColorTag color_tag) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;

  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, GIMP_TYPE_COLOR_TAG, color_tag, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-set-color-tag", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
gboolean gimp_item_set_tattoo(GimpItem *item, guint tattoo) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
...
gboolean gimp_item_attach_parasite(GimpItem *item,
  ...
  args = gimp_value_array_new_from_types(
      NULL, GIMP_TYPE_ITEM, item, GIMP_TYPE_PARASITE, parasite, G_TYPE_NONE);

  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-attach-parasite", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
gboolean gimp_item_detach_parasite(GimpItem *item, const gchar *name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  gboolean success = TRUE;
  ...
  return_vals = gimp_pdb_run_procedure_array(gimp_get_pdb(),
                                             "gimp-item-detach-parasite", args);
  gimp_value_array_unref(args);
 ...
 * Since: 2.8
 **/
GimpParasite *gimp_item_get_parasite(GimpItem *item, const gchar *name) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
 ...
 * Since: 2.8
 **/
gchar **gimp_item_get_parasite_list(GimpItem *item, gint *num_parasites) {
  GimpValueArray *args;
  GimpValueArray *return_vals;
  ...
  return_vals = gimp_pdb_run_procedure_array(
      gimp_get_pdb(), "gimp-item-get-parasite-list", args);
  gimp_value_array_unref(args);
