...
static void gimp_pdb_procedure_set_property(GObject *object, guint property_id,
                                            const GValue *value,
                                            GParamSpec *pspec);
static void gimp_pdb_procedure_get_property(GObject *object, guint property_id,
...
static void _gimp_pdb_procedure_class_init(GimpPDBProcedureClass *klass) {
  ...
  props[PROP_PDB] = g_param_spec_object(
      "pdb", "PDB", "The GimpPDB of this plug-in process", GIMP_TYPE_PDB,
      GIMP_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY);

  g_object_class_install_properties(object_class, N_PROPS, props);
}

static void _gimp_pdb_procedure_init(GimpPDBProcedure *procedure) {
...
GimpProcedure *_gimp_pdb_procedure_new(GimpPDB *pdb, const gchar *name) {
  ...
  procedure = g_object_new(GIMP_TYPE_PDB_PROCEDURE, "plug-in",
                           _gimp_pdb_get_plug_in(pdb), "name", name,
                           "procedure-type", type, "pdb", pdb, NULL);
